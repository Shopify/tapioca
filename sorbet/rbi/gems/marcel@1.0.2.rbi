...
#
# source://marcel-VERSION/lib/marcel.rb:1
module Marcel; end

# @private
#
# source://marcel-VERSION/lib/marcel/tables.rb:10
Marcel::EXTENSIONS = T.let(T.unsafe(nil), Hash)

# @private
#
# source://marcel-VERSION/lib/marcel/tables.rb:2154
Marcel::MAGIC = T.let(T.unsafe(nil), Array)

# Mime type detection
#
# source://marcel-VERSION/lib/marcel/magic.rb:12
class Marcel::Magic
  # Mime type by type string
  #
  # @return [Magic] a new instance of Magic
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:16
  ...
  # @return [Boolean]
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:102
  def ==(other); end

  # @return [Boolean]
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:53
  def audio?; end
  ...
  # @return [Boolean]
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:57
  def child_of?(parent); end

  # Get mime comment
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:67
  def comment; end
  ...
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:62
  def extensions; end

  # source://marcel-VERSION/lib/marcel/magic.rb:106
  def hash; end
  ...
  # @return [Boolean]
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:52
  def image?; end

  # Returns the value of attribute mediatype.
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:13
  def mediatype; end
  ...
  # @return [Boolean]
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:49
  def text?; end

  # Return type as string
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:97
  def to_s; end
  ...
  # @return [Boolean]
  #
  # source://marcel-VERSION/lib/marcel/magic.rb:54
  def video?; end
  ...
  class << self
    ...
    #
    # source://marcel-VERSION/lib/marcel/magic.rb:30
    def add(type, options); end

    # Lookup all mime types by magic content analysis.
    # This is a slower operation.
    #
    # source://marcel-VERSION/lib/marcel/magic.rb:92
    def all_by_magic(io); end

    # Lookup mime type by file extension
    #
    # source://marcel-VERSION/lib/marcel/magic.rb:72
    def by_extension(ext); end

    # Lookup mime type by magic content analysis.
    # This is a slow operation.
    #
    # source://marcel-VERSION/lib/marcel/magic.rb:85
    def by_magic(io); end

    # Lookup mime type by filename
    #
    # source://marcel-VERSION/lib/marcel/magic.rb:79
    def by_path(path); end

    # @return [Boolean]
    #
    # source://marcel-VERSION/lib/marcel/magic.rb:112
    ...
    #
    # source://marcel-VERSION/lib/marcel/magic.rb:42
    def remove(type); end

    private

    # source://marcel-VERSION/lib/marcel/magic.rb:116
    def magic_match(io, method); end

    # source://marcel-VERSION/lib/marcel/magic.rb:126
    def magic_match_io(io, matches, buffer); end
  end
end

# source://marcel-VERSION/lib/marcel/mime_type.rb:2
class Marcel::MimeType
  class << self
    # source://marcel-VERSION/lib/marcel/mime_type.rb:6
    def extend(type, extensions: T.unsafe(nil), parents: T.unsafe(nil), magic: T.unsafe(nil)); end

    # source://marcel-VERSION/lib/marcel/mime_type.rb:16
    def for(pathname_or_io = T.unsafe(nil), name: T.unsafe(nil), extension: T.unsafe(nil), declared_type: T.unsafe(nil)); end

    private

    # source://marcel-VERSION/lib/marcel/mime_type.rb:28
    def for_data(pathname_or_io); end

    # source://marcel-VERSION/lib/marcel/mime_type.rb:54
    def for_declared_type(declared_type); end

    # source://marcel-VERSION/lib/marcel/mime_type.rb:46
    def for_extension(extension); end

    # source://marcel-VERSION/lib/marcel/mime_type.rb:38
    ...
    #
    # source://marcel-VERSION/lib/marcel/mime_type.rb:80
    def most_specific_type(from_magic_type, fallback_type); end

    # source://marcel-VERSION/lib/marcel/mime_type.rb:70
    def parse_media_type(content_type); end

    # source://marcel-VERSION/lib/marcel/mime_type.rb:88
    def root_types(type); end

    # source://marcel-VERSION/lib/marcel/mime_type.rb:62
    def with_io(pathname_or_io, &block); end
  end
end

# source://marcel-VERSION/lib/marcel/mime_type.rb:3
Marcel::MimeType::BINARY = T.let(T.unsafe(nil), String)

# @private
#
# source://marcel-VERSION/lib/marcel/tables.rb:1261
Marcel::TYPES = T.let(T.unsafe(nil), Hash)

# source://marcel-VERSION/lib/marcel/version.rb:2
