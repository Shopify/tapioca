...
# source://activejob-VERSION/lib/active_job/gem_version.rb:3
module ActiveJob
  ...
  class << self
    ...
    #
    # source://activejob-VERSION/lib/active_job/gem_version.rb:5
    def gem_version; end

    # Returns the currently loaded version of Active Job as a <tt>Gem::Version</tt>.
    #
    # source://activejob-VERSION/lib/active_job/version.rb:7
    def version; end
  end
end

# source://activejob-VERSION/lib/active_job/arguments.rb:28
module ActiveJob::Arguments
  ...
  # GlobalID.
  #
  # source://activejob-VERSION/lib/active_job/arguments.rb:42
  ...
  # GlobalID.
  #
  # source://activejob-VERSION/lib/active_job/arguments.rb:34
  def serialize(arguments); end

  private

  # source://activejob-VERSION/lib/active_job/arguments.rb:204
  def convert_to_global_id_hash(argument); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/arguments.rb:151
  def custom_serialized?(hash); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:122
  def deserialize_argument(argument); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:147
  def deserialize_global_id(hash); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:161
  def deserialize_hash(serialized_hash); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:95
  def serialize_argument(argument); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:155
  def serialize_hash(argument); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:174
  def serialize_hash_key(key); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:185
  def serialize_indifferent_hash(indifferent_hash); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/arguments.rb:143
  def serialized_global_id?(hash); end

  # source://activejob-VERSION/lib/active_job/arguments.rb:191
  def transform_symbol_keys(hash, symbol_keys); end
end

# source://activejob-VERSION/lib/active_job/arguments.rb:52
ActiveJob::Arguments::GLOBALID_KEY = T.let(T.unsafe(nil), String)

# source://activejob-VERSION/lib/active_job/arguments.rb:60
ActiveJob::Arguments::OBJECT_SERIALIZER_KEY = T.let(T.unsafe(nil), String)

# source://activejob-VERSION/lib/active_job/arguments.rb:50
ActiveJob::Arguments::PERMITTED_TYPES = T.let(T.unsafe(nil), Array)

# source://activejob-VERSION/lib/active_job/arguments.rb:63
ActiveJob::Arguments::RESERVED_KEYS = T.let(T.unsafe(nil), Array)

# source://activejob-VERSION/lib/active_job/arguments.rb:56
ActiveJob::Arguments::RUBY2_KEYWORDS_KEY = T.let(T.unsafe(nil), String)

# source://activejob-VERSION/lib/active_job/arguments.rb:54
ActiveJob::Arguments::SYMBOL_KEYS_KEY = T.let(T.unsafe(nil), String)

# source://activejob-VERSION/lib/active_job/arguments.rb:58
...
#
# source://activejob-VERSION/lib/active_job/base.rb:63
class ActiveJob::Base
  ...
  # source://activejob-VERSION/lib/active_job/logging.rb:11
  def logger; end

  # source://activejob-VERSION/lib/active_job/logging.rb:11
  def logger=(val); end

  # source://activejob-VERSION/lib/active_job/queue_adapter.rb:15
  def queue_adapter(*_arg0, **_arg1, &_arg2); end

  # source://activejob-VERSION/lib/active_job/queue_name.rb:58
  ...
  class << self
    ...
    # source://activejob-VERSION/lib/active_job/queue_adapter.rb:13
    def _queue_adapter; end

    # source://activejob-VERSION/lib/active_job/queue_adapter.rb:13
    def _queue_adapter=(value); end

    # source://activejob-VERSION/lib/active_job/queue_adapter.rb:12
    def _queue_adapter_name; end

    # source://activejob-VERSION/lib/active_job/queue_adapter.rb:12
    def _queue_adapter_name=(value); end

    # source://activejob-VERSION/lib/active_job/test_helper.rb:19
    def _test_adapter; end

    # source://activejob-VERSION/lib/active_job/test_helper.rb:19
    def _test_adapter=(value); end

    # source://activejob-VERSION/lib/active_job/logging.rb:12
    ...
    # source://activejob-VERSION/lib/active_job/queue_priority.rb:32
    def priority; end
    ...
    # source://activejob-VERSION/lib/active_job/queue_name.rb:57
    ...
    # source://activejob-VERSION/lib/active_job/exceptions.rb:11
    def retry_jitter; end

    # source://activejob-VERSION/lib/active_job/exceptions.rb:11
    def retry_jitter=(value); end

    # source://activejob-VERSION/lib/active_job/callbacks.rb:31
...
#
# source://activejob-VERSION/lib/active_job/callbacks.rb:21
...
#
# source://activejob-VERSION/lib/active_job/callbacks.rb:41
module ActiveJob::Callbacks::ClassMethods
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/callbacks.rb:147
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/callbacks.rb:76
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/callbacks.rb:168
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/callbacks.rb:109
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/callbacks.rb:128
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/callbacks.rb:57
  def before_perform(*filters, &blk); end
end

# source://activejob-VERSION/lib/active_job/configured_job.rb:4
class ActiveJob::ConfiguredJob
  # @return [ConfiguredJob] a new instance of ConfiguredJob
  #
  # source://activejob-VERSION/lib/active_job/configured_job.rb:5
  def initialize(job_class, options = T.unsafe(nil)); end

  # source://activejob-VERSION/lib/active_job/configured_job.rb:14
  def perform_later(*_arg0, **_arg1, &_arg2); end

  # source://activejob-VERSION/lib/active_job/configured_job.rb:10
...
#
# source://activejob-VERSION/lib/active_job/core.rb:6
module ActiveJob::Core
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:91
  def initialize(*arguments, **_arg1); end

  # Job arguments
  #
  # source://activejob-VERSION/lib/active_job/core.rb:10
  def arguments; end
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:44
  def enqueued_at; end
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:35
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:29
  def executions; end
  ...
  # Job Identifier
  #
  # source://activejob-VERSION/lib/active_job/core.rb:17
  def job_id; end
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:38
  def locale; end
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:23
  def priority=(_arg0); end

  # ID optionally provided by adapter
  #
  # source://activejob-VERSION/lib/active_job/core.rb:26
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:20
  def queue_name=(_arg0); end

  # Timestamp when the job should be performed
  #
  # source://activejob-VERSION/lib/active_job/core.rb:14
  ...
  # queuing adapter.
  #
  # source://activejob-VERSION/lib/active_job/core.rb:104
  def serialize; end
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:11
  def serialized_arguments=(_arg0); end

  # Configures the job with the given options.
  #
  # source://activejob-VERSION/lib/active_job/core.rb:160
  def set(options = T.unsafe(nil)); end

  # Track whether the adapter received the job successfully.
  #
  # source://activejob-VERSION/lib/active_job/core.rb:47
  def successfully_enqueued=(_arg0); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/core.rb:49
  def successfully_enqueued?; end

  # Timezone to be used during the job.
  #
  # source://activejob-VERSION/lib/active_job/core.rb:41
  def timezone; end
  ...
  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/core.rb:193
  def arguments_serialized?; end

  # source://activejob-VERSION/lib/active_job/core.rb:189
  def deserialize_arguments(serialized_args); end

  # source://activejob-VERSION/lib/active_job/core.rb:178
  def deserialize_arguments_if_needed; end

  # source://activejob-VERSION/lib/active_job/core.rb:185
  def serialize_arguments(arguments); end

  # source://activejob-VERSION/lib/active_job/core.rb:170
...
#
# source://activejob-VERSION/lib/active_job/core.rb:58
module ActiveJob::Core::ClassMethods
  # Creates a new job instance from a hash created with +serialize+
  #
  # source://activejob-VERSION/lib/active_job/core.rb:60
  def deserialize(job_data); end
  ...
  #
  # source://activejob-VERSION/lib/active_job/core.rb:84
  def set(options = T.unsafe(nil)); end
end
...
#
# source://activejob-VERSION/lib/active_job/enqueuing.rb:10
class ActiveJob::EnqueueError < ::StandardError; end

# source://activejob-VERSION/lib/active_job/enqueuing.rb:12
module ActiveJob::Enqueuing
  ...
  #
  # source://activejob-VERSION/lib/active_job/enqueuing.rb:59
  def enqueue(options = T.unsafe(nil)); end
end

# Includes the +perform_later+ method for job initialization.
#
# source://activejob-VERSION/lib/active_job/enqueuing.rb:16
module ActiveJob::Enqueuing::ClassMethods
  ...
  # @yield [job]
  #
  # source://activejob-VERSION/lib/active_job/enqueuing.rb:28
  def perform_later(*_arg0, **_arg1, &_arg2); end

  private

  # source://activejob-VERSION/lib/active_job/enqueuing.rb:38
  def job_or_instantiate(*args, **_arg1); end
end

# Provides behavior for retrying and discarding jobs on exceptions.
#
# source://activejob-VERSION/lib/active_job/exceptions.rb:7
module ActiveJob::Exceptions
  ...
  #  end
  #
  # source://activejob-VERSION/lib/active_job/exceptions.rb:124
  def retry_job(options = T.unsafe(nil)); end

  private

  # source://activejob-VERSION/lib/active_job/exceptions.rb:134
  def determine_delay(seconds_or_duration_or_algorithm:, executions:, jitter: T.unsafe(nil)); end

  # source://activejob-VERSION/lib/active_job/exceptions.rb:154
  def determine_jitter_for_delay(delay, jitter); end

  # source://activejob-VERSION/lib/active_job/exceptions.rb:159
...
# source://activejob-VERSION/lib/active_job/exceptions.rb:14
module ActiveJob::Exceptions::ClassMethods
  ...
  #  end
  #
  # source://activejob-VERSION/lib/active_job/exceptions.rb:94
  ...
  #  end
  #
  # source://activejob-VERSION/lib/active_job/exceptions.rb:58
...
# source://activejob-VERSION/lib/active_job/exceptions.rb:131
ActiveJob::Exceptions::JITTER_DEFAULT = T.let(T.unsafe(nil), Object)

# source://activejob-VERSION/lib/active_job/execution.rb:7
module ActiveJob::Execution
  ...
  # source://activejob-VERSION/lib/active_job/execution.rb:51
  ...
  #
  # source://activejob-VERSION/lib/active_job/execution.rb:40
  def perform_now; end

  private

  # source://activejob-VERSION/lib/active_job/execution.rb:56
...
#
# source://activejob-VERSION/lib/active_job/execution.rb:12
module ActiveJob::Execution::ClassMethods
  # source://activejob-VERSION/lib/active_job/execution.rb:21
  ...
  #
  # source://activejob-VERSION/lib/active_job/execution.rb:17
  def perform_now(*_arg0, **_arg1, &_arg2); end
end

# source://activejob-VERSION/lib/active_job/instrumentation.rb:4
module ActiveJob::Instrumentation
  extend ::ActiveSupport::Concern

  # source://activejob-VERSION/lib/active_job/instrumentation.rb:13
  def perform_now; end

  private

  # source://activejob-VERSION/lib/active_job/instrumentation.rb:18
  def _perform_job; end

  # source://activejob-VERSION/lib/active_job/instrumentation.rb:39
  def halted_callback_hook(*_arg0); end

  # source://activejob-VERSION/lib/active_job/instrumentation.rb:23
  def instrument(operation, payload = T.unsafe(nil), &block); end
end

# source://activejob-VERSION/lib/active_job/log_subscriber.rb:7
class ActiveJob::LogSubscriber < ::ActiveSupport::LogSubscriber
  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:94
  def discard(event); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:8
  def enqueue(event); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:27
  def enqueue_at(event); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:71
  def enqueue_retry(event); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:53
  def perform(event); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:46
  def perform_start(event); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:85
  def retry_stopped(event); end

  private

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:108
  def args_info(job); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:117
  def format(arg); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:134
  def logger; end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:104
  def queue_name(event); end

  # source://activejob-VERSION/lib/active_job/log_subscriber.rb:130
  def scheduled_at(event); end
end

# source://activejob-VERSION/lib/active_job/logging.rb:7
module ActiveJob::Logging
  ...
  # source://activejob-VERSION/lib/active_job/logging.rb:17
  def perform_now; end
  ...
  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/logging.rb:31
  def logger_tagged_by_active_job?; end

  # source://activejob-VERSION/lib/active_job/logging.rb:22
...
#
# source://activejob-VERSION/lib/active_job/queue_adapter.rb:8
...
#
# source://activejob-VERSION/lib/active_job/queue_adapter.rb:21
module ActiveJob::QueueAdapter::ClassMethods
  # Returns the backend queue provider. The default queue adapter
  # is the +:async+ queue. See QueueAdapters for more information.
  #
  # source://activejob-VERSION/lib/active_job/queue_adapter.rb:24
  ...
  # information.
  #
  # source://activejob-VERSION/lib/active_job/queue_adapter.rb:37
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_adapter.rb:30
  def queue_adapter_name; end

  private

  # source://activejob-VERSION/lib/active_job/queue_adapter.rb:53
  def assign_adapter(adapter_name, queue_adapter); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/queue_adapter.rb:60
  def queue_adapter?(object); end
end

# source://activejob-VERSION/lib/active_job/queue_adapter.rb:58
...
#
# source://activejob-VERSION/lib/active_job/queue_adapters.rb:113
module ActiveJob::QueueAdapters
  ...
  class << self
    ...
    #
    # source://activejob-VERSION/lib/active_job/queue_adapters.rb:136
    def lookup(name); end
  end
end

# source://activejob-VERSION/lib/active_job/queue_adapters.rb:128
...
#
# source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:33
class ActiveJob::QueueAdapters::AsyncAdapter
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:35
  def initialize(**executor_options); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:39
  def enqueue(job); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:43
  def enqueue_at(job, timestamp); end

  # Used for our test suite.
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:55
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:50
...
#
# source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:63
class ActiveJob::QueueAdapters::AsyncAdapter::JobWrapper
  # @return [JobWrapper] a new instance of JobWrapper
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:64
  def initialize(job); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:69
  def perform; end
end

# source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:74
class ActiveJob::QueueAdapters::AsyncAdapter::Scheduler
  # @return [Scheduler] a new instance of Scheduler
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:86
  def initialize(**options); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:92
  def enqueue(job, queue_name:); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:96
  def enqueue_at(job, timestamp, queue_name:); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:110
  def executor; end

  # Returns the value of attribute immediate.
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:84
  def immediate; end
  ...
  # source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:105
  def shutdown(wait: T.unsafe(nil)); end
end

# source://activejob-VERSION/lib/active_job/queue_adapters/async_adapter.rb:75
...
#
# source://activejob-VERSION/lib/active_job/queue_adapters/inline_adapter.rb:13
class ActiveJob::QueueAdapters::InlineAdapter
  # source://activejob-VERSION/lib/active_job/queue_adapters/inline_adapter.rb:14
  def enqueue(job); end

  # @raise [NotImplementedError]
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/inline_adapter.rb:18
...
#
# source://activejob-VERSION/lib/active_job/queue_adapters/sidekiq_adapter.rb:19
class ActiveJob::QueueAdapters::SidekiqAdapter
  # source://activejob-VERSION/lib/active_job/queue_adapters/sidekiq_adapter.rb:20
  def enqueue(job); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/sidekiq_adapter.rb:29
  def enqueue_at(job, timestamp); end
end

# source://activejob-VERSION/lib/active_job/queue_adapters/sidekiq_adapter.rb:38
class ActiveJob::QueueAdapters::SidekiqAdapter::JobWrapper
  ...
  # source://activejob-VERSION/lib/active_job/queue_adapters/sidekiq_adapter.rb:41
  def perform(job_data); end

  # source://sidekiq-VERSION/lib/sidekiq/worker.rb:137
  def sidekiq_options_hash; end

  # source://sidekiq-VERSION/lib/sidekiq/worker.rb:149
  ...
  class << self
    # source://sidekiq-VERSION/lib/sidekiq/worker.rb:104
    def sidekiq_options_hash; end

    # source://sidekiq-VERSION/lib/sidekiq/worker.rb:112
    ...
    # source://sidekiq-VERSION/lib/sidekiq/worker.rb:99
...
#
# source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:14
class ActiveJob::QueueAdapters::TestAdapter
  # Returns the value of attribute at.
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:15
  def at; end
  ...
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:28
  def enqueue(job); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:33
  def enqueue_at(job, timestamp); end

  # Provides a store of all the enqueued jobs with the TestAdapter so you can check them.
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:19
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:16
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:24
  ...
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:79
  def filter_as_proc(filter); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:57
  def filtered?(job); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:71
  def filtered_job_class?(job); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:65
  def filtered_queue?(job); end

  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:61
  def filtered_time?(job); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:39
  def job_to_hash(job, extras = T.unsafe(nil)); end

  # source://activejob-VERSION/lib/active_job/queue_adapters/test_adapter.rb:48
  def perform_or_enqueue(perform, job, job_data); end
end

# source://activejob-VERSION/lib/active_job/queue_name.rb:4
module ActiveJob::QueueName
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_name.rb:62
  def queue_name; end
...
#
# source://activejob-VERSION/lib/active_job/queue_name.rb:8
module ActiveJob::QueueName::ClassMethods
  # source://activejob-VERSION/lib/active_job/queue_name.rb:9
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/queue_name.rb:40
  def queue_as(part_name = T.unsafe(nil), &block); end

  # source://activejob-VERSION/lib/active_job/queue_name.rb:48
...
# source://activejob-VERSION/lib/active_job/queue_priority.rb:4
module ActiveJob::QueuePriority
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_priority.rb:36
  def priority; end
...
#
# source://activejob-VERSION/lib/active_job/queue_priority.rb:8
module ActiveJob::QueuePriority::ClassMethods
  # source://activejob-VERSION/lib/active_job/queue_priority.rb:9
  ...
  #
  # source://activejob-VERSION/lib/active_job/queue_priority.rb:22
...
# = Active Job Railtie
#
# source://activejob-VERSION/lib/active_job/railtie.rb:8
...
#
# source://activejob-VERSION/lib/active_job/arguments.rb:26
class ActiveJob::SerializationError < ::ArgumentError; end

# The <tt>ActiveJob::Serializers</tt> module is used to store a list of known serializers
# and to add new ones. It also has helpers to serialize/deserialize objects.
#
# source://activejob-VERSION/lib/active_job/serializers.rb:8
module ActiveJob::Serializers
  extend ::ActiveSupport::Autoload

  # source://activejob-VERSION/lib/active_job/serializers.rb:22
  ...
  class << self
    ...
    #
    # source://activejob-VERSION/lib/active_job/serializers.rb:54
    ...
    # @raise [ArgumentError]
    #
    # source://activejob-VERSION/lib/active_job/serializers.rb:38
    ...
    #
    # source://activejob-VERSION/lib/active_job/serializers.rb:29
    def serialize(argument); end

    # Returns list of known serializers.
    #
    # source://activejob-VERSION/lib/active_job/serializers.rb:49
    def serializers; end
  end
end

# source://activejob-VERSION/lib/active_job/serializers/date_serializer.rb:5
class ActiveJob::Serializers::DateSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/date_serializer.rb:10
  def deserialize(hash); end

  # source://activejob-VERSION/lib/active_job/serializers/date_serializer.rb:6
  def serialize(date); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/date_serializer.rb:15
  def klass; end
end

# source://activejob-VERSION/lib/active_job/serializers/date_time_serializer.rb:5
class ActiveJob::Serializers::DateTimeSerializer < ::ActiveJob::Serializers::TimeObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/date_time_serializer.rb:6
  def deserialize(hash); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/date_time_serializer.rb:11
  def klass; end
end

# source://activejob-VERSION/lib/active_job/serializers/duration_serializer.rb:5
class ActiveJob::Serializers::DurationSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/duration_serializer.rb:10
  def deserialize(hash); end

  # source://activejob-VERSION/lib/active_job/serializers/duration_serializer.rb:6
  def serialize(duration); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/duration_serializer.rb:18
  def klass; end
end

# source://activejob-VERSION/lib/active_job/serializers/module_serializer.rb:5
class ActiveJob::Serializers::ModuleSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/module_serializer.rb:11
  def deserialize(hash); end

  # @raise [SerializationError]
  #
  # source://activejob-VERSION/lib/active_job/serializers/module_serializer.rb:6
  def serialize(constant); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/module_serializer.rb:16
  def klass; end
end
...
#   end
#
# source://activejob-VERSION/lib/active_job/serializers/object_serializer.rb:24
class ActiveJob::Serializers::ObjectSerializer
  ...
  # @raise [NotImplementedError]
  #
  # source://activejob-VERSION/lib/active_job/serializers/object_serializer.rb:42
  def deserialize(json); end

  # Serializes an argument to a JSON primitive type.
  #
  # source://activejob-VERSION/lib/active_job/serializers/object_serializer.rb:37
  ...
  # @return [Boolean]
  #
  # source://activejob-VERSION/lib/active_job/serializers/object_serializer.rb:32
  def serialize?(argument); end
  ...
  # @raise [NotImplementedError]
  #
  # source://activejob-VERSION/lib/active_job/serializers/object_serializer.rb:48
  def klass; end

  class << self
    # source://activejob-VERSION/lib/active_job/serializers/object_serializer.rb:28
...
# source://activejob-VERSION/lib/active_job/serializers/range_serializer.rb:5
class ActiveJob::Serializers::RangeSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/range_serializer.rb:13
  def deserialize(hash); end

  # source://activejob-VERSION/lib/active_job/serializers/range_serializer.rb:8
  def serialize(range); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/range_serializer.rb:18
  def klass; end
end

# source://activejob-VERSION/lib/active_job/serializers/range_serializer.rb:6
ActiveJob::Serializers::RangeSerializer::KEYS = T.let(T.unsafe(nil), Array)

# source://activejob-VERSION/lib/active_job/serializers/symbol_serializer.rb:5
class ActiveJob::Serializers::SymbolSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/symbol_serializer.rb:10
  def deserialize(argument); end

  # source://activejob-VERSION/lib/active_job/serializers/symbol_serializer.rb:6
  def serialize(argument); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/symbol_serializer.rb:15
  def klass; end
end

# source://activejob-VERSION/lib/active_job/serializers/time_object_serializer.rb:5
class ActiveJob::Serializers::TimeObjectSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/time_object_serializer.rb:8
  def serialize(time); end
end

# source://activejob-VERSION/lib/active_job/serializers/time_object_serializer.rb:6
ActiveJob::Serializers::TimeObjectSerializer::NANO_PRECISION = T.let(T.unsafe(nil), Integer)

# source://activejob-VERSION/lib/active_job/serializers/time_serializer.rb:5
class ActiveJob::Serializers::TimeSerializer < ::ActiveJob::Serializers::TimeObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/time_serializer.rb:6
  def deserialize(hash); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/time_serializer.rb:11
  def klass; end
end

# source://activejob-VERSION/lib/active_job/serializers/time_with_zone_serializer.rb:5
class ActiveJob::Serializers::TimeWithZoneSerializer < ::ActiveJob::Serializers::TimeObjectSerializer
  # source://activejob-VERSION/lib/active_job/serializers/time_with_zone_serializer.rb:6
  def deserialize(hash); end

  private

  # source://activejob-VERSION/lib/active_job/serializers/time_with_zone_serializer.rb:11
  def klass; end
end

# source://activejob-VERSION/lib/active_job/test_case.rb:6
...
#
# source://activejob-VERSION/lib/active_job/test_helper.rb:8
module ActiveJob::TestHelper
  include ::ActiveSupport::Testing::Assertions

  # source://activejob-VERSION/lib/active_job/test_helper.rb:51
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:123
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:392
  ...
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:185
  ...
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:343
  ...
  #     end
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:275
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:494
  ...
  # source://activejob-VERSION/lib/active_job/test_helper.rb:39
  def before_setup; end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:9
  ...
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:598
  ...
  #   end
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:634
  def queue_adapter; end
  ...
  # ActiveJob::QueueAdapters::TestAdapter.
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:66
  def queue_adapter_for_test; end

  private

  # source://activejob-VERSION/lib/active_job/test_helper.rb:639
  def clear_enqueued_jobs; end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:643
  def clear_performed_jobs; end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:704
  def deserialize_args_for_assertion(job); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:679
  def enqueued_jobs_with(only: T.unsafe(nil), except: T.unsafe(nil), queue: T.unsafe(nil), at: T.unsafe(nil), &block); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:673
  def filter_as_proc(filter); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:687
  def flush_enqueued_jobs(only: T.unsafe(nil), except: T.unsafe(nil), queue: T.unsafe(nil), at: T.unsafe(nil)); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:711
  def instantiate_job(payload, skip_deserialize_arguments: T.unsafe(nil)); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:647
  def jobs_with(jobs, only: T.unsafe(nil), except: T.unsafe(nil), queue: T.unsafe(nil), at: T.unsafe(nil)); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:683
  def performed_jobs_with(only: T.unsafe(nil), except: T.unsafe(nil), queue: T.unsafe(nil), &block); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:695
  def prepare_args_for_assertion(args); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:718
  def queue_adapter_changed_jobs; end

  # @raise [ArgumentError]
  #
  # source://activejob-VERSION/lib/active_job/test_helper.rb:725
  def validate_option(only: T.unsafe(nil), except: T.unsafe(nil)); end
end

# source://activejob-VERSION/lib/active_job/test_helper.rb:15
...
# source://activejob-VERSION/lib/active_job/test_helper.rb:22
module ActiveJob::TestHelper::TestQueueAdapter::ClassMethods
  # source://activejob-VERSION/lib/active_job/test_helper.rb:27
  def disable_test_adapter; end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:31
  def enable_test_adapter(test_adapter); end

  # source://activejob-VERSION/lib/active_job/test_helper.rb:23
  def queue_adapter; end
end

# source://activejob-VERSION/lib/active_job/timezones.rb:4
module ActiveJob::Timezones
  extend ::ActiveSupport::Concern
end

# source://activejob-VERSION/lib/active_job/translation.rb:4
module ActiveJob::Translation
  extend ::ActiveSupport::Concern
end

# source://activejob-VERSION/lib/active_job/gem_version.rb:9
module ActiveJob::VERSION; end

# source://activejob-VERSION/lib/active_job/gem_version.rb:10
ActiveJob::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# source://activejob-VERSION/lib/active_job/gem_version.rb:11
ActiveJob::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# source://activejob-VERSION/lib/active_job/gem_version.rb:13
ActiveJob::VERSION::PRE = T.let(T.unsafe(nil), String)

# source://activejob-VERSION/lib/active_job/gem_version.rb:15
ActiveJob::VERSION::STRING = T.let(T.unsafe(nil), String)

# source://activejob-VERSION/lib/active_job/gem_version.rb:12
