...
class ActionView::Digestor
  class << self
    def digest(name:, finder:, dependencies: _); end
    def logger; end
    def tree(name, finder, partial = _, seen = _); end
...
class ActionView::DependencyTracker
  class << self
    def find_dependencies(name, template, view_paths = _); end
...
class ActionView::DependencyTracker::ERBTracker
  ...
  class << self
    def call(name, template, view_paths = _); end
