...
# source://yard-VERSION/lib/yard/core_ext/array.rb:2
class Array
  include ::Enumerable
  ...
  # @see Insertion#after
  #
  # source://yard-VERSION/lib/yard/core_ext/array.rb:15
...
# source://yard-VERSION/lib/yard/core_ext/file.rb:4
class File < ::IO
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/core_ext/file.rb:37
    ...
    # @since 0.5.2
    #
    # source://yard-VERSION/lib/yard/core_ext/file.rb:57
    ...
    # @since 0.5.3
    #
    # source://yard-VERSION/lib/yard/core_ext/file.rb:66
    ...
    #
    # source://yard-VERSION/lib/yard/core_ext/file.rb:19
    def relative_path(from, to); end
  end
end

# source://yard-VERSION/lib/yard/core_ext/file.rb:5
File::RELATIVE_PARENTDIR = T.let(T.unsafe(nil), String)

# source://yard-VERSION/lib/yard/core_ext/file.rb:6
File::RELATIVE_SAMEDIR = T.let(T.unsafe(nil), String)

# :stopdoc:
#
# source://yard-VERSION/lib/yard/rubygems/backports/gem.rb:2
module Gem
  class << self
    # Returns the Gem::SourceIndex of specifications that are in the Gem.path
    #
    # source://yard-VERSION/lib/yard/rubygems/backports/gem.rb:6
...
#
# source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:363
...
#
# source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:21
class Gem::SourceIndex
  ...
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:102
  def initialize(specifications = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:348
  def ==(other); end

  # Add a gem specification to the source index.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:193
  def add_spec(gem_spec, name = T.unsafe(nil)); end

  # Add gem specifications to the source index.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:202
  def add_specs(*gem_specs); end

  # TODO: remove method
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:109
  def all_gems; end

  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:352
  def dump; end

  # Iterate over the specifications in the source index.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:218
  def each(&block); end

  # Find a gem by an exact match on the short name.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:256
  def find_name(gem_name, requirement = T.unsafe(nil)); end

  # The signature for the given gem specification.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:242
  def gem_signature(gem_full_name); end

  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:34
  def gems; end

  # The signature for the source index.  Changes in the signature indicate a
  # change in the index.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:233
  def index_signature; end

  # Returns an Array specifications for the latest released versions
  # of each gem in this index.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:143
  def latest_specs(include_prerelease = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:248
  def length; end

  # Reconstruct the source index from the specifications in +spec_dirs+.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:124
  def load_gems_in(*spec_dirs); end

  # Returns an Array of Gem::Specifications that are not up to date.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:330
  def outdated; end

  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:113
  def prerelease_gems; end

  # An array including only the prerelease gemspecs
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:179
  ...
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:322
  def refresh!; end

  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:117
  def released_gems; end

  # An array including only the released gemspecs
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:186
  def released_specs; end

  # Remove a gem specification named +full_name+.
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:211
  ...
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:270
  ...
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:39
  def spec_dirs; end
  ...
  #
  # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:225
  ...
  class << self
    ...
    # +spec_dirs+.
    #
    # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:80
    ...
    #
    # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:61
    def from_installed_gems(*deprecated); end

    # Returns a list of directories from Gem.path that contain specifications.
    #
    # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:72
    def installed_spec_directories; end

    # Loads a ruby-format specification from +file_name+ and returns the
    # loaded spec.
    #
    # source://yard-VERSION/lib/yard/rubygems/backports/source_index.rb:90
...
# source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:17
class IRB::SLex
  # @return [SLex] a new instance of SLex
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:25
  def initialize; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:60
  def create(token, preproc = T.unsafe(nil), postproc = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:29
  def def_rule(token, preproc = T.unsafe(nil), postproc = T.unsafe(nil), &block); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:36
  def def_rules(*tokens, &block); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:77
  def inspect; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:64
  def match(token); end

  # need a check?
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:51
  def postproc(token); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:45
  def preproc(token, proc); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:56
  def search(token); end
end

# source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:18
IRB::SLex::DOUT = T.let(T.unsafe(nil), IRB::Notifier::CompositeNotifier)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:20
IRB::SLex::D_DEBUG = T.let(T.unsafe(nil), IRB::Notifier::LeveledNotifier)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:21
IRB::SLex::D_DETAIL = T.let(T.unsafe(nil), IRB::Notifier::LeveledNotifier)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:19
...
# ----------------------------------------------------------------------
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:86
class IRB::SLex::Node
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:89
  def initialize(preproc = T.unsafe(nil), postproc = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:113
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:161
  def match(chrs, op = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:198
  def match_io(io, op = T.unsafe(nil)); end

  # Returns the value of attribute postproc.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:96
  def postproc; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:95
  def preproc; end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/irb/slex.rb:98
...
#
# source://yard-VERSION/lib/yard/core_ext/insertion.rb:7
class Insertion
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/insertion.rb:14
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/insertion.rb:30
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/core_ext/insertion.rb:38
  ...
  # @param recursive [Boolean] look inside sublists
  #
  # source://yard-VERSION/lib/yard/core_ext/insertion.rb:22
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/core_ext/insertion.rb:34
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/insertion.rb:49
  def insertion(val, rel, recursive = T.unsafe(nil), list = T.unsafe(nil)); end
end

# source://yard-VERSION/lib/yard/core_ext/module.rb:2
class Module
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/module.rb:8
  def class_name; end
end
...
# @private
#
# source://yard-VERSION/lib/yard/server/rack_adapter.rb:85
class Rack::Request
  # @return [Request] a new instance of Request
  #
  # source://rack-VERSION/lib/rack/request.rb:26
  def initialize(env); end

  # source://rack-VERSION/lib/rack/request.rb:40
  def delete_param(k); end

  # source://rack-VERSION/lib/rack/request.rb:31
  def params; end

  # source://rack-VERSION/lib/rack/request.rb:31
  def query; end

  # source://rack-VERSION/lib/rack/request.rb:35
  def update_param(k, v); end

  # Returns the value of attribute version_supplied.
  #
  # source://yard-VERSION/lib/yard/server/rack_adapter.rb:86
  ...
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/server/rack_adapter.rb:88
  def xhr?; end

  class << self
    # Returns the value of attribute ip_filter.
    #
    # source://rack-VERSION/lib/rack/request.rb:16
    def ip_filter; end
...
# source://rack-VERSION/lib/rack/request.rb:20
Rack::Request::ALLOWED_SCHEMES = T.let(T.unsafe(nil), Array)

# source://rack-VERSION/lib/rack/request.rb:21
Rack::Request::SCHEME_WHITELIST = T.let(T.unsafe(nil), Array)

# source://yard-VERSION/lib/yard/core_ext/string.rb:2
class String
  include ::Comparable
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/string.rb:8
  def shell_split; end
end
...
#
# source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:8
class SymbolHash < ::Hash
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:9
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:49
  def [](key); end
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:42
  def []=(key, value); end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:54
  def delete(key); end
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:59
  def has_key?(key); end
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:74
  def merge(hash); end
  ...
  #
  # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:67
  def merge!(hash); end
  ...
  class << self
    ...
    # @overload []
    #
    # source://yard-VERSION/lib/yard/core_ext/symbol_hash.rb:28
    def [](*hsh); end
  end
end
...
# @private
#
# source://yard-VERSION/lib/yard/server/webrick_adapter.rb:42
class WEBrick::HTTPRequest
  # Returns the value of attribute version_supplied.
  #
  # source://yard-VERSION/lib/yard/server/webrick_adapter.rb:43
  def version_supplied; end
  ...
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/server/webrick_adapter.rb:44
  def xhr?; end
end

# source://webrick-VERSION/lib/webrick/httprequest.rb:449
...
#
# source://yard-VERSION/lib/yard.rb:2
module YARD
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard.rb:31
    ...
    #
    # source://yard-VERSION/lib/yard.rb:20
    def parse(*args); end
...
#
# source://yard-VERSION/lib/yard/autoload.rb:6
module YARD::CLI; end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/command.rb:11
class YARD::CLI::Command
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/command.rb:16
  def description; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/command.rb:24
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/command.rb:68
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/command.rb:55
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/command.rb:80
  ...
  class << self
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/cli/command.rb:14
    def run(*args); end
  end
end
...
# @see default_command
#
# source://yard-VERSION/lib/yard/cli/command_parser.rb:23
class YARD::CLI::CommandParser
  # @return [CommandParser] a new instance of CommandParser
  #
  # source://yard-VERSION/lib/yard/cli/command_parser.rb:56
  def initialize; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/cli/command_parser.rb:63
  def run(*args); end

  private

  # source://yard-VERSION/lib/yard/cli/command_parser.rb:80
  def commands; end

  # source://yard-VERSION/lib/yard/cli/command_parser.rb:82
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/cli/command_parser.rb:27
    def commands; end
    ...
    #   are specified or
    #
    # source://yard-VERSION/lib/yard/cli/command_parser.rb:31
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/cli/command_parser.rb:54
    def run(*args); end
  end
end
...
# @since 0.6.2
#
# source://yard-VERSION/lib/yard/cli/config.rb:7
class YARD::CLI::Config < ::YARD::CLI::Command
  # @return [Config] a new instance of Config
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:26
  def initialize; end

  # @return [Boolean] whether to append values to existing key
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:20
  def append; end
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:17
  def as_list; end
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:36
  def description; end
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:24
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:8
  def key; end
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:14
  def reset; end
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:40
  def run(*args); end

  # @return [Array, nil] the list of values to set (or single value), if modifying
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:11
  def values; end
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:57
  def configure_gemrc; end

  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:111
  def encode_value(value); end

  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:103
  def encode_values; end

  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:97
  def list_configuration; end

  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:78
  def modify_item; end

  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:120
  def optparse(*args); end

  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/config.rb:92
  def view_item; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/diff.rb:11
class YARD::CLI::Diff < ::YARD::CLI::Command
  # @return [Diff] a new instance of Diff
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:12
  def initialize; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:24
  def description; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:28
  def run(*args); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:83
  def added_objects(registry1, registry2); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:78
  def all_objects; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:233
  def cleanup(gemfile); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:175
  def expand_and_parse(gemfile, io); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:187
  def expand_gem(gemfile, io); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:181
  def generate_yardoc(dir); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:118
  def load_gem_data(gemfile); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:102
  def load_git_commit(commit); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:87
  def modified_objects(registry1, registry2); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:239
  def optparse(*args); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:98
  def removed_objects(registry1, registry2); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/diff.rb:225
...
# @since 0.8.6
#
# source://yard-VERSION/lib/yard/cli/display.rb:6
class YARD::CLI::Display < ::YARD::CLI::Yardoc
  # @return [Display] a new instance of Display
  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/display.rb:9
  def initialize(*args); end

  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/display.rb:7
  def description; end

  # @return [String] the output data for all formatted objects
  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/display.rb:27
  def format_objects; end

  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/display.rb:61
  ...
  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/display.rb:46
  ...
  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/display.rb:21
  def run(*args); end

  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/display.rb:33
  def wrap_layout(contents); end
end

# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/gems.rb:5
class YARD::CLI::Gems < ::YARD::CLI::Command
  # @return [Gems] a new instance of Gems
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/gems.rb:6
  def initialize; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/gems.rb:11
  def description; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/gems.rb:18
  def run(*args); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/gems.rb:47
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/gems.rb:27
  def build_gems; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/gems.rb:61
  def optparse(*args); end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/graph.rb:27
class YARD::CLI::Graph < ::YARD::CLI::YardoptsCommand
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:34
  def initialize; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:42
  def description; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:31
  def objects; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:28
  def options; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:52
  def run(*args); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:69
  def optparse(*args); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:65
  def unrecognized_option(err); end
end

# Options to pass to the {Graph} CLI.
#
# source://yard-VERSION/lib/yard/cli/graph.rb:6
class YARD::CLI::GraphOptions < ::YARD::Templates::TemplateOptions
  # @return [String] any contents to pass to the digraph
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:16
  def contents; end
  ...
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:13
  ...
  #
  # source://yard-VERSION/lib/yard/options.rb:82
  def format; end
  ...
  #
  # source://yard-VERSION/lib/yard/cli/graph.rb:10
  def full; end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/help.rb:6
class YARD::CLI::Help < ::YARD::CLI::Command
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/help.rb:7
  def description; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/help.rb:9
  def run(*args); end
end
...
#
# source://yard-VERSION/lib/yard/cli/i18n.rb:13
class YARD::CLI::I18n < ::YARD::CLI::Yardoc
  # @return [I18n] a new instance of I18n
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/cli/i18n.rb:14
  def initialize; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/cli/i18n.rb:19
  def description; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/cli/i18n.rb:23
  def run(*args); end
...
class YARD::CLI::List < ::YARD::CLI::Command
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/cli/list.rb:13
  def run(*args); end
end
...
# @since 0.8.6
#
# source://yard-VERSION/lib/yard/cli/markup_types.rb:6
class YARD::CLI::MarkupTypes < ::YARD::CLI::Command
  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/markup_types.rb:7
  def description; end
  ...
  # @since 0.8.6
  #
  # source://yard-VERSION/lib/yard/cli/markup_types.rb:14
  def run(*args); end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/server.rb:8
class YARD::CLI::Server < ::YARD::CLI::Command
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:29
  def initialize; end

  # @return [YARD::Server::Adapter] the adapter to use for loading the web server
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:18
  def adapter; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:41
  def description; end

  # @return [Hash] a list of library names and yardoc files to serve
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:15
  def libraries; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:9
  def options; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:45
  def run(*args); end

  # @return [Array<String>] a list of scripts to load
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:22
  def scripts; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:12
  ...
  # @since 0.6.2
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:26
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:131
  def add_gems; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:140
  def add_gems_from_gemfile(gemfile = T.unsafe(nil)); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:76
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:115
  def create_library_version_if_yardopts_exist(library, dir); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:249
  def extract_db_from_options_file(options_file); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:239
  def generate_doc_for_first_time(libver); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:56
  def load_scripts; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:60
  def load_template_paths; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:156
  def optparse(*args); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/server.rb:66
  def select_adapter; end
end

# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/stats.rb:5
class YARD::CLI::Stats < ::YARD::CLI::Yardoc
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:18
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:108
  def all_objects; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:25
  def description; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:54
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:79
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:34
  def run(*args); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:135
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:125
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:130
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:113
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:144
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:120
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:199
  def general_options(opts); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:185
  def optparse(*args); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/stats.rb:176
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/stats.rb:12
YARD::CLI::Stats::STATS_ORDER = T.let(T.unsafe(nil), Array)

# A tool to view documentation in the console like `ri`
#
# source://yard-VERSION/lib/yard/cli/yri.rb:9
class YARD::CLI::YRI < ::YARD::CLI::Command
  # @return [YRI] a new instance of YRI
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:31
  def initialize; end

  # source://yard-VERSION/lib/yard/cli/yri.rb:41
  def description; end
  ...
  # @param args [Array<String>] each tokenized argument
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:50
  def run(*args); end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:85
  ...
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:113
  ...
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:98
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:78
  def print_usage; end
  ...
  # @since 0.5.1
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:181
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:161
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:151
  def load_cache; end
  ...
  # @param args [Array<String>] each tokenized argument
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:190
  def optparse(*args); end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/cli/yri.rb:143
  ...
  class << self
    ...
    # @see #run
    #
    # source://yard-VERSION/lib/yard/cli/yri.rb:29
    def run(*args); end
  end
end
...
# from.
#
# source://yard-VERSION/lib/yard/cli/yri.rb:10
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/cli/yri.rb:25
...
# @since 0.5.1
#
# source://yard-VERSION/lib/yard/cli/yri.rb:15
YARD::CLI::YRI::SEARCH_PATHS_FILE = T.let(T.unsafe(nil), String)

# source://yard-VERSION/lib/yard/cli/yardoc.rb:147
class YARD::CLI::Yardoc < ::YARD::CLI::YardoptsCommand
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:207
  def initialize; end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:330
  def all_objects; end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:180
  def apis; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:197
  def assets; end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:234
  def description; end

  # @return [Array<String>] list of excluded paths (regexp matches)
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:155
  def excluded; end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:204
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:151
  def files; end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:166
  def generate; end
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:201
  def has_markup; end
  ...
  # @since 0.8.7
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:185
  def hidden_apis; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:189
  def hidden_tags; end
  ...
  # @since 0.5.5
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:170
  def list; end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:148
  def options; end
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:291
  def parse_arguments(*args); end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:244
  def run(*args); end

  # @return [Boolean] whether objects should be serialized to .yardoc db
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:163
  def save_yardoc; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:193
  def statistics; end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:160
  def use_cache; end
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:175
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:474
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:413
  def add_extra_files(*files); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:507
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:466
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:494
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:389
  def copy_assets; end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:425
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:541
  def general_options(opts); end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:516
  def optparse(*args); end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:586
  def output_options(opts); end
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:446
  ...
  # @since 0.5.5
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:403
  def print_list; end
  ...
  # @since 0.5.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:340
  ...
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:502
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:753
  ...
  # @since 0.2.1
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:364
  def verify_markup_options; end
end

# Default options used in +yard doc+ command.
#
# source://yard-VERSION/lib/yard/cli/yardoc.rb:10
class YARD::CLI::YardocOptions < ::YARD::Templates::TemplateOptions
  ...
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:48
  def file; end
  ...
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:39
  def index; end
  ...
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:43
  def item; end
  ...
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:51
  def locale; end
  ...
  #   the templates with.
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:36
  def objects; end
  ...
  #   along with objects
  #
  # source://yard-VERSION/lib/yard/cli/yardoc.rb:32
  def readme; end
...
# @since 0.8.3
#
# source://yard-VERSION/lib/yard/cli/yardopts_command.rb:11
class YARD::CLI::YardoptsCommand < ::YARD::CLI::Command
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:25
  def initialize; end
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:22
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:36
  def parse_arguments(*args); end

  # @return [Boolean] whether to parse options from .document
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:18
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:15
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:48
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:92
  def parse_rdoc_document_file(file = T.unsafe(nil)); end

  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:96
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:78
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:102
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/cli/yardopts_command.rb:70
...
#
# source://yard-VERSION/lib/yard/autoload.rb:29
...
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:91
...
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:133
class YARD::CodeObjects::Base
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:238
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:322
  def ==(other); end
  ...
  # @see #[]=
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:342
  def [](key); end
  ...
  # @see #[]
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:355
  def []=(key, value); end
  ...
  # @raise [ArgumentError]
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:290
  ...
  # @since 0.8.4
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:557
  ...
  # @since 0.8.4
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:166
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:263
  ...
  # @return [Docstring] the documentation string
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:404
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:426
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:170
  def dynamic; end
  ...
  # @see #dynamic
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:178
  def dynamic?; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:306
  def file; end
  ...
  # @see #add_file
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:137
  def files; end
  ...
  # @see Templates::Engine#render
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:501
  def format(options = T.unsafe(nil)); end

  # @return [String] the group this object is associated with
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:174
  def group; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:552
  def has_tag?(name); end

  # @return [Integer] the object's hash value (for equality checking)
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:333
  def hash; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:509
  def inspect; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:314
  def line; end

  # @overload dynamic_attr_name
  # @overload dynamic_attr_name=
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:372
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:278
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:142
  def namespace; end
  ...
  #   from the Registry.
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:518
  ...
  # @see #sep
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:449
  def path; end
  ...
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:471
  def relative_path(other); end

  # @return [Boolean] whether or not this object is a RootObject
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:563
  def root?; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:572
  def sep; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:159
  def signature; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:146
  def source; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:387
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:152
  def source_type; end
  ...
  # @see Docstring#tag
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:544
  def tag(name); end
  ...
  # @see Docstring#tags
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:548
  ...
  # @see 0.8.4
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:464
  def title; end

  # @return [nil] this object does not turn into an array
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:336
  def to_ary; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:436
  def type; end

  # @return [Symbol] the visibility of an object (:public, :private, :protected)
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:181
  def visibility; end

  # @return [Symbol] the visibility of an object (:public, :private, :protected)
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:183
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:583
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:595
  def format_source(source); end

  # source://yard-VERSION/lib/yard/code_objects/base.rb:602
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/code_objects/base.rb:219
    def ===(other); end
    ...
    # @yield [obj]
    #
    # source://yard-VERSION/lib/yard/code_objects/base.rb:189
...
#
# source://yard-VERSION/lib/yard/code_objects/class_object.rb:9
class YARD::CodeObjects::ClassObject < ::YARD::CodeObjects::NamespaceObject
  ...
  # @see Base.new
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:15
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:101
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:45
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:109
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:79
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:35
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:66
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:10
  def superclass; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/code_objects/class_object.rb:125
...
#
# source://yard-VERSION/lib/yard/code_objects/class_variable_object.rb:8
class YARD::CodeObjects::ClassVariableObject < ::YARD::CodeObjects::Base
  # @return [String] the class variable's value
  #
  # source://yard-VERSION/lib/yard/code_objects/class_variable_object.rb:9
  def value; end
...
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:10
class YARD::CodeObjects::CodeObjectList < ::Array
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:11
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/base.rb:19
  def <<(value); end
...
#
# source://yard-VERSION/lib/yard/code_objects/constant_object.rb:9
class YARD::CodeObjects::ConstantObject < ::YARD::CodeObjects::Base
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/constant_object.rb:10
  def value; end

  # source://yard-VERSION/lib/yard/code_objects/constant_object.rb:12
  def value=(value); end
end
...
# @see MethodObject
#
# source://yard-VERSION/lib/yard/code_objects/extended_method_object.rb:7
class YARD::CodeObjects::ExtendedMethodObject
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/extended_method_object.rb:17
  ...
  # @see MethodObject
  #
  # source://yard-VERSION/lib/yard/code_objects/extended_method_object.rb:22
  def method_missing(sym, *args, &block); end

  # @return [Symbol] always +:class+
  #
  # source://yard-VERSION/lib/yard/code_objects/extended_method_object.rb:11
  def scope; end
end
...
#
# source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:7
class YARD::CodeObjects::ExtraFileObject
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:18
  def initialize(filename, contents = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:64
  def ==(other); end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:30
  def attributes; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:9
  def attributes=(_arg0); end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:39
  def contents; end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:44
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:8
  def filename; end
  ...
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:70
  def hash; end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:57
  def inspect; end

  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:12
  def locale; end
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:52
  def locale=(locale); end

  # Returns the value of attribute name.
  #
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:10
  def name; end
  ...
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:35
  def title; end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:57
  def to_s; end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:62
  def type; end

  private

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:74
  def ensure_parsed; end

  # @param data [String] the file contents
  #
  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:81
  def parse_contents(data); end

  # source://yard-VERSION/lib/yard/code_objects/extra_file_object.rb:129
  def translate(data); end
end

# Instance method separator
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:40
YARD::CodeObjects::ISEP = T.let(T.unsafe(nil), String)

# Regex-quoted instance method separator
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:43
...
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:64
YARD::CodeObjects::METHODMATCH = T.let(T.unsafe(nil), Regexp)

# Regular expression to match a method name
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:61
...
#   property :bar
#
# source://yard-VERSION/lib/yard/code_objects/macro_object.rb:30
class YARD::CodeObjects::MacroObject < ::YARD::CodeObjects::Base
  # @return [Boolean] whether this macro is attached to a method
  #
  # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:149
  def attached?; end
  ...
  # @see expand
  #
  # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:167
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:142
  def macro_data; end
  ...
  #   attached to.
  #
  # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:146
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:152
  def path; end

  # Overrides the separator to be '.'
  #
  # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:155
  def sep; end
  ...
  class << self
    ...
    # @see find_or_create
    #
    # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:120
    ...
    # @return [String] the expanded macro data
    #
    # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:136
    ...
    #
    # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:40
    ...
    #
    # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:71
    ...
    #
    # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:93
    ...
    #
    # source://yard-VERSION/lib/yard/code_objects/macro_object.rb:51
...
# source://yard-VERSION/lib/yard/code_objects/macro_object.rb:31
YARD::CodeObjects::MacroObject::MACRO_MATCH = T.let(T.unsafe(nil), Regexp)

# Represents a Ruby method in source
#
# source://yard-VERSION/lib/yard/code_objects/method_object.rb:10
class YARD::CodeObjects::MethodObject < ::YARD::CodeObjects::Base
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:37
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:149
  def aliases; end
  ...
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:93
  def attr_info; end

  # @return [Boolean] whether or not the method is the #initialize constructor method
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:78
  def constructor?; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:18
  def explicit; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:126
  def is_alias?; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:114
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:134
  def is_explicit?; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:85
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:175
  def name(prefix = T.unsafe(nil)); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:141
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:25
  def parameters; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:161
  def path; end

  # @return [Boolean] whether the method is a reader attribute
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:107
  def reader?; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:11
  def scope; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:58
  def scope=(v); end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:182
  def sep; end

  # @return [Boolean] whether the method is a writer attribute
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:100
  def writer?; end

  protected

  # source://yard-VERSION/lib/yard/code_objects/method_object.rb:192
  def copyable_attributes; end
end

# Represents a Ruby module.
#
# source://yard-VERSION/lib/yard/code_objects/module_object.rb:11
class YARD::CodeObjects::ModuleObject < ::YARD::CodeObjects::NamespaceObject
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/module_object.rb:12
  def inheritance_tree(include_mods = T.unsafe(nil)); end
end

# Regular expression to match namespaces (const A or complex path A::B)
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:58
YARD::CodeObjects::NAMESPACEMATCH = T.let(T.unsafe(nil), Regexp)

# Namespace separator
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:34
YARD::CodeObjects::NSEP = T.let(T.unsafe(nil), String)

# Regex-quoted namespace separator
#
# source://yard-VERSION/lib/yard/code_objects/base.rb:37
...
# @since 0.9.1
#
# source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:8
module YARD::CodeObjects::NamespaceMapper
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:55
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:68
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:27
  def register_separator(sep, *valid_types); end

  # @return [Array<String>] all of the registered separators
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:80
  def separators; end
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:97
  def separators_for_type(type); end

  # @return [Regexp] the regexp match of all separators
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:85
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:91
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:43
  ...
  class << self
    ...
    # @since 0.9.1
    #
    # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:137
    ...
    # @since 0.9.1
    #
    # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:125
    def invalidate; end

    # @return [Hash] a mapping of types to separators
    # @since 0.9.1
    #
    # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:114
    def map; end

    # @return [Regexp] the full list of separators as a regexp match
    # @since 0.9.1
    #
    # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:131
    def map_match; end
    ...
    # @since 0.9.1
    #
    # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:107
    def on_invalidate(&block); end

    # @return [Hash] a reverse mapping of separators to types
    # @since 0.9.1
    #
    # source://yard-VERSION/lib/yard/code_objects/namespace_mapper.rb:119
    def rev_map; end
  end
end
...
#
# source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:11
class YARD::CodeObjects::NamespaceObject < ::YARD::CodeObjects::Base
  ...
  # @see Base#initialize
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:56
  def initialize(namespace, name, *args, &block); end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:44
  def aliases; end
  ...
  # @return [Hash] a list of methods
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:39
  def attributes; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:86
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:16
  def children; end
  ...
  # @see #attributes
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:69
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:48
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:164
  def constants(opts = T.unsafe(nil)); end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:186
  def cvars; end

  # @return [Array<String>] a list of ordered group names inside the namespace
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:12
  def groups; end
  ...
  # @return [Array<ConstantObject>] a list of constant objects
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:172
  ...
  # @see #meths
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:144
  ...
  # @see #attributes
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:76
  ...
  # @return [Array<ModuleObject>] a list of mixins
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:52
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:113
  def meths(opts = T.unsafe(nil)); end
  ...
  # @return [Array<ModuleObject>] a list of mixins
  #
  # source://yard-VERSION/lib/yard/code_objects/namespace_object.rb:194
  def mixins(*scopes); end
end

# @private
#
# source://yard-VERSION/lib/yard/code_objects/proxy.rb:8
...
#
# source://yard-VERSION/lib/yard/code_objects/proxy.rb:24
class YARD::CodeObjects::Proxy
  ...
  # @return [Proxy] self
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:34
  def initialize(namespace, name, type = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:118
  def <=>(other); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:127
  def ==(other); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:113
  def ===(other); end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:142
  def class; end
  ...
  # @return [Integer] the object's hash value (for equality checking)
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:137
  def hash; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:91
  def inspect; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:161
  def instance_of?(klass); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:108
  def is_a?(klass); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:166
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:178
  def method_missing(meth, *args, &block); end
  ...
  #   This must be implemented by the subclass.
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:85
  def name(prefix = T.unsafe(nil)); end

  # Returns the value of attribute namespace.
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:27
  def namespace; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:100
  def path; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:171
  ...
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:200
  def root?; end
  ...
  # @see #type=
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:151
  def type; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:158
  def type=(type); end

  private

  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:228
  def proxy_path; end

  # @note this method fixes a bug in 1.9.2: http://gist.github.com/437136
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:205
  def to_ary; end
  ...
  #
  # source://yard-VERSION/lib/yard/code_objects/proxy.rb:212
  def to_obj; end

  class << self
    # source://yard-VERSION/lib/yard/code_objects/proxy.rb:25
    def ===(other); end
  end
end
...
#
# source://yard-VERSION/lib/yard/code_objects/proxy.rb:5
...
#
# source://yard-VERSION/lib/yard/code_objects/root_object.rb:6
class YARD::CodeObjects::RootObject < ::YARD::CodeObjects::ModuleObject
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/root_object.rb:12
  def equal?(other); end

  # source://yard-VERSION/lib/yard/code_objects/root_object.rb:16
  def hash; end

  # source://yard-VERSION/lib/yard/code_objects/root_object.rb:8
  def inspect; end

  # source://yard-VERSION/lib/yard/code_objects/root_object.rb:7
  def path; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/code_objects/root_object.rb:9
  def root?; end

  # source://yard-VERSION/lib/yard/code_objects/root_object.rb:10
  def title; end
end
...
# @since 0.6.2
#
# source://yard-VERSION/lib/yard/config.rb:86
class YARD::Config
  class << self
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:119
    def load; end
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:189
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:194
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:204
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:169
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:157
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:214
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:146
    def load_plugins; end
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:91
    def options; end
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:236
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:135
    def save; end
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:252
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:228
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/config.rb:259
...
# @since 0.6.2
#
# source://yard-VERSION/lib/yard/config.rb:95
...
# @since 0.6.2
#
# source://yard-VERSION/lib/yard/config.rb:98
...
# @since 0.6.2
#
# source://yard-VERSION/lib/yard/config.rb:105
...
# @since 0.6.2
#
# source://yard-VERSION/lib/yard/config.rb:102
...
# @since 0.6.2
#
# source://yard-VERSION/lib/yard/config.rb:114
...
#
# source://yard-VERSION/lib/yard/docstring.rb:16
class YARD::Docstring < ::String
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:103
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:116
  def +(other); end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/docstring.rb:242
  def add_tag(*tags); end

  # @return [String] the raw documentation (including raw tag text)
  #
  # source://yard-VERSION/lib/yard/docstring.rb:53
  def all; end
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:132
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:310
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:300
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/docstring.rb:291
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/docstring.rb:153
  def dup; end
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:47
  def object; end
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:44
  def ref_tags; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/docstring.rb:328
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:173
  def summary; end
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:265
  def tag(name); end
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:273
  def tags(name = T.unsafe(nil)); end
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:207
  def to_raw; end

  # source://yard-VERSION/lib/yard/docstring.rb:125
  def to_s; end
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:344
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:369
  ...
  #
  # source://yard-VERSION/lib/yard/docstring.rb:382
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/docstring.rb:28
    ...
    #
    # source://yard-VERSION/lib/yard/docstring.rb:77
    ...
    #   docstring.
    #
    # source://yard-VERSION/lib/yard/docstring.rb:38
    def parser(*args); end
  end
end
...
#
# source://yard-VERSION/lib/yard/docstring.rb:61
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/docstring_parser.rb:30
class YARD::DocstringParser
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:81
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:232
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:226
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:209
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:45
  def directives; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:66
  def handler; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:70
  def library; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:56
  def object; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:113
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:129
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:196
  def post_process; end

  # @return [String] the complete input string to the parser.
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:36
  def raw_text; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:61
  def reference; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:51
  def state; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:252
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:40
  def tags; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:33
  def text; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:95
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:324
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:319
  def call_directives_after_parse; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:305
  def detect_reference(content); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/docstring_parser.rb:301
  def namespace; end
  ...
  class << self
    ...
    # @yieldreturn [void]
    #
    # source://yard-VERSION/lib/yard/docstring_parser.rb:266
    def after_parse(&block); end

    # @return [Array<Proc>] the {after_parse} callback proc objects
    # @since 0.8.0
    #
    # source://yard-VERSION/lib/yard/docstring_parser.rb:271
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/docstring_parser.rb:73
YARD::DocstringParser::META_MATCH = T.let(T.unsafe(nil), Regexp)

# source://yard-VERSION/lib/yard/gem_index.rb:6
module YARD::GemIndex
  private

  # source://yard-VERSION/lib/yard/gem_index.rb:25
  def all; end

  # source://yard-VERSION/lib/yard/gem_index.rb:17
  def each(&block); end

  # source://yard-VERSION/lib/yard/gem_index.rb:9
...
#
# source://yard-VERSION/lib/yard/autoload.rb:66
...
# @see #parse_block
#
# source://yard-VERSION/lib/yard/handlers/base.rb:149
class YARD::Handlers::Base
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:276
  ...
  # @since 0.8.4
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:355
  def abort!; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:581
  def call_params; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:590
  ...
  #   finishes processing.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:561
  def ensure_loaded!(object, max_retries = T.unsafe(nil)); end

  # Returns the value of attribute extra_state.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:348
  def extra_state; end

  # Returns the value of attribute globals.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:347
  def globals; end

  # Returns the value of attribute namespace.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:341
  def namespace; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:342
  def namespace=(v); end

  # Returns the value of attribute owner.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:339
  def owner; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:340
  def owner=(v); end
  ...
  # @raise [NotImplementedError]
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:304
  def parse_block(*_arg0); end

  # @return [Processor] the processor object that manages all global state
  #   during handling.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:310
  def parser; end
  ...
  # @see #register
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:297
  def process; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:370
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:407
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:450
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:537
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:429
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:441
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:473
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:523
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:499
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:487
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:511
  def register_visibility(object, visibility = T.unsafe(nil)); end

  # Returns the value of attribute scope.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:345
  def scope; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:346
  def scope=(v); end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:315
  def statement; end

  # Returns the value of attribute visibility.
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:343
  def visibility; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:344
  def visibility=(v); end
  ...
  class << self
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:159
    def clear_subclasses; end

    # @return [Array] a list of matchers for the handler object.
    # @see handles?
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:211
    def handlers; end
    ...
    #   statement.
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:192
    ...
    #   the given statement
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:205
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:235
    def in_file(filename); end

    # @private
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:169
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:242
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:219
    def namespace_only; end

    # @return [Boolean] whether the handler should only be processed inside
    #   a namespace.
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:225
    def namespace_only?; end
    ...
    # @since 0.5.4
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:269
    ...
    #
    # source://yard-VERSION/lib/yard/handlers/base.rb:165
    def subclasses; end
  end
end
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/autoload.rb:74
module YARD::Handlers::C; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/alias_handler.rb:2
class YARD::Handlers::C::AliasHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/alias_handler.rb:3
YARD::Handlers::C::AliasHandler::MATCH = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/attribute_handler.rb:2
class YARD::Handlers::C::AttributeHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/attribute_handler.rb:3
YARD::Handlers::C::AttributeHandler::MATCH = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/base.rb:5
class YARD::Handlers::C::Base < ::YARD::Handlers::Base
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:77
  def ensure_variable_defined!(var, max_retries = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:64
  def namespace_for_variable(var); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:94
  def namespaces; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:60
  def override_comments; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:104
  def parse_block(opts = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:113
  def process_file(file, object); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:98
  def processed_files; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:38
  def register_docstring(object, docstring = T.unsafe(nil), stmt = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:42
  def register_file_info(object, file = T.unsafe(nil), line = T.unsafe(nil), comments = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:46
  def register_source(object, source = T.unsafe(nil), type = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:50
  def register_visibility(object, visibility = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:56
  def symbols; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/base.rb:158
  ...
  class << self
    ...
    # @since 0.8.0
    #
    # source://yard-VERSION/lib/yard/handlers/c/base.rb:10
    def handles?(statement, processor); end

    # @since 0.8.0
    #
    # source://yard-VERSION/lib/yard/handlers/c/base.rb:28
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/base.rb:131
YARD::Handlers::C::Base::ERROR_CLASS_NAMES = T.let(T.unsafe(nil), Hash)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/class_handler.rb:2
class YARD::Handlers::C::ClassHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/class_handler.rb:3
YARD::Handlers::C::ClassHandler::MATCH1 = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/class_handler.rb:9
YARD::Handlers::C::ClassHandler::MATCH2 = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/constant_handler.rb:2
class YARD::Handlers::C::ConstantHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/constant_handler.rb:3
YARD::Handlers::C::ConstantHandler::MATCH = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:5
module YARD::Handlers::C::HandlerMethods
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:86
  def handle_alias(var_name, new_name, old_name); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:75
  def handle_attribute(var_name, name, read, write); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:10
  def handle_class(var_name, class_name, parent, in_module = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:109
  def handle_constants(type, var_name, const_name, value); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:46
  def handle_method(scope, var_name, name, func_name, _source_file = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:33
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:123
  def find_constant_docstring(object); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:154
  def find_method_body(object, symbol); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/handler_methods.rb:196
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/init_handler.rb:3
class YARD::Handlers::C::InitHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/init_handler.rb:4
YARD::Handlers::C::InitHandler::MATCH = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/method_handler.rb:2
class YARD::Handlers::C::MethodHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/method_handler.rb:3
YARD::Handlers::C::MethodHandler::MATCH1 = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/method_handler.rb:14
YARD::Handlers::C::MethodHandler::MATCH2 = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/method_handler.rb:18
YARD::Handlers::C::MethodHandler::MATCH3 = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/mixin_handler.rb:2
class YARD::Handlers::C::MixinHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/mixin_handler.rb:3
YARD::Handlers::C::MixinHandler::MATCH = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/module_handler.rb:2
class YARD::Handlers::C::ModuleHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/module_handler.rb:3
YARD::Handlers::C::ModuleHandler::MATCH1 = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/module_handler.rb:4
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/override_comment_handler.rb:3
class YARD::Handlers::C::OverrideCommentHandler < ::YARD::Handlers::C::Base
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/override_comment_handler.rb:24
  def register_docstring(object, docstring = T.unsafe(nil), stmt = T.unsafe(nil)); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/handlers/c/override_comment_handler.rb:28
  def register_file_info(object, file = T.unsafe(nil), line = T.unsafe(nil), comments = T.unsafe(nil)); end
end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/path_handler.rb:2
class YARD::Handlers::C::PathHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/path_handler.rb:3
YARD::Handlers::C::PathHandler::MATCH = T.let(T.unsafe(nil), Regexp)

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/struct_handler.rb:2
class YARD::Handlers::C::StructHandler < ::YARD::Handlers::C::Base; end

# @since 0.8.0
#
# source://yard-VERSION/lib/yard/handlers/c/struct_handler.rb:3
...
# @since 0.8.4
#
# source://yard-VERSION/lib/yard/handlers/base.rb:8
...
# not be resolved.
#
# source://yard-VERSION/lib/yard/handlers/base.rb:15
class YARD::Handlers::NamespaceMissingError < ::YARD::Parser::UndocumentableError
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:18
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/base.rb:16
  def object; end
...
# @see Handlers::Base
#
# source://yard-VERSION/lib/yard/handlers/processor.rb:20
class YARD::Handlers::Processor
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:92
  ...
  # @see #globals
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:88
  def extra_state; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:41
  def file; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:151
  ...
  # @see #extra_state
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:77
  def globals; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:44
  def namespace; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:56
  def owner; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:140
  def parse_remaining_files; end

  # @return [Symbol] the parser type (:ruby, :ruby18, :c)
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:59
  def parser_type; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:110
  def process(statements); end

  # @return [Symbol] the current scope (class, instance)
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:50
  def scope; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:47
  def visibility; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:172
  ...
  #   {#parser_type}.
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:180
  def handler_base_namespace; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:161
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/handlers/processor.rb:188
  ...
  class << self
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/handlers/processor.rb:33
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/handlers/processor.rb:24
...
class YARD::Handlers::Ruby::AttributeHandler < ::YARD::Handlers::Ruby::Base
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/attribute_handler.rb:75
...
# @see Legacy::Base
#
# source://yard-VERSION/lib/yard/handlers/ruby/base.rb:65
class YARD::Handlers::Ruby::Base < ::YARD::Handlers::Base
  include ::YARD::Parser::Ruby
  extend ::YARD::Parser::Ruby

  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:144
  def call_params; end

  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:155
  def caller_method; end

  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:135
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:113
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:105
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:86
...
#   end
#
# source://yard-VERSION/lib/yard/handlers/ruby/class_condition_handler.rb:12
class YARD::Handlers::Ruby::ClassConditionHandler < ::YARD::Handlers::Ruby::Base
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/class_condition_handler.rb:36
  def parse_condition; end

  # source://yard-VERSION/lib/yard/handlers/ruby/class_condition_handler.rb:87
  def parse_else_block; end

  # source://yard-VERSION/lib/yard/handlers/ruby/class_condition_handler.rb:83
  def parse_then_block; end
end

# Handles class declarations
#
# source://yard-VERSION/lib/yard/handlers/ruby/class_handler.rb:3
class YARD::Handlers::Ruby::ClassHandler < ::YARD::Handlers::Ruby::Base
  include ::YARD::Handlers::Ruby::StructHandlerMethods

  private

  # source://yard-VERSION/lib/yard/handlers/ruby/class_handler.rb:73
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/class_handler.rb:67
  def extract_parameters(superclass); end

  # source://yard-VERSION/lib/yard/handlers/ruby/class_handler.rb:92
  def parse_struct_superclass(klass, superclass); end

  # source://yard-VERSION/lib/yard/handlers/ruby/class_handler.rb:98
  def parse_superclass(superclass); end

  # source://yard-VERSION/lib/yard/handlers/ruby/class_handler.rb:82
  def struct_superclass_name(superclass); end
end

# Handles a class variable (@@variable)
#
# source://yard-VERSION/lib/yard/handlers/ruby/class_variable_handler.rb:3
...
#
# source://yard-VERSION/lib/yard/handlers/ruby/comment_handler.rb:3
class YARD::Handlers::Ruby::CommentHandler < ::YARD::Handlers::Ruby::Base; end

# Handles any constant assignment
#
# source://yard-VERSION/lib/yard/handlers/ruby/constant_handler.rb:3
class YARD::Handlers::Ruby::ConstantHandler < ::YARD::Handlers::Ruby::Base
  ...
  # @return [Array<String>] the member names to generate methods for
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/constant_handler.rb:49
  def extract_parameters(superclass); end

  # source://yard-VERSION/lib/yard/handlers/ruby/constant_handler.rb:21
  def process_constant(statement); end

  # source://yard-VERSION/lib/yard/handlers/ruby/constant_handler.rb:33
  def process_structclass(statement); end
end

# Handles automatic detection of dsl-style methods
#
# source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler.rb:6
class YARD::Handlers::Ruby::DSLHandler < ::YARD::Handlers::Ruby::Base
  include ::YARD::Handlers::Ruby::DSLHandlerMethods
end

# source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:5
module YARD::Handlers::Ruby::DSLHandlerMethods
  include ::YARD::CodeObjects
  include ::YARD::Parser

  # source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:14
  def handle_comments; end

  # source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:48
  def register_docstring(object, docstring = T.unsafe(nil), stmt = T.unsafe(nil)); end

  private

  # source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:72
  def find_attached_macro; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:54
  def implicit_docstring?; end

  # @return [Boolean] whether caller method matches a macro or
  #   its alias names.
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:85
  def macro_name_matches(macro); end

  # source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:59
  def method_name; end

  # source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:68
  def method_signature; end
end

# source://yard-VERSION/lib/yard/handlers/ruby/dsl_handler_methods.rb:9
...
#
# source://yard-VERSION/lib/yard/handlers/ruby/decorator_handler_methods.rb:3
module YARD::Handlers::Ruby::DecoratorHandlerMethods
  # @overload process_decorator
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/decorator_handler_methods.rb:43
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/decorator_handler_methods.rb:78
  def process_decorator_parameter(node, opts = T.unsafe(nil), &block); end
end

# Handles 'raise' calls inside methods
#
# source://yard-VERSION/lib/yard/handlers/ruby/exception_handler.rb:3
...
# @see MixinHandler
#
# source://yard-VERSION/lib/yard/handlers/ruby/extend_handler.rb:4
class YARD::Handlers::Ruby::ExtendHandler < ::YARD::Handlers::Ruby::MixinHandler
  # source://yard-VERSION/lib/yard/handlers/ruby/extend_handler.rb:8
  def scope; end

  private

  # source://yard-VERSION/lib/yard/handlers/ruby/extend_handler.rb:12
...
#   end
#
# source://yard-VERSION/lib/yard/handlers/ruby/base.rb:19
class YARD::Handlers::Ruby::HandlesExtension
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:22
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:27
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:34
  def name; end
end

# Handlers for old Ruby 1.8 parser
#
# source://yard-VERSION/lib/yard/autoload.rb:93
module YARD::Handlers::Ruby::Legacy; end

# Handles alias and alias_method calls
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/alias_handler.rb:3
class YARD::Handlers::Ruby::Legacy::AliasHandler < ::YARD::Handlers::Ruby::Legacy::Base; end

# Handles +attr_*+ statements in modules/classes
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/attribute_handler.rb:3
...
# @abstract See {Handlers::Base} for subclassing information.
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:10
class YARD::Handlers::Ruby::Legacy::Base < ::YARD::Handlers::Base
  include ::YARD::Parser::Ruby::Legacy::RubyToken

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:44
  def call_params; end

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:53
  def caller_method; end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:35
  def parse_block(opts = T.unsafe(nil)); end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:68
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:112
  ...
  # @see #tokval
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:178
  ...
  class << self
    ...
    #   by this handler.
    #
    # source://yard-VERSION/lib/yard/handlers/ruby/legacy/base.rb:15
...
# @since 0.5.4
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_condition_handler.rb:4
class YARD::Handlers::Ruby::Legacy::ClassConditionHandler < ::YARD::Handlers::Ruby::Legacy::Base
  ...
  # @since 0.5.5
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_condition_handler.rb:29
  def parse_condition; end

  # @since 0.5.5
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_condition_handler.rb:73
  def parse_else_block; end

  # @since 0.5.5
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_condition_handler.rb:68
  def parse_then_block; end
end

# Handles class declarations
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_handler.rb:3
class YARD::Handlers::Ruby::Legacy::ClassHandler < ::YARD::Handlers::Ruby::Legacy::Base
  include ::YARD::Handlers::Ruby::StructHandlerMethods

  private

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_handler.rb:74
  def create_struct_superclass(superclass, superclass_def); end
  ...
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_handler.rb:69
  def extract_parameters(superstring); end

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_handler.rb:95
  def parse_struct_subclass(klass, superclass_def); end

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_handler.rb:102
  def parse_superclass(superclass); end

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_handler.rb:83
  def struct_superclass_name(superclass); end
end

# Handles a class variable (@@variable)
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_variable_handler.rb:3
class YARD::Handlers::Ruby::Legacy::ClassVariableHandler < ::YARD::Handlers::Ruby::Legacy::Base; end

# source://yard-VERSION/lib/yard/handlers/ruby/legacy/class_variable_handler.rb:4
YARD::Handlers::Ruby::Legacy::ClassVariableHandler::HANDLER_MATCH = T.let(T.unsafe(nil), Regexp)

# Handles any lone comment statement in a Ruby file
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/comment_handler.rb:3
class YARD::Handlers::Ruby::Legacy::CommentHandler < ::YARD::Handlers::Ruby::Legacy::Base; end

# Handles any constant assignment
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/constant_handler.rb:3
class YARD::Handlers::Ruby::Legacy::ConstantHandler < ::YARD::Handlers::Ruby::Legacy::Base
  include ::YARD::Handlers::Ruby::StructHandlerMethods

  private

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/constant_handler.rb:25
  def extract_parameters(parameters); end

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/constant_handler.rb:20
  def process_structclass(classname, parameters); end
end

# source://yard-VERSION/lib/yard/handlers/ruby/legacy/constant_handler.rb:5
YARD::Handlers::Ruby::Legacy::ConstantHandler::HANDLER_MATCH = T.let(T.unsafe(nil), Regexp)

# Handles automatic detection of dsl-style methods
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/dsl_handler.rb:7
...
# Handles 'raise' calls inside methods
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/exception_handler.rb:3
...
# @see MixinHandler
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/extend_handler.rb:3
class YARD::Handlers::Ruby::Legacy::ExtendHandler < ::YARD::Handlers::Ruby::Legacy::MixinHandler
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/extend_handler.rb:7
  def scope; end

  private

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/extend_handler.rb:11
  def process_mixin(mixin); end
end

# Handles a method definition
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/method_handler.rb:3
...
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/mixin_handler.rb:3
class YARD::Handlers::Ruby::Legacy::MixinHandler < ::YARD::Handlers::Ruby::Legacy::Base
  private

  # @raise [YARD::Parser::UndocumentableError]
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/mixin_handler.rb:26
  def process_mixin(mixin); end
end
...
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/module_function_handler.rb:3
...
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/module_handler.rb:3
...
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/private_class_method_handler.rb:3
class YARD::Handlers::Ruby::Legacy::PrivateClassMethodHandler < ::YARD::Handlers::Ruby::Legacy::Base
  private

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/private_class_method_handler.rb:15
  def privatize_class_method(name); end
end

# Sets visibility of a constant (class, module, const)
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/private_constant_handler.rb:3
class YARD::Handlers::Ruby::Legacy::PrivateConstantHandler < ::YARD::Handlers::Ruby::Legacy::Base
  private

  # source://yard-VERSION/lib/yard/handlers/ruby/legacy/private_constant_handler.rb:15
  def privatize_constant(name); end
end

# Handles 'private', 'protected', and 'public' calls.
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/visibility_handler.rb:3
class YARD::Handlers::Ruby::Legacy::VisibilityHandler < ::YARD::Handlers::Ruby::Legacy::Base; end

# Handles 'yield' calls
#
# source://yard-VERSION/lib/yard/handlers/ruby/legacy/yield_handler.rb:3
class YARD::Handlers::Ruby::Legacy::YieldHandler < ::YARD::Handlers::Ruby::Legacy::Base; end

# source://yard-VERSION/lib/yard/handlers/ruby/base.rb:37
class YARD::Handlers::Ruby::MethodCallWrapper < ::YARD::Handlers::Ruby::HandlesExtension
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:38
  def matches?(node); end
end

# Handles a conditional inside a method
#
# source://yard-VERSION/lib/yard/handlers/ruby/method_condition_handler.rb:3
class YARD::Handlers::Ruby::MethodConditionHandler < ::YARD::Handlers::Ruby::Base; end

# Handles a method definition
#
# source://yard-VERSION/lib/yard/handlers/ruby/method_handler.rb:3
class YARD::Handlers::Ruby::MethodHandler < ::YARD::Handlers::Ruby::Base
  include ::YARD::Handlers::Common::MethodHandler

  # source://yard-VERSION/lib/yard/handlers/ruby/method_handler.rb:69
  def format_args; end
end

# Handles the 'include' statement to mixin a module in the instance scope
#
# source://yard-VERSION/lib/yard/handlers/ruby/mixin_handler.rb:3
class YARD::Handlers::Ruby::MixinHandler < ::YARD::Handlers::Ruby::Base
  protected

  # @raise [YARD::Parser::UndocumentableError]
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/mixin_handler.rb:25
  def process_mixin(mixin); end

  # source://yard-VERSION/lib/yard/handlers/ruby/mixin_handler.rb:43
...
# Also creates a private instance copy of the method.
#
# source://yard-VERSION/lib/yard/handlers/ruby/module_function_handler.rb:4
class YARD::Handlers::Ruby::ModuleFunctionHandler < ::YARD::Handlers::Ruby::Base
  include ::YARD::Handlers::Ruby::DecoratorHandlerMethods

  # source://yard-VERSION/lib/yard/handlers/ruby/module_function_handler.rb:34
  def make_module_function(instance_method, namespace); end
end

# Handles the declaration of a module
#
# source://yard-VERSION/lib/yard/handlers/ruby/module_handler.rb:3
class YARD::Handlers::Ruby::ModuleHandler < ::YARD::Handlers::Ruby::Base; end

# Sets visibility of a class method to private.
#
# source://yard-VERSION/lib/yard/handlers/ruby/private_class_method_handler.rb:3
...
# Sets visibility of a constant (class, module, const)
#
# source://yard-VERSION/lib/yard/handlers/ruby/private_constant_handler.rb:6
class YARD::Handlers::Ruby::PrivateConstantHandler < ::YARD::Handlers::Ruby::Base
  private

  # source://yard-VERSION/lib/yard/handlers/ruby/private_constant_handler.rb:28
  def privatize_constant(node); end
end

# Sets visibility of a class method to public.
#
# source://yard-VERSION/lib/yard/handlers/ruby/public_class_method_handler.rb:3
...
# @since 0.5.6
#
# source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:7
module YARD::Handlers::Ruby::StructHandlerMethods
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:62
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:77
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:134
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:92
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:38
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:121
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:104
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:17
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:26
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/struct_handler_methods.rb:51
  def return_type_from_tag(member_tag); end
end

# source://yard-VERSION/lib/yard/handlers/ruby/base.rb:53
class YARD::Handlers::Ruby::TestNodeWrapper < ::YARD::Handlers::Ruby::HandlesExtension
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/handlers/ruby/base.rb:54
  def matches?(node); end
end

# Handles 'private', 'protected', and 'public' calls.
#
# source://yard-VERSION/lib/yard/handlers/ruby/visibility_handler.rb:3
...
# Handles 'yield' calls
#
# source://yard-VERSION/lib/yard/handlers/ruby/yield_handler.rb:3
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/autoload.rb:151
...
# @since 0.8.2
#
# source://yard-VERSION/lib/yard/i18n/locale.rb:8
class YARD::I18n::Locale
  ...
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/i18n/locale.rb:34
  def initialize(name); end
  ...
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/i18n/locale.rb:44
  ...
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/i18n/locale.rb:29
  def name; end
  ...
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/i18n/locale.rb:62
  ...
  class << self
    ...
    # @since 0.8.4
    #
    # source://yard-VERSION/lib/yard/i18n/locale.rb:15
    def default; end

    # @return [String, nil] the default locale name.
    # @since 0.8.4
    #
    # source://yard-VERSION/lib/yard/i18n/locale.rb:20
...
# @since 0.8.1
#
# source://yard-VERSION/lib/yard/i18n/message.rb:10
class YARD::I18n::Message
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/message.rb:24
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/message.rb:49
  def ==(other); end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/message.rb:43
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/message.rb:35
  def add_location(path, line); end

  # @return [Set] the set of comments for the messages.
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/message.rb:19
  def comments; end

  # @return [String] the message ID of the trnslation target message.
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/message.rb:12
  def id; end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/message.rb:16
  def locations; end
end
...
# @since 0.8.1
#
# source://yard-VERSION/lib/yard/i18n/messages.rb:7
class YARD::I18n::Messages
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/messages.rb:11
  def initialize; end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/messages.rb:45
  def ==(other); end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/messages.rb:27
  def [](id); end
  ...
  #   the enumeration.
  #
  # source://yard-VERSION/lib/yard/i18n/messages.rb:20
  def each(&block); end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/messages.rb:37
  def register(id); end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/messages.rb:53
  def messages; end
end
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/i18n/pot_generator.rb:65
class YARD::I18n::PotGenerator
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:79
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:122
  def generate; end
  ...
  # @since 0.8.1
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:70
  def messages; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:103
  def parse_files(files); end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:91
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:160
  def current_time; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:183
  def escape_message_id(message_id); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:194
  def extract_documents(object); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:268
  def extract_paragraphs(file); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:235
  def extract_tag_documents(tag); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:242
  def extract_tag_name(tag); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:255
  def extract_tag_text(tag); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:168
  def generate_message(pot, message); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:164
  def generate_pot_creation_date_value; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:136
  def header; end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/pot_generator.rb:190
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/i18n/text.rb:5
class YARD::I18n::Text
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:12
  ...
  #   attribute.
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:35
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:52
  ...
  # @yield [part]
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:134
  def emit_attribute_event(match_data, line_no); end

  # @since 0.8.0
  # @yield [part]
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:147
  def emit_empty_line_event(line, line_no); end

  # @since 0.8.0
  # @yield [part]
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:125
  def emit_markup_event(line, line_no); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:156
  def emit_paragraph_event(paragraph, paragraph_start_line, line_no, &block); end

  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/i18n/text.rb:76
  def parse(&block); end
end
...
#
# source://yard-VERSION/lib/yard/logging.rb:12
class YARD::Logger < ::Logger
  # Creates a new logger
  #
  # @return [Logger] a new instance of Logger
  #
  # source://yard-VERSION/lib/yard/logging.rb:43
  ...
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/logging.rb:143
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/logging.rb:154
  ...
  #
  # source://yard-VERSION/lib/yard/logging.rb:80
  ...
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/logging.rb:121
  def clear_progress; end

  # Changes the debug level to DEBUG if $DEBUG is set
  # and writes a debugging message.
  #
  # source://yard-VERSION/lib/yard/logging.rb:59
  def debug(*args); end
  ...
  #
  # source://yard-VERSION/lib/yard/logging.rb:179
  def enter_level(new_level = T.unsafe(nil)); end

  # @return [IO] the IO object being logged to
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/logging.rb:17
  def io; end

  # source://yard-VERSION/lib/yard/logging.rb:18
  def io=(pipe); end
  ...
  # @since 0.8.2
  #
  # source://yard-VERSION/lib/yard/logging.rb:96
  ...
  #
  # source://yard-VERSION/lib/yard/logging.rb:23
  ...
  #
  # source://yard-VERSION/lib/yard/logging.rb:27
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/logging.rb:167
  def warn_no_continuations; end

  # Returns the value of attribute warned.
  #
  # source://yard-VERSION/lib/yard/logging.rb:69
  def warned; end
  ...
  #
  # source://yard-VERSION/lib/yard/logging.rb:190
  def add(*args); end

  # source://yard-VERSION/lib/yard/logging.rb:195
  def clear_line; end

  # Log format (from Logger implementation). Used by Logger internally
  #
  # source://yard-VERSION/lib/yard/logging.rb:201
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/logging.rb:38
...
# @since 0.8.2
#
# source://yard-VERSION/lib/yard/logging.rb:13
...
class YARD::Options
  ...
  #
  # source://yard-VERSION/lib/yard/options.rb:91
  def [](key); end
  ...
  #
  # source://yard-VERSION/lib/yard/options.rb:100
  def []=(key, value); end
  ...
  #
  # source://yard-VERSION/lib/yard/options.rb:207
  def delete(key); end
  ...
  #
  # source://yard-VERSION/lib/yard/options.rb:143
  def each; end

  # Inspects the object
  #
  # source://yard-VERSION/lib/yard/options.rb:151
  def inspect; end
  ...
  # @see #update
  #
  # source://yard-VERSION/lib/yard/options.rb:123
  def merge(opts); end
  ...
  #
  # source://yard-VERSION/lib/yard/options.rb:170
  def method_missing(meth, *args, &block); end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/options.rb:188
  def reset_defaults; end

  # @return [Hash] Converts options object to an options hash. All keys
  #   will be symbolized.
  #
  # source://yard-VERSION/lib/yard/options.rb:129
  def to_hash; end
  ...
  # @return [self]
  #
  # source://yard-VERSION/lib/yard/options.rb:109
  def update(opts); end
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/options.rb:80
...
#
# source://yard-VERSION/lib/yard/autoload.rb:161
...
# @since 0.5.6
#
# source://yard-VERSION/lib/yard/parser/base.rb:16
class YARD::Parser::Base
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/base.rb:26
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/base.rb:52
  def enumerator; end
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/base.rb:33
  def parse; end
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/base.rb:40
  def tokenize; end
  ...
  class << self
    ...
    # @since 0.5.6
    #
    # source://yard-VERSION/lib/yard/parser/base.rb:18
...
#
# source://yard-VERSION/lib/yard/autoload.rb:162
module YARD::Parser::C; end

# source://yard-VERSION/lib/yard/parser/c/statement.rb:41
class YARD::Parser::C::BodyStatement < ::YARD::Parser::C::Statement
  # Returns the value of attribute comments.
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:42
  def comments; end
...
# source://yard-VERSION/lib/yard/parser/c/c_parser.rb:5
class YARD::Parser::C::CParser < ::YARD::Parser::Base
  # @return [CParser] a new instance of CParser
  #
  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:6
  def initialize(source, file = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:24
  def enumerator; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:19
  def parse; end

  # @raise [NotImplementedError]
  #
  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:28
  def tokenize; end

  private

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:213
  def advance(num = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:216
  def advance_loop; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:195
  def attach_comment(statement); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:214
  def back(num = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:225
  def char(num = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:96
  def consume_body_statements; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:136
  def consume_comment(add_comment = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:59
  def consume_directive; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:47
  def consume_quote(type = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:73
  def consume_toplevel_statement; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:169
  def consume_until(end_char, bracket_level = T.unsafe(nil), brace_level = T.unsafe(nil), add_comment = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:132
  def consume_whitespace; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:227
  def nextchar(num = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:220
  def nextline; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:34
  def parse_toplevel; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:226
  def prevchar(num = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:118
  def strip_non_statement_data; end

  # source://yard-VERSION/lib/yard/parser/c/c_parser.rb:229
  def struct; end
end

# source://yard-VERSION/lib/yard/parser/c/statement.rb:51
class YARD::Parser::C::Comment < ::YARD::Parser::C::Statement
  include ::YARD::Parser::C::CommentParser

  # @return [Comment] a new instance of Comment
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:58
  def initialize(source, file = T.unsafe(nil), line = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/c/statement.rb:62
  def comments; end

  # Returns the value of attribute overrides.
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:55
  def overrides; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:56
  def statement; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:54
  def type; end
...
# source://yard-VERSION/lib/yard/parser/c/comment_parser.rb:5
module YARD::Parser::C::CommentParser
  protected

  # source://yard-VERSION/lib/yard/parser/c/comment_parser.rb:8
  def parse_comments(comments); end

  private

  # source://yard-VERSION/lib/yard/parser/c/comment_parser.rb:42
  def parse_callseq(comments); end

  # source://yard-VERSION/lib/yard/parser/c/comment_parser.rb:30
  def parse_overrides(comments); end

  # source://yard-VERSION/lib/yard/parser/c/comment_parser.rb:87
  def parse_types(types); end

  # source://yard-VERSION/lib/yard/parser/c/comment_parser.rb:126
  def remove_private_comments(comment); end
end

# source://yard-VERSION/lib/yard/parser/c/statement.rb:5
class YARD::Parser::C::Statement
  # @return [Statement] a new instance of Statement
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:16
  def initialize(source, file = T.unsafe(nil), line = T.unsafe(nil)); end

  # Returns the value of attribute comments_hash_flag.
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:14
  ...
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:26
  def comments_range; end

  # Returns the value of attribute file.
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:8
  def file; end
  ...
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:30
  def first_line; end

  # @deprecated Groups are now defined by directives
  # @see Tags::GroupDirective
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:12
  def group; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:7
  def line; end
  ...
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:22
  def line_range; end

  # source://yard-VERSION/lib/yard/parser/c/statement.rb:36
  def show; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:6
  def source; end
...
# source://yard-VERSION/lib/yard/parser/c/statement.rb:45
class YARD::Parser::C::ToplevelStatement < ::YARD::Parser::C::Statement
  # Returns the value of attribute block.
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:46
  def block; end
  ...
  # Returns the value of attribute comments.
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:48
  def comments; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/c/statement.rb:47
  def declaration; end
...
#
# source://yard-VERSION/lib/yard/parser/source_parser.rb:21
class YARD::Parser::OrderedParser
  ...
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:33
  def initialize(global_state, files); end

  # @return [Array<String>] the list of remaining files to parse
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:23
  def files; end
  ...
  # @see Processor#parse_remaining_files
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:42
  def parse; end
end

# Raised when the parser sees a Ruby syntax error
#
# source://yard-VERSION/lib/yard/parser/source_parser.rb:13
class YARD::Parser::ParserSyntaxError < ::YARD::Parser::UndocumentableError; end

# Ruby parsing components.
#
# source://yard-VERSION/lib/yard/autoload.rb:171
module YARD::Parser::Ruby
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:25
  def s(*args); end
end
...
#
# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:41
class YARD::Parser::Ruby::AstNode < ::Array
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:153
  ...
  #   the list and type
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:167
  def ==(other); end

  # @return [Boolean] whether the node has a block
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:261
  def block?; end

  # @return [Boolean] whether the node is a method call
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:241
  def call?; end

  # @return [Array<AstNode>] the {AstNode} children inside the node
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:199
  def children; end

  # Returns the value of attribute docstring.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:43
  def comments; end

  # Returns the value of attribute docstring_hash_flag.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:42
  def comments_hash_flag; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:251
  def condition?; end

  # @return [Boolean] whether the node is a method definition
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:246
  def def?; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:76
  def file; end
  ...
  # @param value the value to set the attribute file to.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:49
  def file=(_arg0); end

  # @return [String] the first line of source represented by the node.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:278
  def first_line; end

  # @return [String] the full source that the node was parsed from
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:82
  def full_source; end
  ...
  # @see Tags::GroupDirective
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:47
  def group; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:268
  def has_line?; end

  # @return [String] inspects the object
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:323
  def inspect; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:193
  def jump(*node_types); end

  # @return [Boolean] whether the node is a keyword
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:236
  def kw?; end

  # @return [Fixnum] the starting line number of the node
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:273
  def line; end

  # @return [Range] the line range in {#full_source} represented
  #   by the node
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:70
  def line_range; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:231
  def literal?; end

  # @return [Boolean] whether the node is a loop
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:256
  def loop?; end

  # @return [AstNode, nil] the node's parent or nil if it is a root node.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:59
  def parent; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:290
  def pretty_print(q); end

  # @return [Boolean] whether the node is a reference (variable,
  #   constant name)
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:226
  def ref?; end

  # @return [String] the first line of source the node represents
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:285
  def show; end

  # @return [String] the parse of {#full_source} that the node represents
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:89
  def source; end
  ...
  #   by the node
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:63
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:220
  def token?; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:208
  def traverse; end

  # @return [Symbol] the node's unique symbolic type
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:56
  def type; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:331
  def unfreeze; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:341
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:111
...
# @return [Hash]
#
# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:96
YARD::Parser::Ruby::AstNode::KEYWORDS = T.let(T.unsafe(nil), Hash)

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:530
class YARD::Parser::Ruby::ClassNode < ::YARD::Parser::Ruby::KeywordNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:533
  def block; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:531
  def class_name; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:532
  def superclass; end
end

# Represents a lone comment block in source
#
# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:548
class YARD::Parser::Ruby::CommentNode < ::YARD::Parser::Ruby::AstNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:549
  def comments; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:549
  def docstring; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:550
  def docstring=(value); end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:554
  def first_line; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:553
  def source; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:515
class YARD::Parser::Ruby::ConditionalNode < ::YARD::Parser::Ruby::KeywordNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:517
  def condition; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:516
  def condition?; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:520
  def else_block; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:518
  def then_block; end
  ...
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:527
  def cmod?; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:376
class YARD::Parser::Ruby::KeywordNode < ::YARD::Parser::Ruby::AstNode
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:377
  def kw?; end
end

# Handles Ruby parsing in Ruby 1.8.
#
# source://yard-VERSION/lib/yard/autoload.rb:172
...
# @private
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:314
class YARD::Parser::Ruby::Legacy::RubyLex
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:437
  def initialize(content); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:472
  def char_no; end

  # Returns the value of attribute continue.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:430
  def continue; end

  # Returns the value of attribute exception_on_syntax_error.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:463
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:476
  def get_read; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:480
  def getc; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:484
  def getc_of_rests; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:488
  def gets; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:1257
  def identify_comment; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:945
  def identify_gvar; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:1062
  def identify_here_document; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:980
  def identify_identifier; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:1130
  def identify_number(start); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:1111
  def identify_quotation(initial_char); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:1192
  def identify_string(ltype, quoted = T.unsafe(nil), opener = T.unsafe(nil), initial_char = T.unsafe(nil)); end

  # Returns the value of attribute indent.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:465
  def indent; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:510
  def lex; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:586
  def lex_init; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:759
  def lex_int2; end

  # Returns the value of attribute lex_state.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:431
  def lex_state; end

  # io functions
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:468
  def line_no; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:506
  def peek(i = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:502
  def peek_equal?(str); end

  # Returns the value of attribute read_auto_clean_up.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:462
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:1280
  def read_escape; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:1242
  def skip_inner_expression; end

  # Returns the value of attribute skip_space.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:461
  def skip_space; end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:526
  def token; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:498
  def ungetc(c = T.unsafe(nil)); end

  class << self
    # @return [Boolean]
    #
    # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:433
    def debug?; end
  end
end
...
# , "when"
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:552
...
# @private
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:343
class YARD::Parser::Ruby::Legacy::RubyLex::BufferedReader
  # @return [BufferedReader] a new instance of BufferedReader
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:346
  def initialize(content); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:365
  def column; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:419
  def divert_read_from(reserve); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:400
  def get_read; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:369
  def getc; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:388
  def getc_already_read; end

  # Returns the value of attribute line_num.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:344
  def line_num; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:406
  def peek(at); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:415
  def peek_equal(str); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:392
  def ungetc(_ch); end
end

# , "when"
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:553
YARD::Parser::Ruby::Legacy::RubyLex::DEINDENT_CLAUSE = T.let(T.unsafe(nil), Array)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:580
YARD::Parser::Ruby::Legacy::RubyLex::DLtype2Token = T.let(T.unsafe(nil), Hash)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:548
YARD::Parser::Ruby::Legacy::RubyLex::ENINDENT_CLAUSE = T.let(T.unsafe(nil), Array)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:571
YARD::Parser::Ruby::Legacy::RubyLex::Ltype2Token = T.let(T.unsafe(nil), Hash)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:555
YARD::Parser::Ruby::Legacy::RubyLex::PERCENT_LTYPE = T.let(T.unsafe(nil), Hash)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:564
...
# @since 0.5.6
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_parser.rb:8
class YARD::Parser::Ruby::Legacy::RubyParser < ::YARD::Parser::Base
  # @return [RubyParser] a new instance of RubyParser
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_parser.rb:9
  def initialize(source, _filename); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_parser.rb:26
  def encoding_line; end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_parser.rb:22
  def enumerator; end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_parser.rb:13
  def parse; end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_parser.rb:27
  def shebang_line; end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_parser.rb:18
  def tokenize; end
end

# Legacy lexical tokenizer module.
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:6
module YARD::Parser::Ruby::Legacy::RubyToken
  # @private
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:125
  def Token(token, value = T.unsafe(nil)); end

  # @private
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:119
  def set_token_position(line, char); end

  class << self
    # @private
    #
    # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:275
    def def_token(token_n, super_token = T.unsafe(nil), reading = T.unsafe(nil), *opts); end
  end
end

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:10
YARD::Parser::Ruby::Legacy::RubyToken::EXPR_ARG = T.let(T.unsafe(nil), Symbol)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:7
YARD::Parser::Ruby::Legacy::RubyToken::EXPR_BEG = T.let(T.unsafe(nil), Symbol)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:13
YARD::Parser::Ruby::Legacy::RubyToken::EXPR_CLASS = T.let(T.unsafe(nil), Symbol)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:12
YARD::Parser::Ruby::Legacy::RubyToken::EXPR_DOT = T.let(T.unsafe(nil), Symbol)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:9
YARD::Parser::Ruby::Legacy::RubyToken::EXPR_END = T.let(T.unsafe(nil), Symbol)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:11
YARD::Parser::Ruby::Legacy::RubyToken::EXPR_FNAME = T.let(T.unsafe(nil), Symbol)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:8
YARD::Parser::Ruby::Legacy::RubyToken::EXPR_MID = T.let(T.unsafe(nil), Symbol)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:308
YARD::Parser::Ruby::Legacy::RubyToken::NEWLINE_TOKEN = T.let(T.unsafe(nil), YARD::Parser::Ruby::Legacy::RubyToken::TkNL)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:281
...
# Represents a block
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:54
class YARD::Parser::Ruby::Legacy::RubyToken::TkBlockContents < ::YARD::Parser::Ruby::Legacy::RubyToken::Token
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:55
  def text; end
end
...
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:115
...
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:72
class YARD::Parser::Ruby::Legacy::RubyToken::TkId < ::YARD::Parser::Ruby::Legacy::RubyToken::Token
  # @return [TkId] a new instance of TkId
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:73
  def initialize(line_no, char_no, name); end

  # Returns the value of attribute name.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:77
  def name; end
end

# Represents a Ruby keyword
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:81
...
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:63
class YARD::Parser::Ruby::Legacy::RubyToken::TkNode < ::YARD::Parser::Ruby::Legacy::RubyToken::Token
  # Returns the value of attribute node.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:64
  def node; end
end

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:98
class YARD::Parser::Ruby::Legacy::RubyToken::TkOPASGN < ::YARD::Parser::Ruby::Legacy::RubyToken::TkOp
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:99
  def initialize(line_no, char_no, op); end

  # Returns the value of attribute op.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:104
  def op; end
end
...
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:92
class YARD::Parser::Ruby::Legacy::RubyToken::TkOp < ::YARD::Parser::Ruby::Legacy::RubyToken::Token
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:93
  def name; end
end
...
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:271
...
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:59
class YARD::Parser::Ruby::Legacy::RubyToken::TkStatementEnd < ::YARD::Parser::Ruby::Legacy::RubyToken::Token
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:60
  def text; end
end

# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:272
...
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:107
class YARD::Parser::Ruby::Legacy::RubyToken::TkUnknownChar < ::YARD::Parser::Ruby::Legacy::RubyToken::Token
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:108
  def initialize(line_no, char_no, _id); end

  # Returns the value of attribute name.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:112
  def name; end
end

# Represents a Ruby value
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:85
class YARD::Parser::Ruby::Legacy::RubyToken::TkVal < ::YARD::Parser::Ruby::Legacy::RubyToken::Token
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:86
...
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:68
...
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:16
class YARD::Parser::Ruby::Legacy::RubyToken::Token
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:37
  def initialize(line_no, char_no); end

  # @return [Integer] the character number in the file/stream the token
  #   is located.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:23
  def char_no; end

  # @return [Symbol] the lexical state at the token
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:29
  def lex_state; end
  ...
  #   located.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:19
  def line_no; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:47
  def set_text(text); end

  # @return [String] the token text value
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:26
  def text; end
end

# @private
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:32
YARD::Parser::Ruby::Legacy::RubyToken::Token::NO_TEXT = T.let(T.unsafe(nil), String)

# @private
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/ruby_lex.rb:147
YARD::Parser::Ruby::Legacy::RubyToken::TokenDefinitions = T.let(T.unsafe(nil), Array)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:4
class YARD::Parser::Ruby::Legacy::Statement
  # @return [Statement] a new instance of Statement
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:14
  def initialize(tokens, block = T.unsafe(nil), comments = T.unsafe(nil)); end

  # Returns the value of attribute block.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:5
  def block; end
  ...
  # Returns the value of attribute comments_hash_flag.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:12
  def comments_hash_flag; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:6
  def comments_range; end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:21
  def first_line; end

  # @deprecated Groups are now defined by directives
  # @see Tags::GroupDirective
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:10
  def group; end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:34
  def inspect; end

  # @return [Fixnum] the first line of Ruby source
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:46
  def line; end

  # @return [Range<Fixnum>] the first to last lines of Ruby source
  # @since 0.5.4
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:52
  def line_range; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:41
  def show; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:21
  def signature; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:27
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement.rb:58
  def clean_tokens(tokens); end
end

# source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:4
class YARD::Parser::Ruby::Legacy::StatementList < ::Array
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:17
  def initialize(content); end

  # Returns the value of attribute encoding_line.
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:7
  def encoding_line; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:362
  def balances?(tk); end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:45
  def next_statement; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:34
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:388
  ...
  # @param tk [RubyToken::Token] the token to process
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:194
  ...
  # @param tk [RubyToken::Token] the token to process
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:293
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:213
  ...
  # @param tk [RubyToken::Token] the token to process
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:268
  ...
  # @param tk [RubyToken::Token] the token to process
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:305
  ...
  # @param tk [RubyToken::Token] the token to process
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:130
  ...
  # @param tk [RubyToken::Token] the token to process
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:380
  def push_token(tk); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:111
  def sanitize_block; end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:96
...
#
# source://yard-VERSION/lib/yard/parser/ruby/legacy/statement_list.rb:11
YARD::Parser::Ruby::Legacy::StatementList::OPEN_BLOCK_TOKENS = T.let(T.unsafe(nil), Array)

# source://yard-VERSION/lib/yard/parser/ruby/legacy/token_list.rb:4
class YARD::Parser::Ruby::Legacy::TokenList < ::Array
  include ::YARD::Parser::Ruby::Legacy::RubyToken

  # @return [TokenList] a new instance of TokenList
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/token_list.rb:7
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/token_list.rb:21
  def <<(*tokens); end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/legacy/token_list.rb:37
  def squeeze(type = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/token_list.rb:11
  def to_s(full_statement = T.unsafe(nil), show_block = T.unsafe(nil)); end

  private

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/token_list.rb:53
  def convert_token(lex, tk); end

  # source://yard-VERSION/lib/yard/parser/ruby/legacy/token_list.rb:44
  def parse_content(content); end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:372
class YARD::Parser::Ruby::LiteralNode < ::YARD::Parser::Ruby::AstNode
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:373
  def literal?; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:541
class YARD::Parser::Ruby::LoopNode < ::YARD::Parser::Ruby::KeywordNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:544
  def block; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:543
  def condition; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:542
  def loop?; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:438
class YARD::Parser::Ruby::MethodCallNode < ::YARD::Parser::Ruby::AstNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:464
  def block; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:462
  def block_param; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:439
  def call?; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:442
  def method_name(name_only = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:440
  def namespace; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:453
  ...
  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:474
  def call_has_paren?; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:470
  def index_adjust; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:479
class YARD::Parser::Ruby::MethodDefinitionNode < ::YARD::Parser::Ruby::AstNode
  def block(*_arg0); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:481
  def def?; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:480
  def kw?; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:484
  def method_name(name_only = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:482
  def namespace; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:489
  def parameters(include_block_param = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:495
  def signature; end

  private

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:510
  def index_adjust; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:536
class YARD::Parser::Ruby::ModuleNode < ::YARD::Parser::Ruby::KeywordNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:538
  def block; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:537
  def module_name; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:380
class YARD::Parser::Ruby::ParameterNode < ::YARD::Parser::Ruby::AstNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:430
  def args_forward; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:426
  def block_param; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:414
  def double_splat_param; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:396
  def named_params; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:406
  def splat_param; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:410
  def unnamed_end_params; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:385
  def unnamed_optional_params; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:381
  def unnamed_required_params; end
end

# source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:360
class YARD::Parser::Ruby::ReferenceNode < ::YARD::Parser::Ruby::AstNode
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:367
  def namespace; end

  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:363
  def path; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ast_node.rb:361
  def ref?; end
end
...
# @since 0.5.6
#
# source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:27
class YARD::Parser::Ruby::RipperParser < ::Ripper
  # @return [RipperParser] a new instance of RipperParser
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:32
  def initialize(source, filename, *args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:28
  def ast; end
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:29
  def encoding_line; end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:64
  def enumerator; end
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:68
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:164
  def on_BEGIN(*args); end

  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:182
  def on_CHAR(tok); end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:171
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:156
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:149
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:193
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:443
  def on_if_mod(*args); end

  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:171
  def on_ifop(*args); end

  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:216
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:203
  def on_kw(tok); end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:468
  def on_qsymbols_add(list, item); end

  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:193
  def on_qsymbols_beg(tok); end

  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:456
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:55
  def parse; end
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:661
  def add_comment(line, node = T.unsafe(nil), before_node = T.unsafe(nil), into = T.unsafe(nil)); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:265
  def add_token(token, data); end

  # @return [Boolean]
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:605
  def comment_starts_line?(charno); end

  # @raise [ParserSyntaxError]
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:600
  def compile_error(msg); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:687
  def freeze_tree(node = T.unsafe(nil)); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:614
  def insert_comments; end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:371
  def on_aref(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:379
  def on_aref_field(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:385
  def on_array(other); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:346
  def on_assoc_new(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:358
  def on_assoclist_from_args(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:354
  def on_bare_assoc_hash(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:341
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:536
  def on_comment(comment); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:435
  def on_const_path_ref(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:413
  def on_dyna_symbol(sym); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:586
  def on_embdoc(text); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:580
  def on_embdoc_beg(text); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:591
  def on_embdoc_end(text); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:350
  def on_hash(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:528
  def on_label(data); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:491
  def on_lambda(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:403
  def on_lbracket(tok); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:509
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:337
  def on_program(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:408
  def on_rbracket(tok); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:500
  def on_rescue(exc, *args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:226
  def on_sp(tok); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:495
  def on_string_content(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:478
  def on_string_literal(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:423
  def on_top_const_ref(*args); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:362
  def on_unary(op, val); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:505
  def on_void_stmt; end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:231
  def visit_event(node); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:245
  def visit_event_arr(node); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:253
  def visit_ns_token(token, data, ast_token = T.unsafe(nil)); end
end

# @since 0.5.6
#
# source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:133
YARD::Parser::Ruby::RipperParser::AST_TOKENS = T.let(T.unsafe(nil), Array)

# @since 0.5.6
#
# source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:78
YARD::Parser::Ruby::RipperParser::MAPPINGS = T.let(T.unsafe(nil), Hash)

# @since 0.5.6
#
# source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:131
YARD::Parser::Ruby::RipperParser::REV_MAPPINGS = T.let(T.unsafe(nil), Hash)

# Ruby 1.9 parser
#
# source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:12
class YARD::Parser::Ruby::RubyParser < ::YARD::Parser::Base
  # @return [RubyParser] a new instance of RubyParser
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:13
  def initialize(source, filename); end

  # Ruby 1.9 parser
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:21
  def encoding_line; end

  # Ruby 1.9 parser
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:19
  def enumerator; end

  # Ruby 1.9 parser
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:22
  def frozen_string_line; end

  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:17
  def parse; end

  # Ruby 1.9 parser
  #
  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:20
  def shebang_line; end

  # source://yard-VERSION/lib/yard/parser/ruby/ruby_parser.rb:18
  def tokenize; end
end
...
#
# source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:8
class YARD::Parser::Ruby::TokenResolver
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:16
  ...
  #
  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:46
  def each; end

  protected

  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:94
  def last_sep; end

  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:95
  def last_sep=(v); end
  ...
  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:112
  def lookup(toktype, name); end

  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:134
  def object_resolved_types(obj = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:106
  def pop_state; end

  # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:102
  def push_state; end

  class << self
    # source://yard-VERSION/lib/yard/parser/ruby/token_resolver.rb:92
...
# @see CodeObjects::Base
#
# source://yard-VERSION/lib/yard/parser/source_parser.rb:64
class YARD::Parser::SourceParser
  # @overload initialize
  # @return [SourceParser] a new instance of SourceParser
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:406
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:399
  def contents; end

  # @return [String] the filename being parsed by the parser.
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:386
  def file; end
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:395
  def globals; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:418
  ...
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:390
  def parser_type; end
  ...
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:462
  ...
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:471
  def convert_encoding(content); end

  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:516
  def parser_class; end

  # source://yard-VERSION/lib/yard/parser/source_parser.rb:501
  ...
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:509
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/parser/source_parser.rb:491
  def post_process; end
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:324
    ...
    # @since 0.7.0
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:352
    ...
    # @yieldreturn [void] the return value for the block is ignored.
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:258
    ...
    # @since 0.7.0
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:338
    ...
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:295
    ...
    # @since 0.7.0
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:345
    ...
    #   cancelled.
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:234
    ...
    # @since 0.7.0
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:331
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:100
    ...
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:123
    def parse_string(content, ptype = T.unsafe(nil)); end

    # @return [Symbol] the default parser type (defaults to :ruby)
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:86
    def parser_type; end

    # source://yard-VERSION/lib/yard/parser/source_parser.rb:88
    def parser_type=(value); end
    ...
    # @since 0.5.6
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:163
    def parser_type_extensions; end

    # source://yard-VERSION/lib/yard/parser/source_parser.rb:164
    ...
    # @since 0.5.6
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:171
    ...
    # @since 0.5.6
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:157
    def parser_types; end

    # source://yard-VERSION/lib/yard/parser/source_parser.rb:158
    ...
    # @see Parser::Base
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:146
    ...
    # @return [Array] a list of tokens
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:132
    ...
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:184
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/parser/source_parser.rb:364
...
# @since 0.9.0
#
# source://yard-VERSION/lib/yard/parser/source_parser.rb:71
...
# @since 0.7.0
#
# source://yard-VERSION/lib/yard/parser/source_parser.rb:75
YARD::Parser::SourceParser::ENCODING_BYTE_ORDER_MARKS = T.let(T.unsafe(nil), Hash)

# source://yard-VERSION/lib/yard/parser/source_parser.rb:66
YARD::Parser::SourceParser::ENCODING_LINE = T.let(T.unsafe(nil), Regexp)

# source://yard-VERSION/lib/yard/parser/source_parser.rb:67
YARD::Parser::SourceParser::FROZEN_STRING_LINE = T.let(T.unsafe(nil), Regexp)

# source://yard-VERSION/lib/yard/parser/source_parser.rb:65
...
class YARD::Rake::YardocTask < ::Rake::TaskLib
  ...
  #   to be changed.
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:50
  ...
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:36
  def after; end
  ...
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:32
  def before; end
  ...
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:28
  def files; end
  ...
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:11
  def name; end
  ...
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:15
  def options; end
  ...
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:19
  ...
  # @see Verifier
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:42
  def verifier; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/rake/yardoc_task.rb:68
  def define; end
end
...
#
# source://yard-VERSION/lib/yard/registry.rb:32
module YARD::Registry
  ...
  class << self
    ...
    # @return [nil] if no object is found
    #
    # source://yard-VERSION/lib/yard/registry.rb:261
    def [](path); end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:237
    def all(*types); end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:318
    def checksum_for(data); end

    # @return [Hash{String => String}] a set of checksums for files
    #
    # source://yard-VERSION/lib/yard/registry.rb:312
    def checksums; end
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/registry.rb:200
    def clear; end
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/registry.rb:194
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/registry.rb:176
    def delete_from_disk; end

    # Iterates over {all} with no arguments
    #
    # source://yard-VERSION/lib/yard/registry.rb:221
    def each(&block); end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:363
    def instance; end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:109
    ...
    # @since 0.5.1
    #
    # source://yard-VERSION/lib/yard/registry.rb:144
    ...
    # @since 0.5.1
    #
    # source://yard-VERSION/lib/yard/registry.rb:159
    def load_all; end
    ...
    # @return [Registry] the registry object (for chaining)
    #
    # source://yard-VERSION/lib/yard/registry.rb:130
    ...
    # @since 0.8.3
    #
    # source://yard-VERSION/lib/yard/registry.rb:271
    def locale(name); end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:252
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:353
    def po_dir; end
    ...
    # @return [String] the directory that has .po files
    #
    # source://yard-VERSION/lib/yard/registry.rb:351
    def po_dir=(dir); end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:341
    def proxy_types; end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:186
    ...
    # @see P
    #
    # source://yard-VERSION/lib/yard/registry.rb:303
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:266
    def root; end
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:170
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:335
    ...
    #   adapter will decide how to store the data.
    #
    # source://yard-VERSION/lib/yard/registry.rb:334
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:88
    def yardoc_file; end
    ...
    # @see DEFAULT_YARDOC_FILE
    #
    # source://yard-VERSION/lib/yard/registry.rb:86
    ...
    #
    # source://yard-VERSION/lib/yard/registry.rb:375
    def partial_resolve(namespace, name, type = T.unsafe(nil)); end

    # @since 0.9.1
    #
    # source://yard-VERSION/lib/yard/registry.rb:434
    def thread_local_resolver; end

    # @since 0.6.5
    #
    # source://yard-VERSION/lib/yard/registry.rb:424
    def thread_local_store; end

    # @since 0.6.5
    #
    # source://yard-VERSION/lib/yard/registry.rb:429
    def thread_local_store=(value); end
  end
end

# source://yard-VERSION/lib/yard/registry.rb:35
YARD::Registry::DEFAULT_PO_DIR = T.let(T.unsafe(nil), String)

# source://yard-VERSION/lib/yard/registry.rb:33
YARD::Registry::DEFAULT_YARDOC_FILE = T.let(T.unsafe(nil), String)

# source://yard-VERSION/lib/yard/registry.rb:34
...
# @since 0.9.1
#
# source://yard-VERSION/lib/yard/registry_resolver.rb:9
class YARD::RegistryResolver
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:16
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:50
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:180
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:104
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:121
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:205
  def split_on_separators_match; end

  # @return [Regexp] the regexp match of the default separator
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:193
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:199
  ...
  # @since 0.9.1
  #
  # source://yard-VERSION/lib/yard/registry_resolver.rb:99
...
#
# source://yard-VERSION/lib/yard/registry_store.rb:9
class YARD::RegistryStore
  # @return [RegistryStore] a new instance of RegistryStore
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:14
  def initialize; end
  ...
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:33
  def [](key); end
  ...
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:55
  def []=(key, value); end

  # Returns the value of attribute checksums.
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:12
  def checksums; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:75
  def delete(key); end
  ...
  #   otherwise.
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:218
  ...
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:88
  ...
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:128
  def load(file = T.unsafe(nil)); end
  ...
  # @since 0.5.1
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:142
  def load!(file = T.unsafe(nil)); end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:153
  def load_all; end
  ...
  # @since 0.8.3
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:122
  def locale(name); end
  ...
  # @see #locked_for_writing?
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:201
  def lock_for_writing(file = T.unsafe(nil), &block); end

  # @param file [String] if supplied, the path to the database
  # @return [Boolean] whether the database is currently locked for writing
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:207
  def locked_for_writing?(file = T.unsafe(nil)); end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:102
  def paths_for_type(type, reload = T.unsafe(nil)); end

  # @deprecated The registry no longer tracks proxy types
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:11
  def proxy_types; end
  ...
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:117
  def root; end
  ...
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:177
  def save(merge = T.unsafe(nil), file = T.unsafe(nil)); end
  ...
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:96
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:111
  def values_for_type(type, reload = T.unsafe(nil)); end

  protected

  # source://yard-VERSION/lib/yard/registry_store.rb:243
  def checksums_path; end

  # source://yard-VERSION/lib/yard/registry_store.rb:251
  def load_yardoc; end

  # source://yard-VERSION/lib/yard/registry_store.rb:247
  def object_types_path; end

  # source://yard-VERSION/lib/yard/registry_store.rb:234
  def objects_path; end

  # @deprecated The registry no longer tracks proxy types
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:239
  def proxy_types_path; end

  private

  # source://yard-VERSION/lib/yard/registry_store.rb:319
  def all_disk_objects; end

  # source://yard-VERSION/lib/yard/registry_store.rb:291
  def load_checksums; end

  # source://yard-VERSION/lib/yard/registry_store.rb:313
  def load_locale(name); end

  # source://yard-VERSION/lib/yard/registry_store.rb:281
  def load_object_types; end

  # @deprecated The registry no longer tracks proxy types
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:276
  def load_proxy_types; end

  # source://yard-VERSION/lib/yard/registry_store.rb:299
  def load_root; end

  # source://yard-VERSION/lib/yard/registry_store.rb:271
  def load_yardoc_old; end

  # source://yard-VERSION/lib/yard/registry_store.rb:332
  def write_checksums; end

  # source://yard-VERSION/lib/yard/registry_store.rb:338
  def write_complete_lock; end

  # source://yard-VERSION/lib/yard/registry_store.rb:328
  def write_object_types; end

  # @deprecated The registry no longer tracks proxy types
  #
  # source://yard-VERSION/lib/yard/registry_store.rb:324
  def write_proxy_types; end
end

# Namespace for components that serialize to various endpoints
#
# source://yard-VERSION/lib/yard/autoload.rb:196
...
#
# source://yard-VERSION/lib/yard/serializers/base.rb:17
class YARD::Serializers::Base
  ...
  # @return [Base] a new instance of Base
  #
  # source://yard-VERSION/lib/yard/serializers/base.rb:28
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/serializers/base.rb:80
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/base.rb:73
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/serializers/base.rb:62
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/base.rb:21
  def options; end
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/base.rb:42
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/base.rb:51
  def serialized_path(object); end
end

# Implements a serializer that reads from and writes to the filesystem.
#
# source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:7
class YARD::Serializers::FileSystemSerializer < ::YARD::Serializers::Base
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:28
  def initialize(opts = T.unsafe(nil)); end
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:8
  def basepath; end

  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:10
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:71
  def exists?(object); end
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:17
  def extension; end

  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:19
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:38
  def serialize(object, data); end
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:50
  def serialized_path(object); end
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:84
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:111
  def encode_path_components(*components); end

  # @return [String] the filesystem mapped name of a given object.
  #
  # source://yard-VERSION/lib/yard/serializers/file_system_serializer.rb:102
...
#
# source://yard-VERSION/lib/yard/serializers/process_serializer.rb:12
class YARD::Serializers::ProcessSerializer < ::YARD::Serializers::Base
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/process_serializer.rb:13
  def initialize(cmd); end

  # Overrides serialize behaviour and writes data to standard input
  # of the associated command
  #
  # source://yard-VERSION/lib/yard/serializers/process_serializer.rb:19
  def serialize(_object, data); end
end

# A serializer that writes data to standard output.
#
# source://yard-VERSION/lib/yard/serializers/stdout_serializer.rb:9
class YARD::Serializers::StdoutSerializer < ::YARD::Serializers::Base
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/stdout_serializer.rb:10
  def initialize(wrap = T.unsafe(nil)); end

  # Overrides serialize behaviour to write data to standard output
  #
  # source://yard-VERSION/lib/yard/serializers/stdout_serializer.rb:15
  def serialize(_object, data); end
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/stdout_serializer.rb:26
  def word_wrap(text, _length = T.unsafe(nil)); end
end

# source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:32
class YARD::Serializers::YardocSerializer < ::YARD::Serializers::FileSystemSerializer
  ...
  #
  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:33
  def initialize(yfile); end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:40
  def checksums_path; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:45
  def complete?; end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:42
  def complete_lock_path; end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:101
  ...
  # @see #locked_for_writing?
  #
  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:54
  def lock_for_writing; end

  # @return [Boolean] whether the database is currently locked for writing
  #
  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:62
  def locked_for_writing?; end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:41
  def object_types_path; end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:37
  def objects_path; end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:43
  def processing_path; end

  # @deprecated The registry no longer tracks proxy types
  #
  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:39
  def proxy_types_path; end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:93
  def serialize(object); end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:66
  def serialized_path(object); end

  private

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:114
  def dump(object); end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:119
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/autoload.rb:214
module YARD::Server
  class << self
    ...
    # @since 0.6.2
    #
    # source://yard-VERSION/lib/yard/server.rb:8
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/adapter.rb:23
class YARD::Server::Adapter
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:71
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:88
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:27
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:32
  def libraries; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:36
  def options; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:43
  def router; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:40
  def server_options; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/adapter.rb:95
  def start; end
  ...
  class << self
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/server/adapter.rb:48
    def setup; end
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/server/adapter.rb:56
    def shutdown; end
  end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/autoload.rb:219
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/base.rb:34
class YARD::Server::Commands::Base
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:75
  def initialize(opts = T.unsafe(nil)); end

  # @return [Adapter] the server adapter
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:41
  def adapter; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:61
  def body; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:44
  def caching; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:89
  def call(request); end

  # @return [Hash] the options passed to the command's constructor
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:38
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:55
  def headers; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:52
  def path; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:49
  def request; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:128
  def run; end

  # @return [Numeric] status code. Defaults to 200 per request
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:58
  def status; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:165
  def cache(data); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:180
  def not_found; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:192
  ...
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:144
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/base.rb:202
...
#
# source://yard-VERSION/lib/yard/server/commands/display_file_command.rb:8
class YARD::Server::Commands::DisplayFileCommand < ::YARD::Server::Commands::LibraryCommand
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/display_file_command.rb:9
  def index; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/display_file_command.rb:11
  def run; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/display_object_command.rb:6
class YARD::Server::Commands::DisplayObjectCommand < ::YARD::Server::Commands::LibraryCommand
  include ::YARD::Server::DocServerHelper

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/display_object_command.rb:36
  def index; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/display_object_command.rb:47
  def not_found; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/display_object_command.rb:9
  def run; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/display_object_command.rb:54
  def object_path; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/frames_command.rb:6
class YARD::Server::Commands::FramesCommand < ::YARD::Server::Commands::DisplayObjectCommand
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/frames_command.rb:7
  def run; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/library_command.rb:32
class YARD::Server::Commands::LibraryCommand < ::YARD::Server::Commands::Base
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:63
  def initialize(opts = T.unsafe(nil)); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:68
  def call(request); end

  # @return [Boolean] whether to reparse data
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:53
  def incremental; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:41
  def library; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:44
  def options; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:47
  def serializer; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:50
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:57
  def use_fork; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:96
  def call_with_fork(request, &block); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:83
  def call_without_fork(request); end

  # @return [Boolean]
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:109
  def can_fork?; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:171
  def fulldoc_template; end

  # @raise [LibraryNotPreparedError]
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:147
  def load_yardoc; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:159
  def not_prepared; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:118
  def restore_template_info; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:113
  def save_default_template_info; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:123
  def setup_library; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:130
  def setup_yardopts; end
end

# source://yard-VERSION/lib/yard/server/commands/library_command.rb:35
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/library_index_command.rb:13
class YARD::Server::Commands::LibraryIndexCommand < ::YARD::Server::Commands::Base
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_index_command.rb:14
  def options; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_index_command.rb:16
  def run; end
end

# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/library_index_command.rb:5
class YARD::Server::Commands::LibraryIndexOptions < ::YARD::CLI::YardocOptions
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_index_command.rb:6
  def adapter; end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/library_command.rb:7
class YARD::Server::Commands::LibraryOptions < ::YARD::CLI::YardocOptions
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:8
  def adapter; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:14
  def command; end
  ...
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:17
  def each(&block); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:15
  def frames; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:9
  def library; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:12
  def serialize; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:11
  def serializer; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/library_command.rb:10
  def single_library; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/list_command.rb:6
class YARD::Server::Commands::ListCommand < ::YARD::Server::Commands::LibraryCommand
  include ::YARD::Templates::Helpers::BaseHelper

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/list_command.rb:9
  def run; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/root_request_command.rb:6
class YARD::Server::Commands::RootRequestCommand < ::YARD::Server::Commands::Base
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/root_request_command.rb:9
  def run; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/search_command.rb:7
class YARD::Server::Commands::SearchCommand < ::YARD::Server::Commands::LibraryCommand
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/search_command.rb:12
  def query; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/search_command.rb:14
  def run; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/search_command.rb:26
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/search_command.rb:58
  def search_for_object; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/search_command.rb:47
  def serve_normal; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/search_command.rb:37
  def serve_xhr; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/search_command.rb:32
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/static_file_command.rb:6
class YARD::Server::Commands::StaticFileCommand < ::YARD::Server::Commands::LibraryCommand
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/static_file_command.rb:17
  def run; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/static_file_command.rb:15
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/commands/static_file_helpers.rb:9
module YARD::Server::Commands::StaticFileHelpers
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/static_file_helpers.rb:15
  def favicon?; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/static_file_helpers.rb:27
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/commands/static_file_helpers.rb:43
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/doc_server_helper.rb:6
module YARD::Server::DocServerHelper
  # @param path_components [Array<String>] components of a URL
  # @return [String] the absolute path from any mounted base URI.
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:61
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:69
  def base_path(path); end

  # @return [String] a timestamp for a given file
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:78
  def mtime(file); end

  # @return [String] a URL for a file with a timestamp
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:84
  def mtime_url(file); end

  # @return [Router] convenience method for accessing the router
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:75
  def router; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:11
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:24
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:43
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:55
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:37
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_helper.rb:49
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/doc_server_serializer.rb:6
class YARD::Server::DocServerSerializer < ::YARD::Serializers::FileSystemSerializer
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_serializer.rb:7
  def initialize(_command = T.unsafe(nil)); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_serializer.rb:11
  def serialized_path(object); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/doc_server_serializer.rb:31
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/adapter.rb:6
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/library_version.rb:9
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/library_version.rb:94
class YARD::Server::LibraryVersion
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:134
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:153
  def ==(other); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:191
  def gemspec; end

  # @return [Fixnum] used for Hash mapping.
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:150
  def hash; end

  # @return [String] the name of the library
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:96
  def name; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:182
  def prepare!; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:162
  def ready?; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:116
  def source; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:122
  def source_path; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:125
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:145
  def to_s(url_format = T.unsafe(nil)); end

  # @return [String] the version of the specific library
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:99
  def version; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:106
  def yardoc_file; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:109
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:206
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:226
  def load_yardoc_from_gem; end

  # @return [String] the source path for a disk source
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:243
  def source_path_for_disk; end

  # @return [String] the source path for a gem source
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:248
  def source_path_for_gem; end

  # @return [String] the yardoc file for a gem source
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:253
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:261
  def load_source_path; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:266
  def load_yardoc_file; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/library_version.rb:271
  def serializer; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/adapter.rb:11
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/rack_adapter.rb:44
class YARD::Server::RackAdapter < ::YARD::Server::Adapter
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/rack_adapter.rb:49
  def call(env); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/rack_adapter.rb:62
  def start; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/rack_adapter.rb:71
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/rack_adapter.rb:17
class YARD::Server::RackMiddleware
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/rack_adapter.rb:27
  def initialize(app, opts = T.unsafe(nil)); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/rack_adapter.rb:33
  def call(env); end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/router.rb:32
class YARD::Server::Router
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:45
  def initialize(adapter); end

  # @return [Adapter] the adapter used by the router
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:40
  def adapter; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:54
  def call(request); end

  # @return [String] the URI prefix for all object documentation requests
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:63
  def docs_prefix; end

  # @return [String] the URI prefix for all class/method/file list requests
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:66
  def list_prefix; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:69
  def search_prefix; end

  # @return [String] the URI prefix for all static assets (templates)
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:72
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:181
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:105
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:128
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:146
  def route_index; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:157
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:165
  def route_search(library, paths); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/router.rb:170
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/static_caching.rb:7
module YARD::Server::StaticCaching
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/static_caching.rb:34
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/webrick_adapter.rb:9
class YARD::Server::WebrickAdapter < ::YARD::Server::Adapter
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/webrick_adapter.rb:10
  def start; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/server/webrick_adapter.rb:20
class YARD::Server::WebrickServlet < ::WEBrick::HTTPServlet::AbstractServlet
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/webrick_adapter.rb:23
  def initialize(server, adapter); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/webrick_adapter.rb:21
  def adapter; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/server/webrick_adapter.rb:29
...
# @private
#
# source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:6
class YARD::StubProxy
  # @return [StubProxy] a new instance of StubProxy
  #
  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:13
  def initialize(path, transient = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:9
  def _dump(_depth); end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:11
  def hash; end

  # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:18
  def method_missing(meth, *args, &block); end

  class << self
    # source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:10
    def _load(str); end
  end
end

# source://yard-VERSION/lib/yard/serializers/yardoc_serializer.rb:28
YARD::StubProxy::FILELEN = T.let(T.unsafe(nil), Integer)

# The root path for YARD builtin templates
#
# source://yard-VERSION/lib/yard.rb:10
YARD::TEMPLATE_ROOT = T.let(T.unsafe(nil), String)

# Namespace for Tag components
#
# source://yard-VERSION/lib/yard/autoload.rb:247
...
# @since 0.7.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:461
class YARD::Tags::AttributeDirective < ::YARD::Tags::MethodDirective
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:462
  def after_parse; end
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:470
  def method_name; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:476
  def method_signature; end
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:486
  def create_attribute_data(object); end

  # @return [Boolean]
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:516
  def readable?; end

  # @return [Boolean]
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:512
  def writable?; end
end

# source://yard-VERSION/lib/yard/tags/default_factory.rb:4
class YARD::Tags::DefaultFactory
  ...
  #
  # source://yard-VERSION/lib/yard/tags/default_factory.rb:13
  ...
  #
  # source://yard-VERSION/lib/yard/tags/default_factory.rb:22
  def parse_tag_with_name(tag_name, text); end

  # source://yard-VERSION/lib/yard/tags/default_factory.rb:89
  def parse_tag_with_options(tag_name, text); end

  # source://yard-VERSION/lib/yard/tags/default_factory.rb:70
  ...
  #
  # source://yard-VERSION/lib/yard/tags/default_factory.rb:33
  ...
  #
  # source://yard-VERSION/lib/yard/tags/default_factory.rb:45
  ...
  # @return [Tag] a tag object with the tag_name, name, types and text values filled
  #
  # source://yard-VERSION/lib/yard/tags/default_factory.rb:57
  def parse_tag_with_types_and_title(tag_name, text); end

  # source://yard-VERSION/lib/yard/tags/default_factory.rb:75
  ...
  #
  # source://yard-VERSION/lib/yard/tags/default_factory.rb:101
  def extract_name_from_text(text); end

  # @raise [TagFormatError]
  #
  # source://yard-VERSION/lib/yard/tags/default_factory.rb:105
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:23
class YARD::Tags::Directive
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:55
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:74
  def after_parse; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:69
  def call; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:34
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:49
  def handler; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:43
  def object; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:38
  def parser=(_arg0); end

  # @return [Tag] the meta-data tag containing data input to the directive
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:25
  def tag; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:80
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:105
class YARD::Tags::EndGroupDirective < ::YARD::Tags::Directive
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:106
  def call; end
end
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:128
class YARD::Tags::GroupDirective < ::YARD::Tags::Directive
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:129
  def call; end
end
...
# @see Directive
#
# source://yard-VERSION/lib/yard/tags/library.rb:59
class YARD::Tags::Library
  # @return [Library] a new instance of Library
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:260
  ...
  #   end
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:168
  ...
  # source://yard-VERSION/lib/yard/tags/library.rb:202
  ...
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:290
  ...
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:258
  def factory; end
  ...
  #   the library.
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:280
  ...
  #   the library.
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:267
  ...
  #   def set(*args) end
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:161
  ...
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:273
  ...
  # @return [Directive]
  #
  # source://yard-VERSION/lib/yard/tags/library.rb:244
  def directive_call(tag, parser); end

  # source://yard-VERSION/lib/yard/tags/library.rb:233
  ...
  class << self
    ...
    # @see DefaultFactory
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:83
    ...
    # @see DefaultFactory
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:87
    def default_factory=(factory); end

    # @overload define_directive
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:196
    ...
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:157
    def define_tag(label, tag, meth = T.unsafe(nil)); end

    # source://yard-VERSION/lib/yard/tags/library.rb:220
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:99
    ...
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:142
    def sorted_labels; end

    # source://yard-VERSION/lib/yard/tags/library.rb:216
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:136
    ...
    # @since 0.6.0
    #
    # source://yard-VERSION/lib/yard/tags/library.rb:127
    ...
    # source://yard-VERSION/lib/yard/tags/library.rb:226
...
# @since 0.7.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:258
class YARD::Tags::MacroDirective < ::YARD::Tags::Directive
  # @raise [TagFormatError]
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:259
  def call; end
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:288
  def anonymous?; end

  # @return [Boolean]
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:277
  def attach?; end

  # @return [Boolean]
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:283
  def class_method?; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:292
  def expand(macro_data); end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:308
  def find_or_create; end

  # @return [Boolean]
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:272
  def new?; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:332
  def warn; end
end
...
# @since 0.7.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:368
class YARD::Tags::MethodDirective < ::YARD::Tags::Directive
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:373
  def after_parse; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:371
  def call; end
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:413
  def create_object; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:381
  def method_name; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:390
  def method_signature; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:394
  def sanitized_tag_signature; end

  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:403
  def use_indented_text; end
end

# @since 0.7.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:369
YARD::Tags::MethodDirective::SCOPE_MATCH = T.let(T.unsafe(nil), Regexp)

# source://yard-VERSION/lib/yard/tags/option_tag.rb:4
class YARD::Tags::OptionTag < ::YARD::Tags::Tag
  # @return [OptionTag] a new instance of OptionTag
  #
  # source://yard-VERSION/lib/yard/tags/option_tag.rb:7
  def initialize(tag_name, name, pair); end

  # Returns the value of attribute pair.
  #
  # source://yard-VERSION/lib/yard/tags/option_tag.rb:5
  def pair; end
...
# source://yard-VERSION/lib/yard/tags/overload_tag.rb:4
class YARD::Tags::OverloadTag < ::YARD::Tags::Tag
  # @return [OverloadTag] a new instance of OverloadTag
  #
  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:7
  def initialize(tag_name, text); end

  # Returns the value of attribute docstring.
  #
  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:5
  def docstring; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:15
  def has_tag?(name); end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:36
  def is_a?(other); end
  ...
  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:28
  def method_missing(*args, &block); end

  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:23
  def name(prefix = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:17
  ...
  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:13
  def tag(name); end

  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:14
  def tags(name = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:32
  def type; end

  private

  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:53
  def parse_signature; end

  # source://yard-VERSION/lib/yard/tags/overload_tag.rb:43
...
# @since 0.8.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:545
class YARD::Tags::ParseDirective < ::YARD::Tags::Directive
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:546
  def call; end
end

# source://yard-VERSION/lib/yard/tags/ref_tag.rb:4
module YARD::Tags::RefTag
  # Returns the value of attribute owner.
  #
  # source://yard-VERSION/lib/yard/tags/ref_tag.rb:5
  def owner; end
...
# source://yard-VERSION/lib/yard/tags/ref_tag_list.rb:4
class YARD::Tags::RefTagList
  # @return [RefTagList] a new instance of RefTagList
  #
  # source://yard-VERSION/lib/yard/tags/ref_tag_list.rb:7
  def initialize(tag_name, owner, name = T.unsafe(nil)); end

  # Returns the value of attribute name.
  #
  # source://yard-VERSION/lib/yard/tags/ref_tag_list.rb:5
  def name; end
  ...
  # source://yard-VERSION/lib/yard/tags/ref_tag_list.rb:13
  def tags; end
end
...
# @since 0.7.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:579
class YARD::Tags::ScopeDirective < ::YARD::Tags::Directive
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:580
  def call; end
end
...
#
# source://yard-VERSION/lib/yard/tags/tag.rb:13
class YARD::Tags::Tag
  ...
  #
  # source://yard-VERSION/lib/yard/tags/tag.rb:44
  ...
  #
  # source://yard-VERSION/lib/yard/tags/tag.rb:65
  def explain_types; end

  # @return [String] a name associated with the tag
  #
  # source://yard-VERSION/lib/yard/tags/tag.rb:26
  def name; end
  ...
  #
  # source://yard-VERSION/lib/yard/tags/tag.rb:29
  def object; end
  ...
  #
  # source://yard-VERSION/lib/yard/tags/tag.rb:15
  def tag_name; end
  ...
  #
  # source://yard-VERSION/lib/yard/tags/tag.rb:19
  def text; end
...
# source://yard-VERSION/lib/yard/tags/tag_format_error.rb:4
class YARD::Tags::TagFormatError < ::RuntimeError; end

# source://yard-VERSION/lib/yard/tags/types_explainer.rb:6
class YARD::Tags::TypesExplainer
  class << self
    ...
    # @return [nil] if no types are provided or not parseable
    #
    # source://yard-VERSION/lib/yard/tags/types_explainer.rb:9
    ...
    # @return [nil] if no types are provided or not parseable
    #
    # source://yard-VERSION/lib/yard/tags/types_explainer.rb:17
    def explain!(*types); end
  end
end
...
# @private
#
# source://yard-VERSION/lib/yard/tags/types_explainer.rb:58
class YARD::Tags::TypesExplainer::CollectionType < ::YARD::Tags::TypesExplainer::Type
  ...
  #
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:61
  def initialize(name, types); end

  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:66
  def to_s(_singular = T.unsafe(nil)); end

  # Returns the value of attribute types.
  #
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:59
  def types; end
...
# @private
#
# source://yard-VERSION/lib/yard/tags/types_explainer.rb:72
class YARD::Tags::TypesExplainer::FixedCollectionType < ::YARD::Tags::TypesExplainer::CollectionType
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:73
  def to_s(_singular = T.unsafe(nil)); end
end

# @private
#
# source://yard-VERSION/lib/yard/tags/types_explainer.rb:79
class YARD::Tags::TypesExplainer::HashCollectionType < ::YARD::Tags::TypesExplainer::Type
  ...
  #
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:82
  def initialize(name, key_types, value_types); end

  # Returns the value of attribute key_types.
  #
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:80
  def key_types; end
  ...
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:88
  def to_s(_singular = T.unsafe(nil)); end
...
# @private
#
# source://yard-VERSION/lib/yard/tags/types_explainer.rb:96
class YARD::Tags::TypesExplainer::Parser
  include ::YARD::CodeObjects

  # @return [Parser] a new instance of Parser
  #
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:117
  def initialize(string); end

  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:121
  def parse; end

  class << self
    # source://yard-VERSION/lib/yard/tags/types_explainer.rb:113
    def parse(string); end
  end
end

# source://yard-VERSION/lib/yard/tags/types_explainer.rb:99
YARD::Tags::TypesExplainer::Parser::TOKENS = T.let(T.unsafe(nil), Hash)

# @private
#
# source://yard-VERSION/lib/yard/tags/types_explainer.rb:26
class YARD::Tags::TypesExplainer::Type
  # @return [Type] a new instance of Type
  #
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:29
  def initialize(name); end

  # Returns the value of attribute name.
  #
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:27
  def name; end
  ...
  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:33
  def to_s(singular = T.unsafe(nil)); end

  private

  # source://yard-VERSION/lib/yard/tags/types_explainer.rb:45
...
# @since 0.7.0
#
# source://yard-VERSION/lib/yard/tags/directives.rb:611
class YARD::Tags::VisibilityDirective < ::YARD::Tags::Directive
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/tags/directives.rb:612
  def call; end
end

# Namespace for templating system
#
# source://yard-VERSION/lib/yard/autoload.rb:270
...
#
# source://yard-VERSION/lib/yard/templates/engine.rb:12
module YARD::Templates::Engine
  class << self
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:101
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:21
    ...
    # @return [String] the rendered template
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:82
    ...
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:35
    ...
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:53
    def template!(path, full_paths = T.unsafe(nil)); end

    # @return [Array<String>] the list of registered template paths
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:15
    def template_paths; end
    ...
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:115
    ...
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:161
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:141
    ...
    #
    # source://yard-VERSION/lib/yard/templates/engine.rb:176
...
# @since 0.5.4
#
# source://yard-VERSION/lib/yard/templates/erb_cache.rb:5
module YARD::Templates::ErbCache
  class << self
    # @since 0.5.4
    #
    # source://yard-VERSION/lib/yard/templates/erb_cache.rb:17
    def clear!; end

    # @since 0.5.4
    #
    # source://yard-VERSION/lib/yard/templates/erb_cache.rb:6
...
#
# source://yard-VERSION/lib/yard/autoload.rb:271
module YARD::Templates::Helpers; end

# The base helper module included in all templates.
#
# source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:4
module YARD::Templates::Helpers::BaseHelper
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:196
  ...
  #   for the object
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:182
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:209
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:168
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:20
  def globals; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:38
  def h(text); end
  ...
  # @since 0.5.5
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:152
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:113
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:105
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:122
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:141
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:55
  def linkify(*args); end

  # Returns the value of attribute object.
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:5
  def object; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:11
  def owner; end
  ...
  #   the verifier. If no verifier is supplied, all objects are returned.
  #
  # source://yard-VERSION/lib/yard/templates/helpers/base_helper.rb:30
  def run_verifier(list); end
...
#
# source://yard-VERSION/lib/yard/templates/helpers/filter_helper.rb:5
module YARD::Templates::Helpers::FilterHelper
  # @return [Boolean] whether an object is a class
  #
  # source://yard-VERSION/lib/yard/templates/helpers/filter_helper.rb:17
  def is_class?(object); end

  # @return [Boolean] whether an object is a method
  #
  # source://yard-VERSION/lib/yard/templates/helpers/filter_helper.rb:7
  def is_method?(object); end

  # @return [Boolean] whether an object is a module
  #
  # source://yard-VERSION/lib/yard/templates/helpers/filter_helper.rb:22
  def is_module?(object); end

  # @return [Boolean] whether an object is a namespace
  #
  # source://yard-VERSION/lib/yard/templates/helpers/filter_helper.rb:12
  def is_namespace?(object); end
end

# The helper module for HTML templates.
#
# source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:7
module YARD::Templates::Helpers::HtmlHelper
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:347
  ...
  # @since 0.5.4
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:574
  def charset; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:458
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:476
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:23
  def h(text); end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:109
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:168
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:78
  def html_markup_markdown(text); end

  # @return [String] the same text with no markup
  # @since 0.6.6
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:160
  ...
  # @return [String] output HTML
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:102
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:146
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:136
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:179
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:154
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:118
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:128
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:199
  def html_syntax_highlight(source, type = T.unsafe(nil)); end

  # @return [String] unhighlighted source
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:210
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:57
  def htmlify(text, markup = T.unsafe(nil)); end

  # @return [String] HTMLified text as a single line (paragraphs removed)
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:184
  def htmlify_line(*args); end

  # Inserts an include link while respecting inlining
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:296
  ...
  # @since 0.5.5
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:270
  def link_file(filename, title = T.unsafe(nil), anchor = T.unsafe(nil)); end
  ...
  # @since 0.7.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:282
  def link_include_file(file); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:291
  def link_include_object(obj); end
  ...
  # @return [String] the linked object
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:301
  ...
  # @return [String] the linked URL
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:332
  def link_url(url, title = T.unsafe(nil), params = T.unsafe(nil)); end

  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:400
  def mtime(_file); end
  ...
  # @return [String] the URL location of the object
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:368
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:225
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:529
  ...
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:492
  ...
  # @return [String] the URL pointing to the file
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:407
  def url_for_file(filename, anchor = T.unsafe(nil)); end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:434
  def url_for_frameset; end
  ...
  #   user should see.
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:450
  def url_for_index; end
  ...
  # @since 0.8.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:426
  def url_for_list(type); end
  ...
  #   user should see.
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:442
  def url_for_main; end
  ...
  # @since 0.5.3
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:609
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:664
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:640
  ...
  # @since 0.7.5
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:624
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:603
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:31
...
# @private
#
# source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:15
YARD::Templates::Helpers::HtmlHelper::ASCIIDOC_ATTRIBUTES = T.let(T.unsafe(nil), Hash)

# @private
#
# source://yard-VERSION/lib/yard/templates/helpers/html_helper.rb:12
YARD::Templates::Helpers::HtmlHelper::URLMATCH = T.let(T.unsafe(nil), Regexp)

# Helper methods for syntax highlighting.
#
# source://yard-VERSION/lib/yard/templates/helpers/html_syntax_highlight_helper.rb:6
module YARD::Templates::Helpers::HtmlSyntaxHighlightHelper
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/html_syntax_highlight_helper.rb:12
  def html_syntax_highlight_ruby(source); end

  private

  # source://yard-VERSION/lib/yard/templates/helpers/html_syntax_highlight_helper.rb:63
  def clean_token_object(token_obj); end

  # source://yard-VERSION/lib/yard/templates/helpers/html_syntax_highlight_helper.rb:45
  def html_syntax_highlight_ruby_legacy(source); end

  # source://yard-VERSION/lib/yard/templates/helpers/html_syntax_highlight_helper.rb:22
  def html_syntax_highlight_ruby_ripper(source); end
end

# Namespace for markup providers
#
# source://yard-VERSION/lib/yard/autoload.rb:272
module YARD::Templates::Helpers::Markup; end

# source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markdown.rb:13
class YARD::Templates::Helpers::Markup::RDocMarkdown < ::YARD::Templates::Helpers::Markup::RDocMarkup
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markdown.rb:14
  def initialize(text); end

  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markdown.rb:18
  def fix_typewriter(html); end
end

# source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:12
class YARD::Templates::Helpers::Markup::RDocMarkup
  # @return [RDocMarkup] a new instance of RDocMarkup
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:41
  def initialize(text); end

  # Returns the value of attribute from_path.
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:35
  def from_path; end
  ...
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:50
  def to_html; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:87
  ...
  # @todo Refactor into own SimpleMarkup subclass
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:66
...
# source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:13
class YARD::Templates::Helpers::Markup::RDocMarkupToHtml < ::RDoc::Markup::ToHtml
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:16
  def initialize; end

  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:100
  def accept_paragraph(*args); end

  # Returns the value of attribute from_path.
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:93
  def from_path; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup/rdoc_markup.rb:96
  def handle_special_HYPERLINK(special); end
end

# Helper methods for loading and managing markup types.
#
# source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:7
module YARD::Templates::Helpers::MarkupHelper
  ...
  # @return [Boolean] whether the markup provider was successfully loaded.
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:87
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:158
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:149
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:133
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:168
  ...
  class << self
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:11
    ...
    # @since 0.6.4
    #
    # source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:18
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:61
...
#
# source://yard-VERSION/lib/yard/templates/helpers/markup_helper.rb:74
...
module YARD::Templates::Helpers::UMLHelper
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/uml_helper.rb:20
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/uml_helper.rb:27
  def h(text); end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/uml_helper.rb:34
  def tidy(data); end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/helpers/uml_helper.rb:9
...
# @since 0.6.0
#
# source://yard-VERSION/lib/yard/templates/section.rb:7
class YARD::Templates::Section < ::Array
  # @return [Section] a new instance of Section
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:10
  def initialize(name, *args); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:45
  def <<(*args); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:34
  def ==(other); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:21
  def [](*args); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:74
  def any(item); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:15
  def dup; end

  # @return [Boolean]
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:30
  def eql?(other); end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:54
  def inspect; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:8
  def name; end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:60
  def place(*args); end
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:64
  def to_a; end

  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:50
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/section.rb:84
  def parse_sections(args); end
end

# source://yard-VERSION/lib/yard/templates/template.rb:6
module YARD::Templates::Template
  ...
  # source://yard-VERSION/lib/yard/templates/template.rb:186
  def initialize(opts = T.unsafe(nil)); end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:204
  def T(*path); end

  # Returns the value of attribute class.
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:7
  def class; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:285
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:312
  ...
  # @see #sections
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:239
  def init; end

  # source://yard-VERSION/lib/yard/templates/template.rb:342
  def inspect; end

  # Returns the value of attribute options.
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:8
  def options; end

  # source://yard-VERSION/lib/yard/templates/template.rb:337
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:252
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:226
  ...
  #   paths.
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:330
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:278
  def yieldall(opts = T.unsafe(nil), &block); end

  protected

  # source://yard-VERSION/lib/yard/templates/template.rb:348
  def erb_file_for(section); end

  # source://yard-VERSION/lib/yard/templates/template.rb:352
  def erb_with(content, filename = T.unsafe(nil)); end

  private

  # source://yard-VERSION/lib/yard/templates/template.rb:399
  def add_options(opts = T.unsafe(nil)); end

  # @raise [ArgumentError]
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:378
  def cache(section); end

  # source://yard-VERSION/lib/yard/templates/template.rb:388
  def cache_filename(section); end

  # source://yard-VERSION/lib/yard/templates/template.rb:364
  def render_section(section, &block); end

  # source://yard-VERSION/lib/yard/templates/template.rb:393
  def set_ivars; end

  # source://yard-VERSION/lib/yard/templates/template.rb:412
  ...
  class << self
    ...
    #
    # source://yard-VERSION/lib/yard/templates/template.rb:25
    ...
    # @return [void]
    #
    # source://yard-VERSION/lib/yard/templates/template.rb:38
    def include_extra(template, options); end

    # @private
    # @private
    #
    # source://yard-VERSION/lib/yard/templates/template.rb:29
    def included(klass); end
  end
end

# source://yard-VERSION/lib/yard/templates/template.rb:59
module YARD::Templates::Template::ClassMethods
  # source://yard-VERSION/lib/yard/templates/template.rb:81
  ...
  # @since 0.6.0
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:149
  def S(*args); end

  # Alias for creating {Engine.template}.
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:142
  def T(*path); end
  ...
  # @see find_nth_file
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:98
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:109
  def find_nth_file(basename, index = T.unsafe(nil)); end

  # Returns the value of attribute full_path.
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:60
  def full_path; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:65
  def full_paths; end

  # @return [Boolean]
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:122
  def is_a?(klass); end

  # Creates a new template object to be rendered with {Template#run}
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:128
  def new(*args); end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template.rb:77
  def reset_full_paths; end

  # source://yard-VERSION/lib/yard/templates/template.rb:135
  def run(*args); end

  private

  # source://yard-VERSION/lib/yard/templates/template.rb:170
  def include_inherited(full_paths); end

  # source://yard-VERSION/lib/yard/templates/template.rb:157
  def include_parent; end

  # source://yard-VERSION/lib/yard/templates/template.rb:176
...
#
# source://yard-VERSION/lib/yard/templates/template_options.rb:11
class YARD::Templates::TemplateOptions < ::YARD::Options
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:78
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:64
  def index; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:30
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:57
  def no_highlight; end

  # source://yard-VERSION/lib/yard/templates/template_options.rb:58
  def no_highlight=(value); end

  # @return [CodeObjects::Base] the main object being generated in the template
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:38
  def object; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:41
  def owner; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:61
  def page_title; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:51
  def serializer; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:44
  def type; end
  ...
  #
  # source://yard-VERSION/lib/yard/templates/template_options.rb:89
  def verifier; end
...
# source://yard-VERSION/lib/yard/version.rb:5
...
#   Verifier.new('@return && @param && @yield')
#
# source://yard-VERSION/lib/yard/verifier.rb:34
class YARD::Verifier
  ...
  #
  # source://yard-VERSION/lib/yard/verifier.rb:48
  ...
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/verifier.rb:58
  ...
  #
  # source://yard-VERSION/lib/yard/verifier.rb:76
  def call(object); end

  # @return [Array<String>] a list of all expressions the verifier checks for
  # @since 0.5.6
  #
  # source://yard-VERSION/lib/yard/verifier.rb:37
  def expressions; end

  # source://yard-VERSION/lib/yard/verifier.rb:39
  def expressions=(value); end

  # Passes any method calls to the object from the {#call}
  #
  # source://yard-VERSION/lib/yard/verifier.rb:63
  def method_missing(sym, *args, &block); end
  ...
  #   the verifier.
  #
  # source://yard-VERSION/lib/yard/verifier.rb:91
  def run(list); end
  ...
  #
  # source://yard-VERSION/lib/yard/verifier.rb:98
  def o; end
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/verifier.rb:130
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/verifier.rb:112
  ...
  #
  # source://yard-VERSION/lib/yard/verifier.rb:145
  ...
  # @return [void]
  #
  # source://yard-VERSION/lib/yard/verifier.rb:120
  def unmodify_nilclass; end
end

# @private
#
# source://yard-VERSION/lib/yard/verifier.rb:104
