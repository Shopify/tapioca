...
# source://rexml-3.2.5/lib/rexml/light/node.rb:5
...
# children.
#
# source://rexml-3.2.5/lib/rexml/light/node.rb:9
class REXML::Light::Node
  # Create a new element.
  #
  # @return [Node] a new instance of Node
  #
  # source://rexml-3.2.5/lib/rexml/light/node.rb:13
  ...
  #
  # source://rexml-3.2.5/lib/rexml/light/node.rb:114
  def <<(element); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:90
  def =~(path); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:78
  def [](reference, ns = T.unsafe(nil)); end

  # Doesn't handle namespaces yet
  #
  # source://rexml-3.2.5/lib/rexml/light/node.rb:95
  def []=(reference, ns, value = T.unsafe(nil)); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:143
  def children; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:36
  def each; end

  # @return [Boolean]
  #
  # source://rexml-3.2.5/lib/rexml/light/node.rb:139
  def has_name?(name, namespace = T.unsafe(nil)); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:54
  def local_name; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:59
  def local_name=(name_str); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:40
  def name; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:44
  def name=(name_str, ns = T.unsafe(nil)); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:67
  def namespace(prefix = T.unsafe(nil)); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:71
  def namespace=(namespace); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:125
  def node_type; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:147
  def parent; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:50
  def parent=(node); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:63
  def prefix(namespace = T.unsafe(nil)); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:134
  def root; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:28
  def size; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:129
  def text=(foo); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:151
  def to_s; end

  private

  # source://rexml-3.2.5/lib/rexml/light/node.rb:164
  def namespace_of(node, prefix = T.unsafe(nil)); end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:157
  def namesplit; end

  # source://rexml-3.2.5/lib/rexml/light/node.rb:176
  def prefix_of(node, namespace = T.unsafe(nil)); end
end

# source://rexml-3.2.5/lib/rexml/light/node.rb:10
REXML::Light::Node::NAMESPLIT = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.2.5/lib/rexml/light/node.rb:11
