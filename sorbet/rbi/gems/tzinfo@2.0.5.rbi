...
#
# source://tzinfo-VERSION/lib/tzinfo.rb:5
module TZInfo
  class << self
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo.rb:14
    def eager_load!; end
  end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:129
class TZInfo::AbsoluteDayOfYearTransitionRule < ::TZInfo::DayOfYearTransitionRule
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:130
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:153
  def ==(r); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:137
  def is_always_first_day_of_year?; end

  # @return [Boolean] `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:142
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:168
  def get_day(offset, year); end

  # @return [Array] an `Array` of parameters that will influence the output of
  #   {hash}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:173
  def hash_args; end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone.rb:16
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/annual_rules.rb:9
class TZInfo::AnnualRules
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/annual_rules.rb:36
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/annual_rules.rb:49
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/annual_rules.rb:65
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/string_deduper.rb:50
class TZInfo::ConcurrentStringDeduper < ::TZInfo::StringDeduper
  protected

  # source://tzinfo-VERSION/lib/tzinfo/string_deduper.rb:53
...
# territorial claims.
#
# source://tzinfo-VERSION/lib/tzinfo/country.rb:26
class TZInfo::Country
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:72
  ...
  #   instance of {Country}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:162
  def <=>(c); end
  ...
  #   match.
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:185
  def =~(regexp); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:194
  def _dump(limit); end

  # @return [String] the ISO 3166-1 alpha-2 country code.
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:77
  def code; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:170
  def eql?(c); end

  # @return [Integer] a hash based on the {code}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:175
  def hash; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:94
  def inspect; end

  # @return [String] the name of the country.
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:82
  def name; end

  # @return [String] a `String` representation of this {Country} (the name of
  #   the country).
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:88
  def to_s; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:111
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:152
  def zone_info; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country.rb:132
  def zones; end
  ...
  class << self
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/country.rb:40
    def get(code); end
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/country.rb:59
    def data_source; end
  end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/country_index_definition.rb:62
TZInfo::CountryIndexDefinition = TZInfo::Format1::CountryIndexDefinition

# Information about a time zone used by a {Country}.
#
# source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:5
class TZInfo::CountryTimezone
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:44
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:72
  def ==(ct); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:31
  def description; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:63
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:83
  def eql?(ct); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:89
  def hash; end

  # @return [String] the identifier of the {Timezone} being described.
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:7
  def identifier; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:16
  def latitude; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:25
  def longitude; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/country_timezone.rb:57
  def timezone; end
end
...
#   methods.
#
# source://tzinfo-VERSION/lib/tzinfo/data_source.rb:29
class TZInfo::DataSource
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:166
  def initialize; end
  ...
  #   alpha-2 country codes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:246
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:218
  ...
  # timezone or country is loaded from {DataSources::RubyDataSource}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:255
  def eager_load!; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:237
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:184
  def get_timezone_info(identifier); end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:268
  def inspect; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:228
  def linked_timezone_identifiers; end

  # @return [Array<String>] a frozen `Array`` of all the available time zone
  #   identifiers. The identifiers are sorted according to `String#<=>`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:204
  def timezone_identifiers; end

  # @return [String] a description of the {DataSource}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:262
  def to_s; end
  ...
  #   for the given ISO 3166-1 alpha-2 country code.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:294
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:285
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:337
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:300
  ...
  #   {timezone_identifiers}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:315
  ...
  #   identifiers.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:366
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:382
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:352
  ...
  #   successful.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:436
  def try_with_encoding(string, encoding); end

  class << self
    # @return [DataSource] the currently selected source of data.
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:42
    def get; end
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:127
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_source.rb:145
...
class TZInfo::DataSources::ConstantOffsetDataTimezoneInfo < ::TZInfo::DataSources::DataTimezoneInfo
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/constant_offset_data_timezone_info.rb:19
  def initialize(identifier, constant_offset); end

  # @return [TimezoneOffset] the offset that is constantly observed.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/constant_offset_data_timezone_info.rb:9
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/constant_offset_data_timezone_info.rb:28
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/constant_offset_data_timezone_info.rb:35
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/constant_offset_data_timezone_info.rb:43
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/constant_offset_data_timezone_info.rb:51
...
# {DataSource}.
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/country_info.rb:8
class TZInfo::DataSources::CountryInfo
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/country_info.rb:26
  def initialize(code, name, zones); end

  # @return [String] the ISO 3166-1 alpha-2 country code.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/country_info.rb:10
  def code; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/country_info.rb:37
  def inspect; end

  # @return [String] the name of the country.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/country_info.rb:13
  def name; end

  # @return [Array<CountryTimezone>] the time zones observed in the country.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/country_info.rb:16
  def zones; end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/data_timezone_info.rb:17
class TZInfo::DataSources::DataTimezoneInfo < ::TZInfo::DataSources::TimezoneInfo
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/data_timezone_info.rb:76
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/data_timezone_info.rb:18
  def period_for(timestamp); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/data_timezone_info.rb:34
  def periods_for_local(local_timestamp); end
  ...
  #   changes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/data_timezone_info.rb:70
  def transitions_up_to(to_timestamp, from_timestamp = T.unsafe(nil)); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/data_timezone_info.rb:86
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:16
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:15
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:12
...
# zone.
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/linked_timezone_info.rb:9
class TZInfo::DataSources::LinkedTimezoneInfo < ::TZInfo::DataSources::TimezoneInfo
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/linked_timezone_info.rb:20
  def initialize(identifier, link_to_identifier); end

  # @return [LinkedTimezone] a new {LinkedTimezone} instance for the time
  #   zone represented by this {LinkedTimezoneInfo}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/linked_timezone_info.rb:28
  def create_timezone; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/linked_timezone_info.rb:10
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:24
class TZInfo::DataSources::PosixTimeZoneParser
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:29
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:40
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:173
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:136
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:157
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/posix_time_zone_parser.rb:96
...
#     TZInfo::DataSource.set(:ruby)
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:25
class TZInfo::DataSources::RubyDataSource < ::TZInfo::DataSource
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:38
  def initialize; end
  ...
  #   alpha-2 country codes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:32
  def country_codes; end
  ...
  #   identifiers for data time zones.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:26
  def data_timezone_identifiers; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:76
  def inspect; end
  ...
  #   identifiers that are links to other time zones.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:29
  def linked_timezone_identifiers; end

  # @return [String] a description of the {DataSource}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:71
  def to_s; end
  ...
  #   for the given ISO 3166-1 alpha-2 country code.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:108
  def load_country_info(code); end
  ...
  #   identifier.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:92
  def load_timezone_info(identifier); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:132
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:118
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:125
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:138
...
# data source.
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/ruby_data_source.rb:13
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/timezone_info.rb:9
class TZInfo::DataSources::TimezoneInfo
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/timezone_info.rb:18
  def initialize(identifier); end

  # @return [Timezone] a new {Timezone} instance for the time zone
  #   represented by this {TimezoneInfo}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/timezone_info.rb:31
  def create_timezone; end

  # @return [String] the identifier of the time zone.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/timezone_info.rb:11
  def identifier; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/timezone_info.rb:25
  def inspect; end
  ...
  # @raise NotImplementedError always.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/timezone_info.rb:42
  def raise_not_implemented(method_name); end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:10
class TZInfo::DataSources::TransitionsDataTimezoneInfo < ::TZInfo::DataSources::DataTimezoneInfo
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:31
  ...
  #   specified by `timestamp`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:39
  def period_for(timestamp); end
  ...
  #   time specified by `local_timestamp`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:70
  def periods_for_local(local_timestamp); end

  # @return [Array<TimezoneTransition>] the transitions that define this
  #   time zone in order of ascending timestamp.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:11
  def transitions; end
  ...
  #   changes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:111
  def transitions_up_to(to_timestamp, from_timestamp = T.unsafe(nil)); end
  ...
  #   `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:159
  ...
  #   otherwise `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/transitions_data_timezone_info.rb:207
...
# inaccurate.
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:73
class TZInfo::DataSources::ZoneinfoDataSource < ::TZInfo::DataSource
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:241
  ...
  #   alpha-2 country codes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:208
  def country_codes; end
  ...
  #   identifiers.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:275
  def data_timezone_identifiers; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:294
  def inspect; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:284
  def linked_timezone_identifiers; end

  # @return [String] a description of the {DataSource}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:289
  def to_s; end

  # @return [String] the zoneinfo directory being used.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:205
  ...
  #   for the given ISO 3166-1 alpha-2 country code.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:330
  def load_country_info(code); end
  ...
  #   identifier.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:310
  def load_timezone_info(identifier); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:583
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:438
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:393
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:467
  ...
  #   identifiers found.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:418
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:376
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:349
  ...
  class << self
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:160
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:177
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:127
    def search_path; end
    ...
    #   separated `String`.
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:145
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:191
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:78
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:74
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:92
...
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_data_source.rb:23
class TZInfo::DataSources::ZoneinfoDirectoryNotFound < ::StandardError; end

# Reads compiled zoneinfo TZif (\0, 2 or 3) files.
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:16
class TZInfo::DataSources::ZoneinfoReader
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:29
  ...
  #   {TimezoneTransition}s.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:45
  ...
  #   transition.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:315
  ...
  #   {TimezoneTransition}s.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:203
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:80
  ...
  #   transition.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:98
  ...
  #   if not found.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:237
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:56
  ...
  #   64-bit.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:67
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:183
  ...
  #   {TimezoneTransition}s.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:347
  def parse(file); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:254
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:282
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/data_sources/zoneinfo_reader.rb:20
...
# transitions occur.
#
# source://tzinfo-VERSION/lib/tzinfo/data_timezone.rb:8
class TZInfo::DataTimezone < ::TZInfo::InfoTimezone
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_timezone.rb:40
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_timezone.rb:9
  ...
  #   valid at `local_time`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_timezone.rb:17
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/data_timezone.rb:23
...
#
# source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:19
class TZInfo::DateTimeWithOffset < ::DateTime
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:61
  def downto(min); end
  ...
  # @return [DateTime]
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:75
  def england; end
  ...
  # @return [DateTime]
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:85
  def gregorian; end
  ...
  # @return [DateTime]
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:95
  def italy; end
  ...
  # @return [DateTime]
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:105
  def julian; end
  ...
  # @return [DateTime]
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:115
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:48
  def to_time; end

  # An overridden version of `DateTime#upto` that clears the associated
  # {TimezoneOffset} of the returned or yielded instances.
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:133
  def upto(max); end
  ...
  # @return [DateTimeWithOffset] `self`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/datetime_with_offset.rb:148
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:339
class TZInfo::DayOfMonthTransitionRule < ::TZInfo::DayOfWeekTransitionRule
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:340
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:353
  def ==(r); end
  ...
  #   the given offset and year.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:372
  def get_day(offset, year); end

  # @return [Array] an `Array` of parameters that will influence the output of
  #   {hash}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:386
  def hash_args; end

  # @return [Integer] the day the week starts on for a month starting on a
  #   Sunday.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:362
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:273
class TZInfo::DayOfWeekTransitionRule < ::TZInfo::TransitionRule
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:274
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:299
  def ==(r); end
  ...
  # @return [Boolean] `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:283
  def is_always_first_day_of_year?; end

  # @return [Boolean] `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:288
  def is_always_last_day_of_year?; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:310
  def day_of_week; end

  # @return [Array] an `Array` of parameters that will influence the output of
  #   {hash}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:313
  def hash_args; end

  # @return [Integer] the month of the year (1 to 12).
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:307
  def month; end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:81
class TZInfo::DayOfYearTransitionRule < ::TZInfo::TransitionRule
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:82
  ...
  #   otherwise `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:94
  def ==(r); end
  ...
  #   {hash}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:105
  def hash_args; end

  # @return [Integer] the day multipled by the number of seconds in a day.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:102
  def seconds; end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1.rb:7
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/country_definer.rb:11
class TZInfo::Format1::CountryDefiner < ::TZInfo::Format2::CountryDefiner
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/country_definer.rb:12
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/country_index_definition.rb:11
module TZInfo::Format1::CountryIndexDefinition
  ...
  class << self
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/format1/country_index_definition.rb:16
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/country_index_definition.rb:25
module TZInfo::Format1::CountryIndexDefinition::ClassMethods
  ...
  #   their codes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/country_index_definition.rb:29
  def countries; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/country_index_definition.rb:42
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definer.rb:11
class TZInfo::Format1::TimezoneDefiner < ::TZInfo::Format2::TimezoneDefiner
  ...
  #   the given id.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definer.rb:26
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definer.rb:58
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definition.rb:9
module TZInfo::Format1::TimezoneDefinition
  ...
  class << self
    ...
    # @param base [Module] the includee.
    #
    # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definition.rb:13
    def append_features(base); end
  end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definition.rb:22
module TZInfo::Format1::TimezoneDefinition::ClassMethods
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definition.rb:27
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:10
module TZInfo::Format1::TimezoneIndexDefinition
  ...
  class << self
    ...
    # @param base [Module] the includee.
    #
    # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:15
    def append_features(base); end
  end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:28
module TZInfo::Format1::TimezoneIndexDefinition::ClassMethods
  ...
  #   `String#<=>`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:32
  ...
  #   `String#<=>`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:42
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:63
  ...
  # @param identifier [String] the time zone identifier.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:54
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2.rb:7
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/country_definer.rb:11
class TZInfo::Format2::CountryDefiner
  ...
  # @return [CountryDefiner] a new instance of CountryDefiner
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_definer.rb:24
  def initialize(shared_timezones, identifier_deduper, description_deduper); end

  # @overload timezone
  # @overload timezone
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_definer.rb:46
  ...
  # @return [Array<CountryTimezone>] the time zones observed in the country.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_definer.rb:13
  def timezones; end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definer.rb:10
class TZInfo::Format2::CountryIndexDefiner
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definer.rb:21
  def initialize(identifier_deduper, description_deduper); end

  # @return [Hash<String, CountryInfo>] a `Hash` of all the countries that
  #   have been defined in the index keyed by their codes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definer.rb:13
  def countries; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definer.rb:56
  def country(code, name); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definer.rb:39
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definition.rb:11
module TZInfo::Format2::CountryIndexDefinition
  ...
  class << self
    ...
    # @param base [Module] the includee.
    #
    # source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definition.rb:16
    def append_features(base); end
  end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definition.rb:25
module TZInfo::Format2::CountryIndexDefinition::ClassMethods
  # @return [Hash<String, DataSources::CountryInfo>] a frozen `Hash`
  #   of all the countries that have been defined in the index keyed by
  #   their codes.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definition.rb:29
  def countries; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/country_index_definition.rb:38
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definer.rb:11
class TZInfo::Format2::TimezoneDefiner
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definer.rb:20
  def initialize(string_deduper); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definer.rb:32
  ...
  #   the given id.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definer.rb:49
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definer.rb:90
  ...
  #   `timestamp_value` of the previously defined transition.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definer.rb:74
  def transition(offset_id, timestamp_value); end

  # @return [Array<TimezoneTransition>] the defined transitions of the time
  #   zone.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definer.rb:14
  def transitions; end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definition.rb:9
module TZInfo::Format2::TimezoneDefinition
  ...
  class << self
    ...
    # @param base [Module] the includee.
    #
    # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definition.rb:13
    def append_features(base); end
  end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definition.rb:21
module TZInfo::Format2::TimezoneDefinition::ClassMethods
  # @return [TimezoneInfo] the last time zone to be defined.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definition.rb:23
  def get; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definition.rb:64
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definition.rb:41
  def timezone(identifier); end

  # @return [Class] the class to be instantiated and yielded by
  #   {#timezone}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_definition.rb:31
  def timezone_definer_class; end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definer.rb:9
class TZInfo::Format2::TimezoneIndexDefiner
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definer.rb:20
  def initialize(string_deduper); end
  ...
  # @param identifier [String] the time zone identifier.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definer.rb:29
  def data_timezone(identifier); end

  # @return [Array<String>] the identifiers of all data time zones.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definer.rb:11
  def data_timezones; end
  ...
  # @param identifier [String] the time zone identifier.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definer.rb:38
  def linked_timezone(identifier); end

  # @return [Array<String>] the identifiers of all linked time zones.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definer.rb:14
  def linked_timezones; end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definition.rb:10
module TZInfo::Format2::TimezoneIndexDefinition
  ...
  class << self
    ...
    # @param base [Module] the includee.
    #
    # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definition.rb:15
    def append_features(base); end
  end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definition.rb:29
module TZInfo::Format2::TimezoneIndexDefinition::ClassMethods
  # @return [Array<String>] a frozen `Array` containing the identifiers of
  #   all data time zones. Identifiers are sorted according to
  #   `String#<=>`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definition.rb:33
  def data_timezones; end
  ...
  #   `String#<=>`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definition.rb:38
  def linked_timezones; end
  ...
  #   instance that should be used to define the index.
  #
  # source://tzinfo-VERSION/lib/tzinfo/format2/timezone_index_definition.rb:46
...
# @abstract
#
# source://tzinfo-VERSION/lib/tzinfo/info_timezone.rb:16
class TZInfo::InfoTimezone < ::TZInfo::Timezone
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/info_timezone.rb:17
  def initialize(info); end

  # @return [String] the identifier of the time zone, for example,
  #   `"Europe/Paris"`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/info_timezone.rb:23
  def identifier; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/info_timezone.rb:31
  def info; end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/country.rb:7
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:185
class TZInfo::JulianDayOfYearTransitionRule < ::TZInfo::DayOfYearTransitionRule
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:202
  def initialize(day, transition_at = T.unsafe(nil)); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:226
  def ==(r); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:209
  def is_always_first_day_of_year?; end

  # @return [Boolean] `true` if the day specified by this transition is the
  #   last in the year (a day number of 365), otherwise `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:215
  def is_always_last_day_of_year?; end
  ...
  #   the given offset and year.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:241
  def get_day(offset, year); end

  # @return [Array] an `Array` of parameters that will influence the output of
  #   {hash}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:250
  def hash_args; end
end

# The 60 days in seconds.
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:186
TZInfo::JulianDayOfYearTransitionRule::LEAP = T.let(T.unsafe(nil), Integer)

# The length of a non-leap year in seconds.
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:190
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:408
class TZInfo::LastDayOfMonthTransitionRule < ::TZInfo::DayOfWeekTransitionRule
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:409
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:420
  def ==(r); end
  ...
  #   the given offset and year.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:435
  def get_day(offset, year); end
end
...
# time zone.
#
# source://tzinfo-VERSION/lib/tzinfo/linked_timezone.rb:14
class TZInfo::LinkedTimezone < ::TZInfo::InfoTimezone
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/linked_timezone.rb:15
  def initialize(info); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/linked_timezone.rb:40
  def canonical_zone; end
  ...
  # @return [TimezonePeriod] the {TimezonePeriod} that is valid at `time`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/linked_timezone.rb:21
  def period_for(time); end
  ...
  #   valid at `local_time`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/linked_timezone.rb:26
  def periods_for_local(local_time); end
  ...
  #   by when they occur, from earliest to latest.
  #
  # source://tzinfo-VERSION/lib/tzinfo/linked_timezone.rb:31
  def transitions_up_to(to, from = T.unsafe(nil)); end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/offset_timezone_period.rb:10
class TZInfo::OffsetTimezonePeriod < ::TZInfo::TimezonePeriod
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/offset_timezone_period.rb:11
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/offset_timezone_period.rb:32
  def ==(p); end

  # @return [TimezoneTransition] the transition that defines the end of this
  #   {TimezonePeriod}, always `nil` for {OffsetTimezonePeriod}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/offset_timezone_period.rb:23
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/offset_timezone_period.rb:38
  def hash; end

  # @return [TimezoneTransition] the transition that defines the start of this
  #   {TimezonePeriod}, always `nil` for {OffsetTimezonePeriod}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/offset_timezone_period.rb:17
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone.rb:21
...
class TZInfo::StringDeduper
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/string_deduper.rb:30
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/string_deduper.rb:41
  def create_hash(&block); end
  ...
  class << self
    ...
    #   executing threads.
    #
    # source://tzinfo-VERSION/lib/tzinfo/string_deduper.rb:16
    def global; end
  end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:16
class TZInfo::TimeWithOffset < ::Time
  ...
  #   otherwise `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:43
  def dst?; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:55
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:69
  def gmtime; end
  ...
  # @return [TimeWithOffset] `self`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:79
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:89
  ...
  # @return [TimeWithOffset] `self`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:30
  def set_timezone_offset(timezone_offset); end

  # @return [TimezoneOffset] the {TimezoneOffset} associated with this
  #   instance.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:21
  def timezone_offset; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:98
  def to_a; end
  ...
  #   a `Time` representation.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:135
  def to_datetime; end
  ...
  # @return [TimeWithOffset] `self`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:110
  def utc; end
  ...
  #   no such offset.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:123
  def zone; end
  ...
  # @return [TimeWithOffset] `self`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/time_with_offset.rb:149
  def clear_timezone_offset; end
end
...
# explicitly as UTC.
#
# source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:11
class TZInfo::Timestamp
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:344
  ...
  #   {Timestamp}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:454
  def <=>(t); end
  ...
  #   `utc_offset`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:372
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:468
  def hash; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:474
  def inspect; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:426
  ...
  #   0 and less than 1.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:321
  def sub_second; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:406
  def to_datetime; end
  ...
  #   number of seconds since 1970-01-01 00:00:00 UTC ignoring leap seconds).
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:415
  def to_i; end

  # @return [String] a `String` representation of this {Timestamp}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:432
  def to_s; end
  ...
  #   returned.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:391
  def to_time; end

  # @return [Timestamp] a UTC {Timestamp} equivalent to this instance. Returns
  #   `self` if {#utc? self.utc?} is `true`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:381
  def utc; end
  ...
  #   seconds long).
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:316
  def value; end
  ...
  # @private
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:496
  ...
  # @private
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:486
  ...
  #   seconds or the `Symbol` `:utc`).
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:538
  def initialize!(value, sub_second = T.unsafe(nil), utc_offset = T.unsafe(nil)); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:518
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:510
  ...
  class << self
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:55
    ...
    #   of `value`.
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:112
    ...
    #   than 0 or greater than or equal to 1.
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:172
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:231
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:206
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:296
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:256
    ...
    #   `false`.
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:283
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:192
...
# number.
#
# source://tzinfo-VERSION/lib/tzinfo/timestamp.rb:16
...
#
# source://tzinfo-VERSION/lib/tzinfo/timestamp_with_offset.rb:12
class TZInfo::TimestampWithOffset < ::TZInfo::Timestamp
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp_with_offset.rb:47
  def set_timezone_offset(timezone_offset); end

  # @return [TimezoneOffset] the {TimezoneOffset} associated with this
  #   instance.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp_with_offset.rb:17
  def timezone_offset; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp_with_offset.rb:76
  def to_datetime; end
  ...
  #   a `Time` representation.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timestamp_with_offset.rb:60
  def to_time; end
  ...
  class << self
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timestamp_with_offset.rb:32
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone.rb:80
class TZInfo::Timezone
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1105
  def <=>(tz); end
  ...
  #   match.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1128
  def =~(regexp); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1137
  def _dump(limit); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1048
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1081
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:987
  ...
  # @return [Timezone] the canonical {Timezone} instance for this {Timezone}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:412
  def canonical_zone; end

  # @return [TimezonePeriod] the current {TimezonePeriod} for the time zone.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:997
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1008
  ...
  #   time.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1059
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1113
  def eql?(tz); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:277
  def friendly_identifier(skip_first_part = T.unsafe(nil)); end

  # @return [Integer] a hash based on the {identifier}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1118
  def hash; end

  # @return [String] the identifier of the time zone, for example,
  #   `"Europe/Paris"`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:241
  def identifier; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:259
  def inspect; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:831
  ...
  #   one {TimezonePeriod}, or `nil`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:743
  ...
  #   one {TimezonePeriod}, or `nil`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:919
  ...
  #   one {TimezonePeriod}, or `nil`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:645
  def local_to_utc(local_time, dst = T.unsafe(nil)); end

  # @return [String] the identifier of the time zone, for example,
  #   `"Europe/Paris"`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:247
  def name; end

  # @return [TimeWithOffset] the current local time in the time zone.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:992
  def now; end
  ...
  #   time.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1094
  ...
  #   in any order.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:947
  ...
  # @return [TimezonePeriod] the {TimezonePeriod} that is valid at `time`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:319
  def period_for(time); end
  ...
  #   one {TimezonePeriod}, or `nil`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:494
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:425
  ...
  #   valid at `local_time`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:342
  def periods_for_local(local_time); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1039
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:548
  def to_local(time); end

  # @return [String] {identifier}, modified to make it more readable.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:253
  def to_s; end
  ...
  #   by when they occur, from earliest to latest.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:370
  def transitions_up_to(to, from = T.unsafe(nil)); end
  ...
  #   {DateTimeWithOffset} or {TimestampWithOffset}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:572
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1156
  ...
  class << self
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:1147
    def _load(data); end
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:151
    def all; end
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:219
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:206
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:175
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:169
    def all_data_zones; end

    # @return [Array<String>] an `Array` containing the identifiers of all the
    #   available time zones.
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:157
    ...
    # @return [Array<String>] an `Array` of the identifiers of all available
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:193
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:187
    ...
    #   `false`).
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:110
    def default_dst; end
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:96
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:127
    ...
    #   `identifier`.
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:141
    ...
    # @return [DataSource] the current DataSource.
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:234
    def data_source; end
    ...
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone.rb:229
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/timezone_definition.rb:37
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/format1/timezone_index_definition.rb:75
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:6
class TZInfo::TimezoneOffset
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:62
  ...
  #   otherwise `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:84
  def ==(toi); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:50
  def abbr; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:21
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:74
  def dst?; end
  ...
  #   otherwise `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:95
  def eql?(toi); end

  # @return [Integer] a hash based on {utc_offset}, {std_offset} and
  #   {abbreviation}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:101
  def hash; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:107
  def inspect; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:43
  ...
  #   seconds.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_offset.rb:37
  def std_offset; end
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:14
class TZInfo::TimezonePeriod
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:23
  def initialize(offset); end
  ...
  # @return [String] the abbreviation that identifies this offset.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:80
  def abbr; end
  ...
  # @return [Integer] the base offset from UTC in seconds.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:54
  def base_utc_offset; end
  ...
  # @return [Boolean] `true` if {std_offset} is non-zero, otherwise `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:99
  def dst?; end

  # @return [TimezoneTransition] the transition that defines the end of this
  #   {TimezonePeriod} (`nil` if the end is unbounded).
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:36
  def end_transition; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:125
  def ends_at; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:151
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:138
  ...
  # @return [Integer] the observed offset from UTC in seconds.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:90
  def observed_utc_offset; end

  # @return [TimezoneOffset] the offset that applies in the period of time.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:16
  def offset; end

  # @return [TimezoneTransition] the transition that defines the start of this
  #   {TimezonePeriod} (`nil` if the start is unbounded).
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:30
  def start_transition; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:112
  def starts_at; end
  ...
  #   seconds.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:72
  def std_offset; end
  ...
  # @raise [NotImplementedError] always.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:161
  def raise_not_implemented(method_name); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:168
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_period.rb:175
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:22
class TZInfo::TimezoneProxy < ::TZInfo::Timezone
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:23
  def initialize(identifier); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:60
  def _dump(limit); end
  ...
  # @return [Timezone] the canonical {Timezone} instance for this {Timezone}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:50
  def canonical_zone; end

  # @return [String] the identifier of the time zone, for example,
  #   `"Europe/Paris"`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:30
  def identifier; end
  ...
  # @return [TimezonePeriod] the {TimezonePeriod} that is valid at `time`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:35
  def period_for(time); end
  ...
  #   valid at `local_time`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:40
  def periods_for_local(local_time); end
  ...
  #   by when they occur, from earliest to latest.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:45
  def transitions_up_to(to, from = T.unsafe(nil)); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:82
  ...
  class << self
    ...
    #   {TimezoneProxy}.
    #
    # source://tzinfo-VERSION/lib/tzinfo/timezone_proxy.rb:71
    def _load(data); end
  end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:7
class TZInfo::TimezoneTransition
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:34
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:86
  def ==(tti); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:48
  def at; end
  ...
  #   {timestamp_value}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:94
  def hash; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:62
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:76
  def local_start_at; end

  # @return [TimezoneOffset] the offset this transition changes to.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:9
  def offset; end

  # @return [TimezoneOffset] the offset this transition changes from.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:12
  ...
  #   1970-01-01 00:00:00 UTC ignoring leap seconds.
  #
  # source://tzinfo-VERSION/lib/tzinfo/timezone_transition.rb:21
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:10
class TZInfo::TransitionRule
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:25
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:47
  def ==(r); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:37
  ...
  #   {transition_at}).
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:54
  def hash; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:18
  ...
  #   {hash}.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transition_rule.rb:62
  def hash_args; end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/transitions_timezone_period.rb:10
class TZInfo::TransitionsTimezonePeriod < ::TZInfo::TimezonePeriod
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transitions_timezone_period.rb:27
  ...
  #   `false`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transitions_timezone_period.rb:47
  def ==(p); end

  # @return [TimezoneTransition] the transition that defines the end of this
  #   {TimezonePeriod} (`nil` if the end is unbounded).
  #
  # source://tzinfo-VERSION/lib/tzinfo/transitions_timezone_period.rb:15
  def end_transition; end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/transitions_timezone_period.rb:53
  def hash; end

  # @return [String] the internal object state as a programmer-readable
  #   `String`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/transitions_timezone_period.rb:59
  def inspect; end

  # @return [TimezoneTransition] the transition that defines the start of this
  #   {TimezonePeriod} (`nil` if the start is unbounded).
  #
  # source://tzinfo-VERSION/lib/tzinfo/transitions_timezone_period.rb:11
  def start_transition; end
end
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/string_deduper.rb:90
class TZInfo::UnaryMinusGlobalStringDeduper
  # @param string [String] the string to deduplicate.
  # @return [bool] `string` if it is frozen, otherwise a frozen, possibly
  #   pre-existing copy of `string`.
  #
  # source://tzinfo-VERSION/lib/tzinfo/string_deduper.rb:94
  def dedupe(string); end
end
...
#
# source://tzinfo-VERSION/lib/tzinfo/timezone.rb:32
...
# @private
#
# source://tzinfo-VERSION/lib/tzinfo/untaint_ext.rb:10
module TZInfo::UntaintExt; end

# The TZInfo version number.
#
# source://tzinfo-VERSION/lib/tzinfo/version.rb:6
...
#
# source://tzinfo-VERSION/lib/tzinfo/with_offset.rb:10
module TZInfo::WithOffset
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/with_offset.rb:21
  def strftime(format); end
  ...
  #
  # source://tzinfo-VERSION/lib/tzinfo/with_offset.rb:56
