...
#
# source://ast-VERSION/lib/ast.rb:13
module AST; end
...
# the codebase.
#
# source://ast-VERSION/lib/ast/node.rb:40
class AST::Node
  ...
  #
  # source://ast-VERSION/lib/ast/node.rb:72
  ...
  # @return [AST::Node]
  #
  # source://ast-VERSION/lib/ast/node.rb:168
  def +(array); end
  ...
  # @return [AST::Node]
  #
  # source://ast-VERSION/lib/ast/node.rb:177
  def <<(element); end
  ...
  # @return [Boolean]
  #
  # source://ast-VERSION/lib/ast/node.rb:153
  def ==(other); end
  ...
  # @return self
  #
  # source://ast-VERSION/lib/ast/node.rb:115
  def clone; end
  ...
  # @return [Array]
  #
  # source://ast-VERSION/lib/ast/node.rb:253
  def deconstruct; end
  ...
  # @return [Boolean]
  #
  # source://ast-VERSION/lib/ast/node.rb:85
  def eql?(other); end
  ...
  # @return [Fixnum]
  #
  # source://ast-VERSION/lib/ast/node.rb:61
  def hash; end
  ...
  # @return [String]
  #
  # source://ast-VERSION/lib/ast/node.rb:211
  ...
  #
  # source://ast-VERSION/lib/ast/node.rb:229
  def to_ast; end
  ...
  # @return [String]
  #
  # source://ast-VERSION/lib/ast/node.rb:187
  ...
  #
  # source://ast-VERSION/lib/ast/node.rb:237
  ...
  # @return [Symbol]
  #
  # source://ast-VERSION/lib/ast/node.rb:43
  def type; end
  ...
  # @return [AST::Node]
  #
  # source://ast-VERSION/lib/ast/node.rb:133
  ...
  # @return [nil]
  #
  # source://ast-VERSION/lib/ast/node.rb:98
  ...
  # @return [String]
  #
  # source://ast-VERSION/lib/ast/node.rb:264
  def fancy_type; end
...
#
# source://ast-VERSION/lib/ast/processor.rb:8
class AST::Processor
...
# endless. Have fun.
#
# source://ast-VERSION/lib/ast/processor/mixin.rb:240
module AST::Processor::Mixin
  ...
  # @return [AST::Node, nil]
  #
  # source://ast-VERSION/lib/ast/processor/mixin.rb:284
  ...
  # @return [AST::Node, nil]
  #
  # source://ast-VERSION/lib/ast/processor/mixin.rb:251
  ...
  #
  # source://ast-VERSION/lib/ast/processor/mixin.rb:274
...
#
# source://ast-VERSION/lib/ast/sexp.rb:20
module AST::Sexp
  ...
  # ignores metadata.
  #
  # source://ast-VERSION/lib/ast/sexp.rb:26
