...
#
# source://net-imap-VERSION/lib/net/imap.rb:222
class Net::IMAP < ::Net::Protocol
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:1084
  ...
  # @raise [ArgumentError]
  #
  # source://net-imap-VERSION/lib/net/imap.rb:958
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:746
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:403
  ...
  # using it.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:321
  def capability; end
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:760
  def check; end

  # The thread to receive exceptions.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:255
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:767
  def close; end
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:900
  ...
  # cannot be created.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:461
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:470
  def delete(mailbox); end

  # Disconnects from the server.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:284
  def disconnect; end
  ...
  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap.rb:307
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:450
  def examine(mailbox); end

  # Sends a EXPUNGE command to permanently remove from the currently
  # selected mailbox all messages that have the \Deleted flag set.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:773
  def expunge; end
  ...
  #   #=> 98
  #
  # source://net-imap-VERSION/lib/net/imap.rb:864
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:685
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:645
  ...
  # The QUOTA extension is described in [EXT-QUOTA[https://tools.ietf.org/html/rfc2087]]
  #
  # source://net-imap-VERSION/lib/net/imap.rb:629
  def getquotaroot(mailbox); end

  # Returns an initial greeting response from the server.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:232
  def greeting; end
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:345
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:1007
  def idle(timeout = T.unsafe(nil), &response_handler); end

  # Leaves IDLE.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:1037
  def idle_done; end

  # Seconds to wait until an IDLE response is received.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:252
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:527
  ...
  # A Net::IMAP::NoResponseError is raised if authentication fails.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:421
  def login(user, password); end

  # Sends a LOGOUT command to inform the server that the client is
  # done with the connection.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:359
  def logout; end
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:698
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:915
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:584
  def namespace; end

  # Sends a NOOP command to the server. It does nothing.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:353
  def noop; end
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:249
  def open_timeout; end

  # Removes the response handler.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:964
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:481
  def rename(mailbox, newname); end

  # Returns all response handlers.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:244
  ...
  #   #=> 968263756
  #
  # source://net-imap-VERSION/lib/net/imap.rb:241
  def responses; end
  ...
  #   #=> [1, 6, 7, 8]
  #
  # source://net-imap-VERSION/lib/net/imap.rb:820
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:437
  ...
  # The ACL extension is described in [EXT-ACL[https://tools.ietf.org/html/rfc4314]]
  #
  # source://net-imap-VERSION/lib/net/imap.rb:672
  ...
  # The QUOTA extension is described in [EXT-QUOTA[https://tools.ietf.org/html/rfc2087]]
  #
  # source://net-imap-VERSION/lib/net/imap.rb:658
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:935
  def sort(sort_keys, search_keys, charset); end

  # Sends a STARTTLS command to start TLS session.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:364
  ...
  # does not exist.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:721
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:887
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:491
  ...
  #
  # source://net-imap-VERSION/lib/net/imap.rb:981
  def thread(algorithm, search_keys, charset); end

  # Similar to #copy, but +set+ contains unique identifiers.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:905
  def uid_copy(set, mailbox); end

  # Similar to #fetch, but +set+ contains unique identifiers.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:869
  ...
  # The MOVE extension is described in [EXT-MOVE[https://tools.ietf.org/html/rfc6851]].
  #
  # source://net-imap-VERSION/lib/net/imap.rb:922
  def uid_move(set, mailbox); end

  # Similar to #search, but returns unique identifiers.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:825
  ...
  # The SORT extension is described in [EXT-SORT-THREAD[https://tools.ietf.org/html/rfc5256]].
  #
  # source://net-imap-VERSION/lib/net/imap.rb:942
  def uid_sort(sort_keys, search_keys, charset); end

  # Similar to #store, but +set+ contains unique identifiers.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:892
  ...
  # The THREAD extension is described in [EXT-SORT-THREAD[https://tools.ietf.org/html/rfc5256]].
  #
  # source://net-imap-VERSION/lib/net/imap.rb:989
  ...
  # subscribed to it.
  #
  # source://net-imap-VERSION/lib/net/imap.rb:501
  ...
  #        #<Net::IMAP::MailboxList attr=[:Noinferiors], delim="/", name="foo/baz">]
  #
  # source://net-imap-VERSION/lib/net/imap.rb:616
  def xlist(refname, mailbox); end

  private

  # source://net-imap-VERSION/lib/net/imap.rb:1376
  def copy_internal(cmd, set, mailbox); end

  # source://net-imap-VERSION/lib/net/imap.rb:1415
  def create_ssl_params(certs = T.unsafe(nil), verify = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap.rb:1344
  def fetch_internal(cmd, set, attr, mod = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap.rb:1308
  def generate_tag; end

  # source://net-imap-VERSION/lib/net/imap.rb:1253
  def get_response; end

  # source://net-imap-VERSION/lib/net/imap.rb:1226
  def get_tagged_response(tag, cmd, timeout = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap.rb:1404
  def normalize_searching_criteria(keys); end

  # source://net-imap-VERSION/lib/net/imap.rb:1313
  def put_string(str); end

  # source://net-imap-VERSION/lib/net/imap.rb:1155
  def receive_responses; end

  # source://net-imap-VERSION/lib/net/imap.rb:1273
  def record_response(name, data); end

  # source://net-imap-VERSION/lib/net/imap.rb:1328
  def search_internal(cmd, keys, charset); end

  # source://net-imap-VERSION/lib/net/imap.rb:1280
  def send_command(cmd, *args, &block); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:31
  def send_data(data, tag = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:90
  def send_list_data(list, tag = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:69
  def send_literal(str, tag = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:86
  def send_number_data(num); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:65
  def send_quoted_string(str); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:50
  def send_string_data(str, tag = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:114
  def send_symbol_data(symbol); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:106
  def send_time_data(time); end

  # source://net-imap-VERSION/lib/net/imap.rb:1380
  def sort_internal(cmd, sort_keys, search_keys, charset); end

  # source://net-imap-VERSION/lib/net/imap.rb:1432
  def start_tls_session(params = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap.rb:1365
  def store_internal(cmd, set, attr, flags); end

  # source://net-imap-VERSION/lib/net/imap.rb:1146
  def tcp_socket(host, port); end

  # source://net-imap-VERSION/lib/net/imap.rb:1393
  def thread_internal(cmd, algorithm, search_keys, charset); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:10
  def validate_data(data); end

  class << self
    # Returns the debug mode.
    #
    # source://net-imap-VERSION/lib/net/imap.rb:258
    def debug; end

    # Sets the debug mode.
    #
    # source://net-imap-VERSION/lib/net/imap.rb:263
    def debug=(val); end
    ...
    #
    # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:16
    def decode_utf7(s); end

    # The default port for IMAP connections, port 143
    #
    # source://net-imap-VERSION/lib/net/imap.rb:268
    def default_imap_port; end

    # The default port for IMAPS connections, port 993
    #
    # source://net-imap-VERSION/lib/net/imap.rb:273
    ...
    #
    # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:27
    def encode_utf7(s); end

    # Formats +time+ as an IMAP-style date.
    #
    # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:39
    def format_date(time); end

    # Formats +time+ as an IMAP-style date-time.
    #
    # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:44
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:193
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:199
Net::IMAP::ARCHIVE = T.let(T.unsafe(nil), Symbol)

# source://net-imap-VERSION/lib/net/imap/command_data.rb:133
class Net::IMAP::Atom
  # @return [Atom] a new instance of Atom
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:143
  def initialize(data); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:134
  def send_data(imap, tag); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:138
  def validate; end
end

# Registry for SASL authenticators used by Net::IMAP.
#
# source://net-imap-VERSION/lib/net/imap/authenticators.rb:4
module Net::IMAP::Authenticators
  ...
  #
  # source://net-imap-VERSION/lib/net/imap/authenticators.rb:16
  ...
  #
  # source://net-imap-VERSION/lib/net/imap/authenticators.rb:22
  def authenticator(auth_type, *args); end

  private

  # source://net-imap-VERSION/lib/net/imap/authenticators.rb:33
...
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:472
class Net::IMAP::BodyTypeAttachment < ::Struct
  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:473
  def multipart?; end
end
...
# multipart?:: Returns false.
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:388
class Net::IMAP::BodyTypeBasic < ::Struct
  # Obsolete: use +subtype+ instead.  Calling this will
  # generate a warning message to +stderr+, then return
  # the value of +subtype+.
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:396
  def media_subtype; end

  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:389
  def multipart?; end
end

# source://net-imap-VERSION/lib/net/imap/response_data.rb:520
class Net::IMAP::BodyTypeExtension < ::Struct
  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:521
  def multipart?; end
end
...
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:444
class Net::IMAP::BodyTypeMessage < ::Struct
  # Obsolete: use +subtype+ instead.  Calling this will
  # generate a warning message to +stderr+, then return
  # the value of +subtype+.
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:452
  def media_subtype; end

  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:445
  def multipart?; end
end
...
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:504
class Net::IMAP::BodyTypeMultipart < ::Struct
  # Obsolete: use +subtype+ instead.  Calling this will
  # generate a warning message to +stderr+, then return
  # the value of +subtype+.
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:512
  def media_subtype; end

  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:505
  def multipart?; end
end
...
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:415
class Net::IMAP::BodyTypeText < ::Struct
  # Obsolete: use +subtype+ instead.  Calling this will
  # generate a warning message to +stderr+, then return
  # the value of +subtype+.
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:423
  def media_subtype; end

  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap/response_data.rb:416
  def multipart?; end
end

# source://net-imap-VERSION/lib/net/imap/command_data.rb:234
class Net::IMAP::ClientID
  # @return [ClientID] a new instance of ClientID
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:246
  def initialize(data); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:236
  def send_data(imap, tag); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:240
  def validate; end

  private

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:260
  def format_internal(client_id); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:250
...
#
# source://net-imap-VERSION/lib/net/imap/authenticators/cram_md5.rb:18
class Net::IMAP::CramMD5Authenticator
  # @return [CramMD5Authenticator] a new instance of CramMD5Authenticator
  #
  # source://net-imap-VERSION/lib/net/imap/authenticators/cram_md5.rb:26
  def initialize(user, password); end

  # source://net-imap-VERSION/lib/net/imap/authenticators/cram_md5.rb:19
  def process(challenge); end

  private

  # source://net-imap-VERSION/lib/net/imap/authenticators/cram_md5.rb:31
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:207
...
#
# source://net-imap-VERSION/lib/net/imap/authenticators/digest_md5.rb:14
class Net::IMAP::DigestMD5Authenticator
  # @return [DigestMD5Authenticator] a new instance of DigestMD5Authenticator
  #
  # source://net-imap-VERSION/lib/net/imap/authenticators/digest_md5.rb:80
  def initialize(user, password, authname = T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap/authenticators/digest_md5.rb:15
  def process(challenge); end

  private

  # source://net-imap-VERSION/lib/net/imap/authenticators/digest_md5.rb:90
  def nc(nonce); end

  # some responses need quoting
  #
  # source://net-imap-VERSION/lib/net/imap/authenticators/digest_md5.rb:100
  def qdval(k, v); end
end
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:127
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:140
...
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:53
...
# spam filter.
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:215
Net::IMAP::JUNK = T.let(T.unsafe(nil), Symbol)

# source://net-imap-VERSION/lib/net/imap/command_data.rb:163
class Net::IMAP::Literal
  # @return [Literal] a new instance of Literal
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:173
  def initialize(data); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:164
  def send_data(imap, tag); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:168
  def validate; end
end
...
#
# source://net-imap-VERSION/lib/net/imap/authenticators/login.rb:20
class Net::IMAP::LoginAuthenticator
  # @return [LoginAuthenticator] a new instance of LoginAuthenticator
  #
  # source://net-imap-VERSION/lib/net/imap/authenticators/login.rb:36
  def initialize(user, password); end

  # source://net-imap-VERSION/lib/net/imap/authenticators/login.rb:21
  def process(data); end
end

# source://net-imap-VERSION/lib/net/imap/command_data.rb:178
class Net::IMAP::MessageSet
  # @return [MessageSet] a new instance of MessageSet
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:189
  def initialize(data); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:179
  def send_data(imap, tag); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:183
  def validate; end

  private

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:193
  def format_internal(data); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:214
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:96
...
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:204
...
#
# source://net-imap-VERSION/lib/net/imap/response_data.rb:222
class Net::IMAP::Namespaces < ::Struct; end

# Common validators of number and nz_number types
#
# source://net-imap-VERSION/lib/net/imap/data_encoding.rb:49
module Net::IMAP::NumValidator
  private

  # Ensure argument is 'mod_sequence_value' or raise DataFormatError
  #
  # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:96
  def ensure_mod_sequence_value(num); end

  # Ensure argument is 'number' or raise DataFormatError
  #
  # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:80
  def ensure_number(num); end

  # Ensure argument is 'nz_number' or raise DataFormatError
  #
  # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:88
  def ensure_nz_number(num); end

  # Check is passed argument valid 'mod_sequence_value' in RFC 4551 terminology
  #
  # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:71
  def valid_mod_sequence_value?(num); end

  # Check is passed argument valid 'number' in RFC 3501 terminology
  #
  # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:53
  def valid_number?(num); end

  # Check is passed argument valid 'nz_number' in RFC 3501 terminology
  #
  # source://net-imap-VERSION/lib/net/imap/data_encoding.rb:62
...
# can be secured by TLS encryption.
#
# source://net-imap-VERSION/lib/net/imap/authenticators/plain.rb:12
class Net::IMAP::PlainAuthenticator
  ...
  #
  # source://net-imap-VERSION/lib/net/imap/authenticators/plain.rb:31
  def initialize(username, password, authzid: T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap/authenticators/plain.rb:14
  def process(data); end
end

# source://net-imap-VERSION/lib/net/imap/authenticators/plain.rb:19
Net::IMAP::PlainAuthenticator::NULL = T.let(T.unsafe(nil), String)

# source://net-imap-VERSION/lib/net/imap/command_data.rb:148
class Net::IMAP::QuotedString
  # @return [QuotedString] a new instance of QuotedString
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:158
  def initialize(data); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:149
  def send_data(imap, tag); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:153
  def validate; end
end

# The mailbox is a remote mailbox.
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:165
Net::IMAP::REMOTE = T.let(T.unsafe(nil), Symbol)

# source://net-imap-VERSION/lib/net/imap/errors.rb:54
Net::IMAP::RESPONSE_ERRORS = T.let(T.unsafe(nil), Hash)

# source://net-imap-VERSION/lib/net/imap/command_data.rb:118
class Net::IMAP::RawData
  # @return [RawData] a new instance of RawData
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:128
  def initialize(data); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:119
  def send_data(imap, tag); end

  # source://net-imap-VERSION/lib/net/imap/command_data.rb:123
  def validate; end
end
...
# from the server.
#
# source://net-imap-VERSION/lib/net/imap/errors.rb:20
class Net::IMAP::ResponseError < ::Net::IMAP::Error
  # @return [ResponseError] a new instance of ResponseError
  #
  # source://net-imap-VERSION/lib/net/imap/errors.rb:25
  def initialize(response); end

  # The response that caused this error
  #
  # source://net-imap-VERSION/lib/net/imap/errors.rb:23
  def response; end
...
# source://net-imap-VERSION/lib/net/imap/response_parser.rb:8
class Net::IMAP::ResponseParser
  # @return [ResponseParser] a new instance of ResponseParser
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:9
  def initialize; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:16
  def parse(str); end
  ...
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1375
  def accept(*args); end

  # This advances @pos directly so it's safe before changing @lex_state.
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1332
  ...
  # This advances @pos directly so it's safe before changing @lex_state.
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1344
  def accept_spaces; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1178
  def address; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1148
  def address_list; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1234
  def astring; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1287
  def astring_chars; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1279
  def atom; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:326
  def body; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:307
  def body_data; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:513
  def body_ext_1part; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:549
  def body_ext_mpart; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:639
  def body_extension; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:625
  def body_extensions; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:475
  def body_fields; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:585
  def body_fld_dsp; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:599
  def body_fld_lang; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:488
  def body_fld_param; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:346
  def body_type_1part; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:432
  def body_type_attachment; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:362
  def body_type_basic; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:439
  def body_type_mixed; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:446
  def body_type_mpart; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:391
  def body_type_msg; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:377
  def body_type_text; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:967
  def capability_data; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:960
  def capability_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1259
  ...
  # charset = atom / quoted
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1306
  def charset; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1135
  def charset_list; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1291
  def combine_adjacent(*tokens); end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:108
  def continue_req; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:238
  def envelope; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:231
  def envelope_data; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1209
  def flag_list; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:273
  def flags_data; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:736
  def flags_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:689
  def format_string(str); end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:814
  def getacl_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:764
  def getquota_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:797
  def getquotaroot_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:983
  def id_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:722
  def ignored_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:280
  def internaldate_data; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:743
  def list_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1383
  def lookahead; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:750
  def mailbox_list; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1351
  def match(*args, lex_state: T.unsafe(nil)); end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:464
  def media_type; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:712
  def modseq_data; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:193
  def msg_att(n); end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1046
  def namespace; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1012
  def namespace_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1056
  def namespace_response_extensions; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1028
  def namespaces; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1391
  def next_token; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1324
  def nil_atom; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1224
  def nstring; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1314
  def number; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:177
  def numeric_response; end

  # @raise [ResponseParseError]
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1510
  def parse_error(fmt, *args); end

  # resp-text       = ["[" resp-text-code "]" SP] text
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1082
  def resp_text; end
  ...
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1106
  def resp_text_code; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:89
  def response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:170
  def response_cond; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:161
  def response_tagged; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:119
  def response_untagged; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:300
  def rfc822_size; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:288
  def rfc822_text; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:840
  def search_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:654
  def section; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1387
  def shift_token; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:933
  def status_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1243
  def string; end

  # @return [Boolean]
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1255
  def string_token?(token); end

  # text            = 1*TEXT-CHAR
  # TEXT-CHAR       = <any CHAR except CR and LF>
  #
  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:1077
  def text; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:729
  def text_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:898
  def thread_branch(token); end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:871
  def thread_response; end

  # source://net-imap-VERSION/lib/net/imap/response_parser.rb:705
  def uid_data; end
end
...
# resp-specials   = "]"
#
# source://net-imap-VERSION/lib/net/imap/response_parser.rb:1285
Net::IMAP::ResponseParser::ASTRING_CHARS_TOKENS = T.let(T.unsafe(nil), Array)

# source://net-imap-VERSION/lib/net/imap/response_parser.rb:1329
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:221
Net::IMAP::SENT = T.let(T.unsafe(nil), Symbol)

# The mailbox name was subscribed to using the SUBSCRIBE command.
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:162
Net::IMAP::SUBSCRIBED = T.let(T.unsafe(nil), Symbol)

# source://net-imap-VERSION/lib/net/imap/command_data.rb:269
module Net::IMAP::StringFormatter
  private

  # coerces non-nil using +to_s+
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:296
  def nstring(str); end

  # coerces using +to_s+
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:286
  def string(str); end

  # Allows nil, symbols, and strings
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:281
  def valid_nstring?(str); end

  # Allows symbols in addition to strings
  #
  # source://net-imap-VERSION/lib/net/imap/command_data.rb:276
...
# source://net-imap-VERSION/lib/net/imap/command_data.rb:271
...
#
# source://net-imap-VERSION/lib/net/imap/flags.rb:231
Net::IMAP::TRASH = T.let(T.unsafe(nil), Symbol)

# Error raised upon an unknown response from the server.
#
# source://net-imap-VERSION/lib/net/imap/errors.rb:51
class Net::IMAP::UnknownResponseError < ::Net::IMAP::ResponseError; end

# source://net-imap-VERSION/lib/net/imap.rb:223
