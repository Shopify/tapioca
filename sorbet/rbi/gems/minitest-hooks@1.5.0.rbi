...
#
# source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:5
module Minitest::Hooks
  ...
  #
  # source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:21
  def after_all; end

  # Method that just yields, so that super calls in spec subclasses work.
  #
  # source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:30
  def around; end

  # Method that just yields, so that super calls in spec subclasses work.
  #
  # source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:25
  def around_all; end

  # Empty method, necessary so that super calls in spec subclasses work.
  #
  # source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:17
  def before_all; end

  # Run around hook inside, since time_it is run around every spec.
  #
  # source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:35
  def time_it; end
...
module Minitest::Hooks::ClassMethods
  ...
  #
  # source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:64
  def with_info_handler(reporter, &block); end

  private

  # source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:137
...
#
# source://minitest-hooks-VERSION/lib/minitest/hooks/test.rb:47
Minitest::Hooks::ClassMethods::NEW = T.let(T.unsafe(nil), Object)

# Spec subclass that includes the hook methods.
#
# source://minitest-hooks-VERSION/lib/minitest/hooks.rb:5
