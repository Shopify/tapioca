...
module AbstractController::Railties::RoutesHelpers
  class << self
    def with(routes, include_path_helpers = _); end
  end
end
...
class ActionController::Renderer
  ...
  class << self
    def for(controller, env = _, defaults = _); end
  end
end
...
class ActionDispatch::Response
  ...
  class << self
    def create(status = _, header = _, body = _, default_headers: _); end
    def default_charset; end
    def default_charset=(obj); end
    def default_headers; end
    def default_headers=(obj); end
...
class ActionDispatch::Session::CookieStore::SessionId
  def initialize(session_id, cookie_value = _); end
...
class ActionDispatch::RequestEncoder
  ...
  class << self
    ...
    def register_encoder(mime_name, param_encoder: _, response_parser: _); end
  end
end
...
class Mime::Type
  ...
  class << self
    ...
    def register(string, symbol, mime_type_synonyms = _, extension_synonyms = _, skip_lookup = _); end
    def register_alias(string, symbol, extension_synonyms = _); end
