...
#
# source://public_suffix-VERSION/lib/public_suffix/domain.rb:9
module PublicSuffix
  class << self
    # private
    #
    # source://public_suffix-VERSION/lib/public_suffix.rb:149
    ...
    # @return [String]
    #
    # source://public_suffix-VERSION/lib/public_suffix.rb:140
    def domain(name, **options); end

    # Pretend we know how to deal with user input.
    #
    # source://public_suffix-VERSION/lib/public_suffix.rb:164
    ...
    #
    # source://public_suffix-VERSION/lib/public_suffix.rb:67
...
class PublicSuffix::Domain
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:65
  ...
  # @see #subdomain
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:137
  def domain; end
  ...
  # @see #subdomain?
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:198
  def domain?; end
  ...
  # @return [String]
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:105
  def name; end

  # Returns the value of attribute sld.
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:33
  def sld; end
  ...
  # @see #domain
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:169
  def subdomain; end
  ...
  # @see #domain?
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:229
  def subdomain?; end
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:89
  def to_a; end
  ...
  # @return [String]
  #
  # source://public_suffix-VERSION/lib/public_suffix/domain.rb:73
  def to_s; end
  ...
  class << self
    ...
    # @return [Array<String>]
    #
    # source://public_suffix-VERSION/lib/public_suffix/domain.rb:28
...
#   # => PublicSuffix::DomainInvalid
#
# source://public_suffix-VERSION/lib/public_suffix/errors.rb:25
...
#   # => PublicSuffix::Domain
#
# source://public_suffix-VERSION/lib/public_suffix/errors.rb:38
class PublicSuffix::DomainNotAllowed < ::PublicSuffix::DomainInvalid; end

# source://public_suffix-VERSION/lib/public_suffix/errors.rb:11
...
#
# source://public_suffix-VERSION/lib/public_suffix/list.rb:40
class PublicSuffix::List
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:106
  def initialize; end
  ...
  # @return [self]
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:141
  def <<(rule); end
  ...
  # @return [Boolean]
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:120
  def ==(other); end
  ...
  # @return [self]
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:164
  def clear; end
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:226
  def default_rule; end

  # Iterates each rule in the list.
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:128
  def each(&block); end
  ...
  # @return [Boolean]
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:157
  def empty?; end
  ...
  # @return [PublicSuffix::Rule::*]
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:174
  ...
  # @return [Integer]
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:150
  def size; end
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:233
  def rules; end

  private

  # source://public_suffix-VERSION/lib/public_suffix/list.rb:238
  def entry_to_rule(entry, value); end

  # source://public_suffix-VERSION/lib/public_suffix/list.rb:242
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/list.rb:199
  ...
  class << self
    ...
    #
    # source://public_suffix-VERSION/lib/public_suffix/list.rb:50
    ...
    # @return [PublicSuffix::List]
    #
    # source://public_suffix-VERSION/lib/public_suffix/list.rb:58
    ...
    # @return [PublicSuffix::List]
    #
    # source://public_suffix-VERSION/lib/public_suffix/list.rb:69
    def parse(input, private_domains: T.unsafe(nil)); end
  end
end

# source://public_suffix-VERSION/lib/public_suffix/list.rb:42
...
#   # => #<PublicSuffix::Rule::Normal>
#
# source://public_suffix-VERSION/lib/public_suffix/rule.rb:22
module PublicSuffix::Rule
  class << self
    ...
    #
    # source://public_suffix-VERSION/lib/public_suffix/rule.rb:344
    def default; end
    ...
    #
    # source://public_suffix-VERSION/lib/public_suffix/rule.rb:326
...
# @abstract
#
# source://public_suffix-VERSION/lib/public_suffix/rule.rb:102
class PublicSuffix::Rule::Base
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:126
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:137
  def ==(other); end
  ...
  # @return [Array<String, nil>]
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:180
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:108
  def length; end
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:163
  def match?(name); end

  # @abstract
  # @raise [NotImplementedError]
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:173
  def parts; end

  # @return [Boolean] true if the rule is a private domain
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:111
  def private; end

  # @return [String] the rule definition
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:105
  def value; end
  ...
  class << self
    ...
    # @param private [Boolean]
    #
    # source://public_suffix-VERSION/lib/public_suffix/rule.rb:118
...
# @api internal
#
# source://public_suffix-VERSION/lib/public_suffix/rule.rb:25
...
#
# source://public_suffix-VERSION/lib/public_suffix/rule.rb:265
class PublicSuffix::Rule::Exception < ::PublicSuffix::Rule::Base
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:286
  ...
  # @return [Array<String>]
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:301
  def parts; end
  ...
  # @return [String] The rule definition.
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:278
  def rule; end
  ...
  class << self
    ...
    # @param private [Boolean]
    #
    # source://public_suffix-VERSION/lib/public_suffix/rule.rb:271
    def build(content, private: T.unsafe(nil)); end
  end
end
...
#
# source://public_suffix-VERSION/lib/public_suffix/rule.rb:187
class PublicSuffix::Rule::Normal < ::PublicSuffix::Rule::Base
  ...
  # @return [Array<String>] The array with [trd + sld, tld].
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:200
  def decompose(domain); end
  ...
  # @return [Array<String>]
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:210
  def parts; end
  ...
  # @return [String] The rule definition.
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:192
  def rule; end
end

# Wildcard represents a wildcard rule (e.g. *.co.uk).
#
# source://public_suffix-VERSION/lib/public_suffix/rule.rb:217
class PublicSuffix::Rule::Wildcard < ::PublicSuffix::Rule::Base
  ...
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:232
  def initialize(value:, length: T.unsafe(nil), private: T.unsafe(nil)); end
  ...
  # @return [Array<String>] The array with [trd + sld, tld].
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:248
  def decompose(domain); end
  ...
  # @return [Array<String>]
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:258
  def parts; end
  ...
  # @return [String] The rule definition.
  #
  # source://public_suffix-VERSION/lib/public_suffix/rule.rb:240
  def rule; end
  ...
  class << self
    ...
    # @param private [Boolean]
    #
    # source://public_suffix-VERSION/lib/public_suffix/rule.rb:223
    def build(content, private: T.unsafe(nil)); end
  end
end

# source://public_suffix-VERSION/lib/public_suffix.rb:27
PublicSuffix::STAR = T.let(T.unsafe(nil), String)

# @return [String] The current library version.
#
# source://public_suffix-VERSION/lib/public_suffix/version.rb:13
