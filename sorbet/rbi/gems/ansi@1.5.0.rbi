...
#
# source://ansi-VERSION/lib/ansi/code.rb:1
module ANSI
...
#
# source://ansi-VERSION/lib/ansi/chart.rb:6
...
#
# source://ansi-VERSION/lib/ansi/code.rb:37
module ANSI::Code
  ...
  #
  # source://ansi-VERSION/lib/ansi/code.rb:60
  def [](*codes); end
  ...
  #
  # source://ansi-VERSION/lib/ansi/code.rb:176
  def ansi(*codes); end

  # Move cursor left a specified number of spaces.
  #
  # source://ansi-VERSION/lib/ansi/code.rb:149
  def back(spaces = T.unsafe(nil)); end

  # source://ansi-VERSION/lib/ansi/code.rb:70
  ...
  #
  # source://ansi-VERSION/lib/ansi/code.rb:241
  def code(*codes); end
  ...
  #
  # source://ansi-VERSION/lib/ansi/code.rb:325
  ...
  #
  # source://ansi-VERSION/lib/ansi/code.rb:89
  def method_missing(code, *args, &blk); end

  # Move cursor to line and column.
  #
  # source://ansi-VERSION/lib/ansi/code.rb:134
  ...
  #
  # source://ansi-VERSION/lib/ansi/code.rb:274
  ...
  # @param background [Boolean] Use `true` for background color, otherwise foreground color.
  #
  # source://ansi-VERSION/lib/ansi/code.rb:286
  def rgb(*args); end
  ...
  # @raise [ArgumentError]
  #
  # source://ansi-VERSION/lib/ansi/code.rb:335
  ...
  # @param background [Boolean] Use `true` for background color, otherwise foreground color.
  #
  # source://ansi-VERSION/lib/ansi/code.rb:313
  ...
  # @return [String] String wrapped ANSI code.
  #
  # source://ansi-VERSION/lib/ansi/code.rb:201
  ...
  #
  # source://ansi-VERSION/lib/ansi/code.rb:139
  ...
  class << self
    ...
    #
    # source://ansi-VERSION/lib/ansi/code.rb:55
    def colors; end

    # List of primary styles.
    #
    # source://ansi-VERSION/lib/ansi/code.rb:50
    def styles; end
  end
end
...
# ANSI clear code.
#
# source://ansi-VERSION/lib/ansi/code.rb:47
ANSI::Code::ENDCODE = T.let(T.unsafe(nil), String)

# Regexp for matching most ANSI codes.
#
# source://ansi-VERSION/lib/ansi/code.rb:44
...
#
# source://ansi-VERSION/lib/ansi/constants.rb:13
module ANSI::Constants; end

# source://ansi-VERSION/lib/ansi/constants.rb:16
...
# source://ansi-VERSION/lib/ansi/constants.rb:20
...
# source://ansi-VERSION/lib/ansi/chart.rb:86
