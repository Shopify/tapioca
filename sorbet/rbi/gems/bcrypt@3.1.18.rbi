...
# hashing passwords.
#
# source://bcrypt-VERSION/lib/bcrypt.rb:3
module BCrypt; end

# A Ruby wrapper for the bcrypt() C extension calls and the Java calls.
#
# source://bcrypt-VERSION/lib/bcrypt/engine.rb:3
class BCrypt::Engine
  class << self
    # Autodetects the cost from the salt string.
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:122
    ...
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:112
    ...
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:32
    def cost; end
    ...
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:49
    def cost=(cost); end

    # Generates a random salt with a given computational cost.
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:74
    def generate_salt(cost = T.unsafe(nil)); end

    # Given a secret and a valid salt (see BCrypt::Engine.generate_salt) calculates
    # a bcrypt() password hash. Secrets longer than 72 bytes are truncated.
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:55
    ...
    # @return [Boolean]
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:91
    ...
    # @return [Boolean]
    #
    # source://bcrypt-VERSION/lib/bcrypt/engine.rb:96
...
#
# source://bcrypt-VERSION/lib/bcrypt/password.rb:24
class BCrypt::Password < ::String
  # Initializes a BCrypt::Password instance with the data from a stored hash.
  #
  # @return [Password] a new instance of Password
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:55
  ...
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:76
  def ==(secret); end

  # The hash portion of the stored password hash.
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:25
  def checksum; end

  # The cost factor used to create the hash.
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:31
  def cost; end
  ...
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:27
  def salt; end

  # The version of the bcrypt() algorithm used to create the hash.
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:29
  def version; end
  ...
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:92
  ...
  # @return [Boolean]
  #
  # source://bcrypt-VERSION/lib/bcrypt/password.rb:84
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://bcrypt-VERSION/lib/bcrypt/password.rb:43
    def create(secret, options = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://bcrypt-VERSION/lib/bcrypt/password.rb:49
    def valid_hash?(h); end
  end
end
