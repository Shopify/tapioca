...
class Parlour::Plugin
  ...
  def self.run_plugins(plugins, generator, allow_failure: _); end
end
...
module Parlour::TypeLoader
  ...
  def self.load_file(filename, generator: _); end
  ...
  def self.load_project(root, inclusions: _, exclusions: _, generator: _); end
  ...
  def self.load_source(source, filename = _, generator: _); end
end
...
class Parlour::TypeParser
  ...
  def self.from_source(filename, source, generator: _); end
end
