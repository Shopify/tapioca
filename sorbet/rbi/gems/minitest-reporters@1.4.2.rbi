...
module Minitest::Reporters
  ...
  def self.reporters=(_); end
  def self.use!(console_reporters = _, env = _, backtrace_filter = _); end
...
class Minitest::Reporters::JUnitReporter < ::Minitest::Reporters::BaseReporter
  def initialize(reports_dir = _, empty = _, options = _); end
