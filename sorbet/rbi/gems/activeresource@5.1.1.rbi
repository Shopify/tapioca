...
class ActiveResource::Base
  ...
  class << self
    ...
    def build(attributes = _); end
    def collection_name; end
    def collection_name=(_); end
    def collection_parser; end
    def collection_parser=(parser_instance); end
    def collection_path(prefix_options = _, query_options = _); end
    def connection(refresh = _); end
    def connection_class; end
    def connection_class=(val); end
    def connection_class?; end
    def create(attributes = _); end
    def create!(attributes = _); end
    def delete(custom_method_name, options = _); end
    def element_name; end
    def element_name=(_); end
    def element_path(id, prefix_options = _, query_options = _); end
    def element_url(id, prefix_options = _, query_options = _); end
    def exists?(id, options = _); end
    def find(*arguments); end
    def first(*args); end
    def format; end
    def format=(mime_type_reference_or_format); end
    def format_extension; end
    def get(custom_method_name, options = _); end
    def headers; end
    def include_format_in_path; end
    def include_format_in_path=(val); end
    def include_format_in_path?; end
    ...
    def new_element_path(prefix_options = _); end
    def open_timeout; end
    def open_timeout=(timeout); end
    def orig_delete(id, options = _); end
    def password; end
    def password=(password); end
    def patch(custom_method_name, options = _, body = _); end
    def post(custom_method_name, options = _, body = _); end
    def prefix(options = _); end
    def prefix=(value = _); end
    def prefix_source; end
    def primary_key; end
    def primary_key=(_); end
    def proxy; end
    def proxy=(proxy); end
    def put(custom_method_name, options = _, body = _); end
    ...
    def instantiate_collection(collection, original_params = _, prefix_options = _); end
    def instantiate_record(record, prefix_options = _); end
