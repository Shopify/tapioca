...
module Crass
  class << self
    def parse(input, options = _); end
    def parse_properties(input, options = _); end
  end
end
...
class Crass::Parser
  ...
  class << self
    def parse_properties(input, options = _); end
    def parse_rules(input, options = _); end
    def parse_stylesheet(input, options = _); end
    def stringify(nodes, options = _); end
  end
end
...
class Crass::Tokenizer
  ...
  class << self
    def tokenize(input, options = _); end
  end
end
