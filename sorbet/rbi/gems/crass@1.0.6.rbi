...
#
# source://crass-VERSION/lib/crass/token-scanner.rb:3
module Crass
  class << self
    ...
    #
    # source://crass-VERSION/lib/crass.rb:10
    ...
    # See {Tokenizer#initialize} for _options_.
    #
    # source://crass-VERSION/lib/crass.rb:18
...
#
# source://crass-VERSION/lib/crass/parser.rb:10
class Crass::Parser
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:126
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:137
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:184
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:209
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:276
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:326
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:357
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:398
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:483
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:510
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:524
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:552
  ...
  #
  # source://crass-VERSION/lib/crass/parser.rb:560
  ...
  class << self
    ...
    # 5.3.6. http://dev.w3.org/csswg/css-syntax/#parse-a-list-of-declarations
    #
    # source://crass-VERSION/lib/crass/parser.rb:25
    def parse_properties(input, options = T.unsafe(nil)); end
    ...
    #
    # source://crass-VERSION/lib/crass/parser.rb:36
    ...
    #
    # source://crass-VERSION/lib/crass/parser.rb:54
    ...
    #
    # source://crass-VERSION/lib/crass/parser.rb:74
    def stringify(nodes, options = T.unsafe(nil)); end
  end
end

# source://crass-VERSION/lib/crass/parser.rb:11
...
#
# source://crass-VERSION/lib/crass/scanner.rb:8
class Crass::Scanner
  # Creates a Scanner instance for the given _input_ string or IO instance.
  #
  # @return [Scanner] a new instance of Scanner
  #
  # source://crass-VERSION/lib/crass/scanner.rb:25
  ...
  #
  # source://crass-VERSION/lib/crass/scanner.rb:34
  def consume; end
  ...
  #
  # source://crass-VERSION/lib/crass/scanner.rb:46
  ...
  #
  # source://crass-VERSION/lib/crass/scanner.rb:11
  def current; end
  ...
  #
  # source://crass-VERSION/lib/crass/scanner.rb:80
  ...
  #
  # source://crass-VERSION/lib/crass/scanner.rb:19
  def pos; end
  ...
  # character.
  #
  # source://crass-VERSION/lib/crass/scanner.rb:87
  def reconsume; end

  # Resets the pointer to the beginning of the string.
  #
  # source://crass-VERSION/lib/crass/scanner.rb:93
  def reset; end
  ...
  #
  # source://crass-VERSION/lib/crass/scanner.rb:103
...
class Crass::TokenScanner
  ...
  #
  # source://crass-VERSION/lib/crass/token-scanner.rb:39
  def reconsume; end

  # Resets the pointer to the first token in the list.
  #
  # source://crass-VERSION/lib/crass/token-scanner.rb:44
  def reset; end
...
#
# source://crass-VERSION/lib/crass/tokenizer.rb:9
class Crass::Tokenizer
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:62
  def initialize(input, options = T.unsafe(nil)); end
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:70
  def consume; end
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:275
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:301
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:326
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:350
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:375
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:407
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:430
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:469
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:510
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:542
  def consume_url; end
  ...
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:627
  ...
  # @return [Boolean]
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:642
  ...
  # @return [Boolean]
  #
  # source://crass-VERSION/lib/crass/tokenizer.rb:702
