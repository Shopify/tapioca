...
# pkg:gem/cityhash#lib/cityhash/version.rb:1
module CityHash
  class << self
    # pkg:gem/cityhash#lib/cityhash.rb:22
    def hash128(input, seed = T.unsafe(nil)); end

    # pkg:gem/cityhash#lib/cityhash.rb:8
    def hash32(input); end

    # pkg:gem/cityhash#lib/cityhash.rb:14
    def hash64(input, seed1 = T.unsafe(nil), seed2 = T.unsafe(nil)); end

    # pkg:gem/cityhash#lib/cityhash.rb:59
    def packed_seed(seed); end

    # pkg:gem/cityhash#lib/cityhash.rb:63
    def unpacked_digest(digest); end
  end
end

# pkg:gem/cityhash#lib/cityhash.rb:6
CityHash::HIGH64_MASK = T.let(T.unsafe(nil), Integer)

# pkg:gem/cityhash#lib/cityhash.rb:2
...
# pkg:gem/cityhash#lib/cityhash.rb:5
CityHash::LOW64_MASK = T.let(T.unsafe(nil), Integer)

# pkg:gem/cityhash#lib/cityhash/version.rb:2
