...
# pkg:gem/aasm#lib/aasm/version.rb:1
module AASM
  ...
  #
  # pkg:gem/aasm#lib/aasm/aasm.rb:86
  ...
  class << self
    ...
    #
    # pkg:gem/aasm#lib/aasm/aasm.rb:8
...
module AASM::ClassMethods
  ...
  #
  # pkg:gem/aasm#lib/aasm/aasm.rb:21
  def inherited(base); end
end

# pkg:gem/aasm#lib/aasm/configuration.rb:2
class AASM::Configuration
  # for all persistence layers: which database column to use?
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:4
  def column; end
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:42
  def logger; end
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:39
  def namespace; end
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:31
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:25
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:22
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:16
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:28
  def timestamps; end
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:19
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:13
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:7
  ...
  #
  # pkg:gem/aasm#lib/aasm/configuration.rb:34
  def with_klass; end
...
# pkg:gem/aasm#lib/aasm/core/transition.rb:3
module AASM::Core; end

# pkg:gem/aasm#lib/aasm/core/event.rb:4
class AASM::Core::Event
  ...
  # pkg:gem/aasm#lib/aasm/core/event.rb:110
  def failed_callbacks; end

  # pkg:gem/aasm#lib/aasm/core/event.rb:50
  def fire(obj, options = T.unsafe(nil), to_state = T.unsafe(nil), *args); end

  # pkg:gem/aasm#lib/aasm/core/event.rb:74
  def fire_callbacks(callback_name, record, *args); end

  # pkg:gem/aasm#lib/aasm/core/event.rb:70
  def fire_global_callbacks(callback_name, record, *args); end

  # pkg:gem/aasm#lib/aasm/core/event.rb:80
  ...
  # pkg:gem/aasm#lib/aasm/core/event.rb:114
  def to_s; end

  # DSL interface
  #
  # pkg:gem/aasm#lib/aasm/core/event.rb:96
  ...
  # pkg:gem/aasm#lib/aasm/core/event.rb:132
  def _fire(obj, options = T.unsafe(nil), to_state = T.unsafe(nil), *args); end

  # pkg:gem/aasm#lib/aasm/core/event.rb:120
  def attach_event_guards(definitions); end

  # pkg:gem/aasm#lib/aasm/core/event.rb:167
  def clear_failed_callbacks; end

  # called internally by Ruby 1.9 after clone()
  #
  # pkg:gem/aasm#lib/aasm/core/event.rb:34
  def initialize_copy(orig); end

  # pkg:gem/aasm#lib/aasm/core/event.rb:172
...
#
# pkg:gem/aasm#lib/aasm/core/invoker.rb:9
class AASM::Core::Invoker
  ...
  # pkg:gem/aasm#lib/aasm/core/invoker.rb:83
  def invoke; end
  ...
  #
  # pkg:gem/aasm#lib/aasm/core/invoker.rb:72
  ...
  #
  # pkg:gem/aasm#lib/aasm/core/invoker.rb:57
  ...
  #
  # pkg:gem/aasm#lib/aasm/core/invoker.rb:45
  ...
  # pkg:gem/aasm#lib/aasm/core/invoker.rb:97
...
class AASM::Core::Invokers::BaseInvoker
  ...
  #
  # pkg:gem/aasm#lib/aasm/core/invokers/base_invoker.rb:46
  def invoke; end
  ...
  # +failures+ - failures buffer to collect failures
  #
  # pkg:gem/aasm#lib/aasm/core/invokers/base_invoker.rb:38
...
#
# pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:9
class AASM::Core::Invokers::ClassInvoker < ::AASM::Core::Invokers::BaseInvoker
  # pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:19
  def invoke_subject; end
  ...
  # pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:33
  def instance; end

  # pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:65
  ...
  # pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:29
  def log_method_info; end

  # pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:25
  def log_source_location; end

  # pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:37
  def retrieve_instance; end

  # pkg:gem/aasm#lib/aasm/core/invokers/class_invoker.rb:69
...
#
# pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:9
class AASM::Core::Invokers::LiteralInvoker < ::AASM::Core::Invokers::BaseInvoker
  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:18
  def invoke_subject; end
  ...
  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:34
  def ensure_method_exists; end

  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:28
  def exec_subject; end

  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:57
  def instance_with_keyword_args; end

  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:42
  def invoke_with_arguments; end

  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:71
  ...
  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:80
  def record_error; end

  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:38
  def simple_invoke; end

  # pkg:gem/aasm#lib/aasm/core/invokers/literal_invoker.rb:24
  def subject_arity; end
end
...
#
# pkg:gem/aasm#lib/aasm/core/invokers/proc_invoker.rb:9
class AASM::Core::Invokers::ProcInvoker < ::AASM::Core::Invokers::BaseInvoker
  # pkg:gem/aasm#lib/aasm/core/invokers/proc_invoker.rb:19
  def invoke_subject; end
  ...
  # pkg:gem/aasm#lib/aasm/core/invokers/proc_invoker.rb:57
  ...
  # pkg:gem/aasm#lib/aasm/core/invokers/proc_invoker.rb:74
  def log_proc_info; end

  # pkg:gem/aasm#lib/aasm/core/invokers/proc_invoker.rb:70
  def log_source_location; end
...
class AASM::Core::State
  ...
  # pkg:gem/aasm#lib/aasm/core/state.rb:36
  def <=>(state); end
  ...
  # pkg:gem/aasm#lib/aasm/core/state.rb:57
  def display_name; end

  # pkg:gem/aasm#lib/aasm/core/state.rb:48
  def fire_callbacks(action, record, *args); end

  # pkg:gem/aasm#lib/aasm/core/state.rb:72
  def for_select; end

  # pkg:gem/aasm#lib/aasm/core/state.rb:70
  def human_name; end
  ...
  # pkg:gem/aasm#lib/aasm/core/state.rb:44
  def to_s; end

  private

  # pkg:gem/aasm#lib/aasm/core/state.rb:86
  def _fire_callbacks(action, record, args); end

  # called internally by Ruby 1.9 after clone()
  #
  # pkg:gem/aasm#lib/aasm/core/state.rb:16
  def initialize_copy(orig); end

  # pkg:gem/aasm#lib/aasm/core/state.rb:78
  def update(options = T.unsafe(nil)); end
end

# pkg:gem/aasm#lib/aasm/core/transition.rb:4
class AASM::Core::Transition
  ...
  # pkg:gem/aasm#lib/aasm/core/transition.rb:78
  def _fire_callbacks(code, record, args); end

  # called internally by Ruby 1.9 after clone()
  #
  # pkg:gem/aasm#lib/aasm/core/transition.rb:34
  def initialize_copy(orig); end

  # pkg:gem/aasm#lib/aasm/core/transition.rb:66
  def invoke_callbacks_compatible_with_guard(code, record, args, options = T.unsafe(nil)); end
end

# pkg:gem/aasm#lib/aasm/dsl_helper.rb:2
module AASM::DslHelper
  # pkg:gem/aasm#lib/aasm/dsl_helper.rb:25
...
class AASM::InstanceBase
  ...
  # pkg:gem/aasm#lib/aasm/instance_base.rb:10
  def current_state; end

  # pkg:gem/aasm#lib/aasm/instance_base.rb:14
  def current_state=(state); end

  # pkg:gem/aasm#lib/aasm/instance_base.rb:97
  def determine_state_name(state); end

  # pkg:gem/aasm#lib/aasm/instance_base.rb:18
  def enter_initial_state; end

  # pkg:gem/aasm#lib/aasm/instance_base.rb:60
...
# pkg:gem/aasm#lib/aasm/localizer.rb:2
class AASM::Localizer
  # pkg:gem/aasm#lib/aasm/localizer.rb:3
  def human_event_name(klass, event); end

  # pkg:gem/aasm#lib/aasm/localizer.rb:11
...
module AASM::Persistence::Base
  ...
  #
  # pkg:gem/aasm#lib/aasm/persistence/base.rb:35
  def aasm_read_state(name = T.unsafe(nil)); end

  class << self
    # pkg:gem/aasm#lib/aasm/persistence/base.rb:5
    def included(base); end
  end
end

# pkg:gem/aasm#lib/aasm/persistence/base.rb:48
module AASM::Persistence::Base::ClassMethods
  # pkg:gem/aasm#lib/aasm/persistence/base.rb:49
  def aasm_column(attribute_name = T.unsafe(nil)); end
end

# pkg:gem/aasm#lib/aasm/persistence/plain_persistence.rb:3
module AASM::Persistence::PlainPersistence
  # may be overwritten by persistence mixins
  #
  # pkg:gem/aasm#lib/aasm/persistence/plain_persistence.rb:6
  def aasm_read_state(name = T.unsafe(nil)); end

  # may be overwritten by persistence mixins
  #
  # pkg:gem/aasm#lib/aasm/persistence/plain_persistence.rb:15
  def aasm_write_state(new_state, name = T.unsafe(nil)); end

  # may be overwritten by persistence mixins
  #
  # pkg:gem/aasm#lib/aasm/persistence/plain_persistence.rb:20
...
class AASM::StateMachine
  ...
  # called internally by Ruby 1.9 after clone()
  #
  # pkg:gem/aasm#lib/aasm/state_machine.rb:17
  def initialize_copy(orig); end

  # pkg:gem/aasm#lib/aasm/state_machine.rb:48
...
class AASM::StateMachineStore
  ...
  # pkg:gem/aasm#lib/aasm/state_machine_store.rb:59
  def [](name); end

  # pkg:gem/aasm#lib/aasm/state_machine_store.rb:48
  def clone; end

  # pkg:gem/aasm#lib/aasm/state_machine_store.rb:64
  def keys; end

  # pkg:gem/aasm#lib/aasm/state_machine_store.rb:56
  def machine(name); end

  # pkg:gem/aasm#lib/aasm/state_machine_store.rb:61
  def machine_names; end

  # pkg:gem/aasm#lib/aasm/state_machine_store.rb:66
  ...
  class << self
    ...
    # pkg:gem/aasm#lib/aasm/state_machine_store.rb:28
    def fetch(klass, fallback = T.unsafe(nil)); end

    # do not overwrite existing state machines, which could have been created by
    # inheritance, see AASM::ClassMethods method inherited
    #
    # pkg:gem/aasm#lib/aasm/state_machine_store.rb:14
    def register(klass, overwrite = T.unsafe(nil), state_machine = T.unsafe(nil)); end

    # pkg:gem/aasm#lib/aasm/state_machine_store.rb:8
    def stores; end

    # pkg:gem/aasm#lib/aasm/state_machine_store.rb:39
    def unregister(klass); end
  end
end

# pkg:gem/aasm#lib/aasm/errors.rb:20
class AASM::UndefinedEvent < ::AASM::UndefinedState; end

# pkg:gem/aasm#lib/aasm/errors.rb:19
class AASM::UndefinedState < ::RuntimeError; end

# pkg:gem/aasm#lib/aasm/errors.rb:3
class AASM::UnknownStateMachineError < ::RuntimeError; end

# pkg:gem/aasm#lib/aasm/version.rb:2
