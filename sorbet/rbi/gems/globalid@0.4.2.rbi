...
class GlobalID
  ...
  class << self
    def app; end
    def app=(app); end
    def create(model, options = _); end
    def eager_load!; end
    def find(gid, options = _); end
    def parse(gid, options = _); end
...
module GlobalID::Locator
  class << self
    def locate(gid, options = _); end
    def locate_many(gids, options = _); end
    def locate_many_signed(sgids, options = _); end
    def locate_signed(sgid, options = _); end
    def use(app, locator = _, &locator_block); end

    private

    def find_allowed?(model_class, only = _); end
    def locator_for(gid); end
    def normalize_app(app); end
    def parse_allowed(gids, only = _); end
  end
end
...
class URI::GID < ::URI::Generic
  ...
  class << self
    def build(args); end
    def create(app, model, params = _); end
    def parse(uri); end
