...
#
# source://hashdiff-VERSION/lib/hashdiff/util.rb:3
module Hashdiff
  class << self
    ...
    #
    # source://hashdiff-VERSION/lib/hashdiff/diff.rb:31
    ...
    # @return [Boolean]
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:108
    ...
    # @private
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:86
    ...
    # @private
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:25
    ...
    # @private
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:36
    ...
    # @private
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:119
    ...
    # @private
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:58
    ...
    # @yield [path, value1, value2] Optional block is used to compare each value, instead of default #==. If the block returns value other than true of false, then other specified comparison options will be used to do the comparison.
    #
    # source://hashdiff-VERSION/lib/hashdiff/diff.rb:78
    ...
    # @yield [links]
    #
    # source://hashdiff-VERSION/lib/hashdiff/diff.rb:119
    ...
    # @private
    #
    # source://hashdiff-VERSION/lib/hashdiff/lcs.rb:8
    ...
    # @private
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:75
    ...
    # @since 0.0.1
    #
    # source://hashdiff-VERSION/lib/hashdiff/patch.rb:17
    def patch!(obj, changes, options = T.unsafe(nil)); end

    # source://hashdiff-VERSION/lib/hashdiff/util.rb:137
    def prefix_append_array_index(prefix, array_index, opts); end

    # source://hashdiff-VERSION/lib/hashdiff/util.rb:129
    ...
    # @return [Boolean]
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:7
    ...
    # @since 0.0.1
    #
    # source://hashdiff-VERSION/lib/hashdiff/patch.rb:58
    ...
    # @return [Boolean]
    #
    # source://hashdiff-VERSION/lib/hashdiff/util.rb:151
...
# @private
#
# source://hashdiff-VERSION/lib/hashdiff/compare_hashes.rb:6
class Hashdiff::CompareHashes
  class << self
    # source://hashdiff-VERSION/lib/hashdiff/compare_hashes.rb:8
...
# @private
#
# source://hashdiff-VERSION/lib/hashdiff/lcs_compare_arrays.rb:6
class Hashdiff::LcsCompareArrays
  class << self
    # source://hashdiff-VERSION/lib/hashdiff/lcs_compare_arrays.rb:8
    def call(obj1, obj2, opts = T.unsafe(nil)); end
  end
end
...
# @private
#
# source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:8
class Hashdiff::LinearCompareArray
  # @return [LinearCompareArray] a new instance of LinearCompareArray
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:45
  def initialize(old_array, new_array, options); end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:14
  def call; end
  ...
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:42
  def additions; end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:139
  def append_addition(item, index); end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:123
  def append_addititions_before_match(match_index); end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:144
  def append_deletion(item, index); end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:131
  def append_deletions_before_match(match_index); end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:149
  def append_differences(difference); end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:153
  def changes; end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:67
  ...
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:43
  ...
  # @return [Boolean]
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:59
  def extra_items_in_new_array?; end

  # @return [Boolean]
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:55
  ...
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:89
  ...
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:107
  def index_of_match_after_deletions; end

  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:82
  def item_difference(old_item, new_item, item_index); end

  # @return [Boolean]
  #
  # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:63
  ...
  class << self
    # source://hashdiff-VERSION/lib/hashdiff/linear_compare_array.rb:9
    def call(old_array, new_array, options = T.unsafe(nil)); end
  end
end

# source://hashdiff-VERSION/lib/hashdiff/version.rb:4
