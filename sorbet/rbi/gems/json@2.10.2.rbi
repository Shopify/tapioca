...
module JSON
  ...
  #
  # source://json//lib/json/common.rb#368
  ...
  # I want to deprecate these later, so I'll first be silent about them, and later delete them.
  #
  # source://json//lib/json/common.rb#423
  ...
  # source://json//lib/json/common.rb#781
  ...
  # later delete them.
  #
  # source://json//lib/json/common.rb#340
  ...
  class << self
    ...
    # I want to deprecate these later, so I'll first be silent about them, and later delete them.
    #
    # source://json//lib/json/common.rb#369
    def fast_unparse(obj, opts = T.unsafe(nil)); end
    ...
    # source://json//lib/json/common.rb#782
    def restore(source, proc = T.unsafe(nil), options = T.unsafe(nil)); end
...
class JSON::Coder
  ...
  # Serialize the given object into a \JSON document.
  #
  # source://json//lib/json/common.rb#916
