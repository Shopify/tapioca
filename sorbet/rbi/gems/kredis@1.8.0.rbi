...
# pkg:gem/kredis#lib/kredis/version.rb:1
module Kredis
  ...
  # pkg:gem/kredis#lib/kredis.rb:31
  def instrument(channel, **options, &block); end

  # pkg:gem/kredis#lib/kredis.rb:25
  def logger; end

  # pkg:gem/kredis#lib/kredis.rb:25
  def logger=(val); end

  # pkg:gem/kredis#lib/kredis.rb:27
...
# pkg:gem/kredis#lib/kredis/attributes.rb:3
module Kredis::Attributes
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:123
  def enrich_after_change_with_record_access(type, original_after_change); end

  # pkg:gem/kredis#lib/kredis/attributes.rb:119
  def extract_kredis_id; end

  # pkg:gem/kredis#lib/kredis/attributes.rb:130
  def kredis_default_evaluated(default); end

  # pkg:gem/kredis#lib/kredis/attributes.rb:107
  def kredis_key_evaluated(key); end

  # pkg:gem/kredis#lib/kredis/attributes.rb:115
  def kredis_key_for_attribute(name); end
end

# pkg:gem/kredis#lib/kredis/attributes.rb:6
module Kredis::Attributes::ClassMethods
  # pkg:gem/kredis#lib/kredis/attributes.rb:83
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:71
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:23
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:19
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:35
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:79
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:15
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:43
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:59
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:51
  ...
  # pkg:gem/kredis#lib/kredis/attributes.rb:88
  def kredis_connection_with(method, name, key, **options); end
end

# pkg:gem/kredis#lib/kredis/connections.rb:5
module Kredis::Connections
  # pkg:gem/kredis#lib/kredis/connections.rb:25
  def clear_all; end

  # pkg:gem/kredis#lib/kredis/connections.rb:10
  def configurator; end

  # pkg:gem/kredis#lib/kredis/connections.rb:10
  def configurator=(val); end

  # pkg:gem/kredis#lib/kredis/connections.rb:13
  def configured_for(name); end

  # pkg:gem/kredis#lib/kredis/connections.rb:9
  def connections; end

  # pkg:gem/kredis#lib/kredis/connections.rb:9
  def connections=(val); end

  # pkg:gem/kredis#lib/kredis/connections.rb:11
  def connector; end
...
# pkg:gem/kredis#lib/kredis/connections.rb:7
Kredis::Connections::DEFAULT_REDIS_TIMEOUT = T.let(T.unsafe(nil), Integer)

# pkg:gem/kredis#lib/kredis/connections.rb:6
Kredis::Connections::DEFAULT_REDIS_URL = T.let(T.unsafe(nil), String)

# pkg:gem/kredis#lib/kredis/default_values.rb:3
module Kredis::DefaultValues
  extend ::ActiveSupport::Concern

  # pkg:gem/kredis#lib/kredis/default_values.rb:25
  def initialize(*_arg0, **_arg1, &_arg2); end
end

# pkg:gem/kredis#lib/kredis/log_subscriber.rb:5
class Kredis::LogSubscriber < ::ActiveSupport::LogSubscriber
  # pkg:gem/kredis#lib/kredis/log_subscriber.rb:14
  def meta(event); end

  # pkg:gem/kredis#lib/kredis/log_subscriber.rb:10
  def migration(event); end

  # pkg:gem/kredis#lib/kredis/log_subscriber.rb:6
  def proxy(event); end

  private

  # pkg:gem/kredis#lib/kredis/log_subscriber.rb:19
...
class Kredis::Migration
  ...
  # pkg:gem/kredis#lib/kredis/migration.rb:35
  def delete_all(*key_patterns); end

  # pkg:gem/kredis#lib/kredis/migration.rb:23
  def migrate(from:, to:, pipeline: T.unsafe(nil)); end

  # pkg:gem/kredis#lib/kredis/migration.rb:14
  def migrate_all(key_pattern); end

  private

  # pkg:gem/kredis#lib/kredis/migration.rb:50
  def each_key_batch_matching(key_pattern, &block); end

  # pkg:gem/kredis#lib/kredis/migration.rb:58
  def log_migration(message, &block); end

  class << self
    # pkg:gem/kredis#lib/kredis/migration.rb:6
...
# pkg:gem/kredis#lib/kredis/migration.rb:48
...
module Kredis::Namespace
  ...
  # pkg:gem/kredis#lib/kredis/namespace.rb:6
  def namespace; end

  # Backward compatibility
  #
  # pkg:gem/kredis#lib/kredis/namespace.rb:27
  def namespace=(value); end

  # pkg:gem/kredis#lib/kredis/namespace.rb:29
  def namespaced_key(key); end

  # pkg:gem/kredis#lib/kredis/namespace.rb:18
  def thread_namespace; end

  # pkg:gem/kredis#lib/kredis/namespace.rb:22
  def thread_namespace=(value); end
end

# pkg:gem/kredis#lib/kredis/railtie.rb:3
class Kredis::Railtie < ::Rails::Railtie; end

# pkg:gem/kredis#lib/kredis/type/boolean.rb:4
module Kredis::Type; end

# pkg:gem/kredis#lib/kredis/type/boolean.rb:5
class Kredis::Type::Boolean < ::ActiveModel::Type::Boolean
  # pkg:gem/kredis#lib/kredis/type/boolean.rb:6
  def serialize(value); end
end

# pkg:gem/kredis#lib/kredis/type/datetime.rb:5
class Kredis::Type::DateTime < ::ActiveModel::Type::DateTime
  # pkg:gem/kredis#lib/kredis/type/datetime.rb:10
  def cast_value(value); end

  # pkg:gem/kredis#lib/kredis/type/datetime.rb:6
  def serialize(value); end
end

# pkg:gem/kredis#lib/kredis/type/json.rb:5
class Kredis::Type::Json < ::ActiveModel::Type::Value
  # pkg:gem/kredis#lib/kredis/type/json.rb:10
  def cast_value(value); end

  # pkg:gem/kredis#lib/kredis/type/json.rb:14
  def serialize(value); end

  # pkg:gem/kredis#lib/kredis/type/json.rb:6
  def type; end
end
...
module Kredis::Types
  ...
  # pkg:gem/kredis#lib/kredis/types.rb:6
  def proxy(key, config: T.unsafe(nil), after_change: T.unsafe(nil)); end

  # pkg:gem/kredis#lib/kredis/types.rb:11
  ...
  # pkg:gem/kredis#lib/kredis/types.rb:93
...
class Kredis::Types::CallbacksProxy
  ...
  # pkg:gem/kredis#lib/kredis/types/callbacks_proxy.rb:24
  ...
  # pkg:gem/kredis#lib/kredis/types/callbacks_proxy.rb:31
  def invoke_suitable_after_change_callback_for(method); end
end

# pkg:gem/kredis#lib/kredis/types/callbacks_proxy.rb:7
Kredis::Types::CallbacksProxy::AFTER_CHANGE_OPERATIONS = T.let(T.unsafe(nil), Hash)

# pkg:gem/kredis#lib/kredis/types/counter.rb:3
class Kredis::Types::Counter < ::Kredis::Types::Proxying
  include ::Kredis::DefaultValues

  # pkg:gem/kredis#lib/kredis/types/counter.rb:6
  def decrby(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/counter.rb:17
  ...
  # pkg:gem/kredis#lib/kredis/types/counter.rb:10
  def increment(by: T.unsafe(nil)); end

  # pkg:gem/kredis#lib/kredis/types/counter.rb:6
  def multi(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/counter.rb:28
  def reset; end
  ...
  # pkg:gem/kredis#lib/kredis/types/counter.rb:24
  def value; end
...
# pkg:gem/kredis#lib/kredis/types/cycle.rb:3
class Kredis::Types::Cycle < ::Kredis::Types::Counter
  # pkg:gem/kredis#lib/kredis/types/cycle.rb:6
  def index; end

  # pkg:gem/kredis#lib/kredis/types/cycle.rb:12
  def next; end
...
# pkg:gem/kredis#lib/kredis/types/enum.rb:5
class Kredis::Types::Enum < ::Kredis::Types::Proxying
  ...
  # pkg:gem/kredis#lib/kredis/types/enum.rb:6
  def default; end

  # pkg:gem/kredis#lib/kredis/types/enum.rb:6
  def default=(_arg0); end

  # pkg:gem/kredis#lib/kredis/types/enum.rb:10
  def del(*_arg0, **_arg1, &_arg2); end
  ...
  # pkg:gem/kredis#lib/kredis/types/enum.rb:29
  def reset; end
  ...
  # pkg:gem/kredis#lib/kredis/types/enum.rb:25
  def value; end
  ...
  # pkg:gem/kredis#lib/kredis/types/enum.rb:37
...
# pkg:gem/kredis#lib/kredis/types/enum.rb:8
class Kredis::Types::Enum::InvalidDefault < ::StandardError; end

# pkg:gem/kredis#lib/kredis/types/flag.rb:3
class Kredis::Types::Flag < ::Kredis::Types::Proxying
  ...
  # pkg:gem/kredis#lib/kredis/types/flag.rb:6
  def del(*_arg0, **_arg1, &_arg2); end
  ...
  # pkg:gem/kredis#lib/kredis/types/flag.rb:18
  def remove; end
...
# pkg:gem/kredis#lib/kredis/types/hash.rb:5
class Kredis::Types::Hash < ::Kredis::Types::Proxying
  include ::Kredis::DefaultValues

  # pkg:gem/kredis#lib/kredis/types/hash.rb:12
  def [](key); end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:16
  def []=(key, value); end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:35
  def clear; end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:6
  def default; end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:6
  def default=(_arg0); end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:8
  def del(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:28
  def delete(*keys); end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:37
  def entries; end
  ...
  # pkg:gem/kredis#lib/kredis/types/hash.rb:42
  def keys; end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:32
  def remove; end
  ...
  # pkg:gem/kredis#lib/kredis/types/hash.rb:20
  def update(**entries); end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:46
  def values; end

  # pkg:gem/kredis#lib/kredis/types/hash.rb:24
...
class Kredis::Types::Limiter < ::Kredis::Types::Counter
  ...
  # pkg:gem/kredis#lib/kredis/types/limiter.rb:13
  def poke; end
end

# pkg:gem/kredis#lib/kredis/types/limiter.rb:9
class Kredis::Types::Limiter::LimitExceeded < ::StandardError; end

# pkg:gem/kredis#lib/kredis/types/list.rb:3
class Kredis::Types::List < ::Kredis::Types::Proxying
  include ::Kredis::DefaultValues

  # pkg:gem/kredis#lib/kredis/types/list.rb:26
  def <<(*elements); end

  # pkg:gem/kredis#lib/kredis/types/list.rb:23
  def append(*elements); end

  # pkg:gem/kredis#lib/kredis/types/list.rb:28
  def clear; end

  # pkg:gem/kredis#lib/kredis/types/list.rb:4
  def default; end

  # pkg:gem/kredis#lib/kredis/types/list.rb:4
  def default=(_arg0); end

  # pkg:gem/kredis#lib/kredis/types/list.rb:6
  def del(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/list.rb:10
  def elements; end

  # pkg:gem/kredis#lib/kredis/types/list.rb:4
  def exists?(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/list.rb:32
  ...
  # pkg:gem/kredis#lib/kredis/types/list.rb:19
  def prepend(*elements); end

  # pkg:gem/kredis#lib/kredis/types/list.rb:15
...
# pkg:gem/kredis#lib/kredis/types/ordered_set.rb:3
class Kredis::Types::OrderedSet < ::Kredis::Types::Proxying
  include ::Kredis::DefaultValues

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:31
  def <<(elements); end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:28
  def append(elements); end
  ...
  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:6
  def del(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:11
  def elements; end
  ...
  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:33
  def limit=(limit); end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:6
  def multi(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:24
  def prepend(elements); end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:16
  def remove(*elements); end
  ...
  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:62
  def base_score; end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:40
  def insert(elements, prepending: T.unsafe(nil)); end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:66
  def process_start_time; end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:70
  def process_uptime; end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:4
  def set_default; end

  # pkg:gem/kredis#lib/kredis/types/ordered_set.rb:74
  def trim(from_beginning:); end
end

# pkg:gem/kredis#lib/kredis/types/proxy.rb:3
class Kredis::Types::Proxy
  ...
  # pkg:gem/kredis#lib/kredis/types/proxy.rb:35
  def method_missing(method, *args, **kwargs); end

  # pkg:gem/kredis#lib/kredis/types/proxy.rb:16
  def multi(*args, **kwargs, &block); end

  # pkg:gem/kredis#lib/kredis/types/proxy.rb:9
  def pipeline; end

  # pkg:gem/kredis#lib/kredis/types/proxy.rb:9
  def pipeline=(obj); end

  # pkg:gem/kredis#lib/kredis/types/proxy.rb:31
  def unwatch; end

  # pkg:gem/kredis#lib/kredis/types/proxy.rb:25
  def watch(&block); end

  private

  # pkg:gem/kredis#lib/kredis/types/proxy.rb:48
  def log_message(method, *args, **kwargs); end

  # pkg:gem/kredis#lib/kredis/types/proxy.rb:44
  def redis; end
...
# pkg:gem/kredis#lib/kredis/types/proxy/failsafe.rb:3
module Kredis::Types::Proxy::Failsafe
  # pkg:gem/kredis#lib/kredis/types/proxy/failsafe.rb:4
  def initialize(*_arg0); end

  # pkg:gem/kredis#lib/kredis/types/proxy/failsafe.rb:9
  def failsafe; end

  # pkg:gem/kredis#lib/kredis/types/proxy/failsafe.rb:15
...
class Kredis::Types::Proxying
  ...
  # pkg:gem/kredis#lib/kredis/types/proxying.rb:30
  ...
  # pkg:gem/kredis#lib/kredis/types/proxying.rb:23
  def unproxied_redis; end

  class << self
    # pkg:gem/kredis#lib/kredis/types/proxying.rb:8
    def proxying(*commands); end
  end
end

# pkg:gem/kredis#lib/kredis/types/scalar.rb:3
class Kredis::Types::Scalar < ::Kredis::Types::Proxying
  ...
  # pkg:gem/kredis#lib/kredis/types/scalar.rb:32
  def clear; end

  # pkg:gem/kredis#lib/kredis/types/scalar.rb:4
  def default; end
  ...
  # pkg:gem/kredis#lib/kredis/types/scalar.rb:40
  def expire_at(datetime); end

  # pkg:gem/kredis#lib/kredis/types/scalar.rb:36
  ...
  # pkg:gem/kredis#lib/kredis/types/scalar.rb:14
  def value; end

  # pkg:gem/kredis#lib/kredis/types/scalar.rb:10
  def value=(value); end
...
# pkg:gem/kredis#lib/kredis/types/set.rb:3
class Kredis::Types::Set < ::Kredis::Types::Proxying
  include ::Kredis::DefaultValues

  # pkg:gem/kredis#lib/kredis/types/set.rb:21
  def <<(*members); end

  # pkg:gem/kredis#lib/kredis/types/set.rb:18
  def add(*members); end

  # pkg:gem/kredis#lib/kredis/types/set.rb:46
  def clear; end
  ...
  # pkg:gem/kredis#lib/kredis/types/set.rb:6
  def del(*_arg0, **_arg1, &_arg2); end
  ...
  # pkg:gem/kredis#lib/kredis/types/set.rb:13
  def members; end

  # pkg:gem/kredis#lib/kredis/types/set.rb:9
  def move(set, member); end

  # pkg:gem/kredis#lib/kredis/types/set.rb:6
  def multi(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/set.rb:23
  def remove(*members); end

  # pkg:gem/kredis#lib/kredis/types/set.rb:27
  def replace(*members); end

  # pkg:gem/kredis#lib/kredis/types/set.rb:6
  def sadd(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/kredis#lib/kredis/types/set.rb:50
  ...
  # pkg:gem/kredis#lib/kredis/types/set.rb:38
  def size; end
  ...
  # pkg:gem/kredis#lib/kredis/types/set.rb:42
  def take; end
...
class Kredis::Types::Slots < ::Kredis::Types::Proxying
  ...
  # pkg:gem/kredis#lib/kredis/types/slots.rb:6
  ...
  # pkg:gem/kredis#lib/kredis/types/slots.rb:34
  def release; end

  # pkg:gem/kredis#lib/kredis/types/slots.rb:10
  def reserve; end

  # pkg:gem/kredis#lib/kredis/types/slots.rb:49
  def reset; end

  # pkg:gem/kredis#lib/kredis/types/slots.rb:53
  def taken; end
end

# pkg:gem/kredis#lib/kredis/types/slots.rb:4
class Kredis::Types::Slots::NotAvailable < ::StandardError; end

# You'd normally call this a set, but Redis already has another data type for that
#
# pkg:gem/kredis#lib/kredis/types/unique_list.rb:4
class Kredis::Types::UniqueList < ::Kredis::Types::List
  # pkg:gem/kredis#lib/kredis/types/unique_list.rb:30
  def <<(elements); end

  # pkg:gem/kredis#lib/kredis/types/unique_list.rb:20
  def append(elements); end
...
# pkg:gem/kredis#lib/kredis/version.rb:2
