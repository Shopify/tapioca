...
module CodeRay
  ...
  def self.encode(code, lang, format, options = _); end
  def self.encode_file(filename, format, options = _); end
  def self.encode_tokens(tokens, format, options = _); end
  def self.encoder(format, options = _); end
  def self.get_scanner_options(options); end
  def self.highlight(code, lang, options = _, format = _); end
  def self.highlight_file(filename, options = _, format = _); end
  def self.scan(code, lang, options = _, &block); end
  def self.scan_file(filename, lang = _, options = _, &block); end
  def self.scanner(lang, options = _, &block); end
end

CodeRay::CODERAY_PATH = T.let(T.unsafe(nil), String)

class CodeRay::Duo
  def initialize(lang = _, format = _, options = _); end

  def call(code, options = _); end
  def encode(code, options = _); end
  def encoder; end
  def format; end
  def format=(_); end
  def highlight(code, options = _); end
  def lang; end
  def lang=(_); end
  def options; end
  def options=(_); end
...
class CodeRay::Encoders::Encoder
  ...
  def encode(code, lang, options = _); end
  def encode_tokens(tokens, options = _); end
  def end_group(kind); end
  def end_line(kind); end
  def file_extension; end
  def highlight(code, lang, options = _); end
  def options; end
  def options=(_); end
  def scanner; end
  def scanner=(_); end
  ...
  def tokens(tokens, options = _); end

  protected

  def compile(tokens, options = _); end
...
module CodeRay::FileType
  def self.[](filename, read_shebang = _); end
  def self.fetch(filename, default = _, read_shebang = _); end
end
...
module CodeRay::Plugin
  def aliases; end
  def plugin_host(host = _); end
  def plugin_id; end
  def register_for(id); end
  def title(title = _); end
end
...
class CodeRay::Scanners::Scanner < ::StringScanner
  ...
  def initialize(code = _, options = _); end

  def binary_string; end
  def column(pos = _); end
  def each(&block); end
  def file_extension; end
  def lang; end
  def line(pos = _); end
  ...
  def state=(_); end
  def string=(code); end
  def tokenize(source = _, options = _); end
  def tokens; end

  protected

  def raise_inspect(message, tokens, state = _, ambit = _, backtrace = _); end
  ...
  def self.encoding(name = _); end
  def self.file_extension(extension = _); end
  def self.lang; end
...
class CodeRay::Tokens < ::Array
  ...
  def begin_line(kind); end
  def count; end
  def encode(encoder, options = _); end
  def end_group(kind); end
  def end_line(kind); end
  def method_missing(meth, options = _); end
  def scanner; end
  def scanner=(_); end
...
class CodeRay::TokensProxy
  def initialize(input, lang, options = _, block = _); end
...
class CodeRay::Encoders::HTML::CSS
  ...
  def self.load_stylesheet(style = _); end
end
...
module CodeRay::Encoders::HTML::Numbering
  def self.number!(output, mode = _, options = _); end
end
...
class CodeRay::Scanners::HTML < ::CodeRay::Scanners::Scanner
  ...
  def scan_css(encoder, code, state = _); end
...
class CodeRay::Scanners::Ruby::StringState < ::Struct
  def initialize(kind, interpreted, delim, heredoc = _); end
