...
module CodeRay
  class << self
    ...
    def encode(code, lang, format, options = _); end
    def encode_file(filename, format, options = _); end
    def encode_tokens(tokens, format, options = _); end
    def encoder(format, options = _); end
    def get_scanner_options(options); end
    def highlight(code, lang, options = _, format = _); end
    def highlight_file(filename, options = _, format = _); end
    def scan(code, lang, options = _, &block); end
    def scan_file(filename, lang = _, options = _, &block); end
    def scanner(lang, options = _, &block); end
  end
end
...
module CodeRay::FileType
  class << self
    def [](filename, read_shebang = _); end
    def fetch(filename, default = _, read_shebang = _); end
...
class CodeRay::Scanners::Scanner < ::StringScanner
  ...
  class << self
    def encoding(name = _); end
    def file_extension(extension = _); end
    def lang; end
...
class CodeRay::Encoders::HTML::CSS
  ...
  class << self
    def load_stylesheet(style = _); end
  end
end
...
module CodeRay::Encoders::HTML::Numbering
  class << self
    def number!(output, mode = _, options = _); end
  end
end
...
module CodeRay::Encoders::HTML::Output
  ...
  class << self
    def extended(o); end
    def make_stylesheet(css, in_tag = _); end
