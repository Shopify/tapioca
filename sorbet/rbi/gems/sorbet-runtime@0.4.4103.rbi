...
module T::Configuration
  def self.call_validation_error_handler; end
  def self.call_validation_error_handler=(value); end
  def self.inline_type_error_handler; end
  def self.inline_type_error_handler=(value); end
  def self.sig_builder_error_handler; end
  def self.sig_builder_error_handler=(value); end
  def self.sig_validation_error_handler; end
...
T::Props::Constants::SCALAR_TYPES = T.let(T.unsafe(nil), Set)
...
class T::Private::Methods::Signature
  def initialize(method:, method_name:, raw_arg_types:, raw_return_type:, bind:, mode:, check_level:, soft_notify:, parameters: _, generated: _, override_allow_incompatible: _); end
