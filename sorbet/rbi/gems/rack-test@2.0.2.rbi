...
# :nocov:
#
# source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:6
module Rack
  class << self
...
# source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:7
module Rack::Test
  class << self
    ...
    # @return [Boolean]
    #
    # source://rack-test-VERSION/lib/rack/test.rb:407
...
#
# source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:10
class Rack::Test::Cookie
  include ::Rack::Utils

  # @return [Cookie] a new instance of Cookie
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:23
  def initialize(raw, uri = T.unsafe(nil), default_host = T.unsafe(nil)); end

  # Order cookies by name, path, and domain.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:107
  def <=>(other); end

  # The explicit or implicit domain for the cookie.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:58
  def domain; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:53
  def empty?; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:85
  def expired?; end

  # A Time value for when the cookie expires, if the expires option is set.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:80
  def expires; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:70
  def http_only?; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:102
  def matches?(uri); end

  # The name of the cookie, will be a string
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:14
  def name; end

  # The explicit or implicit path for the cookie.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:75
  def path; end

  # The raw string for the cookie, without options. Will generally be in
  # name=value format is name and value are provided.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:21
  def raw; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:48
  ...
  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:64
  def secure?; end

  # A hash of cookie options, including the cookie value, but excluding the cookie name.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:112
  def to_h; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:90
  def valid?(uri); end

  # The value of the cookie, will be a string or nil if there is no value.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:17
  def value; end
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:124
  def default_uri; end
end
...
#
# source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:133
class Rack::Test::CookieJar
  # @return [CookieJar] a new instance of CookieJar
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:136
  def initialize(cookies = T.unsafe(nil), default_host = T.unsafe(nil)); end

  # Add a Cookie to the cookie jar.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:192
  def <<(new_cookie); end

  # Return the value for first cookie with the given name, or nil
  # if no such cookie exists.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:143
  def [](name); end

  # Set a cookie with the given name and value in the
  # cookie jar.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:153
  def []=(name, value); end

  # Delete all cookies with the given name from the cookie jar.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:167
  def delete(name); end

  # Return a raw cookie string for the cookie header to
  # use for the given URI.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:203
  def for(uri); end

  # Return the first cookie with the given name, or nil if
  # no such cookie exists.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:159
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:177
  def merge(raw_cookies, uri = T.unsafe(nil)); end

  # Return a hash cookie names and cookie values for cookies in the jar.
  #
  # source://rack-test-VERSION/lib/rack/test/cookie_jar.rb:220
  def to_hash; end
...
#   end
#
# source://rack-test-VERSION/lib/rack/test/methods.rb:24
module Rack::Test::Methods
  extend ::Forwardable

  # Private accessor to avoid uninitialized instance variable warning in Ruby 2.*
  #
  # source://rack-test-VERSION/lib/rack/test/methods.rb:91
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/methods.rb:40
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/methods.rb:51
  ...
  # source://rack-test-VERSION/lib/rack/test/methods.rb:64
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/methods.rb:29
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/methods.rb:57
...
#
# source://rack-test-VERSION/lib/rack/test.rb:39
...
#
# source://rack-test-VERSION/lib/rack/test.rb:53
class Rack::Test::Session
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:200
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:125
  def clear_cookies; end

  # The Rack::Test::CookieJar for the cookies for the current session.
  #
  # source://rack-test-VERSION/lib/rack/test.rb:67
  def cookie_jar; end
  ...
  #   custom_request "LINK", "/"
  #
  # source://rack-test-VERSION/lib/rack/test.rb:162
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:70
  def default_host; end

  # source://rack-test-VERSION/lib/rack/test.rb:113
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:213
  def digest_authorize(username, password); end
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:187
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:226
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:175
  ...
  # @raise [Error]
  #
  # source://rack-test-VERSION/lib/rack/test.rb:136
  ...
  # @raise [Error]
  #
  # source://rack-test-VERSION/lib/rack/test.rb:143
  ...
  #   request "/"
  #
  # source://rack-test-VERSION/lib/rack/test.rb:152
  def request(uri, env = T.unsafe(nil), &block); end

  # Set a cookie in the current cookie jar.
  #
  # source://rack-test-VERSION/lib/rack/test.rb:130
  ...
  #
  # source://rack-test-VERSION/lib/rack/test.rb:355
  def process_request(uri, env); end

  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test.rb:395
  def retry_with_digest_auth?(env); end

  class << self
    # source://rack-test-VERSION/lib/rack/test.rb:57
    def new(app, default_host = T.unsafe(nil)); end
  end
end

# source://rack-test-VERSION/lib/rack/test.rb:277
...
#
# source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:14
class Rack::Test::UploadedFile
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:31
  ...
  # buffer.
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:58
  def append_to(buffer); end

  # The content type of the "uploaded" file
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:22
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:44
  def local_path; end

  # Delegate all methods not handled to the tempfile.
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:50
  def method_missing(method_name, *args, &block); end

  # The filename, *not* including the path, of the "uploaded" file
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:16
  ...
  # The tempfile
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:19
  def tempfile; end
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:94
  def initialize_from_file_path(path); end

  # Use the StringIO as the tempfile.
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:88
  def initialize_from_stringio(stringio, original_filename); end

  # @return [Boolean]
  #
  # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:69
  ...
  class << self
    ...
    #
    # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:80
    def actually_finalize(file); end

    # A proc that can be used as a finalizer to close and unlink the tempfile.
    #
    # source://rack-test-VERSION/lib/rack/test/uploaded_file.rb:74
    def finalize(file); end
  end
end

# source://rack-test-VERSION/lib/rack/test/utils.rb:5
module Rack::Test::Utils
  ...
  # @raise [ArgumentError]
  #
  # source://rack-test-VERSION/lib/rack/test/utils.rb:34
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/utils.rb:11
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/utils.rb:121
  ...
  #
  # source://rack-test-VERSION/lib/rack/test/utils.rb:62
  def normalize_multipart_params(params, first = T.unsafe(nil)); end
end

# source://rack-test-VERSION/lib/rack/test/version.rb:3
