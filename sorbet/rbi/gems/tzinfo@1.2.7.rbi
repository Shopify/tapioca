...
class TZInfo::CountryTimezone
  ...
  class << self
    def new(identifier, latitude, longitude, description = _); end
    def new!(*_); end
  end
end
...
module TZInfo::RubyCoreSupport
  class << self
    def datetime_new(y = _, m = _, d = _, h = _, min = _, s = _, of = _, sg = _); end
    def datetime_new!(ajd = _, of = _, sg = _); end
    def force_encoding(str, encoding); end
    def open_file(file_name, mode, opts, &block); end
    def rational_new!(numerator, denominator = _); end
