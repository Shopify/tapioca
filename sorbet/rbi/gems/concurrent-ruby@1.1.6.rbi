...
module Concurrent
  ...
  class << self
    ...
    def atomically; end
    def call_dataflow(method, executor, *inputs, &block); end
    def create_simple_logger(level = _, output = _); end
    def create_stdlib_logger(level = _, output = _); end
    def dataflow(*inputs, &block); end
    def dataflow!(*inputs, &block); end
    def dataflow_with(executor, *inputs, &block); end
    def dataflow_with!(executor, *inputs, &block); end
    ...
    def leave_transaction; end
    def monotonic_time; end
    def new_fast_executor(opts = _); end
    def new_io_executor(opts = _); end
    def physical_processor_count; end
    def processor_count; end
    def processor_counter; end
    def use_simple_logger(level = _, output = _); end
    def use_stdlib_logger(level = _, output = _); end
  end
end
...
module Concurrent::Options
  class << self
    def executor(executor_identifier); end
    def executor_from_options(opts = _); end
  end
end
...
class Concurrent::Promise < ::Concurrent::IVar
  ...
  class << self
    ...
    def execute(opts = _, &block); end
    def fulfill(value, opts = _); end
    def reject(reason, opts = _); end
...
class Concurrent::ScheduledTask < ::Concurrent::IVar
  ...
  class << self
    def execute(delay, opts = _, &task); end
  end
end
...
class Concurrent::Synchronization::Object < ::Concurrent::Synchronization::MriObject
  ...
  class << self
    ...
    def atomic_attributes(inherited = _); end
