...
class RBI::Tree < ::RBI::NodeWithComments
  ...
  sig { params(name: String, parameters: T::Array[RBI::TypedParam], return_type: String, class_method: T::Boolean, comments: T::Array[RBI::Comment]).void }
  def create_method(name, parameters: T.unsafe(nil), return_type: T.unsafe(nil), class_method: T.unsafe(nil), comments: T.unsafe(nil)); end
