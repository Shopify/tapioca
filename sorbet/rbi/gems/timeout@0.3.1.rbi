...
class Timeout::Request
  ...
  # @return [Boolean]
  #
  # source://timeout//timeout.rb#79
  def expired?(now); end

  # source://timeout//timeout.rb#92
  def finished; end
