...
class Spoom::Deadcode::Indexer < ::Spoom::Visitor
  ...
  sig do
    params(path: ::String, index: ::Spoom::Deadcode::Index, plugins: T::Array[::Spoom::Deadcode::Plugins::Base]).void
  end
...
class Spoom::Deadcode::Remover::NodeRemover
  ...
  sig do
    params(source: ::String, kind: T.nilable(::Spoom::Deadcode::Definition::Kind), location: ::Spoom::Location).void
  end
  ...
  sig do
    params(node: ::Prism::Node, send_context: ::Spoom::Deadcode::Remover::NodeContext, was_removed: T::Boolean).void
  end
...
class Spoom::Sorbet::Metrics::CodeMetricsVisitor < ::Spoom::Visitor
  ...
  sig do
    params(node: T.any(::Prism::ClassNode, ::Prism::ModuleNode, ::Prism::SingletonClassNode), block: T.proc.void).void
  end
