...
# quantities of docs.
#
# source://loofah-VERSION/lib/loofah/version.rb:2
module Loofah
  class << self
    # Shortcut for Loofah::HTML::Document.parse
    # This method accepts the same parameters as Nokogiri::HTML::Document.parse
    #
    # source://loofah-VERSION/lib/loofah.rb:35
    ...
    #
    # source://loofah-VERSION/lib/loofah.rb:57
    ...
    #
    # source://loofah-VERSION/lib/loofah.rb:63
...
#
# source://loofah-VERSION/lib/loofah/html5/safelist.rb:865
Loofah::HTML5::SafeList::VOID_ELEMENTS = T.let(T.unsafe(nil), Set)

# source://loofah-VERSION/lib/loofah/html5/scrub.rb:7
module Loofah::HTML5::Scrub
  class << self
    # @return [Boolean]
    #
    # source://loofah-VERSION/lib/loofah/html5/scrub.rb:16
    ...
    #
    # source://loofah-VERSION/lib/loofah/html5/scrub.rb:135
    def force_correct_attribute_escaping!(node); end

    # alternative implementation of the html5lib attribute scrubbing algorithm
    #
    # source://loofah-VERSION/lib/loofah/html5/scrub.rb:21
    def scrub_attributes(node); end

    # source://loofah-VERSION/lib/loofah/html5/scrub.rb:79
    def scrub_css(style); end

    # source://loofah-VERSION/lib/loofah/html5/scrub.rb:74
    def scrub_css_attribute(node); end
  end
end

# source://loofah-VERSION/lib/loofah/html5/scrub.rb:8
Loofah::HTML5::Scrub::CONTROL_CHARACTERS = T.let(T.unsafe(nil), Regexp)

# source://loofah-VERSION/lib/loofah/html5/scrub.rb:10
Loofah::HTML5::Scrub::CRASS_SEMICOLON = T.let(T.unsafe(nil), Hash)

# source://loofah-VERSION/lib/loofah/html5/scrub.rb:11
Loofah::HTML5::Scrub::CSS_IMPORTANT = T.let(T.unsafe(nil), String)

# source://loofah-VERSION/lib/loofah/html5/scrub.rb:9
Loofah::HTML5::Scrub::CSS_KEYWORDISH = T.let(T.unsafe(nil), Regexp)

# source://loofah-VERSION/lib/loofah/html5/scrub.rb:12
Loofah::HTML5::Scrub::CSS_PROPERTY_STRING_WITHOUT_EMBEDDED_QUOTES = T.let(T.unsafe(nil), Regexp)

# source://loofah-VERSION/lib/loofah/html5/scrub.rb:13
Loofah::HTML5::Scrub::DATA_ATTRIBUTE_NAME = T.let(T.unsafe(nil), Regexp)

# source://loofah-VERSION/lib/loofah/html5/safelist.rb:882
...
#
# source://loofah-VERSION/lib/loofah/html/document.rb:9
class Loofah::HTML::Document < ::Nokogiri::HTML4::Document
  include ::Loofah::ScrubBehavior::Node
  include ::Loofah::DocumentDecorator
  include ::Loofah::TextBehavior

  # source://loofah-VERSION/lib/loofah/html/document.rb:14
...
#  See Loofah::ScrubBehavior and Loofah::TextBehavior for additional methods.
#
# source://loofah-VERSION/lib/loofah/html/document_fragment.rb:9
class Loofah::HTML::DocumentFragment < ::Nokogiri::HTML4::DocumentFragment
  include ::Loofah::TextBehavior

  # Returns the HTML markup contained by the fragment
  #
  # source://loofah-VERSION/lib/loofah/html/document_fragment.rb:31
  def serialize; end

  # source://loofah-VERSION/lib/loofah/html/document_fragment.rb:37
  def serialize_root; end
  ...
  class << self
    ...
    #  parse a fragment.
    #
    # source://loofah-VERSION/lib/loofah/html/document_fragment.rb:18
...
#  ಠ_ಠ
#
# source://loofah-VERSION/lib/loofah/html5/libxml2_workarounds.rb:11
...
#  see comments about CVE-2018-8048 within the tests for more information
#
# source://loofah-VERSION/lib/loofah/html5/libxml2_workarounds.rb:19
Loofah::LibxmlWorkarounds::BROKEN_ESCAPING_ATTRIBUTES = T.let(T.unsafe(nil), Set)

# source://loofah-VERSION/lib/loofah/html5/libxml2_workarounds.rb:25
Loofah::LibxmlWorkarounds::BROKEN_ESCAPING_ATTRIBUTES_QUALIFYING_TAG = T.let(T.unsafe(nil), Hash)

# source://loofah-VERSION/lib/loofah/metahelpers.rb:3
module Loofah::MetaHelpers
  class << self
    # source://loofah-VERSION/lib/loofah/metahelpers.rb:4
...
#
# source://loofah-VERSION/lib/loofah/instance_methods.rb:30
module Loofah::ScrubBehavior
  class << self
    # source://loofah-VERSION/lib/loofah/instance_methods.rb:60
    def resolve_scrubber(scrubber); end
  end
end

# source://loofah-VERSION/lib/loofah/instance_methods.rb:31
module Loofah::ScrubBehavior::Node
  # source://loofah-VERSION/lib/loofah/instance_methods.rb:32
  def scrub!(scrubber); end
end

# source://loofah-VERSION/lib/loofah/instance_methods.rb:53
module Loofah::ScrubBehavior::NodeSet
  # source://loofah-VERSION/lib/loofah/instance_methods.rb:54
  def scrub!(scrubber); end
end
...
#
# source://loofah-VERSION/lib/loofah/scrubber.rb:34
class Loofah::Scrubber
  ...
  #
  # source://loofah-VERSION/lib/loofah/scrubber.rb:65
  def initialize(options = T.unsafe(nil), &block); end

  # If the attribute is not set, add it
  # If the attribute is set, don't overwrite the existing value
  #
  # source://loofah-VERSION/lib/loofah/scrubber.rb:94
  ...
  #
  # source://loofah-VERSION/lib/loofah/scrubber.rb:86
  def scrub(node); end
  ...
  #
  # source://loofah-VERSION/lib/loofah/scrubber.rb:78
  def traverse(node); end

  private

  # source://loofah-VERSION/lib/loofah/scrubber.rb:103
  def html5lib_sanitize(node); end

  # source://loofah-VERSION/lib/loofah/scrubber.rb:125
  def traverse_conditionally_bottom_up(node); end

  # source://loofah-VERSION/lib/loofah/scrubber.rb:116
...
#
# source://loofah-VERSION/lib/loofah/scrubber.rb:37
Loofah::Scrubber::CONTINUE = T.let(T.unsafe(nil), Object)

# Top-down Scrubbers may return STOP to indicate that the subtree should not be traversed.
#
# source://loofah-VERSION/lib/loofah/scrubber.rb:40
Loofah::Scrubber::STOP = T.let(T.unsafe(nil), Object)

# A RuntimeError raised when Loofah could not find an appropriate scrubber.
#
# source://loofah-VERSION/lib/loofah/scrubber.rb:6
...
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:86
module Loofah::Scrubbers
  class << self
    # Returns an array of symbols representing the built-in scrubbers
    #
    # source://loofah-VERSION/lib/loofah/scrubbers.rb:299
...
#     => "ohai! <div>div is safe</div> &lt;foo&gt;but foo is &lt;b&gt;not&lt;/b&gt;&lt;/foo&gt;"
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:143
class Loofah::Scrubbers::Escape < ::Loofah::Scrubber
  # @return [Escape] a new instance of Escape
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:144
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:148
  def scrub(node); end
end

# A hash that maps a symbol (like +:prune+) to the appropriate Scrubber (Loofah::Scrubbers::Prune).
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:285
Loofah::Scrubbers::MAP = T.let(T.unsafe(nil), Hash)

# This class probably isn't useful publicly, but is used for #to_text's current implemention
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:237
class Loofah::Scrubbers::NewlineBlockElements < ::Loofah::Scrubber
  ...
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:238
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:242
  def scrub(node); end
end
...
#     => "ohai! <a href='http://www.myswarmysite.com/' rel="nofollow">I like your blog post</a>"
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:203
class Loofah::Scrubbers::NoFollow < ::Loofah::Scrubber
  # @return [NoFollow] a new instance of NoFollow
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:204
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:208
  def scrub(node); end
end
...
#     => "ohai! <a href='http://www.myswarmysite.com/' rel="noopener">I like your blog post</a>"
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:224
class Loofah::Scrubbers::NoOpener < ::Loofah::Scrubber
  # @return [NoOpener] a new instance of NoOpener
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:225
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:229
  def scrub(node); end
end
...
#     => "ohai! <div>div is safe</div> "
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:122
class Loofah::Scrubbers::Prune < ::Loofah::Scrubber
  # @return [Prune] a new instance of Prune
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:123
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:127
  def scrub(node); end
end
...
#     => "ohai! <div>div is safe</div> but foo is <b>not</b>"
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:96
class Loofah::Scrubbers::Strip < ::Loofah::Scrubber
  # @return [Strip] a new instance of Strip
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:97
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:101
  def scrub(node); end
end
...
#     http://timelessrepo.com/json-isnt-a-javascript-subset
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:269
class Loofah::Scrubbers::Unprintable < ::Loofah::Scrubber
  # @return [Unprintable] a new instance of Unprintable
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:270
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:274
  def scrub(node); end
end
...
#  Certainly not me.
#
# source://loofah-VERSION/lib/loofah/scrubbers.rb:174
class Loofah::Scrubbers::Whitewash < ::Loofah::Scrubber
  # @return [Whitewash] a new instance of Whitewash
  #
  # source://loofah-VERSION/lib/loofah/scrubbers.rb:175
  def initialize; end

  # source://loofah-VERSION/lib/loofah/scrubbers.rb:179
  def scrub(node); end
end
...
#
# source://loofah-VERSION/lib/loofah/instance_methods.rb:73
module Loofah::TextBehavior
  ...
  #
  # source://loofah-VERSION/lib/loofah/instance_methods.rb:95
  ...
  #    # => "\nTitle\n\nContent\nNext line\n"
  #
  # source://loofah-VERSION/lib/loofah/instance_methods.rb:121
  def to_text(options = T.unsafe(nil)); end
end

# The version of Loofah you are using
#
# source://loofah-VERSION/lib/loofah/version.rb:4
Loofah::VERSION = T.let(T.unsafe(nil), String)

# source://loofah-VERSION/lib/loofah/xml/document.rb:3
...
#
# source://loofah-VERSION/lib/loofah/xml/document.rb:9
...
#
# source://loofah-VERSION/lib/loofah/xml/document_fragment.rb:9
class Loofah::XML::DocumentFragment < ::Nokogiri::XML::DocumentFragment
  class << self
    ...
    #  parse a fragment.
    #
    # source://loofah-VERSION/lib/loofah/xml/document_fragment.rb:16
    def parse(tags); end
  end
end
