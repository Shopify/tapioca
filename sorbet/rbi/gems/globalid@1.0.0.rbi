...
# source://globalid-VERSION/lib/global_id/global_id.rb:8
class GlobalID
  extend ::ActiveSupport::Autoload

  # @return [GlobalID] a new instance of GlobalID
  #
  # source://globalid-VERSION/lib/global_id/global_id.rb:51
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-VERSION/lib/global_id/global_id.rb:63
  def ==(other); end

  # source://globalid-VERSION/lib/global_id/global_id.rb:49
  def app(*_arg0, **_arg1, &_arg2); end

  # source://globalid-VERSION/lib/global_id/global_id.rb:63
  def eql?(other); end

  # source://globalid-VERSION/lib/global_id/global_id.rb:55
  def find(options = T.unsafe(nil)); end

  # source://globalid-VERSION/lib/global_id/global_id.rb:68
  def hash; end

  # source://globalid-VERSION/lib/global_id/global_id.rb:59
  def model_class; end
  ...
  # source://globalid-VERSION/lib/global_id/global_id.rb:72
  def to_param; end
  ...
  #
  # source://globalid-VERSION/lib/global_id/global_id.rb:48
  def uri; end

  class << self
    # Returns the value of attribute app.
    #
    # source://globalid-VERSION/lib/global_id/global_id.rb:10
    def app; end

    # source://globalid-VERSION/lib/global_id/global_id.rb:32
    def app=(app); end

    # source://globalid-VERSION/lib/global_id/global_id.rb:12
    def create(model, options = T.unsafe(nil)); end

    # source://globalid-VERSION/lib/global_id.rb:15
    def eager_load!; end

    # source://globalid-VERSION/lib/global_id/global_id.rb:22
    def find(gid, options = T.unsafe(nil)); end

    # source://globalid-VERSION/lib/global_id/global_id.rb:26
    def parse(gid, options = T.unsafe(nil)); end

    private

    # source://globalid-VERSION/lib/global_id/global_id.rb:37
    ...
    #
    # source://globalid-VERSION/lib/global_id/global_id.rb:42
    def repad_gid(gid); end
  end
end

# source://globalid-VERSION/lib/global_id/identification.rb:2
module GlobalID::Identification
  # source://globalid-VERSION/lib/global_id/identification.rb:3
  def to_gid(options = T.unsafe(nil)); end

  # source://globalid-VERSION/lib/global_id/identification.rb:8
  def to_gid_param(options = T.unsafe(nil)); end

  # source://globalid-VERSION/lib/global_id/identification.rb:3
  def to_global_id(options = T.unsafe(nil)); end

  # source://globalid-VERSION/lib/global_id/identification.rb:12
  def to_sgid(options = T.unsafe(nil)); end

  # source://globalid-VERSION/lib/global_id/identification.rb:17
...
# source://globalid-VERSION/lib/global_id/locator.rb:5
module GlobalID::Locator
  class << self
    ...
    #
    # source://globalid-VERSION/lib/global_id/locator.rb:15
    ...
    #
    # source://globalid-VERSION/lib/global_id/locator.rb:41
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-VERSION/lib/global_id/locator.rb:75
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-VERSION/lib/global_id/locator.rb:58
    ...
    # @raise [ArgumentError]
    #
    # source://globalid-VERSION/lib/global_id/locator.rb:99
    ...
    # @return [Boolean]
    #
    # source://globalid-VERSION/lib/global_id/locator.rb:112
    def find_allowed?(model_class, only = T.unsafe(nil)); end

    # source://globalid-VERSION/lib/global_id/locator.rb:108
    def locator_for(gid); end

    # source://globalid-VERSION/lib/global_id/locator.rb:120
    def normalize_app(app); end

    # source://globalid-VERSION/lib/global_id/locator.rb:116
    def parse_allowed(gids, only = T.unsafe(nil)); end
  end
end

# source://globalid-VERSION/lib/global_id/locator.rb:128
class GlobalID::Locator::BaseLocator
  # source://globalid-VERSION/lib/global_id/locator.rb:129
  def locate(gid); end

  # source://globalid-VERSION/lib/global_id/locator.rb:133
  def locate_many(gids, options = T.unsafe(nil)); end

  private

  # source://globalid-VERSION/lib/global_id/locator.rb:144
  def find_records(model_class, ids, options); end
end

# source://globalid-VERSION/lib/global_id/locator.rb:173
class GlobalID::Locator::BlockLocator
  # @return [BlockLocator] a new instance of BlockLocator
  #
  # source://globalid-VERSION/lib/global_id/locator.rb:174
  def initialize(block); end

  # source://globalid-VERSION/lib/global_id/locator.rb:178
  def locate(gid); end

  # source://globalid-VERSION/lib/global_id/locator.rb:182
  def locate_many(gids, options = T.unsafe(nil)); end
end

# source://globalid-VERSION/lib/global_id/locator.rb:171
GlobalID::Locator::DEFAULT_LOCATOR = T.let(T.unsafe(nil), GlobalID::Locator::UnscopedLocator)

# source://globalid-VERSION/lib/global_id/locator.rb:153
class GlobalID::Locator::UnscopedLocator < ::GlobalID::Locator::BaseLocator
  # source://globalid-VERSION/lib/global_id/locator.rb:154
  def locate(gid); end

  private

  # source://globalid-VERSION/lib/global_id/locator.rb:159
  def find_records(model_class, ids, options); end

  # source://globalid-VERSION/lib/global_id/locator.rb:163
  def unscoped(model_class); end
end

# source://globalid-VERSION/lib/global_id/railtie.rb:13
class GlobalID::Railtie < ::Rails::Railtie; end

# source://globalid-VERSION/lib/global_id/verifier.rb:5
class GlobalID::Verifier < ::ActiveSupport::MessageVerifier
  private

  # source://globalid-VERSION/lib/global_id/verifier.rb:11
  def decode(data); end

  # source://globalid-VERSION/lib/global_id/verifier.rb:7
  def encode(data); end
end

# source://globalid-VERSION/lib/global_id/signed_global_id.rb:5
class SignedGlobalID < ::GlobalID
  # @return [SignedGlobalID] a new instance of SignedGlobalID
  #
  # source://globalid-VERSION/lib/global_id/signed_global_id.rb:51
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-VERSION/lib/global_id/signed_global_id.rb:69
  def ==(other); end

  # Returns the value of attribute expires_at.
  #
  # source://globalid-VERSION/lib/global_id/signed_global_id.rb:49
  def expires_at; end
  ...
  # source://globalid-VERSION/lib/global_id/signed_global_id.rb:63
  def to_h; end

  # source://globalid-VERSION/lib/global_id/signed_global_id.rb:58
  def to_param; end
  ...
  # source://globalid-VERSION/lib/global_id/signed_global_id.rb:74
  def encoded_expiration; end

  # source://globalid-VERSION/lib/global_id/signed_global_id.rb:78
  def pick_expiration(options); end

  class << self
    # Returns the value of attribute expires_in.
    #
    # source://globalid-VERSION/lib/global_id/signed_global_id.rb:23
    def expires_in; end
    ...
    # source://globalid-VERSION/lib/global_id/signed_global_id.rb:11
    def parse(sgid, options = T.unsafe(nil)); end

    # source://globalid-VERSION/lib/global_id/signed_global_id.rb:27
    ...
    #
    # source://globalid-VERSION/lib/global_id/signed_global_id.rb:17
    def pick_verifier(options); end

    # Returns the value of attribute verifier.
    #
    # source://globalid-VERSION/lib/global_id/signed_global_id.rb:9
    def verifier; end
    ...
    # source://globalid-VERSION/lib/global_id/signed_global_id.rb:42
    def raise_if_expired(expires_at); end

    # source://globalid-VERSION/lib/global_id/signed_global_id.rb:32
    def verify(sgid, options); end
  end
end

# source://globalid-VERSION/lib/global_id/signed_global_id.rb:6
class SignedGlobalID::ExpiredMessage < ::StandardError; end

# source://globalid-VERSION/lib/global_id/uri/gid.rb:6
module URI
  include ::URI::RFC2396_REGEXP
end

# source://globalid-VERSION/lib/global_id/uri/gid.rb:27
class URI::GID < ::URI::Generic
  ...
  #
  # source://globalid-VERSION/lib/global_id/uri/gid.rb:29
  def model_id; end
  ...
  # source://globalid-VERSION/lib/global_id/uri/gid.rb:96
  def to_s; end
  ...
  #
  # source://globalid-VERSION/lib/global_id/uri/gid.rb:108
  def query=(query); end

  # source://globalid-VERSION/lib/global_id/uri/gid.rb:119
  def set_params(params); end

  # source://globalid-VERSION/lib/global_id/uri/gid.rb:102
  def set_path(path); end

  # Ruby 2.1 or less uses #set_query to assign the query
  #
  # source://globalid-VERSION/lib/global_id/uri/gid.rb:114
  def set_query(query); end

  private

  # source://globalid-VERSION/lib/global_id/uri/gid.rb:129
  def check_host(host); end

  # source://globalid-VERSION/lib/global_id/uri/gid.rb:134
  def check_path(path); end

  # source://globalid-VERSION/lib/global_id/uri/gid.rb:139
  def check_scheme(scheme); end

  # source://globalid-VERSION/lib/global_id/uri/gid.rb:171
  def parse_query_params(query); end

  # source://globalid-VERSION/lib/global_id/uri/gid.rb:147
  def set_model_components(path, validate = T.unsafe(nil)); end

  # @raise [URI::InvalidComponentError]
  #
  # source://globalid-VERSION/lib/global_id/uri/gid.rb:157
  def validate_component(component); end

  # @raise [MissingModelIdError]
  #
  # source://globalid-VERSION/lib/global_id/uri/gid.rb:164
  ...
  class << self
    ...
    #
    # source://globalid-VERSION/lib/global_id/uri/gid.rb:83
    def build(args); end
    ...
    #
    # source://globalid-VERSION/lib/global_id/uri/gid.rb:67
    ...
    #
    # source://globalid-VERSION/lib/global_id/uri/gid.rb:59
    def parse(uri); end
