...
module Nokogiri
  class << self
    def HTML(thing, url = _, encoding = _, options = _, &block); end
    def Slop(*args, &block); end
    def XML(thing, url = _, encoding = _, options = _, &block); end
    def XSLT(stylesheet, modules = _); end
    def install_default_aliases; end
    def jruby?; end
    def make(input = _, opts = _, &blk); end
    def parse(string, url = _, encoding = _, options = _); end
    def uses_libxml?; end
  end
end
...
module Nokogiri::CSS
  class << self
    ...
    def xpath_for(selector, options = _); end
  end
end
...
module Nokogiri::HTML
  class << self
    def fragment(string, encoding = _); end
    def parse(thing, url = _, encoding = _, options = _, &block); end
  end
end
...
class Nokogiri::HTML::Document < ::Nokogiri::XML::Document
  ...
  class << self
    def new(*_); end
    def parse(string_or_io, url = _, encoding = _, options = _); end
...
module Nokogiri::XML
  class << self
    def Reader(string_or_io, url = _, encoding = _, options = _); end
...
module Nokogiri::XSLT
  class << self
    def parse(string, modules = _); end
