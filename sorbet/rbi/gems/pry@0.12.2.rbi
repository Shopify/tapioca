...
class Pry::Code
  ...
  class << self
    def from_file(filename, code_type = _); end
    def from_method(meth, start_line = _); end
    def from_module(mod, candidate_rank = _, start_line = _); end
  end
end
...
class Pry::CodeObject
  ...
  class << self
    def lookup(str, _pry_, options = _); end
  end
end
...
class Pry::ColorPrinter < ::PP
  ...
  class << self
    def pp(obj, out = _, width = _, newline = _); end
  end
end
...
module Pry::Helpers
  class << self
    def tablify(things, line_length, config = _); end
    def tablify_or_one_line(heading, things, config = _); end
    def tablify_to_screen_width(things, options, config = _); end
  end
end
...
class Pry::Method
  ...
  class << self
    def all_from_class(klass, include_super = _); end
    def all_from_common(obj, _method_type = _, include_super = _); end
    def all_from_obj(obj, include_super = _); end
    def from_binding(b); end
    def from_class(klass, name, target = _); end
    def from_module(klass, name, target = _); end
    def from_obj(obj, name, target = _); end
    def from_str(name, target = _, options = _); end
    def instance_method_definition?(name, definition_line); end
    def instance_resolution_order(klass); end
    def lookup_method_via_binding(obj, method_name, method_type, target = _); end
...
module Pry::Prompt
  class << self
    def [](prompt_name); end
    def add(prompt_name, description = _, separators = _); end
    def all; end
...
class Pry::Slop
  ...
  class << self
    def optspec(string, config = _); end
    def parse(items = _, config = _, &block); end
    def parse!(items = _, config = _, &block); end
  end
end
...
class Pry::WrappedModule
  ...
  class << self
    def from_str(mod_name, target = _); end
