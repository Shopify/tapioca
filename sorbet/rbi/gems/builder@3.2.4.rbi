...
#
# source://builder-VERSION/lib/builder/blankslate.rb:17
module Builder
  class << self
    # source://builder-VERSION/lib/builder/xchar.rb:13
    def check_for_name_collision(klass, method_name, defined_constant = T.unsafe(nil)); end
  end
end

# source://builder-VERSION/lib/builder/blankslate.rb:19
Builder::BlankSlate = BasicObject

# Generic error for builder
#
# source://builder-VERSION/lib/builder/xmlbase.rb:9
class Builder::IllegalBlockError < ::RuntimeError; end

# source://builder-VERSION/lib/builder/xchar.rb:33
module Builder::XChar
  class << self
    # encode a string per XML rules
    #
    # source://builder-VERSION/lib/builder/xchar.rb:152
    def encode(string); end

    # convert a string to valid UTF-8, compensating for a number of
    # common errors.
    #
    # source://builder-VERSION/lib/builder/xchar.rb:126
...
#
# source://builder-VERSION/lib/builder/xchar.rb:76
Builder::XChar::VALID = T.let(T.unsafe(nil), Array)

# source://builder-VERSION/lib/builder/xchar.rb:105
Builder::XChar::XML_PREDEFINED = T.let(T.unsafe(nil), Regexp)

# XmlBase is a base class for building XML builders.  See
# Builder::XmlMarkup and Builder::XmlEvents for examples.
#
# source://builder-VERSION/lib/builder/xmlbase.rb:13
class Builder::XmlBase < ::BasicObject
  ...
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:29
  ...
  # targets.
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:118
  def <<(text); end

  # @return [Boolean]
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:35
  ...
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:92
  ...
  # @return [Boolean]
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:128
  def nil?; end
  ...
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:42
  ...
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:101
  def text!(text); end

  private

  # source://builder-VERSION/lib/builder/xmlbase.rb:136
  def _escape(text); end

  # source://builder-VERSION/lib/builder/xmlbase.rb:159
  def _escape_attribute(text); end

  # source://builder-VERSION/lib/builder/xmlbase.rb:169
  def _indent; end

  # source://builder-VERSION/lib/builder/xmlbase.rb:174
  def _nested_structures(block); end

  # source://builder-VERSION/lib/builder/xmlbase.rb:164
  def _newline; end
  ...
  # significantly.
  #
  # source://builder-VERSION/lib/builder/xmlbase.rb:187
  def cache_method_call(sym); end

  class << self
    # Returns the value of attribute cache_method_calls.
    #
    # source://builder-VERSION/lib/builder/xmlbase.rb:16
...
#
# source://builder-VERSION/lib/builder/xmlevents.rb:49
class Builder::XmlEvents < ::Builder::XmlMarkup
  # source://builder-VERSION/lib/builder/xmlevents.rb:59
  def _end_tag(sym); end

  # source://builder-VERSION/lib/builder/xmlevents.rb:54
  def _start_tag(sym, attrs, end_too = T.unsafe(nil)); end

  # source://builder-VERSION/lib/builder/xmlevents.rb:50
  def text!(text); end
end
...
#     }
#
# source://builder-VERSION/lib/builder/xmlmarkup.rb:161
class Builder::XmlMarkup < ::Builder::XmlBase
  ...
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:190
  ...
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:270
  def cdata!(text); end

  # source://builder-VERSION/lib/builder/xmlmarkup.rb:275
  def cdata_value!(open, text); end

  # source://builder-VERSION/lib/builder/xmlmarkup.rb:204
  ...
  #       # => <!ELEMENT blah "yada">
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:215
  ...
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:248
  def instruct!(directive_tag = T.unsafe(nil), attrs = T.unsafe(nil)); end

  # Return the target of the builder.
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:200
  def target!; end

  private

  # source://builder-VERSION/lib/builder/xmlmarkup.rb:326
  def _attr_value(value); end

  # Insert an ending tag.
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:310
  def _end_tag(sym); end

  # source://builder-VERSION/lib/builder/xmlmarkup.rb:335
  def _ensure_no_block(got_block); end

  # Insert the attributes (given in the hash).
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:315
  def _insert_attributes(attrs, order = T.unsafe(nil)); end

  # Insert special instruction.
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:291
  def _special(open, close, data = T.unsafe(nil), attrs = T.unsafe(nil), order = T.unsafe(nil)); end

  # Start an XML tag.  If <tt>end_too</tt> is true, then the start
  # tag is also the end tag (e.g.  <br/>
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:302
  def _start_tag(sym, attrs, end_too = T.unsafe(nil)); end

  # Insert text directly in to the builder's target.
  #
  # source://builder-VERSION/lib/builder/xmlmarkup.rb:286
  def _text(text); end
end
