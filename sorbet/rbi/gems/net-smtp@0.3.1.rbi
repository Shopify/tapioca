...
#
# source://net-smtp-VERSION/lib/net/smtp.rb:181
class Net::SMTP < ::Net::Protocol
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:234
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:399
  def address; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:843
  def auth_cram_md5(user, secret); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:832
  def auth_login(user, secret); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:823
  def auth_plain(user, secret); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:817
  def authenticate(user, secret, authtype = T.unsafe(nil)); end

  # The server capabilities by EHLO response
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:293
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:287
  def capable?(key); end

  # Returns supported authentication methods on this server.
  # You cannot get valid value before opening SMTP session.
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:322
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:309
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:303
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:297
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:282
  ...
  #   }
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:981
  ...
  #   end
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:435
  def debug_output=(arg); end

  # Disables SMTP/TLS for this object.  Must be called before the
  # connection is established to have any effect.
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:349
  def disable_ssl; end

  # Disables SMTP/TLS (STARTTLS) for this object.  Must be called
  # before the connection is established to have any effect.
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:393
  ...
  # source://net-smtp-VERSION/lib/net/smtp.rb:921
  def ehlo(domain); end
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:338
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:375
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:384
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:275
  def esmtp; end
  ...
  # @raise [IOError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:617
  def finish; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:917
  def helo(domain); end

  # Provide human-readable stringification of class state.
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:264
  def inspect; end

  # +from_addr+ is +String+ or +Net::SMTP::Address+
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:926
  ...
  # @raise [IOError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:801
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:407
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:402
  def port; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1008
  def quit; end

  # +to_addr+ is +String+ or +Net::SMTP::Address+
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:953
  def rcptto(to_addr); end

  # @raise [ArgumentError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:931
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:412
  def read_timeout; end

  # Set the number of seconds to wait until timing-out a read(2)
  # call.
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:416
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:909
  def rset; end
  ...
  # @raise [IOError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:748
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:329
  def ssl?; end

  # Hash for additional SSLContext parameters.
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:261
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:584
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:525
  def started?; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:913
  def starttls; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:359
  def starttls?; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:364
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:369
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:258
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:255
  def tls_verify; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:313
  def auth_capable?(type); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:863
  def auth_method(type); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:876
  def base64_encode(str); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:867
  def check_auth_args(user, secret, authtype = T.unsafe(nil)); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1075
  def check_auth_continue(res); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:857
  def check_auth_method(type); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1069
  def check_auth_response(res); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1063
  def check_continue(res); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1057
  def check_response(res); end

  # CRAM-MD5: [RFC2195]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:885
  def cram_md5_response(secret, challenge); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:892
  def cram_secret(secret, mask); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1047
  def critical; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:697
  def do_finish; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:685
  def do_helo(helo_domain); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:633
  def do_start(helo_domain, user, secret, authtype); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1031
  def get_response(reqline); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1021
  def getok(reqline); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1160
  def logging(msg); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:680
  def new_internet_message_io(s); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1037
  def recv_response; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:663
  def ssl_socket(socket, context); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:624
  def tcp_socket(address, port); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:667
  def tlsconnect(s, context); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1014
  def validate_line(line); end

  class << self
    # The default SMTP port number, 25.
    #
    # source://net-smtp-VERSION/lib/net/smtp.rb:187
    def default_port; end

    # source://net-smtp-VERSION/lib/net/smtp.rb:205
    def default_ssl_context(ssl_context_params = T.unsafe(nil)); end

    # The default SMTPS port number, 465.
    #
    # source://net-smtp-VERSION/lib/net/smtp.rb:197
    def default_ssl_port; end

    # The default mail submission port number, 587.
    #
    # source://net-smtp-VERSION/lib/net/smtp.rb:192
    ...
    # @raise [ArgumentError]
    #
    # source://net-smtp-VERSION/lib/net/smtp.rb:511
...
#
# source://net-smtp-VERSION/lib/net/smtp.rb:1165
class Net::SMTP::Address
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:1176
  def initialize(address, *args, **kw_args); end

  # mail address [String]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:1167
  def address; end

  # paramters [Array<String>]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:1169
  def parameters; end

  # source://net-smtp-VERSION/lib/net/smtp.rb:1186
  def to_s; end
end
...
#
# source://net-smtp-VERSION/lib/net/smtp.rb:1085
class Net::SMTP::Response
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:1094
  ...
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:1137
  def capabilities; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:1112
  def success?; end
  ...
  class << self
    ...
    # readable reply text
    #
    # source://net-smtp-VERSION/lib/net/smtp.rb:1088
    def parse(str); end
  end
end

# source://net-smtp-VERSION/lib/net/smtp.rb:182
Net::SMTP::VERSION = T.let(T.unsafe(nil), String)

# source://net-smtp-VERSION/lib/net/smtp.rb:48
...
#
# source://net-smtp-VERSION/lib/net/smtp.rb:31
module Net::SMTPError
  # source://net-smtp-VERSION/lib/net/smtp.rb:37
  def initialize(response, message: T.unsafe(nil)); end

  # source://net-smtp-VERSION/lib/net/smtp.rb:42
  def message; end

  # This *class* is a module for backward compatibility.
  # In later release, this module becomes a class.
  #
  # source://net-smtp-VERSION/lib/net/smtp.rb:35
  def response; end
end

# source://net-smtp-VERSION/lib/net/smtp.rb:63
class Net::SMTPFatalError < ::Net::ProtoFatalError
  include ::Net::SMTPError
end

# source://net-smtp-VERSION/lib/net/smtp.rb:53
...
# class SMTP
#
# source://net-smtp-VERSION/lib/net/smtp.rb:1193
Net::SMTPSession = Net::SMTP

# source://net-smtp-VERSION/lib/net/smtp.rb:58
class Net::SMTPSyntaxError < ::Net::ProtoSyntaxError
  include ::Net::SMTPError
end

# source://net-smtp-VERSION/lib/net/smtp.rb:68
class Net::SMTPUnknownError < ::Net::ProtoUnknownError
  include ::Net::SMTPError
end

# source://net-smtp-VERSION/lib/net/smtp.rb:73
