...
#
# source://net-smtp//lib/net/smtp.rb#181
class Net::SMTP < ::Net::Protocol
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#234
  ...
  # source://net-smtp//lib/net/smtp.rb#832
  def auth_login(user, secret); end

  # source://net-smtp//lib/net/smtp.rb#823
  def auth_plain(user, secret); end

  # source://net-smtp//lib/net/smtp.rb#817
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#322
  ...
  # @return [Boolean]
  #
  # source://net-smtp//lib/net/smtp.rb#297
  ...
  #   }
  #
  # source://net-smtp//lib/net/smtp.rb#981
  ...
  #   end
  #
  # source://net-smtp//lib/net/smtp.rb#435
  def debug_output=(arg); end

  # Disables SMTP/TLS for this object.  Must be called before the
  # connection is established to have any effect.
  #
  # source://net-smtp//lib/net/smtp.rb#349
  def disable_ssl; end

  # Disables SMTP/TLS (STARTTLS) for this object.  Must be called
  # before the connection is established to have any effect.
  #
  # source://net-smtp//lib/net/smtp.rb#393
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp//lib/net/smtp.rb#338
  ...
  # @raise [IOError]
  #
  # source://net-smtp//lib/net/smtp.rb#617
  def finish; end

  # source://net-smtp//lib/net/smtp.rb#917
  def helo(domain); end
  ...
  # @raise [IOError]
  #
  # source://net-smtp//lib/net/smtp.rb#801
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#402
  def port; end

  # source://net-smtp//lib/net/smtp.rb#1008
  def quit; end

  # +to_addr+ is +String+ or +Net::SMTP::Address+
  #
  # source://net-smtp//lib/net/smtp.rb#953
  ...
  # call.
  #
  # source://net-smtp//lib/net/smtp.rb#416
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp//lib/net/smtp.rb#584
  ...
  # @return [Boolean]
  #
  # source://net-smtp//lib/net/smtp.rb#525
  def started?; end

  # source://net-smtp//lib/net/smtp.rb#913
  def starttls; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp//lib/net/smtp.rb#359
  def starttls?; end
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#258
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#255
  def tls_verify; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp//lib/net/smtp.rb#313
  def auth_capable?(type); end

  # source://net-smtp//lib/net/smtp.rb#863
  def auth_method(type); end

  # source://net-smtp//lib/net/smtp.rb#876
  def base64_encode(str); end

  # source://net-smtp//lib/net/smtp.rb#867
  def check_auth_args(user, secret, authtype = T.unsafe(nil)); end

  # source://net-smtp//lib/net/smtp.rb#1075
  ...
  # source://net-smtp//lib/net/smtp.rb#1057
  def check_response(res); end

  # CRAM-MD5: [RFC2195]
  #
  # source://net-smtp//lib/net/smtp.rb#885
  def cram_md5_response(secret, challenge); end

  # source://net-smtp//lib/net/smtp.rb#892
  def cram_secret(secret, mask); end

  # source://net-smtp//lib/net/smtp.rb#1047
  def critical; end
  ...
  class << self
    ...
    # source://net-smtp//lib/net/smtp.rb#205
    ...
    # @raise [ArgumentError]
    #
    # source://net-smtp//lib/net/smtp.rb#511
...
class Net::SMTP::Address
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#1176
  def initialize(address, *args, **kw_args); end

  # mail address [String]
  #
  # source://net-smtp//lib/net/smtp.rb#1167
  def address; end

  # paramters [Array<String>]
  #
  # source://net-smtp//lib/net/smtp.rb#1169
  def parameters; end
...
#
# source://net-smtp//lib/net/smtp.rb#1085
class Net::SMTP::Response
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#1137
  def capabilities; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp//lib/net/smtp.rb#1118
  def continue?; end
  ...
  #
  # source://net-smtp//lib/net/smtp.rb#1149
  ...
  # @return [Boolean]
  #
  # source://net-smtp//lib/net/smtp.rb#1112
  def success?; end
...
# source://net-smtp//lib/net/smtp.rb#182
Net::SMTP::VERSION = T.let(T.unsafe(nil), String)

# source://net-smtp//lib/net/smtp.rb#48
...
module Net::SMTPError
  ...
  # source://net-smtp//lib/net/smtp.rb#42
  def message; end
