...
module ActiveSupport::Cache
  class << self
    def expand_cache_key(key, namespace = _); end
...
class ActiveSupport::ExecutionWrapper
  ...
  class << self
    ...
    def register_hook(hook, outer: _); end
    def run!; end
...
module ActiveSupport::Gzip
  class << self
    def compress(source, level = _, strategy = _); end
...
module ActiveSupport::JSON
  class << self
    def decode(json); end
    def encode(value, options = _); end
    def parse_error; end
...
class ActiveSupport::Messages::Metadata
  ...
  class << self
    ...
    def wrap(message, expires_at: _, expires_in: _, purpose: _); end
...
class ActiveSupport::Subscriber
  ...
  class << self
    def attach_to(namespace, subscriber = _, notifier = _); end
...
class ActiveSupport::TimeZone
  ...
  class << self
    ...
    def new(name); end
    def seconds_to_utc_offset(seconds, colon = _); end
    def us_zones; end
...
class DateTime < ::Date
  ...
  class << self
    def civil_from_format(utc_or_local, year, month = _, day = _, hour = _, min = _, sec = _); end
    def current; end
  end
end
...
class Hash
  ...
  class << self
    ...
    def from_xml(xml, disallowed_types = _); end
  end
end
...
class Time
  ...
  class << self
    ...
    def current; end
    def days_in_month(month, year = _); end
    def days_in_year(year = _); end
