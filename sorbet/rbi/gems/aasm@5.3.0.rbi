...
# source://aasm-5.3.0/lib/aasm/version.rb:1
module AASM
  ...
  #
  # source://aasm-5.3.0/lib/aasm/aasm.rb:86
  ...
  class << self
    ...
    #
    # source://aasm-5.3.0/lib/aasm/aasm.rb:8
...
# Persistence
#
# source://aasm-5.3.0/lib/aasm/base.rb:4
class AASM::Base
  # @return [Base] a new instance of Base
  #
  # source://aasm-5.3.0/lib/aasm/base.rb:8
  def initialize(klass, name, state_machine, options = T.unsafe(nil), &block); end

  # source://aasm-5.3.0/lib/aasm/base.rb:161
  def after_all_events(*callbacks, &block); end

  # source://aasm-5.3.0/lib/aasm/base.rb:149
  def after_all_transactions(*callbacks, &block); end

  # source://aasm-5.3.0/lib/aasm/base.rb:145
  def after_all_transitions(*callbacks, &block); end

  # This method is both a getter and a setter
  #
  # source://aasm-5.3.0/lib/aasm/base.rb:66
  def attribute_name(column_name = T.unsafe(nil)); end

  # source://aasm-5.3.0/lib/aasm/base.rb:157
  def before_all_events(*callbacks, &block); end

  # source://aasm-5.3.0/lib/aasm/base.rb:153
  def before_all_transactions(*callbacks, &block); end

  # source://aasm-5.3.0/lib/aasm/base.rb:169
  def ensure_on_all_events(*callbacks, &block); end

  # source://aasm-5.3.0/lib/aasm/base.rb:165
  def error_on_all_events(*callbacks, &block); end

  # define an event
  #
  # source://aasm-5.3.0/lib/aasm/base.rb:111
  def event(name, options = T.unsafe(nil), &block); end

  # source://aasm-5.3.0/lib/aasm/base.rb:177
  def events; end

  # source://aasm-5.3.0/lib/aasm/base.rb:190
  def from_states_for_state(state, options = T.unsafe(nil)); end

  # aasm.event(:event_name).human?
  #
  # source://aasm-5.3.0/lib/aasm/base.rb:182
  def human_event_name(event); end

  # source://aasm-5.3.0/lib/aasm/base.rb:75
  def initial_state(new_initial_state = T.unsafe(nil)); end

  # Returns the value of attribute klass.
  #
  # source://aasm-5.3.0/lib/aasm/base.rb:6
  def klass; end

  # make sure to create a (named) scope for each state
  #
  # source://aasm-5.3.0/lib/aasm/persistence/base.rb:60
  def state(*args); end
  ...
  # [1..] state
  #
  # source://aasm-5.3.0/lib/aasm/base.rb:90
  def state_without_scope(*args); end

  # source://aasm-5.3.0/lib/aasm/base.rb:173
  def states; end

  # source://aasm-5.3.0/lib/aasm/base.rb:186
  def states_for_select; end

  private

  # source://aasm-5.3.0/lib/aasm/base.rb:231
  def apply_ruby2_keyword(klass, sym); end

  # source://aasm-5.3.0/lib/aasm/base.rb:205
  def configure(key, default_value); end

  # source://aasm-5.3.0/lib/aasm/persistence/base.rb:75
  def create_scope(name); end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/persistence/base.rb:71
  def create_scope?(name); end

  # source://aasm-5.3.0/lib/aasm/persistence/base.rb:79
  def create_scopes(name); end

  # source://aasm-5.3.0/lib/aasm/base.rb:201
  def default_column; end

  # source://aasm-5.3.0/lib/aasm/base.rb:254
  def interpret_state_args(args); end

  # source://aasm-5.3.0/lib/aasm/base.rb:246
  def namespace; end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/base.rb:242
  def namespace?; end

  # source://aasm-5.3.0/lib/aasm/base.rb:213
  def safely_define_method(klass, method_name, method_definition); end

  # source://aasm-5.3.0/lib/aasm/base.rb:290
  def setup_no_direct_assignment(aasm_name); end

  # source://aasm-5.3.0/lib/aasm/base.rb:279
  def setup_timestamps(aasm_name); end

  # source://aasm-5.3.0/lib/aasm/base.rb:264
  def skip_instance_level_validation(event, name, aasm_name, klass); end
end

# source://aasm-5.3.0/lib/aasm/aasm.rb:19
module AASM::ClassMethods
  # this is the entry point for all state and event definitions
  #
  # @raise [ArgumentError]
  #
  # source://aasm-5.3.0/lib/aasm/aasm.rb:28
  def aasm(*args, &block); end

  # make sure inheritance (aka subclassing) works with AASM
  #
  # source://aasm-5.3.0/lib/aasm/aasm.rb:21
  def inherited(base); end
end

# source://aasm-5.3.0/lib/aasm/configuration.rb:2
class AASM::Configuration
  # for all persistence layers: which database column to use?
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:4
  def column; end
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:10
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:36
  def enum; end
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:42
  def logger; end
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:39
  def namespace; end
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:31
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:25
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:22
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:16
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:28
  def timestamps; end
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:19
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:13
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:7
  ...
  #
  # source://aasm-5.3.0/lib/aasm/configuration.rb:34
  def with_klass; end
  ...
  class << self
    ...
    #
    # source://aasm-5.3.0/lib/aasm/configuration.rb:45
...
# source://aasm-5.3.0/lib/aasm/core/transition.rb:3
module AASM::Core; end

# source://aasm-5.3.0/lib/aasm/core/event.rb:4
class AASM::Core::Event
  include ::AASM::DslHelper

  # @return [Event] a new instance of Event
  #
  # source://aasm-5.3.0/lib/aasm/core/event.rb:9
  def initialize(name, state_machine, options = T.unsafe(nil), &block); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:87
  def ==(event); end

  # Returns the value of attribute default_display_name.
  #
  # source://aasm-5.3.0/lib/aasm/core/event.rb:7
  def default_display_name; end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:110
  def failed_callbacks; end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:50
  def fire(obj, options = T.unsafe(nil), to_state = T.unsafe(nil), *args); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:74
  def fire_callbacks(callback_name, record, *args); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:70
  def fire_global_callbacks(callback_name, record, *args); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:80
  ...
  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/event.rb:46
  ...
  # source://aasm-5.3.0/lib/aasm/core/event.rb:114
  def to_s; end

  # DSL interface
  #
  # source://aasm-5.3.0/lib/aasm/core/event.rb:96
  def transitions(definitions = T.unsafe(nil), &block); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:58
  def transitions_from_state(state); end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/event.rb:54
  def transitions_from_state?(state); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:66
  def transitions_to_state(state); end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/event.rb:62
  def transitions_to_state?(state); end

  private

  # source://aasm-5.3.0/lib/aasm/core/event.rb:132
  def _fire(obj, options = T.unsafe(nil), to_state = T.unsafe(nil), *args); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:120
  def attach_event_guards(definitions); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:167
  def clear_failed_callbacks; end

  # called internally by Ruby 1.9 after clone()
  #
  # source://aasm-5.3.0/lib/aasm/core/event.rb:34
  def initialize_copy(orig); end

  # source://aasm-5.3.0/lib/aasm/core/event.rb:172
...
#
# source://aasm-5.3.0/lib/aasm/core/invoker.rb:9
class AASM::Core::Invoker
  ...
  #
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:24
  def initialize(subject, record, args); end

  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:83
  def invoke; end
  ...
  #
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:72
  ...
  #
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:57
  ...
  #
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:45
  ...
  #
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:94
  def args; end

  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:116
  ...
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:97
  def invoke_array; end

  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:122
  ...
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:110
  ...
  # source://aasm-5.3.0/lib/aasm/core/invoker.rb:103
...
class AASM::Core::Invokers::BaseInvoker
  ...
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/base_invoker.rb:23
  def initialize(subject, record, args); end

  # Returns the value of attribute args.
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/base_invoker.rb:10
  def args; end
  ...
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/base_invoker.rb:46
  def invoke; end
  ...
  # @raise [NoMethodError]
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/base_invoker.rb:69
  ...
  # @raise [NoMethodError]
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/base_invoker.rb:62
  def log_failure; end
  ...
  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/base_invoker.rb:55
  def may_invoke?; end
  ...
  # +failures+ - failures buffer to collect failures
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/base_invoker.rb:38
...
#
# source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:9
class AASM::Core::Invokers::ClassInvoker < ::AASM::Core::Invokers::BaseInvoker
  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:19
  def invoke_subject; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:14
  def log_failure; end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:10
  def may_invoke?; end

  private

  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:33
  def instance; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:29
  def log_method_info; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:25
  def log_source_location; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:38
  def retrieve_instance; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/class_invoker.rb:46
...
#
# source://aasm-5.3.0/lib/aasm/core/invokers/literal_invoker.rb:9
class AASM::Core::Invokers::LiteralInvoker < ::AASM::Core::Invokers::BaseInvoker
  # source://aasm-5.3.0/lib/aasm/core/invokers/literal_invoker.rb:18
  def invoke_subject; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/literal_invoker.rb:14
  def log_failure; end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/literal_invoker.rb:10
  def may_invoke?; end

  private

  # source://aasm-5.3.0/lib/aasm/core/invokers/literal_invoker.rb:29
  def exec_subject; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/literal_invoker.rb:37
  def record_error; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/literal_invoker.rb:24
  def subject_arity; end
end
...
#
# source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:9
class AASM::Core::Invokers::ProcInvoker < ::AASM::Core::Invokers::BaseInvoker
  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:19
  def invoke_subject; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:14
  def log_failure; end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:10
  def may_invoke?; end

  private

  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:34
  def exec_proc(parameters_size); end

  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:45
  def log_proc_info; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:41
  def log_source_location; end

  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:49
  def parameters_to_arity; end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/invokers/proc_invoker.rb:29
  def support_parameters?; end
end

# source://aasm-5.3.0/lib/aasm/core/state.rb:4
class AASM::Core::State
  # @return [State] a new instance of State
  #
  # source://aasm-5.3.0/lib/aasm/core/state.rb:7
  def initialize(name, klass, state_machine, options = T.unsafe(nil)); end

  # source://aasm-5.3.0/lib/aasm/core/state.rb:36
  def <=>(state); end

  # source://aasm-5.3.0/lib/aasm/core/state.rb:28
  def ==(state); end

  # Returns the value of attribute default_display_name.
  #
  # source://aasm-5.3.0/lib/aasm/core/state.rb:5
  def default_display_name; end

  # source://aasm-5.3.0/lib/aasm/core/state.rb:57
  def display_name; end

  # source://aasm-5.3.0/lib/aasm/core/state.rb:48
  def fire_callbacks(action, record, *args); end

  # source://aasm-5.3.0/lib/aasm/core/state.rb:72
  def for_select; end

  # source://aasm-5.3.0/lib/aasm/core/state.rb:67
  def human_name; end
  ...
  # source://aasm-5.3.0/lib/aasm/core/state.rb:44
  def to_s; end

  private

  # source://aasm-5.3.0/lib/aasm/core/state.rb:86
  def _fire_callbacks(action, record, args); end

  # called internally by Ruby 1.9 after clone()
  #
  # source://aasm-5.3.0/lib/aasm/core/state.rb:16
  def initialize_copy(orig); end

  # source://aasm-5.3.0/lib/aasm/core/state.rb:78
  def update(options = T.unsafe(nil)); end
end

# source://aasm-5.3.0/lib/aasm/core/transition.rb:4
class AASM::Core::Transition
  include ::AASM::DslHelper

  # @return [Transition] a new instance of Transition
  #
  # source://aasm-5.3.0/lib/aasm/core/transition.rb:10
  def initialize(event, opts, &block); end

  # source://aasm-5.3.0/lib/aasm/core/transition.rb:52
  def ==(obj); end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/transition.rb:42
  def allowed?(obj, *args); end

  # Returns the value of attribute event.
  #
  # source://aasm-5.3.0/lib/aasm/core/transition.rb:7
  def event; end

  # source://aasm-5.3.0/lib/aasm/core/transition.rb:47
  ...
  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/core/transition.rb:56
  def from?(value); end

  # source://aasm-5.3.0/lib/aasm/core/transition.rb:60
  ...
  # source://aasm-5.3.0/lib/aasm/core/transition.rb:78
  def _fire_callbacks(code, record, args); end

  # called internally by Ruby 1.9 after clone()
  #
  # source://aasm-5.3.0/lib/aasm/core/transition.rb:34
  def initialize_copy(orig); end

  # source://aasm-5.3.0/lib/aasm/core/transition.rb:66
  def invoke_callbacks_compatible_with_guard(code, record, args, options = T.unsafe(nil)); end
end

# source://aasm-5.3.0/lib/aasm/dsl_helper.rb:2
module AASM::DslHelper
  # source://aasm-5.3.0/lib/aasm/dsl_helper.rb:25
  def add_options_from_dsl(options, valid_keys, &block); end
end

# source://aasm-5.3.0/lib/aasm/dsl_helper.rb:4
class AASM::DslHelper::Proxy
  # @return [Proxy] a new instance of Proxy
  #
  # source://aasm-5.3.0/lib/aasm/dsl_helper.rb:7
  def initialize(options, valid_keys, source); end

  # source://aasm-5.3.0/lib/aasm/dsl_helper.rb:14
  def method_missing(name, *args, &block); end

  # Returns the value of attribute options.
  #
  # source://aasm-5.3.0/lib/aasm/dsl_helper.rb:5
  def options; end
...
# source://aasm-5.3.0/lib/aasm/instance_base.rb:2
class AASM::InstanceBase
  ...
  #
  # source://aasm-5.3.0/lib/aasm/instance_base.rb:5
  def initialize(instance, name = T.unsafe(nil)); end

  # Returns the value of attribute current_event.
  #
  # source://aasm-5.3.0/lib/aasm/instance_base.rb:3
  ...
  # source://aasm-5.3.0/lib/aasm/instance_base.rb:10
  def current_state; end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:14
  def current_state=(state); end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:97
  def determine_state_name(state); end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:18
  def enter_initial_state; end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:60
  def events(options = T.unsafe(nil), *args); end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:116
  def fire(event_name, *args, &block); end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:122
  def fire!(event_name, *args, &block); end
  ...
  # source://aasm-5.3.0/lib/aasm/instance_base.rb:29
  def human_state; end

  # @return [Boolean]
  #
  # source://aasm-5.3.0/lib/aasm/instance_base.rb:108
  def may_fire_event?(name, *args); end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:80
  def permitted_transitions; end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:128
  def set_current_state_with_persistence(state); end

  # @raise [AASM::UndefinedState]
  #
  # source://aasm-5.3.0/lib/aasm/instance_base.rb:91
  def state_object_for_name(name); end

  # source://aasm-5.3.0/lib/aasm/instance_base.rb:33
...
class AASM::InvalidTransition < ::RuntimeError
  ...
  # source://aasm-5.3.0/lib/aasm/errors.rb:14
  def reasoning; end
...
module AASM::Persistence::Base
  ...
  #
  # source://aasm-5.3.0/lib/aasm/persistence/base.rb:35
  def aasm_read_state(name = T.unsafe(nil)); end

  class << self
    # source://aasm-5.3.0/lib/aasm/persistence/base.rb:5
    def included(base); end
  end
end

# source://aasm-5.3.0/lib/aasm/persistence/base.rb:48
module AASM::Persistence::Base::ClassMethods
  # source://aasm-5.3.0/lib/aasm/persistence/base.rb:49
  def aasm_column(attribute_name = T.unsafe(nil)); end
end

# source://aasm-5.3.0/lib/aasm/persistence/plain_persistence.rb:3
module AASM::Persistence::PlainPersistence
  # may be overwritten by persistence mixins
  #
  # source://aasm-5.3.0/lib/aasm/persistence/plain_persistence.rb:6
  def aasm_read_state(name = T.unsafe(nil)); end

  # may be overwritten by persistence mixins
  #
  # source://aasm-5.3.0/lib/aasm/persistence/plain_persistence.rb:15
  def aasm_write_state(new_state, name = T.unsafe(nil)); end

  # may be overwritten by persistence mixins
  #
  # source://aasm-5.3.0/lib/aasm/persistence/plain_persistence.rb:20
  def aasm_write_state_without_persistence(new_state, name = T.unsafe(nil)); end
end

# source://aasm-5.3.0/lib/aasm/state_machine.rb:2
class AASM::StateMachine
  # @return [StateMachine] a new instance of StateMachine
  #
  # source://aasm-5.3.0/lib/aasm/state_machine.rb:7
  def initialize(name); end

  # source://aasm-5.3.0/lib/aasm/state_machine.rb:34
  def add_event(name, options, &block); end

  # source://aasm-5.3.0/lib/aasm/state_machine.rb:38
  def add_global_callbacks(name, *callbacks, &block); end

  # source://aasm-5.3.0/lib/aasm/state_machine.rb:25
  def add_state(state_name, klass, options); end

  # the following four methods provide the storage of all state machines
  #
  # source://aasm-5.3.0/lib/aasm/state_machine.rb:5
  def config; end
  ...
  # called internally by Ruby 1.9 after clone()
  #
  # source://aasm-5.3.0/lib/aasm/state_machine.rb:17
  def initialize_copy(orig); end

  # source://aasm-5.3.0/lib/aasm/state_machine.rb:48
  def set_initial_state(name, options); end
end

# source://aasm-5.3.0/lib/aasm/state_machine_store.rb:3
class AASM::StateMachineStore
  # @return [StateMachineStore] a new instance of StateMachineStore
  #
  # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:43
  def initialize; end

  # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:55
  def [](name); end

  # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:47
  def clone; end

  # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:60
  def keys; end
  ...
  # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:65
  def register(name, machine, force = T.unsafe(nil)); end

  class << self
    # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:27
    def [](klass, fallback = T.unsafe(nil)); end

    # do not overwrite existing state machines, which could have been created by
    # inheritance, see AASM::ClassMethods method inherited
    #
    # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:13
    ...
    # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:7
    def stores; end

    # source://aasm-5.3.0/lib/aasm/state_machine_store.rb:38
    def unregister(klass); end
  end
end

# source://aasm-5.3.0/lib/aasm/errors.rb:19
class AASM::UndefinedState < ::RuntimeError; end

# source://aasm-5.3.0/lib/aasm/errors.rb:3
class AASM::UnknownStateMachineError < ::RuntimeError; end

# source://aasm-5.3.0/lib/aasm/version.rb:2
