...
module ActiveRecord::ConnectionAdapters::SchemaStatements
  ...
  def add_column_for_alter(table_name, column_name, type, options = T.unsafe(nil)); end
  ...
  def remove_column_for_alter(table_name, column_name, type = T.unsafe(nil), options = T.unsafe(nil)); end
...
module ActiveRecord::Locking::Optimistic
  ...
  def _create_record(attribute_names = T.unsafe(nil), *_); end
...
class ActiveRecord::Relation
  ...
  def values_for_create(attributes = T.unsafe(nil)); end
end
