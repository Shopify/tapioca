...
class BCrypt::Password < ::String
  ...
  #
  # pkg:gem/bcrypt#lib/bcrypt/password.rb:76
  def ==(secret); end
  ...
  #    @password.to_s == @password.to_s # => True
  #
  # pkg:gem/bcrypt#lib/bcrypt/password.rb:79
  ...
  #
  # pkg:gem/bcrypt#lib/bcrypt/password.rb:92
  ...
  # @return [Boolean]
  #
  # pkg:gem/bcrypt#lib/bcrypt/password.rb:84
