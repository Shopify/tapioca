...
# source://actionmailbox-7.0.3/lib/action_mailbox.rb:5
module ActionMailbox
  extend ::ActiveSupport::Autoload

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:14
  def incinerate; end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:14
  def incinerate=(val); end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:15
  def incinerate_after; end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:15
  def incinerate_after=(val); end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:12
  def ingress; end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:12
  def ingress=(val); end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:13
  def logger; end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:13
  def logger=(val); end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:16
  def queues; end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:16
  def queues=(val); end

  # source://actionmailbox-7.0.3/lib/action_mailbox.rb:17
...
#   end
#
# source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:63
class ActionMailbox::Base
  ...
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:76
  ...
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:101
  def bounce_with(message); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:68
  ...
  # @return [Boolean]
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:95
  def finished_processing?; end

  # Returns the value of attribute inbound_email.
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:67
  def inbound_email; end

  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:70
  def logger(*_arg0, &_arg1); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:68
  def mail(*_arg0, &_arg1); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:80
  def perform_processing; end

  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:91
  def process; end
  ...
  # source://actionmailbox-7.0.3/lib/action_mailbox/routing.rb:9
  def router; end
  ...
  # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:107
  ...
  class << self
    ...
    # source://actionmailbox-7.0.3/lib/action_mailbox/base.rb:72
...
# source://actionmailbox-7.0.3/app/controllers/action_mailbox/base_controller.rb:5
class ActionMailbox::BaseController < ::ActionController::Base
  ...
  # source://actionmailbox-7.0.3/app/controllers/action_mailbox/base_controller.rb:22
  def authenticate_by_password; end

  # source://actionmailbox-7.0.3/app/controllers/action_mailbox/base_controller.rb:11
  def ensure_configured; end

  # source://actionmailbox-7.0.3/app/controllers/action_mailbox/base_controller.rb:17
  def ingress_name; end

  # source://actionmailbox-7.0.3/app/controllers/action_mailbox/base_controller.rb:30
  def password; end
...
#
# source://actionmailbox-7.0.3/lib/action_mailbox/callbacks.rb:7
...
# source://actionmailbox-7.0.3/lib/action_mailbox/callbacks.rb:0
module ActionMailbox::Callbacks::ClassMethods
  # source://actionmailbox-7.0.3/lib/action_mailbox/callbacks.rb:25
  def after_processing(*methods, &block); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/callbacks.rb:29
  def around_processing(*methods, &block); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/callbacks.rb:21
  def before_processing(*methods, &block); end
end

# source://actionmailbox-7.0.3/lib/action_mailbox/callbacks.rb:11
ActionMailbox::Callbacks::TERMINATOR = T.let(T.unsafe(nil), Proc)

# source://actionmailbox-7.0.3/lib/action_mailbox/engine.rb:12
class ActionMailbox::Engine < ::Rails::Engine; end

# source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email.rb:27
...
# source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email.rb:0
...
# source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable.rb:6
module ActionMailbox::InboundEmail::Incineratable
  extend ::ActiveSupport::Concern

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable.rb:17
  def incinerate; end

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable.rb:13
  def incinerate_later; end
end

# source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable/incineration.rb:8
class ActionMailbox::InboundEmail::Incineratable::Incineration
  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable/incineration.rb:9
  def initialize(inbound_email); end

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable/incineration.rb:13
  def run; end

  private

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable/incineration.rb:18
  def due?; end

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/incineratable/incineration.rb:22
  def processed?; end
end

# source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/message_id.rb:9
...
# source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/message_id.rb:0
module ActionMailbox::InboundEmail::MessageId::ClassMethods
  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/message_id.rb:16
  def create_and_extract_message_id!(source, **options); end

  private

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/message_id.rb:37
  def create_and_upload_raw_email!(source); end

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/message_id.rb:27
  def extract_message_id(source); end

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/message_id.rb:31
  def generate_missing_message_id(message_checksum); end
end

# source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/routable.rb:8
module ActionMailbox::InboundEmail::Routable
  extend ::ActiveSupport::Concern

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/routable.rb:21
  def route; end

  # source://actionmailbox-7.0.3/app/models/action_mailbox/inbound_email/routable.rb:16
  def route_later; end
end

# source://actionmailbox-7.0.3/app/jobs/action_mailbox/incineration_job.rb:12
class ActionMailbox::IncinerationJob < ::ActiveJob::Base
  # source://actionmailbox-7.0.3/app/jobs/action_mailbox/incineration_job.rb:21
  ...
  class << self
    ...
    # source://actionmailbox-7.0.3/app/jobs/action_mailbox/incineration_job.rb:17
    def schedule(inbound_email); end
  end
end

# source://actionmailbox-7.0.3/app/models/action_mailbox/record.rb:4
...
# source://actionmailbox-7.0.3/app/models/action_mailbox/record.rb:0
...
#
# source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:6
class ActionMailbox::Router
  # @return [Router] a new instance of Router
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:9
  def initialize; end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:19
  def add_route(address, to:); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:13
  def add_routes(routes); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:33
  def mailbox_for(inbound_email); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:23
  ...
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:38
  def routes; end
end

# source://actionmailbox-7.0.3/lib/action_mailbox/router/route.rb:7
class ActionMailbox::Router::Route
  # source://actionmailbox-7.0.3/lib/action_mailbox/router/route.rb:10
  def initialize(address, to:); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router/route.rb:8
  def address; end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router/route.rb:31
  def mailbox_class; end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router/route.rb:8
  def mailbox_name; end

  # source://actionmailbox-7.0.3/lib/action_mailbox/router/route.rb:16
  def match?(inbound_email); end

  private

  # source://actionmailbox-7.0.3/lib/action_mailbox/router/route.rb:36
  def ensure_valid_address; end
end

# source://actionmailbox-7.0.3/lib/action_mailbox/router.rb:7
class ActionMailbox::Router::RoutingError < ::StandardError; end

# See ActionMailbox::Base for how to specify routing.
#
# source://actionmailbox-7.0.3/lib/action_mailbox/routing.rb:5
...
# source://actionmailbox-7.0.3/lib/action_mailbox/routing.rb:0
module ActionMailbox::Routing::ClassMethods
  # source://actionmailbox-7.0.3/lib/action_mailbox/routing.rb:21
  def mailbox_for(inbound_email); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/routing.rb:17
  def route(inbound_email); end

  # source://actionmailbox-7.0.3/lib/action_mailbox/routing.rb:13
  def routing(routes); end
end

# source://actionmailbox-7.0.3/app/jobs/action_mailbox/routing_job.rb:6
class ActionMailbox::RoutingJob < ::ActiveJob::Base
  # source://actionmailbox-7.0.3/app/jobs/action_mailbox/routing_job.rb:9
  def perform(inbound_email); end
...
# source://actionmailbox-7.0.3/lib/action_mailbox/test_case.rb:7
class ActionMailbox::TestCase < ::ActiveSupport::TestCase
  include ::ActionMailbox::TestHelper
end

# source://actionmailbox-7.0.3/lib/action_mailbox/test_helper.rb:6
module ActionMailbox::TestHelper
  # Create an InboundEmail record using an eml fixture in the format of message/rfc822
  # referenced with +fixture_name+ located in +test/fixtures/files/fixture_name+.
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/test_helper.rb:9
  ...
  #   end
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/test_helper.rb:63
  def create_inbound_email_from_mail(status: T.unsafe(nil), **mail_options, &block); end

  # Create an InboundEmail using the raw rfc822 +source+ as text.
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/test_helper.rb:72
  ...
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/test_helper.rb:79
  ...
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/test_helper.rb:85
  ...
  # to processing.
  #
  # source://actionmailbox-7.0.3/lib/action_mailbox/test_helper.rb:91
  def receive_inbound_email_from_source(*args); end
end

# source://actionmailbox-7.0.3/lib/action_mailbox/mail_ext/address_equality.rb:3
module Mail
  class << self
...
# source://actionmailbox-7.0.3/lib/action_mailbox/mail_ext/address_equality.rb:4
class Mail::Address
...
# source://actionmailbox-7.0.3/lib/action_mailbox/mail_ext/addresses.rb:4
class Mail::Message
...
# source://actionmailbox-7.0.3/app/controllers/rails/conductor/action_mailbox/inbound_emails/sources_controller.rb:3
module Rails
  class << self
