...
class Thor
  ...
  class << self
    def check_unknown_options!(options = _); end
    def check_unknown_options?(config); end
    def command_help(shell, command_name); end
    def default_command(meth = _); end
    def default_task(meth = _); end
    def deprecation_warning(message); end
    def desc(usage, description, options = _); end
    def disable_required_check!(*command_names); end
    def disable_required_check?(command); end
    def help(shell, subcommand = _); end
    def long_desc(long_description, options = _); end
    def map(mappings = _, **kw); end
    def method_option(name, options = _); end
    def method_options(options = _); end
    def option(name, options = _); end
    def options(options = _); end
    def package_name(name, _ = _); end
    def printable_commands(all = _, subcommand = _); end
    def printable_tasks(all = _, subcommand = _); end
    def register(klass, subcommand_name, usage, description, options = _); end
    ...
    def banner(command, namespace = _, subcommand = _); end
    def baseclass; end
...
module Thor::LineEditor
  class << self
    ...
    def readline(prompt, options = _); end
  end
end
...
module Thor::Util
  class << self
    ...
    def find_class_and_command_by_namespace(namespace, fallback = _); end
    def find_class_and_task_by_namespace(namespace, fallback = _); end
    def globs_for(path); end
    def load_thorfile(path, content = _, debug = _); end
    def namespace_from_thor_class(constant); end
    def namespaces_in_content(contents, file = _); end
