...
module Mail::Encodings
  ...
  class << self
    def address_encode(address, charset = _); end
    def b_value_decode(str); end
    def b_value_encode(string, encoding = _); end
    ...
    def q_value_encode(encoded_str, encoding = _); end
    def register(name, cls); end
    def transcode_charset(str, from_charset, to_charset = _); end
...
class Mail::Encodings::TransferEncoding
  class << self
    ...
    def negotiate(message_encoding, source_encoding, str, allowed_encodings = _); end
    def renegotiate(message_encoding, source_encoding, str, allowed_encodings = _); end
    def to_s; end
  end
end
...
class Mail::Ruby19
  class << self
    def b_value_decode(str); end
    def b_value_encode(str, encoding = _); end
    def bracket(str); end
    ...
    def q_value_decode(str); end
    def q_value_encode(str, encoding = _); end
    def string_byteslice(str, *args); end
    def transcode_charset(str, from_encoding, to_encoding = _); end
    def uri_parser; end
