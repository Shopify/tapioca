...
module ActiveModel
  class << self
    # source://activemodel/7.0.7.2/lib/active_model.rb#72
    def eager_load!; end

    # source://activemodel/7.0.7.2/lib/active_model/gem_version.rb#5
    def gem_version; end

    # source://activemodel/7.0.7.2/lib/active_model/version.rb#7
    def version; end
  end
end
