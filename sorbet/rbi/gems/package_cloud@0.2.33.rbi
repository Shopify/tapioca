...
class PackageCloud::CLI::Entry < ::PackageCloud::CLI::Base
  ...
  def create_package(client_repo, f, dist_id, files, ext); end
  def create_package_skip_errors(client_repo, f, dist_id, files, ext); end
...
class PackageCloud::ConfigFile
  ...
  def abort_on_incorrect_locale; end
...
class PackageCloud::Repository < ::PackageCloud::Object
  ...
  def create_package(file_path, dist_id, files = _, filetype = _); end
