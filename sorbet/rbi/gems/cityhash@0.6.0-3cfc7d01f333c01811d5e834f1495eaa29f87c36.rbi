...
# source://cityhash-VERSION/lib/cityhash/version.rb:1
module CityHash
  class << self
    # source://cityhash-VERSION/lib/cityhash.rb:14
    def hash128(input, seed = T.unsafe(nil)); end

    # source://cityhash-VERSION/lib/cityhash.rb:8
    def hash64(input, seed1 = T.unsafe(nil), seed2 = T.unsafe(nil)); end
  end
end

# source://cityhash-VERSION/lib/cityhash.rb:6
...
# source://cityhash-VERSION/lib/cityhash.rb:5
CityHash::LOW64_MASK = T.let(T.unsafe(nil), Integer)

# source://cityhash-VERSION/lib/cityhash/version.rb:2
