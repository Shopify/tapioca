...
# source://railties-7.0.3.1/lib/rails/command.rb:10
module Rails::Command
  ...
  class << self
    # source://railties-7.0.3.1/lib/rails/command.rb:25
    def environment; end
    ...
    #
    # source://railties-7.0.3.1/lib/rails/command.rb:68
    def find_by_namespace(namespace, command_name = T.unsafe(nil)); end

    # source://railties-7.0.3.1/lib/rails/command.rb:21
    def hidden_commands; end

    # Receives a namespace, arguments, and the behavior to invoke the command.
    #
    # source://railties-7.0.3.1/lib/rails/command.rb:30
    def invoke(full_namespace, args = T.unsafe(nil), **config); end

    # source://railties-7.0.3.1/lib/rails/command.rb:88
    def print_commands; end

    # Returns the root of the Rails engine or app running the command.
    #
    # source://railties-7.0.3.1/lib/rails/command.rb:80
    def root; end

    private

    # source://railties-7.0.3.1/lib/rails/command.rb:108
    def command_type; end

    # source://railties-7.0.3.1/lib/rails/command.rb:100
    def commands; end

    # source://railties-7.0.3.1/lib/rails/command.rb:116
    def file_lookup_paths; end

    # source://railties-7.0.3.1/lib/rails/command.rb:112
    def lookup_paths; end

    # @return [Boolean]
    #
    # source://railties-7.0.3.1/lib/rails/command.rb:96
    def rails_new_with_no_path?(args); end
  end
end

# source://railties-7.0.3.1/lib/rails/command/actions.rb:5
module Rails::Command::Actions
  # source://railties-7.0.3.1/lib/rails/command/actions.rb:48
  def load_generators; end

  # source://railties-7.0.3.1/lib/rails/command/actions.rb:44
  def load_tasks; end

  # source://railties-7.0.3.1/lib/rails/command/actions.rb:18
  def require_application!; end

  # source://railties-7.0.3.1/lib/rails/command/actions.rb:13
  def require_application_and_environment!; end

  # source://railties-7.0.3.1/lib/rails/command/actions.rb:26
  def require_environment!; end
  ...
  #
  # source://railties-7.0.3.1/lib/rails/command/actions.rb:9
  def set_application_directory!; end
end

# source://railties-7.0.3.1/lib/rails/command/base.rb:13
class Rails::Command::Base < ::Thor
  include ::Rails::Command::Actions

  # source://railties-7.0.3.1/lib/rails/command/base.rb:174
  def help; end

  class << self
    # Use Rails' default banner.
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:99
    ...
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:106
    def base_name; end
    ...
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:115
    ...
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:135
    def default_command_root; end

    # Tries to get the description from a USAGE file one folder above the command
    # root.
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:49
    ...
    # @return [Boolean]
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:43
    def engine?; end

    # source://railties-7.0.3.1/lib/rails/command/base.rb:94
    def executable; end

    # @return [Boolean]
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:38
    def exit_on_failure?; end

    # Convenience method to hide this command from the available ones when
    # running rails command.
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:70
    def hide_command!; end

    # source://railties-7.0.3.1/lib/rails/command/base.rb:74
    def inherited(base); end
    ...
    # is removed.
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:60
    def namespace(name = T.unsafe(nil)); end

    # source://railties-7.0.3.1/lib/rails/command/base.rb:82
    def perform(command, args, config); end

    # source://railties-7.0.3.1/lib/rails/command/base.rb:90
    def printing_commands; end

    # Path to lookup a USAGE description in a file.
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:123
    def usage_path; end

    private

    # source://railties-7.0.3.1/lib/rails/command/base.rb:155
    def command_root_namespace; end

    # Allow the command method to be called perform.
    #
    # source://railties-7.0.3.1/lib/rails/command/base.rb:142
    def create_command(meth); end

    # source://railties-7.0.3.1/lib/rails/command/base.rb:163
    def namespaced_commands; end

    # source://railties-7.0.3.1/lib/rails/command/base.rb:159
    def relative_command_path; end
  end
end

# source://railties-7.0.3.1/lib/rails/command/base.rb:17
class Rails::Command::Base::CorrectableError < ::Rails::Command::Base::Error
  ...
  #
  # source://railties-7.0.3.1/lib/rails/command/base.rb:20
  def initialize(message, key, options); end

  # source://railties-7.0.3.1/lib/rails/command/base.rb:29
  def corrections; end

  # Returns the value of attribute key.
  #
  # source://railties-7.0.3.1/lib/rails/command/base.rb:18
  def key; end
...
# source://railties-7.0.3.1/lib/rails/command/base.rb:14
class Rails::Command::Base::Error < ::Thor::Error; end

# source://railties-7.0.3.1/lib/rails/command/behavior.rb:7
...
# source://railties-7.0.3.1/lib/rails/command/behavior.rb:0
module Rails::Command::Behavior::ClassMethods
  # source://railties-7.0.3.1/lib/rails/command/behavior.rb:12
  def no_color!; end

  # source://railties-7.0.3.1/lib/rails/command/behavior.rb:17
  def subclasses; end

  private

  # source://railties-7.0.3.1/lib/rails/command/behavior.rb:36
  def lookup(namespaces); end

  # source://railties-7.0.3.1/lib/rails/command/behavior.rb:56
  def lookup!; end

  # source://railties-7.0.3.1/lib/rails/command/behavior.rb:70
  def namespaces_to_paths(namespaces); end

  # source://railties-7.0.3.1/lib/rails/command/behavior.rb:23
  def print_list(base, namespaces); end
end

# source://railties-7.0.3.1/lib/rails/command.rb:18
...
# source://railties-7.0.3.1/lib/rails/generators.rb:17
module Rails::Generators
  include ::Rails::Command::Behavior
  extend ::Rails::Command::Behavior::ClassMethods

  # source://railties-7.0.3.1/lib/rails/generators.rb:30
  def namespace; end
  ...
  class << self
    # source://railties-7.0.3.1/lib/rails/generators.rb:276
    def add_generated_file(file); end

    # source://railties-7.0.3.1/lib/rails/generators.rb:91
    def after_generate_callbacks; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:83
    def aliases; end
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators.rb:115
    def api_only!; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:67
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators.rb:107
    def fallbacks; end
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators.rb:232
    def find_by_namespace(name, base = T.unsafe(nil), context = T.unsafe(nil)); end

    # Show help message with available generators.
    #
    # source://railties-7.0.3.1/lib/rails/generators.rb:168
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators.rb:133
    def hidden_namespaces; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:162
    ...
    # commands.
    #
    # source://railties-7.0.3.1/lib/rails/generators.rb:259
    ...
    # source://railties-7.0.3.1/lib/rails/generators.rb:87
    def options; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:189
    def print_generators; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:184
    def public_namespaces; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:193
    def sorted_groups; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:79
    def templates_path; end

    private

    # source://railties-7.0.3.1/lib/rails/generators.rb:303
    def command_type; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:311
    def file_lookup_paths; end

    # Try fallbacks for the given base.
    #
    # source://railties-7.0.3.1/lib/rails/generators.rb:288
    def invoke_fallbacks_for(name, base); end

    # source://railties-7.0.3.1/lib/rails/generators.rb:307
    def lookup_paths; end

    # source://railties-7.0.3.1/lib/rails/generators.rb:282
    def print_list(base, namespaces); end

    # source://railties-7.0.3.1/lib/rails/generators.rb:315
    def run_after_generate_callback; end
  end
end

# source://railties-7.0.3.1/lib/rails/generators/actions.rb:9
module Rails::Generators::Actions
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:10
  def initialize(*_arg0); end
  ...
  #   end
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:106
  ...
  #   end
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:132
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:22
  def gem(*args); end
  ...
  #   end
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:66
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:238
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:154
  def git(commands = T.unsafe(nil)); end

  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:80
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:227
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:187
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:263
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:253
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:208
  ...
  #   readme "README"
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:314
  def readme(path); end
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:281
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:173
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:388
  def append_file_with_newline(path, str, options = T.unsafe(nil)); end

  # Runs the supplied command using either "rake ..." or "rails ..."
  # based on the executor parameter provided.
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:333
  def execute_command(executor, command, options = T.unsafe(nil)); end

  # Add an extension to the given name based on the platform.
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:347
  def extify(name); end

  # Indent the +Gemfile+ to the depth of @indentation
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:375
  def indentation; end
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:322
  def log(*args); end

  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:394
  def match_file(path, pattern); end

  # Returns optimized string with indentation
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:368
  def optimize_indentation(value, amount = T.unsafe(nil)); end

  # Always returns value in double quotes.
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:356
  def quote(value); end
  ...
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:398
  def route_namespace_pattern(namespace); end

  # Manage +Gemfile+ indentation for a DSL action block
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions.rb:380
  def with_indentation(&block); end
end

# source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:9
class Rails::Generators::Actions::CreateMigration < ::Thor::Actions::CreateFile
  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:41
  ...
  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:18
  def identical?; end

  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:22
  def invoke!; end

  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:10
  def migration_dir; end

  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:14
  def migration_file_name; end

  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:37
  def relative_existing_migration; end

  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:29
  def revoke!; end

  private

  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:48
  def on_conflict_behavior; end

  # source://railties-7.0.3.1/lib/rails/generators/actions/create_migration.rb:69
...
# instead of self.new.
#
# source://railties-7.0.3.1/lib/rails/generators/active_model.rb:28
class Rails::Generators::ActiveModel
  # @return [ActiveModel] a new instance of ActiveModel
  #
  # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:31
  def initialize(name); end

  # DELETE destroy
  #
  # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:75
  def destroy; end

  # POST create
  # PATCH/PUT update
  #
  # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:70
  def errors; end

  # Returns the value of attribute name.
  #
  # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:29
  def name; end

  # POST create
  #
  # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:59
  def save; end

  # PATCH/PUT update
  #
  # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:64
  def update(params = T.unsafe(nil)); end

  class << self
    # GET index
    #
    # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:36
    def all(klass); end

    # GET new
    # POST create
    #
    # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:50
    ...
    # DELETE destroy
    #
    # source://railties-7.0.3.1/lib/rails/generators/active_model.rb:44
    def find(klass, params = T.unsafe(nil)); end
  end
end

# source://railties-7.0.3.1/lib/rails/generators/app_base.rb:13
class Rails::Generators::AppBase < ::Rails::Generators::Base
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:103
  ...
  # source://railties-7.0.3.1/lib/rails/generators/base.rb:393
  def shebang; end
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:347
  def adjusted_javascript_option; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:144
  def apply_rails_template; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:175
  def asset_pipeline_gemfile_entry; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:133
  def build(meth, *args); end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:125
  def builder; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:380
  def bundle_command(command, env = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:406
  def bundle_install?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:373
  def cable_gemfile_entry; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:201
  def comment_if(value); end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:137
  def create_root; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:355
  def css_gemfile_entry; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:163
  def database_gemfile_entry; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:414
  def depend_on_bootsnap?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:410
  def depends_on_system_test?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:475
  def empty_directory_with_keep_file(destination, config = T.unsafe(nil)); end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:397
  def exec_bundle_command(bundle_command, command, env); end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:110
  def gemfile_entries; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:469
  def generate_bundler_binstub; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:329
  def hotwire_gemfile_entry; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:186
  def include_all_railties?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:319
  def javascript_gemfile_entry; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:314
  def jbuilder_gemfile_entry; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:480
  def keep_file(destination); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:214
  def keeps?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:365
  def psych_gemfile_entry; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:287
  def rails_gemfile_entry; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:283
  def rails_prerelease?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:301
  def rails_version_specifier(gem_version = T.unsafe(nil)); end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:440
  def run_bundle; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:459
  def run_css; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:453
  def run_hotwire; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:444
  def run_javascript; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:150
  def set_default_accessors!; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:226
  def skip_action_mailbox?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:230
  def skip_action_text?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:222
  def skip_active_storage?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:234
  def skip_dev_gems?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:242
  def skip_propshaft?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:238
  def skip_sprockets?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:218
  def sqlite3?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:418
  def target_rails_prerelease(self_command = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:341
  def using_node?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:171
  def web_server_gemfile_entry; end

  class << self
    # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:26
    def add_shared_options_for(name); end

    # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:22
    def strict_args_position; end
  end
end

# source://railties-7.0.3.1/lib/rails/generators/app_base.rb:247
class Rails::Generators::AppBase::GemfileEntry < ::Struct
  # @return [GemfileEntry] a new instance of GemfileEntry
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:248
  def initialize(name, version, comment, options = T.unsafe(nil), commented_out = T.unsafe(nil)); end

  # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:272
  def to_s; end

  class << self
    # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:264
    def floats(name, comment = T.unsafe(nil)); end

    # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:252
    def github(name, github, branch = T.unsafe(nil), comment = T.unsafe(nil)); end

    # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:268
    def path(name, path, comment = T.unsafe(nil)); end

    # source://railties-7.0.3.1/lib/rails/generators/app_base.rb:260
    def version(name, version, comment = T.unsafe(nil)); end
  end
end

# source://railties-7.0.3.1/lib/rails/generators/app_name.rb:5
module Rails::Generators::AppName
  private

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:33
  def app_const; end

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:28
  def app_const_base; end

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:9
  def app_name; end

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:28
  def camelized; end

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:21
  def defined_app_const_base; end

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:21
  def defined_app_const_base?; end

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:17
  def defined_app_name; end

  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:13
  def original_app_name; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/app_name.rb:37
  def valid_const?; end
end

# source://railties-7.0.3.1/lib/rails/generators/app_name.rb:6
Rails::Generators::AppName::RESERVED_NAMES = T.let(T.unsafe(nil), Array)

# source://railties-7.0.3.1/lib/rails/generators/base.rb:17
class Rails::Generators::Base < ::Thor::Group
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/base.rb:256
  def class_collisions(*class_names); end

  # Takes in an array of nested modules and extracts the last module
  #
  # source://railties-7.0.3.1/lib/rails/generators/base.rb:279
  def extract_last_module(nesting); end

  # source://railties-7.0.3.1/lib/rails/generators/base.rb:294
  def indent(content, multiplier = T.unsafe(nil)); end

  # Wrap block with namespace of current application
  # if namespace exists and is not skipped
  #
  # source://railties-7.0.3.1/lib/rails/generators/base.rb:288
  def module_namespacing(&block); end

  # source://railties-7.0.3.1/lib/rails/generators/base.rb:304
  def namespace; end

  # source://railties-7.0.3.1/lib/rails/generators/base.rb:312
  def namespace_dirs; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/base.rb:308
  def namespaced?; end

  # source://railties-7.0.3.1/lib/rails/generators/base.rb:316
  def namespaced_path; end

  # source://railties-7.0.3.1/lib/rails/generators/base.rb:299
  ...
  class << self
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:388
    def add_shebang_option!; end

    # Use Rails default banner.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:321
    def banner; end

    # Sets the base_name taking into account the current class namespace.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:326
    def base_name; end

    # Returns the base root for a common set of generators. This is used to dynamically
    # guess the default source root.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:228
    def base_root; end

    # Make class option aware of Rails::Generators.options and Rails::Generators.aliases.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:209
    def class_option(name, options = T.unsafe(nil)); end

    # Returns default aliases for the option name given doing a lookup in
    # Rails::Generators.aliases.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:349
    def default_aliases_for_option(name, options); end

    # Returns default for the option name given doing a lookup in config.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:354
    def default_for_option(config, name, options, default); end

    # source://railties-7.0.3.1/lib/rails/generators/base.rb:414
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:219
    def default_source_root; end

    # Returns the default value for the option name given doing a lookup in
    # Rails::Generators.options.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:343
    def default_value_for_option(name, options); end

    # Tries to get the description from a USAGE file one folder above the source
    # root otherwise uses a default description.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:41
    def desc(description = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:29
    def exit_on_failure?; end

    # Removes the namespaces and get the generator name. For example,
    # Rails::Generators::ModelGenerator will return "model" as generator name.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:334
    def generator_name; end

    # Convenience method to hide this generator from the available ones when
    # running rails generator command.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:61
    def hide!; end
    ...
    #   end
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:174
    def hook_for(*names, &block); end

    # Keep hooks configuration that are used on prepare_for_invocation.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:367
    def hooks; end

    # Cache source root and add lib/generators/base/generator/templates to
    # source paths.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:234
    def inherited(base); end
    ...
    # is removed.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:54
    def namespace(name = T.unsafe(nil)); end

    # Prepare class invocation to search on Rails namespace if a previous
    # added hook is being used.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:373
    ...
    #   remove_hook_for :orm
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:200
    def remove_hook_for(*names); end

    # Returns the source root for this generator using default_source_root as default.
    #
    # source://railties-7.0.3.1/lib/rails/generators/base.rb:34
    def source_root(path = T.unsafe(nil)); end

    # source://railties-7.0.3.1/lib/rails/generators/base.rb:406
    def usage_path; end
  end
end

# source://railties-7.0.3.1/lib/rails/generators.rb:32
Rails::Generators::DEFAULT_ALIASES = T.let(T.unsafe(nil), Hash)

# source://railties-7.0.3.1/lib/rails/generators.rb:49
Rails::Generators::DEFAULT_OPTIONS = T.let(T.unsafe(nil), Hash)

# source://railties-7.0.3.1/lib/rails/generators/database.rb:5
module Rails::Generators::Database
  # source://railties-7.0.3.1/lib/rails/generators/database.rb:9
  def initialize(*_arg0); end

  # source://railties-7.0.3.1/lib/rails/generators/database.rb:29
  def convert_database_option_for_jruby; end

  # source://railties-7.0.3.1/lib/rails/generators/database.rb:14
  def gem_for_database(database = T.unsafe(nil)); end

  private

  # source://railties-7.0.3.1/lib/rails/generators/database.rb:42
  def mysql_socket; end
end

# source://railties-7.0.3.1/lib/rails/generators/database.rb:7
Rails::Generators::Database::DATABASES = T.let(T.unsafe(nil), Array)

# source://railties-7.0.3.1/lib/rails/generators/database.rb:6
Rails::Generators::Database::JDBC_DATABASES = T.let(T.unsafe(nil), Array)

# source://railties-7.0.3.1/lib/rails/generators/base.rb:14
class Rails::Generators::Error < ::Thor::Error; end

# source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:7
class Rails::Generators::GeneratedAttribute
  # @return [GeneratedAttribute] a new instance of GeneratedAttribute
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:97
  def initialize(name, type = T.unsafe(nil), index_type = T.unsafe(nil), attr_options = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:199
  def attachment?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:203
  def attachments?; end

  # Returns the value of attribute attr_options.
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:31
  def attr_options; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:159
  def column_name; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:121
  def default; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:105
  def field_type; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:163
  def foreign_key?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:179
  def has_index?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:183
  def has_uniq_index?; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:147
  def human_name; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:151
  def index_name; end
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:32
  def index_name=(_arg0); end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:215
  def inject_index_options; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:211
  def inject_options; end

  # Returns the value of attribute name.
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:30
  def name; end
  ...
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:219
  def options_for_migration; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:187
  def password_digest?; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:139
  def plural_name; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:171
  def polymorphic?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:167
  def reference?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:175
  def required?; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:195
  def rich_text?; end

  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:143
  def singular_name; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:191
  def token?; end
  ...
  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:207
  def virtual?; end

  class << self
    # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:35
    def parse(column_definition); end

    # @return [Boolean]
    #
    # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:72
    def reference?(type); end

    # @return [Boolean]
    #
    # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:68
    def valid_index_type?(index_type); end

    # @return [Boolean]
    #
    # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:63
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:79
    def parse_type_and_options(type); end
  end
end

# source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:10
Rails::Generators::GeneratedAttribute::DEFAULT_TYPES = T.let(T.unsafe(nil), Array)

# source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:8
Rails::Generators::GeneratedAttribute::INDEX_OPTIONS = T.let(T.unsafe(nil), Array)

# source://railties-7.0.3.1/lib/rails/generators/generated_attribute.rb:9
...
module Rails::Generators::Migration
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/migration.rb:56
  def migration_template(source, destination, config = T.unsafe(nil)); end

  # source://railties-7.0.3.1/lib/rails/generators/migration.rb:39
  def set_migration_assigns!(destination); end
end

# source://railties-7.0.3.1/lib/rails/generators/migration.rb:15
module Rails::Generators::Migration::ClassMethods
  # source://railties-7.0.3.1/lib/rails/generators/migration.rb:24
  def current_migration_number(dirname); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/migration.rb:20
  def migration_exists?(dirname, file_name); end

  # source://railties-7.0.3.1/lib/rails/generators/migration.rb:16
  def migration_lookup_at(dirname); end

  # @raise [NotImplementedError]
  #
  # source://railties-7.0.3.1/lib/rails/generators/migration.rb:30
  def next_migration_number(dirname); end
end

# source://railties-7.0.3.1/lib/rails/generators/model_helpers.rb:7
module Rails::Generators::ModelHelpers
  # source://railties-7.0.3.1/lib/rails/generators/model_helpers.rb:25
  def initialize(args, *_options); end

  # source://railties-7.0.3.1/lib/rails/generators/model_helpers.rb:19
  def skip_warn; end
  ...
  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/model_helpers.rb:55
  def inflection_impossible?(name); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/model_helpers.rb:51
  def irregular_model_name?(name); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/model_helpers.rb:47
  def plural_model_name?(name); end

  class << self
    # source://railties-7.0.3.1/lib/rails/generators/model_helpers.rb:21
...
class Rails::Generators::NamedBase < ::Rails::Generators::Base
  ...
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:29
  ...
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:23
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:138
  def application_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:175
  def assign_names!(name); end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:188
  def attributes_names; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:70
  def class_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:58
  def class_path; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:105
  def edit_helper(*_arg0, &_arg1); end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:54
  def file_path; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:125
  def fixture_file_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:74
  def human_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:82
  def i18n_scope; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:97
  def index_helper(type: T.unsafe(nil)); end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:43
  def inside_template; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:50
  def inside_template?; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:150
  def model_resource_name(base_name = T.unsafe(nil), prefix: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:200
  def mountable_engine?; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:66
  def namespaced_class_path; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:109
  def new_helper(type: T.unsafe(nil)); end

  # Convert attributes array into GeneratedAttribute objects.
  #
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:182
  def parse_attributes!; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:121
  def plural_file_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:78
  def plural_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:167
  def plural_route_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:117
  def plural_table_name; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:196
  def pluralize_table_names?; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:146
  def redirect_resource_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:62
  def regular_class_path; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:129
  def route_url; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:101
  def show_helper(arg = T.unsafe(nil), type: T.unsafe(nil)); end

  # FIXME: We are avoiding to use alias because a bug on thor that make
  # this method public and add it to the task list.
  #
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:39
  def singular_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:159
  def singular_route_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:113
  def singular_table_name; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:86
  def table_name; end

  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:93
  def uncountable?; end

  # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:133
  ...
  class << self
    ...
    #
    # source://railties-7.0.3.1/lib/rails/generators/named_base.rb:214
...
# ActiveModel.
#
# source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:10
module Rails::Generators::ResourceHelpers
  include ::Rails::Generators::ModelHelpers

  # Set controller variables on initialization.
  #
  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:17
  def initialize(*args); end

  private

  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:39
  def assign_controller_names!(name); end

  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:50
  def controller_class_name; end

  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:31
  def controller_class_path; end

  # Returns the value of attribute controller_file_name.
  #
  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:29
  def controller_file_name; end

  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:46
  def controller_file_path; end

  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:54
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:61
  def orm_class; end

  # Initialize ORM::Generators::ActiveModel to access instance methods.
  #
  # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:77
  def orm_instance(name = T.unsafe(nil)); end

  class << self
    # source://railties-7.0.3.1/lib/rails/generators/resource_helpers.rb:11
    def included(base); end
  end
end
...
#   end
#
# source://railties-7.0.3.1/lib/rails/generators/test_case.rb:30
class Rails::Generators::TestCase < ::ActiveSupport::TestCase
  ...
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:21
  ...
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:22
  ...
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:23
  ...
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:24
...
# source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:13
module Rails::Generators::Testing; end

# source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:6
module Rails::Generators::Testing::Assertions
  ...
  #   end
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:88
  ...
  #   end
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:25
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:117
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:110
  ...
  #   end
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:100
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:64
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:47
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/assertions.rb:74
  def assert_no_migration(relative); end
end

# source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:14
module Rails::Generators::Testing::Behaviour
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:85
  def create_generated_attribute(attribute_type, name = T.unsafe(nil), index = T.unsafe(nil)); end

  # Instantiate the generator.
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:77
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:67
  ...
  # @return [Boolean]
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:90
  def destination_root_is_set?; end

  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:94
  def ensure_current_path; end

  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:104
  def migration_file_name(relative); end

  # Clears all files and directories in destination.
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:99
...
# source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:27
module Rails::Generators::Testing::Behaviour::ClassMethods
  ...
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:39
  ...
  #   destination File.expand_path("../tmp", __dir__)
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:46
  ...
  #   tests AppGenerator
  #
  # source://railties-7.0.3.1/lib/rails/generators/testing/behaviour.rb:31
  def tests(klass); end
end

# source://railties-7.0.3.1/lib/rails/generators/testing/setup_and_teardown.rb:6
module Rails::Generators::Testing::SetupAndTeardown
  # source://railties-7.0.3.1/lib/rails/generators/testing/setup_and_teardown.rb:7
  def setup; end

  # source://railties-7.0.3.1/lib/rails/generators/testing/setup_and_teardown.rb:13
  def teardown; end
end
