...
class Rack::Builder
  ...
  class << self
    def app(default_app = _, &block); end
    def load_file(path, opts = _); end
    def new_from_string(builder_script, file = _); end
    def parse_file(config, opts = _); end
  end
end
...
class Rack::Cascade
  def initialize(apps, cascade_for = _); end
...
module Rack::Multipart
  class << self
    def build_multipart(params, first = _); end
    def extract_multipart(req, params = _); end
    def parse_multipart(env, params = _); end
  end
end
...
class Rack::Multipart::UploadedFile
  def initialize(filepath = _, ct = _, bin = _, path: _, content_type: _, binary: _, filename: _, io: _); end
...
module Rack::Request::Helpers
  ...
  def host_with_port(authority = _); end
  def hostname; end
  def ip; end
  def link?; end
  def logger; end
...
class Rack::Response
  ...
  def initialize(body = _, status = _, headers = _); end
...
module Rack::Response::Helpers
  ...
  def add_header(key, v); end
  def bad_request?; end
  def cache!(duration = _, directive: _); end
