...
# source://shopify-money-VERSION/lib/money/accounting_money_parser.rb:3
class AccountingMoneyParser < ::MoneyParser
  # source://shopify-money-VERSION/lib/money/accounting_money_parser.rb:4
  def parse(input, currency = T.unsafe(nil), **options); end
end

# source://shopify-money-VERSION/lib/money/helpers.rb:4
class Money
  include ::Comparable
  extend ::Forwardable
  ...
  #
  # source://shopify-money-VERSION/lib/money/money.rb:84
  def initialize(value, currency); end

  # source://shopify-money-VERSION/lib/money/money.rb:139
  def *(numeric); end

  # source://shopify-money-VERSION/lib/money/money.rb:127
  def +(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:133
  def -(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:116
  def -@; end

  # source://shopify-money-VERSION/lib/money/money.rb:146
  def /(numeric); end

  # source://shopify-money-VERSION/lib/money/money.rb:120
  def <=>(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:154
  def ==(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:240
  def abs; end

  # @see Money::Allocator#allocate
  #
  # source://shopify-money-VERSION/lib/money/money.rb:260
  def allocate(splits, strategy = T.unsafe(nil)); end

  # @see Money::Allocator#allocate_max_amounts
  #
  # source://shopify-money-VERSION/lib/money/money.rb:265
  def allocate_max_amounts(maximums); end

  # source://shopify-money-VERSION/lib/money/money.rb:236
  ...
  #
  # source://shopify-money-VERSION/lib/money/money.rb:292
  ...
  # @raise [ArgumentError]
  #
  # source://shopify-money-VERSION/lib/money/money.rb:314
  def clamp(min, max); end

  # @raise [TypeError]
  #
  # source://shopify-money-VERSION/lib/money/money.rb:189
  def coerce(other); end

  # Returns the value of attribute currency.
  #
  # source://shopify-money-VERSION/lib/money/money.rb:10
  def currency; end

  # source://shopify-money-VERSION/lib/money/money.rb:95
  ...
  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/money.rb:159
  def eql?(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:244
  def floor; end

  # @raise [ArgumentError]
  #
  # source://shopify-money-VERSION/lib/money/money.rb:252
  def fraction(rate); end

  # source://RUBY_ROOT/forwardable.rb:229
  def hash(*args, **_arg1, &block); end

  # source://shopify-money-VERSION/lib/money/money.rb:91
  def init_with(coder); end

  # source://shopify-money-VERSION/lib/money/money.rb:150
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/money.rb:112
  def no_currency?; end
  ...
  # source://shopify-money-VERSION/lib/money/money.rb:248
  ...
  #
  # source://shopify-money-VERSION/lib/money/money.rb:277
  def split(num); end

  # source://shopify-money-VERSION/lib/money/money.rb:100
  def subunits(format: T.unsafe(nil)); end

  # source://shopify-money-VERSION/lib/money/money.rb:208
  def to_d; end
  ...
  # source://shopify-money-VERSION/lib/money/money.rb:232
  def to_json(options = T.unsafe(nil)); end

  # source://shopify-money-VERSION/lib/money/money.rb:194
  def to_money(curr = T.unsafe(nil)); end

  # source://shopify-money-VERSION/lib/money/money.rb:212
  ...
  # @yield [other]
  #
  # source://shopify-money-VERSION/lib/money/money.rb:329
  def arithmetic(money_or_numeric); end

  # source://shopify-money-VERSION/lib/money/money.rb:336
  def calculated_currency(other); end

  class << self
    # source://shopify-money-VERSION/lib/money/deprecations.rb:5
    def active_support_deprecator; end

    # source://shopify-money-VERSION/lib/money/money.rb:55
    def current_currency; end

    # source://shopify-money-VERSION/lib/money/money.rb:59
    def current_currency=(currency); end

    # Returns the value of attribute default_currency.
    #
    # source://shopify-money-VERSION/lib/money/money.rb:14
    ...
    # source://shopify-money-VERSION/lib/money/money.rb:77
    def default_settings; end

    # source://shopify-money-VERSION/lib/money/deprecations.rb:9
    def deprecate(message); end

    # source://shopify-money-VERSION/lib/money/money.rb:16
    def from_amount(value = T.unsafe(nil), currency = T.unsafe(nil)); end

    # source://shopify-money-VERSION/lib/money/money.rb:33
    def from_subunits(subunits, currency_iso, format: T.unsafe(nil)); end

    # source://shopify-money-VERSION/lib/money/money.rb:16
    def new(value = T.unsafe(nil), currency = T.unsafe(nil)); end

    # source://shopify-money-VERSION/lib/money/money.rb:29
    ...
    # source://shopify-money-VERSION/lib/money/money.rb:48
    ...
    #
    # source://shopify-money-VERSION/lib/money/money.rb:67
    def with_currency(new_currency); end
  end
end

# source://shopify-money-VERSION/lib/money/allocator.rb:5
class Money::Allocator < ::SimpleDelegator
  # @return [Allocator] a new instance of Allocator
  #
  # source://shopify-money-VERSION/lib/money/allocator.rb:6
  ...
  #
  # source://shopify-money-VERSION/lib/money/allocator.rb:42
  def allocate(splits, strategy = T.unsafe(nil)); end
  ...
  #
  # source://shopify-money-VERSION/lib/money/allocator.rb:78
  def allocate_max_amounts(maximums); end
  ...
  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/allocator.rb:129
  def all_rational?(splits); end

  # source://shopify-money-VERSION/lib/money/allocator.rb:133
  def allocation_index_for(strategy, length, idx); end

  # @raise [ArgumentError]
  #
  # source://shopify-money-VERSION/lib/money/allocator.rb:115
  def amounts_from_splits(allocations, splits, subunits_to_split = T.unsafe(nil)); end

  # source://shopify-money-VERSION/lib/money/allocator.rb:107
  def extract_currency(money_array); end
end

# source://shopify-money-VERSION/lib/money/currency/loader.rb:5
class Money::Currency
  # @raise [UnknownCurrency]
  # @return [Currency] a new instance of Currency
  #
  # source://shopify-money-VERSION/lib/money/currency.rb:33
  def initialize(currency_iso); end

  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/currency.rb:49
  def ==(other); end

  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/currency.rb:57
  def compatible?(other); end

  # Returns the value of attribute decimal_mark.
  #
  # source://shopify-money-VERSION/lib/money/currency.rb:30
  ...
  # source://shopify-money-VERSION/lib/money/currency.rb:53
  def hash; end
  ...
  class << self
    # source://shopify-money-VERSION/lib/money/currency.rb:25
    def currencies; end

    # source://shopify-money-VERSION/lib/money/currency.rb:19
    def find(currency_iso); end

    # @raise [UnknownCurrency]
    #
    # source://shopify-money-VERSION/lib/money/currency.rb:12
    def find!(currency_iso); end
...
# source://shopify-money-VERSION/lib/money/currency/loader.rb:6
module Money::Currency::Loader
  class << self
    # source://shopify-money-VERSION/lib/money/currency/loader.rb:8
    def load_currencies; end

    private

    # source://shopify-money-VERSION/lib/money/currency/loader.rb:20
    def deep_deduplicate!(data); end
  end
end

# source://shopify-money-VERSION/lib/money/currency.rb:9
class Money::Currency::UnknownCurrency < ::ArgumentError; end

# source://shopify-money-VERSION/lib/money/errors.rb:3
class Money::Error < ::StandardError; end

# source://shopify-money-VERSION/lib/money/helpers.rb:5
module Money::Helpers
  private

  # source://shopify-money-VERSION/lib/money/helpers.rb:43
  def value_to_currency(currency); end

  # source://shopify-money-VERSION/lib/money/helpers.rb:15
...
# source://shopify-money-VERSION/lib/money/helpers.rb:8
Money::Helpers::DECIMAL_ZERO = T.let(T.unsafe(nil), BigDecimal)

# source://shopify-money-VERSION/lib/money/helpers.rb:9
Money::Helpers::MAX_DECIMAL = T.let(T.unsafe(nil), Integer)

# source://shopify-money-VERSION/lib/money/helpers.rb:11
Money::Helpers::STRIPE_SUBUNIT_OVERRIDE = T.let(T.unsafe(nil), Hash)

# source://shopify-money-VERSION/lib/money/errors.rb:6
class Money::IncompatibleCurrencyError < ::Money::Error; end

# source://shopify-money-VERSION/lib/money/money.rb:8
...
#
# source://shopify-money-VERSION/lib/money/null_currency.rb:34
class Money::NullCurrency
  # @return [NullCurrency] a new instance of NullCurrency
  #
  # source://shopify-money-VERSION/lib/money/null_currency.rb:39
  def initialize; end

  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/null_currency.rb:57
  def ==(other); end

  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/null_currency.rb:53
  def compatible?(other); end

  # Returns the value of attribute decimal_mark.
  #
  # source://shopify-money-VERSION/lib/money/null_currency.rb:36
  def decimal_mark; end
  ...
  # source://shopify-money-VERSION/lib/money/null_currency.rb:61
  def to_s; end
end

# source://shopify-money-VERSION/lib/money/money.rb:165
class Money::ReverseOperationProxy
  include ::Comparable

  # @return [ReverseOperationProxy] a new instance of ReverseOperationProxy
  #
  # source://shopify-money-VERSION/lib/money/money.rb:168
  def initialize(value); end

  # source://shopify-money-VERSION/lib/money/money.rb:184
  def *(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:176
  def +(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:180
  def -(other); end

  # source://shopify-money-VERSION/lib/money/money.rb:172
  def <=>(other); end
end

# source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:2
module MoneyColumn; end

# source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:3
module MoneyColumn::ActiveRecordHooks
  mixes_in_class_methods ::MoneyColumn::ActiveRecordHooks::ClassMethods

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:8
  def reload(*_arg0); end

  private

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:20
  def clear_money_column_cache; end

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:24
  def init_internals; end

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:13
  def initialize_dup(*_arg0); end

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:29
  def read_money_attribute(column); end

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:42
  def write_money_attribute(column, money); end

  class << self
    # @private
    #
    # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:4
    def included(base); end
  end
end

# source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:70
module MoneyColumn::ActiveRecordHooks::ClassMethods
  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:73
  ...
  #
  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:71
  def money_column_options; end

  private

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:121
  def clear_cache_on_currency_change(currency_column); end

  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:130
  def inherited(subclass); end

  # @raise [ArgumentError]
  #
  # source://shopify-money-VERSION/lib/money_column/active_record_hooks.rb:106
  def normalize_money_column_options(options); end
end

# source://shopify-money-VERSION/lib/money_column/active_record_type.rb:2
class MoneyColumn::ActiveRecordType < ::ActiveModel::Type::Decimal
  # source://shopify-money-VERSION/lib/money_column/active_record_type.rb:3
  def serialize(money); end
end

# source://shopify-money-VERSION/lib/money_column/railtie.rb:3
class MoneyColumn::Railtie < ::Rails::Railtie; end

# Parse an amount from a string
#
# source://shopify-money-VERSION/lib/money/money_parser.rb:4
class MoneyParser
  # source://shopify-money-VERSION/lib/money/money_parser.rb:64
  ...
  #
  # source://shopify-money-VERSION/lib/money/money_parser.rb:72
  def extract_amount_from_string(input, currency, strict); end

  # @return [Boolean]
  #
  # source://shopify-money-VERSION/lib/money/money_parser.rb:127
  def last_digits_decimals?(digits, marks, currency); end

  # source://shopify-money-VERSION/lib/money/money_parser.rb:116
  def normalize_number(number, marks, currency); end

  class << self
    # source://shopify-money-VERSION/lib/money/money_parser.rb:60
    def parse(input, currency = T.unsafe(nil), **options); end
  end
end
...
# 1,1123,4567.89
#
# source://shopify-money-VERSION/lib/money/money_parser.rb:51
MoneyParser::CHINESE_NUMERIC_REGEX = T.let(T.unsafe(nil), Regexp)

# 1.234.567,89
#
# source://shopify-money-VERSION/lib/money/money_parser.rb:30
MoneyParser::COMMA_DECIMAL_REGEX = T.let(T.unsafe(nil), Regexp)

# 1,234,567.89
#
# source://shopify-money-VERSION/lib/money/money_parser.rb:20
MoneyParser::DOT_DECIMAL_REGEX = T.let(T.unsafe(nil), Regexp)

# source://shopify-money-VERSION/lib/money/money_parser.rb:9
MoneyParser::ESCAPED_MARKS = T.let(T.unsafe(nil), String)

# source://shopify-money-VERSION/lib/money/money_parser.rb:12
MoneyParser::ESCAPED_NON_COMMA_MARKS = T.let(T.unsafe(nil), String)

# source://shopify-money-VERSION/lib/money/money_parser.rb:11
MoneyParser::ESCAPED_NON_DOT_MARKS = T.let(T.unsafe(nil), String)

# source://shopify-money-VERSION/lib/money/money_parser.rb:10
MoneyParser::ESCAPED_NON_SPACE_MARKS = T.let(T.unsafe(nil), String)

# 12,34,567.89
#
# source://shopify-money-VERSION/lib/money/money_parser.rb:40
MoneyParser::INDIAN_NUMERIC_REGEX = T.let(T.unsafe(nil), Regexp)

# source://shopify-money-VERSION/lib/money/money_parser.rb:7
MoneyParser::MARKS = T.let(T.unsafe(nil), Array)

# source://shopify-money-VERSION/lib/money/money_parser.rb:5
class MoneyParser::MoneyFormatError < ::ArgumentError; end

# source://shopify-money-VERSION/lib/money/money_parser.rb:14
...
#
# source://shopify-money-VERSION/lib/money/core_extensions.rb:5
class Numeric
  include ::Comparable

  # source://shopify-money-VERSION/lib/money/core_extensions.rb:6
...
# source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:3
module RuboCop; end

# source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:4
module RuboCop::Cop; end

# source://rubocop-VERSION/lib/rubocop/cop/mixin/allowed_pattern.rb:38
RuboCop::Cop::IgnoredPattern = RuboCop::Cop::AllowedPattern

# source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:5
module RuboCop::Cop::Money; end

# source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:20
class RuboCop::Cop::Money::MissingCurrency < ::RuboCop::Cop::Cop
  # source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:47
  def autocorrect(node); end

  # source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:22
  def money_new(param0 = T.unsafe(nil)); end

  # source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:34
  def on_csend(node); end

  # source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:34
  def on_send(node); end

  # source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:30
  def to_money_block?(param0 = T.unsafe(nil)); end

  # source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:26
  def to_money_without_currency?(param0 = T.unsafe(nil)); end

  private

  # source://shopify-money-VERSION/lib/rubocop/cop/money/missing_currency.rb:73
  def replacement_currency; end
end

# source://shopify-money-VERSION/lib/rubocop/cop/money/zero_money.rb:25
class RuboCop::Cop::Money::ZeroMoney < ::RuboCop::Cop::Cop
  # source://shopify-money-VERSION/lib/rubocop/cop/money/zero_money.rb:39
  def autocorrect(node); end

  # source://shopify-money-VERSION/lib/rubocop/cop/money/zero_money.rb:29
  def money_zero(param0 = T.unsafe(nil)); end

  # source://shopify-money-VERSION/lib/rubocop/cop/money/zero_money.rb:33
  def on_send(node); end

  private

  # source://shopify-money-VERSION/lib/rubocop/cop/money/zero_money.rb:56
...
#   Money.new(0, 'CAD')
#
# source://shopify-money-VERSION/lib/rubocop/cop/money/zero_money.rb:27
...
#   '100.37'.to_money => #<Money @cents=10037>
#
# source://shopify-money-VERSION/lib/money/core_extensions.rb:15
class String
  include ::Comparable

  # source://shopify-money-VERSION/lib/money/core_extensions.rb:16
  def to_money(currency = T.unsafe(nil)); end
end
