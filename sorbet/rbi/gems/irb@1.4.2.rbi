...
module IRB
  class << self
    ...
    # source://irb//lib/irb/init.rb#208
    def init_error; end
    ...
    #
    # source://irb//lib/irb.rb#379
    def irb_at_exit; end

    # Quits irb
    #
    # source://irb//lib/irb.rb#384
    def irb_exit(irb, ret); end

    # loading modules
    #
    # source://irb//lib/irb/init.rb#400
    ...
    #
    # source://irb//lib/irb/init.rb#376
    def rc_file_generators; end

    # running config
    #
    # source://irb//lib/irb/init.rb#341
    def run_config; end

    # source://irb//lib/irb/init.rb#163
...
module IRB::Color
  class << self
    ...
    # source://irb//lib/irb/color.rb#210
    def dispatch_seq(token, expr, str, in_symbol:); end

    # source://irb//lib/irb/color.rb#168
    def scan(code, allow_last_error:); end

    # source://irb//lib/irb/color.rb#160
...
#
# source://irb//lib/irb/color.rb#226
...
class IRB::Context
  ...
  # IRB::History.
  #
  # source://irb//lib/irb/extend-command.rb#289
  def eval_history=(*opts, &b); end

  # source://irb//lib/irb/context.rb#473
  def evaluate(line, line_no, exception: T.unsafe(nil)); end

  # Exits the current session, see IRB.irb_exit
  #
  # source://irb//lib/irb/context.rb#489
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/context.rb#413
  def file_input?; end
  ...
  # source://irb//lib/irb/context.rb#483
  ...
  # See IRB@Command+line+options for more command line options.
  #
  # source://irb//lib/irb/context.rb#430
  ...
  #
  # source://irb//lib/irb/context.rb#378
  def last_value; end
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/context.rb#371
  def prompting?; end
  ...
  # to #last_value.
  #
  # source://irb//lib/irb/context.rb#382
...
module IRB::ContextExtender
  class << self
    ...
    #
    # source://irb//lib/irb/extend-command.rb#287
    ...
    #
    # source://irb//lib/irb/extend-command.rb#277
    def install_extend_commands; end
  end
end

# source://irb//lib/irb/init.rb#411
...
module IRB::ExtendCommandBundle
  ...
  #
  # source://irb//lib/irb/extend-command.rb#222
  def install_alias_method(to, from, override = T.unsafe(nil)); end

  # source://irb//lib/irb/extend-command.rb#189
  ...
  class << self
    ...
    #
    # source://irb//lib/irb/extend-command.rb#165
    def install_extend_commands; end
...
# source://irb//lib/irb/init.rb#356
...
module IRB::InputCompletor
  class << self
    ...
    # source://irb//lib/irb/completion.rb#447
    ...
    # source://irb//lib/irb/completion.rb#75
    def retrieve_gem_and_system_load_path; end

    # source://irb//lib/irb/completion.rb#435
...
#
# source://irb//lib/irb/completion.rb#433
IRB::InputCompletor::Operators = T.let(T.unsafe(nil), Array)

# source://irb//lib/irb/completion.rb#398
...
class IRB::Irb
  ...
  #
  # source://irb//lib/irb.rb#805
  def inspect; end

  # source://irb//lib/irb.rb#767
  def output_value(omit = T.unsafe(nil)); end

  # source://irb//lib/irb.rb#728
  def prompt(prompt, ltype, indent, line_no); end

  # source://irb//lib/irb.rb#433
  ...
  # information.
  #
  # source://irb//lib/irb.rb#659
  def suspend_workspace(workspace); end
end

# source://irb//lib/irb.rb#396
...
module IRB::MethodExtender
  ...
  # +extend_method+.
  #
  # source://irb//lib/irb/extend-command.rb#323
  def def_post_proc(base_method, extend_method); end

  # Extends the given +base_method+ with a prefix call to the given
  # +extend_method+.
  #
  # source://irb//lib/irb/extend-command.rb#307
  ...
  #
  # source://irb//lib/irb/extend-command.rb#344
...
# source://irb//lib/irb/input-method.rb#474
...
class IRB::RelineInputMethod < ::IRB::InputMethod
  ...
  # See IO#gets for more information.
  #
  # source://irb//lib/irb/input-method.rb#416
  def gets; end

  # For debug message
  #
  # source://irb//lib/irb/input-method.rb#461
  def inspect; end
  ...
  #
  # source://irb//lib/irb/input-method.rb#451
  def line(line_no); end
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#442
  def readable_after_eof?; end
end
...
class RubyLex
  ...
  # source://irb//lib/irb/ruby-lex.rb#468
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/ruby-lex.rb#828
  def heredoc_scope?; end

  # @return [Boolean]
  #
  # source://irb//lib/irb/ruby-lex.rb#833
