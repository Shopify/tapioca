...
# source://state_machines-VERSION/lib/state_machines/assertions.rb:1
class Hash
  include ::Enumerable
  ...
  # @raise [ArgumentError]
  #
  # source://state_machines-VERSION/lib/state_machines/assertions.rb:35
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/assertions.rb:14
...
#
# source://state_machines-VERSION/lib/state_machines/version.rb:1
...
#
# source://state_machines-VERSION/lib/state_machines/matcher.rb:23
class StateMachines::AllMatcher < ::StateMachines::Matcher
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:33
  def -(blacklist); end

  # A human-readable description of this matcher.  Always "all".
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:48
  def description; end

  # Always returns the given set of values
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:43
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:38
...
# based events
#
# source://state_machines-VERSION/lib/state_machines/transition_collection.rb:193
class StateMachines::AttributeTransitionCollection < ::StateMachines::TransitionCollection
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:194
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:229
  def persist; end

  # Resets callback tracking
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:235
  def reset; end

  # Resets the event attribute so it can be re-evaluated if attempted again
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:241
  def rollback; end

  # Hooks into running transition callbacks so that event / event transition
  # attributes can be properly updated
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:201
  def run_callbacks(index = T.unsafe(nil)); end
end

# Matches everything but a specific set of values
#
# source://state_machines-VERSION/lib/state_machines/matcher.rb:82
class StateMachines::BlacklistMatcher < ::StateMachines::Matcher
  # A human-readable description of this matcher
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:94
  def description; end

  # Finds all values that are *not* within the blacklist configured for this
  # matcher
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:89
  def filter(values); end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:83
  def matches?(value, context = T.unsafe(nil)); end
end
...
# an object's state.
#
# source://state_machines-VERSION/lib/state_machines/branch.rb:6
class StateMachines::Branch
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:30
  def initialize(options = T.unsafe(nil)); end

  # source://state_machines-VERSION/lib/state_machines/branch.rb:122
  def draw(graph, event, valid_states); end

  # The requirement for verifying the event being matched
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:17
  def event_requirement; end

  # The condition that must be met on an object
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:11
  ...
  # * +to+ / +except_to+
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:27
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:114
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:85
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:21
  def state_requirements; end

  # The condition that must *not* be met on an object
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:14
  ...
  # built.
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:130
  def build_matcher(options, whitelist_option, blacklist_option); end

  # Verifies that the event requirement matches the given query
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:157
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:148
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:163
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:177
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/branch.rb:171
...
#
# source://state_machines-VERSION/lib/state_machines/callback.rb:7
class StateMachines::Callback
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:123
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:107
  def branch; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:157
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:147
  def known_states; end
  ...
  #   end
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:100
  def terminator; end
  ...
  # * +failure+
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:71
  def type; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:200
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/callback.rb:176
  ...
  class << self
    ...
    #   end
    #
    # source://state_machines-VERSION/lib/state_machines/callback.rb:55
    ...
    #
    # source://state_machines-VERSION/lib/state_machines/callback.rb:62
    def terminator; end
...
# source://state_machines-VERSION/lib/state_machines/extensions.rb:2
module StateMachines::ClassMethods
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/extensions.rb:17
  def state_machines; end

  class << self
    # source://state_machines-VERSION/lib/state_machines/extensions.rb:3
...
#
# source://state_machines-VERSION/lib/state_machines/error.rb:4
class StateMachines::Error < ::StandardError
  # @return [Error] a new instance of Error
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:7
  def initialize(object, message = T.unsafe(nil)); end

  # The object that failed
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:5
  def object; end
end
...
# of an object.
#
# source://state_machines-VERSION/lib/state_machines/eval_helpers.rb:4
module StateMachines::EvalHelpers
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/eval_helpers.rb:53
...
#
# source://state_machines-VERSION/lib/state_machines/event.rb:5
class StateMachines::Event
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:33
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:23
  def branches; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:107
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:67
  def context(&block); end

  # source://state_machines-VERSION/lib/state_machines/event.rb:181
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:192
  def inspect; end

  # A list of all of the states known to this event using the configured
  # branches/transitions as the source
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:27
  def known_states; end

  # The state machine for which this event is defined
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:10
  def machine; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:13
  def name; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:164
  def on_failure(object); end

  # The fully-qualified name of the event, scoped by the machine's namespace
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:16
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:175
  def reset; end
  ...
  # @raise [ArgumentError]
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:87
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:121
  ...
  # the current event
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:205
  def add_actions; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event.rb:53
  def initialize_copy(orig); end
end

# Represents a collection of events in a state machine
#
# source://state_machines-VERSION/lib/state_machines/event_collection.rb:3
class StateMachines::EventCollection < ::StateMachines::NodeCollection
  # @return [EventCollection] a new instance of EventCollection
  #
  # source://state_machines-VERSION/lib/state_machines/event_collection.rb:4
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event_collection.rb:114
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event_collection.rb:81
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/event_collection.rb:41
  def valid_for(object, requirements = T.unsafe(nil)); end

  private

  # source://state_machines-VERSION/lib/state_machines/event_collection.rb:135
...
# state machine
#
# source://state_machines-VERSION/lib/state_machines/helper_module.rb:4
class StateMachines::HelperModule < ::Module
  # @return [HelperModule] a new instance of HelperModule
  #
  # source://state_machines-VERSION/lib/state_machines/helper_module.rb:5
  def initialize(machine, kind); end

  # Provides a human-readable description of the module
  #
  # source://state_machines-VERSION/lib/state_machines/helper_module.rb:11
  def to_s; end
end

# source://state_machines-VERSION/lib/state_machines/extensions.rb:22
module StateMachines::InstanceMethods
  ...
  #   vehicle.alarm_state                           # => "off"
  #
  # source://state_machines-VERSION/lib/state_machines/extensions.rb:100
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/extensions.rb:137
  def fire_events!(*events); end

  protected

  # source://state_machines-VERSION/lib/state_machines/extensions.rb:144
  def initialize_state_machines(options = T.unsafe(nil), &block); end
end

# An invalid integration was registered
#
# source://state_machines-VERSION/lib/state_machines/error.rb:42
class StateMachines::IntegrationError < ::StandardError; end

# An invalid integration was specified
#
# source://state_machines-VERSION/lib/state_machines/error.rb:15
class StateMachines::IntegrationNotFound < ::StateMachines::Error
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:16
  def initialize(name); end

  # source://state_machines-VERSION/lib/state_machines/error.rb:32
  def error_message; end

  # source://state_machines-VERSION/lib/state_machines/error.rb:28
  def no_integrations; end

  # source://state_machines-VERSION/lib/state_machines/error.rb:20
  def valid_integrations; end

  # source://state_machines-VERSION/lib/state_machines/error.rb:24
...
# integrations.
#
# source://state_machines-VERSION/lib/state_machines/integrations.rb:20
module StateMachines::Integrations
  class << self
    ...
    #
    # source://state_machines-VERSION/lib/state_machines/integrations.rb:99
    ...
    #
    # source://state_machines-VERSION/lib/state_machines/integrations.rb:48
    ...
    #
    # source://state_machines-VERSION/lib/state_machines/integrations.rb:75
    def match(klass); end
    ...
    #
    # source://state_machines-VERSION/lib/state_machines/integrations.rb:87
    def match_ancestors(ancestors); end

    # Register integration
    #
    # source://state_machines-VERSION/lib/state_machines/integrations.rb:25
    def register(name_or_module); end

    # source://state_machines-VERSION/lib/state_machines/integrations.rb:35
    def reset; end

    private

    # source://state_machines-VERSION/lib/state_machines/integrations.rb:105
...
#
# source://state_machines-VERSION/lib/state_machines/integrations/base.rb:4
module StateMachines::Integrations::Base
  mixes_in_class_methods ::StateMachines::Integrations::Base::ClassMethods

  class << self
    # source://state_machines-VERSION/lib/state_machines/integrations/base.rb:36
    def included(base); end
  end
end

# source://state_machines-VERSION/lib/state_machines/integrations/base.rb:5
module StateMachines::Integrations::Base::ClassMethods
  # The default options to use for state machines using this integration
  #
  # source://state_machines-VERSION/lib/state_machines/integrations/base.rb:7
  def defaults; end

  # The name of the integration
  #
  # source://state_machines-VERSION/lib/state_machines/integrations/base.rb:10
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/integrations/base.rb:26
...
class StateMachines::InvalidParallelTransition < ::StateMachines::Error
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:102
  def initialize(object, events); end

  # The set of events that failed the transition(s)
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:100
  def events; end
end

# An invalid transition was attempted
#
# source://state_machines-VERSION/lib/state_machines/error.rb:58
class StateMachines::InvalidTransition < ::StateMachines::Error
  # @return [InvalidTransition] a new instance of InvalidTransition
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:64
  def initialize(object, machine, event); end

  # The event that triggered the failed transition
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:77
  def event; end

  # The current state value for the machine
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:62
  def from; end

  # The name for the current state
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:87
  def from_name; end

  # The machine attempting to be transitioned
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:59
  def machine; end

  # The fully-qualified name of the event that triggered the failed transition
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:82
  def qualified_event; end

  # The fully-qualified name for the current state
  #
  # source://state_machines-VERSION/lib/state_machines/error.rb:92
...
#
# source://state_machines-VERSION/lib/state_machines/matcher.rb:101
class StateMachines::LoopbackMatcher < ::StateMachines::Matcher
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:117
  def description; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:112
...
#
# source://state_machines-VERSION/lib/state_machines/machine.rb:400
class StateMachines::Machine
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:503
  def initialize(owner_class, *args, &block); end

  # The action to invoke when an object transitions
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:492
  def action; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1881
  ...
  #   end
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1747
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1652
  ...
  # for defining callbacks.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1713
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:678
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1641
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:489
  def callbacks; end
  ...
  #   end_eval
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:718
  def define_helper(scope, method, *args, &block); end

  # source://state_machines-VERSION/lib/state_machines/machine.rb:1875
  def draw(*_arg0); end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:651
  ...
  # raised.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1837
  ...
  #   end
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1307
  def event(*names, &block); end

  # The events that trigger transitions.  These are sorted, by default, in
  # the order in which they were defined.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:473
  def events; end

  # Generates the message to use when invalidating the given object after
  # failing to transition on a specific event
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1849
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:646
  ...
  # creation time.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:593
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:663
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1831
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:469
  def name; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:497
  def namespace; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1005
  def other_states(*names, &block); end

  # The class that the machine is defined in
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:465
  def owner_class; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:565
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1824
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1052
  ...
  # By default, this is a no-op.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1844
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:484
  def states; end
  ...
  # @raise [ArgumentError]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1426
  def transition(options); end

  # Whether the machine will use transactions when firing events
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:500
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1866
  ...
  #   vehicle.event                                           # => "park"
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1076
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2044
  def action_hook; end

  # Adds a new transition callback of the given type.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2189
  def add_callback(type, options, &block); end

  # Tracks the given set of events in the list of all known events for
  # this machine
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2218
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2181
  def add_sibling_machine_configs; end

  # Tracks the given set of states in the list of all known states for
  # this machine
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2197
  def add_states(new_states); end

  # Runs additional initialization hooks.  By default, this is a no-op.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1887
  ...
  # By default, this is a no-op.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2152
  ...
  # By default, this is a no-op.
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2159
  def create_without_scope(name); end

  # Adds helper methods for automatically firing events when an action
  # is invoked
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2013
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2007
  def define_action_helpers?; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2023
  def define_action_hook; end

  # Adds helper methods for getting information about this state machine's
  # events
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1955
  def define_event_helpers; end

  # Adds helper methods for interacting with the state machine, including
  # for states, events, and transitions
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1914
  def define_helpers; end

  # Adds helper methods for accessing naming information about states and
  # events on the owner class
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2085
  def define_name_helpers; end

  # Adds helper methods for getting information about this state machine's
  # available transition paths
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1997
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2112
  def define_scopes(custom_plural = T.unsafe(nil)); end

  # Adds reader/writer methods for accessing the state attribute
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1935
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1926
  def define_state_initializer; end

  # Adds predicate method to the owner class for determining the name of the
  # current state
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1944
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1907
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2052
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2169
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2175
  def owner_class_attribute_default_matches?(state); end

  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2078
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2139
  def pluralize(word); end

  # Generates the results for the given scope based on one or more states to
  # filter by
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2132
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:1896
  def sibling_machines; end

  # Always yields
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:2163
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine.rb:552
  def initialize_copy(orig); end

  class << self
    # Default messages to use for validation errors in ORM integrations
    #
    # source://state_machines-VERSION/lib/state_machines/machine.rb:451
    ...
    # source://state_machines-VERSION/lib/state_machines/machine.rb:446
    def draw(*_arg0); end
    ...
    #
    # source://state_machines-VERSION/lib/state_machines/machine.rb:417
    def find_or_create(owner_class, *args, &block); end

    # Returns the value of attribute ignore_method_conflicts.
    #
    # source://state_machines-VERSION/lib/state_machines/machine.rb:452
...
#
# source://state_machines-VERSION/lib/state_machines/machine_collection.rb:21
class StateMachines::MachineCollection < ::Hash
  # Runs one or more events in parallel on the given object.  See
  # StateMachines::InstanceMethods#fire_events for more information.
  #
  # source://state_machines-VERSION/lib/state_machines/machine_collection.rb:44
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine_collection.rb:22
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/machine_collection.rb:76
  def transitions(object, action, options = T.unsafe(nil)); end

  protected

  # source://state_machines-VERSION/lib/state_machines/machine_collection.rb:86
  def resolve_use_transactions; end
end

# source://state_machines-VERSION/lib/state_machines/macro_methods.rb:5
module StateMachines::MacroMethods
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/macro_methods.rb:516
...
# the matcher in use.
#
# source://state_machines-VERSION/lib/state_machines/matcher.rb:5
class StateMachines::Matcher
  # Creates a new matcher for querying against the given set of values
  #
  # @return [Matcher] a new instance of Matcher
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:10
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:16
  def filter(values); end

  # The list of values against which queries are matched
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:7
  def values; end
end

# Provides a set of helper methods for generating matchers
#
# source://state_machines-VERSION/lib/state_machines/matcher_helpers.rb:3
module StateMachines::MatcherHelpers
  ...
  # * +idling+
  #
  # source://state_machines-VERSION/lib/state_machines/matcher_helpers.rb:28
  def all; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/matcher_helpers.rb:50
  def same; end
end
...
#
# source://state_machines-VERSION/lib/state_machines/node_collection.rb:5
class StateMachines::NodeCollection
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:18
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:85
  def <<(node); end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:142
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:128
  def at(index); end

  # Appends a group of nodes to the collection
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:93
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:72
  ...
  #   parked -- idling --
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:115
  def each; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:161
  def fetch(key, index_name = T.unsafe(nil)); end

  # Gets the set of unique keys for the given index
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:65
  def keys(index_name = T.unsafe(nil)); end

  # Gets the number of nodes in this collection
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:60
  def length; end

  # The machine associated with the nodes
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:9
  def machine; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:54
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:100
  def update(node); end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:180
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:215
  def eval_context(context, node); end

  # Gets the given index.  If the index does not exist, then an ArgumentError
  # is raised.
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:168
  def index(name); end

  # Removes the given key from an index, including the string and symbol
  # versions of the index
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:188
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:209
  def to_sym?(value); end

  # Updates the node for the given index, including the string and symbol
  # versions of the index
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:196
  def update_index(name, node); end

  # Gets the value for the given attribute on the node
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:174
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/node_collection.rb:37
  def initialize_copy(orig); end
end
...
#
# source://state_machines-VERSION/lib/state_machines/path.rb:5
class StateMachines::Path < ::Array
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:22
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:85
  def complete?; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:70
  def events; end

  # The initial state name for this path
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:37
  def from_name; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:46
  def from_states; end

  # The state machine this path is walking
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:12
  def machine; end

  # The object whose state machine is being walked
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:9
  def object; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:52
  def to_name; end
  ...
  #   path.to_states  # => [:parked, :idling, :first_gear, ...]
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:61
  def to_states; end

  # Walks down the next transitions at the end of this path.  This will only
  # walk down paths that are considered valid.
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:76
  def walk; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/path.rb:110
  def can_walk_to?(transition); end

  # source://state_machines-VERSION/lib/state_machines/path.rb:31
  def initialize_copy(orig); end
...
#
# source://state_machines-VERSION/lib/state_machines/path_collection.rb:4
class StateMachines::PathCollection < ::Array
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:27
  def initialize(object, machine, options = T.unsafe(nil)); end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:67
  def events; end

  # The initial state to start each path from
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:14
  def from_name; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:47
  def from_states; end

  # The state machine these path are walking
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:11
  def machine; end

  # The object whose state machine is being walked
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:8
  def object; end

  # The target state for each path
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:17
  def to_name; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:57
  def to_states; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:73
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/path_collection.rb:83
  def walk(path); end
end
...
#
# source://state_machines-VERSION/lib/state_machines/state.rb:10
class StateMachines::State
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:53
  def initialize(machine, name, options = T.unsafe(nil)); end

  # Whether this state's value should be cached after being evaluated
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:30
  def cache; end
  ...
  # will be raised.
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:219
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:181
  def context(&block); end

  # The list of methods that have been defined in this state's context
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:208
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:127
  def description(options = T.unsafe(nil)); end

  # source://state_machines-VERSION/lib/state_machines/state.rb:242
  def draw(graph, options = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:98
  def final?; end

  # Transforms the state name into a more human-readable format, such as
  # "first gear" instead of "first_gear"
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:110
  def human_name(klass = T.unsafe(nil)); end

  # The human-readable name for the state
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:23
  def human_name=(_arg0); end

  # Whether or not this state is the initial state to use for new objects
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:33
  def initial; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:252
  def inspect; end

  # The state machine for which this state is defined
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:13
  def machine; end

  # source://state_machines-VERSION/lib/state_machines/state.rb:89
  def machine=(machine); end

  # A custom lambda block for determining whether a given value matches this
  # state
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:38
  def matcher; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:172
  def matches?(other_value); end

  # The unique identifier for the state used in event and callback definitions
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:16
  def name; end

  # The fully-qualified identifier for the state, scoped by the machine's
  # namespace
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:20
  def qualified_name; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:143
  def value(eval = T.unsafe(nil)); end

  # The value that is written to a machine's attribute when an object
  # transitions into this state
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:27
  def value=(_arg0); end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:265
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:259
  def cache_value?; end

  # Generates the name of the method containing the actual implementation
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:273
  def context_name_for(method); end

  # Creates a copy of this state, excluding the context to prevent conflicts
  # across different machines.
  #
  # source://state_machines-VERSION/lib/state_machines/state.rb:84
  def initialize_copy(orig); end
end

# Represents a collection of states in a state machine
#
# source://state_machines-VERSION/lib/state_machines/state_collection.rb:3
class StateMachines::StateCollection < ::StateMachines::NodeCollection
  # @return [StateCollection] a new instance of StateCollection
  #
  # source://state_machines-VERSION/lib/state_machines/state_collection.rb:4
  def initialize(machine); end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state_collection.rb:91
  def by_priority; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state_collection.rb:53
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state_collection.rb:77
  def match!(object); end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/state_collection.rb:27
  ...
  # Gets the value for the given attribute on the node
  #
  # source://state_machines-VERSION/lib/state_machines/state_collection.rb:106
  def value(node, attribute); end
end
...
#   vehicle.moving?           # => false
#
# source://state_machines-VERSION/lib/state_machines/state_context.rb:54
class StateMachines::StateContext < ::Module
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/state_context.rb:65
  def initialize(state); end

  # The state machine for which this context's state is defined
  #
  # source://state_machines-VERSION/lib/state_machines/state_context.rb:59
  def machine; end

  # Hooks in condition-merging to methods that don't exist in this module
  #
  # source://state_machines-VERSION/lib/state_machines/state_context.rb:99
  def method_missing(*args, &block); end

  # The state that must be present in an object for this context to be active
  #
  # source://state_machines-VERSION/lib/state_machines/state_context.rb:62
  def state; end
  ...
  # @raise [ArgumentError]
  #
  # source://state_machines-VERSION/lib/state_machines/state_context.rb:90
  def transition(options); end
end
...
# * An ending state
#
# source://state_machines-VERSION/lib/state_machines/transition.rb:8
class StateMachines::Transition
  # Creates a new, specific transition
  #
  # @return [Transition] a new instance of Transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:38
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:264
  def ==(other); end

  # The action that will be run when this transition is performed
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:60
  def action; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:23
  def args; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:55
  def attribute; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:136
  def attributes; end

  # The event that triggered the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:65
  def event; end

  # The original state value *before* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:16
  def from; end

  # The state name *before* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:80
  def from_name; end

  # The human-readable name of the event that triggered the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:75
  def human_event; end

  # The human-readable state name *before* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:90
  def human_from_name; end

  # The new human-readable state name *after* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:105
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:279
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:117
  def loopback?; end

  # The state machine for which this transition is defined
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:13
  def machine; end

  # The object being transitioned
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:10
  def object; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:158
  ...
  #   vehicle.state   # => 'idling'
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:219
  def persist; end

  # The fully-qualified name of the event that triggered the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:70
  def qualified_event; end

  # The fully-qualified state name *before* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:85
  def qualified_from_name; end

  # The new fully-qualified state name *after* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:100
  def qualified_to_name; end

  # Resets any tracking of which callbacks have already been run and whether
  # the state has already been persisted
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:257
  def reset; end

  # The result of invoking the action associated with the machine
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:26
  def result; end
  ...
  #   vehicle.state             # => "parked"
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:250
  def rollback; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:186
  def run_callbacks(options = T.unsafe(nil), &block); end

  # The new state value *after* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:19
  def to; end

  # The new state name *after* the transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:95
  def to_name; end

  # Whether the transition is only existing temporarily for the object
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:29
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:124
  def transient?; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:169
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:388
  def after; end
  ...
  # is reset.
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:343
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:410
  def context; end
  ...
  # getting paused.
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:290
  def pausable; end
  ...
  # @raise [ArgumentError]
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:307
  def pause; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition.rb:321
  def resume; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://state_machines-VERSION/lib/state_machines/transition.rb:33
...
#
# source://state_machines-VERSION/lib/state_machines/transition_collection.rb:3
class StateMachines::TransitionCollection < ::Array
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:22
  def initialize(transitions = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:50
  def perform(&block); end

  # Whether to skip running the action for each transition's machine
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:7
  def skip_actions; end

  # Whether to skip running the after callbacks
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:10
  def skip_after; end

  # Whether transitions should wrapped around a transaction block
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:13
  def use_transactions; end

  protected

  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:77
  def results; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:102
  def actions; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:168
  def catch_exceptions; end

  # Gets the object being transitioned
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:96
  def object; end

  # Transitions the current value of the object's states to those specified by
  # each transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:139
  def persist; end

  # Resets any information tracked from previous attempts to perform the
  # collection
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:115
  def reset; end

  # Rolls back changes made to the object's states via each transition
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:161
  def rollback; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:147
  def run_actions; end
  ...
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:125
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:91
  def success?; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:109
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:83
  def valid?; end

  # Runs a block within a transaction for the object being transitioned.  If
  # transactions are disabled, then this is a no-op.
  #
  # source://state_machines-VERSION/lib/state_machines/transition_collection.rb:179
  def within_transaction; end
end

# source://state_machines-VERSION/lib/state_machines/version.rb:2
StateMachines::VERSION = T.let(T.unsafe(nil), String)

# Matches a specific set of values
#
# source://state_machines-VERSION/lib/state_machines/matcher.rb:62
class StateMachines::WhitelistMatcher < ::StateMachines::Matcher
  # A human-readable description of this matcher
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:68
  def description; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-VERSION/lib/state_machines/matcher.rb:63
  def matches?(value, context = T.unsafe(nil)); end
end
