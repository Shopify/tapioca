...
#
# source://sprockets-VERSION/lib/sprockets/version.rb:2
module Sprockets
...
#
# source://sprockets-VERSION/lib/sprockets/add_source_map_comment_to_asset_processor.rb:28
class Sprockets::AddSourceMapCommentToAssetProcessor
  class << self
    # source://sprockets-VERSION/lib/sprockets/add_source_map_comment_to_asset_processor.rb:29
    def call(input); end
  end
end

# source://sprockets-VERSION/lib/sprockets/errors.rb:5
class Sprockets::ArgumentError < ::Sprockets::Error; end

# source://sprockets-VERSION/lib/sprockets/asset.rb:6
class Sprockets::Asset
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:17
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:207
  def ==(other); end

  # Public: Returns String base64 digest of source.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:152
  def base64digest; end

  # Public: Returns Integer length of source.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:120
  def bytesize; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:115
  def charset; end

  # Public: Returns String MIME type of asset. Returns nil if type is unknown.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:82
  def content_type; end

  # Public: Returns String byte digest of source.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:126
  def digest; end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:66
  def digest_path; end
  ...
  # @yield [to_s]
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:168
  def each; end

  # Private: Return the version of the environment where the asset was generated.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:131
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:141
  def etag; end

  # Public: Returns String path of asset.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:47
  def filename; end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:77
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:198
  def hash; end

  # Public: Returns String hexdigest of source.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:136
  def hexdigest; end
  ...
  # Returns a String.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:52
  def id; end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:190
  def inspect; end

  # Public: A "named information" URL for subresource integrity.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:157
  def integrity; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:89
  def links; end

  # Returns the value of attribute logical_path.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:7
  ...
  # Returns Hash.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:44
  def metadata; end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:96
  def source; end
  ...
  # Returns a Hash.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:33
  def to_hash; end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:108
  def to_s; end
  ...
  # Returns URI.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:59
  def uri; end
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/asset.rb:177
  def write_to(filename); end
end

# source://sprockets-VERSION/lib/sprockets/autoload.rb:3
module Sprockets::Autoload; end

# source://sprockets-VERSION/lib/sprockets/babel_processor.rb:8
class Sprockets::BabelProcessor
  # @return [BabelProcessor] a new instance of BabelProcessor
  #
  # source://sprockets-VERSION/lib/sprockets/babel_processor.rb:25
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute cache_key.
  #
  # source://sprockets-VERSION/lib/sprockets/babel_processor.rb:23
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/babel_processor.rb:40
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/babel_processor.rb:19
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/babel_processor.rb:15
    def call(input); end

    # source://sprockets-VERSION/lib/sprockets/babel_processor.rb:11
    def instance; end
  end
end

# source://sprockets-VERSION/lib/sprockets/babel_processor.rb:9
Sprockets::BabelProcessor::VERSION = T.let(T.unsafe(nil), String)

# `Base` class for `Environment` and `CachedEnvironment`.
#
# source://sprockets-VERSION/lib/sprockets/base.rb:32
class Sprockets::Base
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:118
  def [](*args, **options); end

  # Get persistent cache store
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:41
  def cache; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:48
  def cache=(cache); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:53
  def cached; end

  # source://sprockets-VERSION/lib/sprockets/base.rb:139
  def compress_from_root(uri); end

  # source://sprockets-VERSION/lib/sprockets/base.rb:143
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:63
  def file_digest(path); end

  # @yield [asset]
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:85
  def find_all_linked_assets(*args); end

  # Find asset by logical path or expanded path.
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:78
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:125
  ...
  # Pretty inspect
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:133
  def inspect; end
end

# source://sprockets-VERSION/lib/sprockets/bower.rb:5
module Sprockets::Bower
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/bower.rb:48
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/bower.rb:17
...
#
# source://sprockets-VERSION/lib/sprockets/bower.rb:9
...
#
# source://sprockets-VERSION/lib/sprockets/bundle.rb:16
class Sprockets::Bundle
  class << self
    # source://sprockets-VERSION/lib/sprockets/bundle.rb:17
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/bundle.rb:61
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/bundle.rb:80
...
#
# source://sprockets-VERSION/lib/sprockets/cache.rb:45
class Sprockets::Cache
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:68
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:156
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:85
  def fetch(key); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:115
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:149
  def inspect; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:140
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:170
  def expand_key(key); end

  # source://sprockets-VERSION/lib/sprockets/cache.rb:196
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache.rb:181
  def peek_key(key); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/cache.rb:56
...
#
# source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:20
class Sprockets::Cache::FileStore
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:42
  ...
  # Returns true
  #
  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:139
  def clear(options = T.unsafe(nil)); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:56
  def get(key); end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:126
  def inspect; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:85
  def set(key, value); end

  private

  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:166
  ...
  # mtime.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:152
  def find_caches; end

  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:183
  def gc!; end

  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:176
  def safe_open(path, &block); end

  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:170
  def safe_stat(fn); end

  # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:162
  def size; end
  ...
  class << self
    ...
    # Returns a Logger.
    #
    # source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:29
    def default_logger; end
  end
end
...
#
# source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:22
Sprockets::Cache::FileStore::DEFAULT_MAX_SIZE = T.let(T.unsafe(nil), Integer)

# source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:23
Sprockets::Cache::FileStore::EXCLUDED_DIRS = T.let(T.unsafe(nil), Array)

# source://sprockets-VERSION/lib/sprockets/cache/file_store.rb:24
Sprockets::Cache::FileStore::GITKEEP_FILES = T.let(T.unsafe(nil), Array)

# source://sprockets-VERSION/lib/sprockets/cache.rb:221
class Sprockets::Cache::GetWrapper < ::Sprockets::Cache::Wrapper
  # source://sprockets-VERSION/lib/sprockets/cache.rb:230
  def clear(options = T.unsafe(nil)); end

  # source://sprockets-VERSION/lib/sprockets/cache.rb:222
  def get(key); end

  # source://sprockets-VERSION/lib/sprockets/cache.rb:226
  def set(key, value); end
end

# source://sprockets-VERSION/lib/sprockets/cache.rb:241
class Sprockets::Cache::HashWrapper < ::Sprockets::Cache::Wrapper
  # source://sprockets-VERSION/lib/sprockets/cache.rb:250
  def clear(options = T.unsafe(nil)); end

  # source://sprockets-VERSION/lib/sprockets/cache.rb:242
  def get(key); end

  # source://sprockets-VERSION/lib/sprockets/cache.rb:246
  def set(key, value); end
end
...
#
# source://sprockets-VERSION/lib/sprockets/cache/memory_store.rb:14
class Sprockets::Cache::MemoryStore
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cache/memory_store.rb:22
  ...
  # Returns true
  #
  # source://sprockets-VERSION/lib/sprockets/cache/memory_store.rb:69
  def clear(options = T.unsafe(nil)); end
  ...
  # Returns Object or nil or the value is not set.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/memory_store.rb:34
  def get(key); end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/memory_store.rb:62
  def inspect; end
  ...
  # Returns Object value.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/memory_store.rb:52
  def set(key, value); end
end

# Internal: Default key limit for store.
#
# source://sprockets-VERSION/lib/sprockets/cache/memory_store.rb:16
...
#
# source://sprockets-VERSION/lib/sprockets/cache/null_store.rb:15
class Sprockets::Cache::NullStore
  # Public: Simulate clearing the cache
  #
  # Returns true
  #
  # source://sprockets-VERSION/lib/sprockets/cache/null_store.rb:49
  def clear(options = T.unsafe(nil)); end
  ...
  # Returns nil.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/null_store.rb:23
  def get(key); end
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/null_store.rb:42
  def inspect; end
  ...
  # Returns Object value.
  #
  # source://sprockets-VERSION/lib/sprockets/cache/null_store.rb:35
  def set(key, value); end
end

# source://sprockets-VERSION/lib/sprockets/cache.rb:176
Sprockets::Cache::PEEK_SIZE = T.let(T.unsafe(nil), Integer)

# source://sprockets-VERSION/lib/sprockets/cache.rb:256
class Sprockets::Cache::ReadWriteWrapper < ::Sprockets::Cache::Wrapper
  # source://sprockets-VERSION/lib/sprockets/cache.rb:265
  def clear(options = T.unsafe(nil)); end

  # source://sprockets-VERSION/lib/sprockets/cache.rb:257
  def get(key); end

  # source://sprockets-VERSION/lib/sprockets/cache.rb:261
  def set(key, value); end
end
...
# releases though.
#
# source://sprockets-VERSION/lib/sprockets/cache.rb:54
Sprockets::Cache::VERSION = T.let(T.unsafe(nil), String)

# source://sprockets-VERSION/lib/sprockets/cache.rb:218
...
# `Environment#cached`.
#
# source://sprockets-VERSION/lib/sprockets/cached_environment.rb:14
class Sprockets::CachedEnvironment < ::Sprockets::Base
  # @return [CachedEnvironment] a new instance of CachedEnvironment
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:15
  def initialize(environment); end

  # No-op return self as cached environment.
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:27
  def cached; end

  # Internal: Cache Environment#entries
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:33
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:43
  def load(uri); end

  # Internal: Cache Environment#processor_cache_key
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:48
  def processor_cache_key(str); end

  # Internal: Cache Environment#resolve_dependency
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:53
  def resolve_dependency(str); end

  # Internal: Cache Environment#stat
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:38
  def stat(path); end
  ...
  # @raise [RuntimeError]
  #
  # source://sprockets-VERSION/lib/sprockets/cached_environment.rb:60
...
#
# source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:18
class Sprockets::ClosureCompressor
  # @return [ClosureCompressor] a new instance of ClosureCompressor
  #
  # source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:38
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute cache_key.
  #
  # source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:36
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:43
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:32
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:28
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:24
    def instance; end
  end
end

# source://sprockets-VERSION/lib/sprockets/closure_compressor.rb:19
...
#
# source://sprockets-VERSION/lib/sprockets/coffee_script_processor.rb:13
module Sprockets::CoffeeScriptProcessor
  class << self
    # source://sprockets-VERSION/lib/sprockets/coffee_script_processor.rb:16
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/coffee_script_processor.rb:20
    def call(input); end
  end
end

# source://sprockets-VERSION/lib/sprockets/coffee_script_processor.rb:14
...
#
# source://sprockets-VERSION/lib/sprockets/compressing.rb:7
module Sprockets::Compressing
  include ::Sprockets::Utils

  # source://sprockets-VERSION/lib/sprockets/compressing.rb:10
  def compressors; end

  # Return CSS compressor or nil if none is set
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:40
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:49
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:116
  def gzip=(gzip); end
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:94
  def gzip?; end

  # Return JS compressor or nil if none is set
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:67
  ...
  # The compressor object must respond to `compress`.
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:76
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:32
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/compressing.rb:99
  def skip_gzip?; end
end

# source://sprockets-VERSION/lib/sprockets/configuration.rb:12
module Sprockets::Configuration
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:21
  def config; end

  # @raise [TypeError]
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:23
  def config=(config); end
  ...
  #     end
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:77
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:56
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:66
  def digest_class=(klass); end

  # source://sprockets-VERSION/lib/sprockets/configuration.rb:15
  def initialize_configuration(parent); end

  # Get and set `Logger` instance.
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:29
  def logger; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:41
  def version; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/configuration.rb:49
  def version=(version); end
end

# source://sprockets-VERSION/lib/sprockets/errors.rb:6
...
#
# source://sprockets-VERSION/lib/sprockets/context.rb:21
class Sprockets::Context
  # @return [Context] a new instance of Context
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:42
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:201
  ...
  # @raise [NotImplementedError]
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:216
  def asset_path(path, options = T.unsafe(nil)); end

  # Expand logical audio asset path.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:241
  ...
  #     'text/css'
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:88
  def content_type; end
  ...
  # source file.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:128
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:144
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:153
  def depend_on_env(key); end

  # source://sprockets-VERSION/lib/sprockets/context.rb:64
  def env_proxy; end

  # Returns the value of attribute environment.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:40
  def environment; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:246
  def font_path(path); end

  # Expand logical image asset path.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:231
  def image_path(path); end

  # Expand logical javascript asset path.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:251
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:184
  ...
  # Returns Asset.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:116
  def load(uri); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:73
  def load_path; end
  ...
  #     # => 'application'
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:81
  def logical_path; end

  # source://sprockets-VERSION/lib/sprockets/context.rb:57
  def metadata; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:166
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:104
  ...
  # in the bundle.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:174
  def stub_asset(path); end

  # Expand logical stylesheet asset path.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:256
  def stylesheet_path(path); end

  # Expand logical video asset path.
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:236
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:272
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:297
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:283
  def optimize_svg_for_uri_escaping!(svg); end

  # Returns a URI-encoded data URI (always "-quoted).
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:263
  def svg_asset_data_uri(asset); end
end

# Internal: Proxy for ENV that keeps track of the environment variables used
#
# source://sprockets-VERSION/lib/sprockets/context.rb:23
class Sprockets::Context::ENVProxy < ::SimpleDelegator
  # @return [ENVProxy] a new instance of ENVProxy
  #
  # source://sprockets-VERSION/lib/sprockets/context.rb:24
  def initialize(context); end

  # source://sprockets-VERSION/lib/sprockets/context.rb:29
  def [](key); end

  # source://sprockets-VERSION/lib/sprockets/context.rb:34
  def fetch(key, *_arg1); end
end

# source://sprockets-VERSION/lib/sprockets/errors.rb:9
...
#
# source://sprockets-VERSION/lib/sprockets/dependencies.rb:9
module Sprockets::Dependencies
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/dependencies.rb:48
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/dependencies.rb:25
  ...
  # Returns Hash.
  #
  # source://sprockets-VERSION/lib/sprockets/dependencies.rb:18
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/dependencies.rb:37
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/dependencies.rb:58
  def resolve_dependency(str); end
end
...
# Environment.
#
# source://sprockets-VERSION/lib/sprockets/digest_utils.rb:9
module Sprockets::DigestUtils
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:185
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:32
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:87
  def digest(obj); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:15
  def digest_class; end
  ...
  # Returns a String digest of the object.
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:98
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:176
  ...
  # Returns a String or nil if hash algorithm is incompatible.
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:154
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:125
  ...
  # Returns hex String.
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:107
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:134
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:116
  def unpack_hexdigest(hex); end

  private

  # source://sprockets-VERSION/lib/sprockets/digest_utils.rb:190
  def build_digest(obj); end
end

# source://sprockets-VERSION/lib/sprockets/digest_utils.rb:36
Sprockets::DigestUtils::ADD_VALUE_TO_DIGEST = T.let(T.unsafe(nil), Hash)

# Internal: Maps digest bytesize to the digest class.
#
# source://sprockets-VERSION/lib/sprockets/digest_utils.rb:20
Sprockets::DigestUtils::DIGEST_SIZES = T.let(T.unsafe(nil), Hash)

# Internal: Maps digest class to the CSP hash algorithm name.
#
# source://sprockets-VERSION/lib/sprockets/digest_utils.rb:142
...
#
# source://sprockets-VERSION/lib/sprockets/directive_processor.rb:37
class Sprockets::DirectiveProcessor
  # @return [DirectiveProcessor] a new instance of DirectiveProcessor
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:60
  def initialize(comments: T.unsafe(nil)); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:68
  def _call(input); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:64
  def call(input); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:104
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:141
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:284
  ...
  #     //= depend_on "foo.png"
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:269
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:300
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:186
  ...
  #   /*= link "logo.png" */
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:326
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:342
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:358
  ...
  #     //= require "./bar"
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:215
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:242
  ...
  #      */
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:229
  ...
  #     //= require_tree "./public"
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:252
  def process_require_tree_directive(path = T.unsafe(nil)); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:118
  ...
  #     //= stub "jquery"
  #
  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:314
  def process_stub_directive(path); end

  private

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:365
  def expand_accept_shorthand(accept); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:399
  def expand_relative_dirname(directive, path); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:383
  def link_paths(paths, deps, accept); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:377
  def require_paths(paths, deps); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:420
  def resolve(path, **kargs); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:389
  def resolve_paths(paths, deps, **kargs); end

  # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:415
  def to_load(uri); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:56
    def call(input); end

    # source://sprockets-VERSION/lib/sprockets/directive_processor.rb:51
    def instance; end
  end
end
...
#     //= require "foo"
#
# source://sprockets-VERSION/lib/sprockets/directive_processor.rb:47
Sprockets::DirectiveProcessor::DIRECTIVE_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://sprockets-VERSION/lib/sprockets/base.rb:20
class Sprockets::DoubleLinkError < ::Sprockets::Error
  # @return [DoubleLinkError] a new instance of DoubleLinkError
  #
  # source://sprockets-VERSION/lib/sprockets/base.rb:21
  def initialize(parent_filename:, logical_path:, last_filename:, filename:); end
end

# source://sprockets-VERSION/lib/sprockets/erb_processor.rb:4
class Sprockets::ERBProcessor
  # @return [ERBProcessor] a new instance of ERBProcessor
  #
  # source://sprockets-VERSION/lib/sprockets/erb_processor.rb:16
  def initialize(&block); end

  # source://sprockets-VERSION/lib/sprockets/erb_processor.rb:20
  def call(input); end
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/erb_processor.rb:39
  def keyword_constructor?; end

  class << self
    # source://sprockets-VERSION/lib/sprockets/erb_processor.rb:12
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/erb_processor.rb:8
    def instance; end
  end
end
...
#
# source://sprockets-VERSION/lib/sprockets/eco_processor.rb:12
module Sprockets::EcoProcessor
  class << self
    # source://sprockets-VERSION/lib/sprockets/eco_processor.rb:15
    def cache_key; end
    ...
    #     # => "function(...) {...}"
    #
    # source://sprockets-VERSION/lib/sprockets/eco_processor.rb:26
    def call(input); end
  end
end

# source://sprockets-VERSION/lib/sprockets/eco_processor.rb:13
...
#
# source://sprockets-VERSION/lib/sprockets/ejs_processor.rb:11
module Sprockets::EjsProcessor
  class << self
    # source://sprockets-VERSION/lib/sprockets/ejs_processor.rb:14
    def cache_key; end
    ...
    #     # => "function(obj){...}"
    #
    # source://sprockets-VERSION/lib/sprockets/ejs_processor.rb:25
    def call(input); end
  end
end

# source://sprockets-VERSION/lib/sprockets/ejs_processor.rb:12
...
#
# source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:9
module Sprockets::EncodingUtils
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:73
  def base64(str); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:122
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:19
  def deflate(str); end
  ...
  # Returns encoded String.
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:100
  def detect(str); end
  ...
  # Returns a encoded String.
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:178
  ...
  # Returns a encoded String.
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:245
  ...
  # Returns encoded String.
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:139
  ...
  # no BOM was present.
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:157
  ...
  # Returns a compressed String
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:59
  def gzip(str); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/encoding_utils.rb:208
...
class Sprockets::Environment < ::Sprockets::Base
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/environment.rb:13
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/environment.rb:25
  def cached; end

  # source://sprockets-VERSION/lib/sprockets/environment.rb:38
  def find_all_linked_assets(*args, &block); end

  # source://sprockets-VERSION/lib/sprockets/environment.rb:30
  def find_asset(*args, **options); end

  # source://sprockets-VERSION/lib/sprockets/environment.rb:34
  def find_asset!(*args); end
  ...
  # source://sprockets-VERSION/lib/sprockets/environment.rb:42
  def load(*args); end
end

# source://sprockets-VERSION/lib/sprockets/errors.rb:4
class Sprockets::Error < ::StandardError; end

# source://sprockets-VERSION/lib/sprockets/exporters/base.rb:2
...
#
# source://sprockets-VERSION/lib/sprockets/exporters/base.rb:9
class Sprockets::Exporters::Base
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/base.rb:24
  def initialize(asset: T.unsafe(nil), environment: T.unsafe(nil), directory: T.unsafe(nil)); end

  # Returns the value of attribute asset.
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/base.rb:10
  def asset; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/base.rb:55
  def call; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/base.rb:36
  def setup; end
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/base.rb:46
  def skip?(logger); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/base.rb:63
  def write(filename = T.unsafe(nil)); end
end

# Writes a an asset file to disk
#
# source://sprockets-VERSION/lib/sprockets/exporters/file_exporter.rb:6
class Sprockets::Exporters::FileExporter < ::Sprockets::Exporters::Base
  # source://sprockets-VERSION/lib/sprockets/exporters/file_exporter.rb:17
  def call; end

  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/file_exporter.rb:7
  def skip?(logger); end
end
...
#
# source://sprockets-VERSION/lib/sprockets/exporters/zlib_exporter.rb:8
class Sprockets::Exporters::ZlibExporter < ::Sprockets::Exporters::Base
  # source://sprockets-VERSION/lib/sprockets/exporters/zlib_exporter.rb:26
  def call; end

  # source://sprockets-VERSION/lib/sprockets/exporters/zlib_exporter.rb:9
  def setup; end

  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/exporters/zlib_exporter.rb:14
  def skip?(logger); end
end
...
# Zopfli gem.
#
# source://sprockets-VERSION/lib/sprockets/exporters/zopfli_exporter.rb:7
class Sprockets::Exporters::ZopfliExporter < ::Sprockets::Exporters::ZlibExporter
  # source://sprockets-VERSION/lib/sprockets/exporters/zopfli_exporter.rb:8
  def setup; end
end
...
# the `Environment` and `CachedEnvironment` classes.
#
# source://sprockets-VERSION/lib/sprockets/exporting.rb:4
module Sprockets::Exporting
  # Public: Checks if concurrent exporting is allowed
  #
  # source://sprockets-VERSION/lib/sprockets/exporting.rb:59
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/exporting.rb:69
  def export_concurrent=(export_concurrent); end

  # Exporters are ran on the assets:precompile task
  #
  # source://sprockets-VERSION/lib/sprockets/exporting.rb:6
  def exporters; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/exporting.rb:19
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/exporting.rb:38
  def unregister_exporter(mime_types, exporter = T.unsafe(nil)); end
end

# source://sprockets-VERSION/lib/sprockets/errors.rb:10
class Sprockets::FileNotFound < ::Sprockets::NotFound; end

# source://sprockets-VERSION/lib/sprockets/errors.rb:11
...
#
# source://sprockets-VERSION/lib/sprockets/file_reader.rb:7
class Sprockets::FileReader
  class << self
    # source://sprockets-VERSION/lib/sprockets/file_reader.rb:8
    def call(input); end
  end
end
...
# Environment.
#
# source://sprockets-VERSION/lib/sprockets/http_utils.rb:5
module Sprockets::HTTPUtils
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/http_utils.rb:129
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/http_utils.rb:107
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/http_utils.rb:117
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/http_utils.rb:74
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/http_utils.rb:16
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/http_utils.rb:28
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/http_utils.rb:58
  def parse_q_values(values); end
end

# source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:6
class Sprockets::JSMincCompressor
  # @return [JSMincCompressor] a new instance of JSMincCompressor
  #
  # source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:23
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute cache_key.
  #
  # source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:21
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:28
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:17
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:13
    def call(input); end

    # source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:9
    def instance; end
  end
end

# source://sprockets-VERSION/lib/sprockets/jsminc_compressor.rb:7
...
#
# source://sprockets-VERSION/lib/sprockets/jst_processor.rb:21
class Sprockets::JstProcessor
  # @return [JstProcessor] a new instance of JstProcessor
  #
  # source://sprockets-VERSION/lib/sprockets/jst_processor.rb:37
  def initialize(namespace: T.unsafe(nil)); end

  # source://sprockets-VERSION/lib/sprockets/jst_processor.rb:41
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/jst_processor.rb:33
    def call(input); end

    # source://sprockets-VERSION/lib/sprockets/jst_processor.rb:22
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/jst_processor.rb:29
    def instance; end
  end
end
...
# object.
#
# source://sprockets-VERSION/lib/sprockets/loader.rb:19
module Sprockets::Loader
  ...
  # Returns Asset.
  #
  # source://sprockets-VERSION/lib/sprockets/loader.rb:31
  def load(uri); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/loader.rb:111
  def asset_from_cache(key); end

  # source://sprockets-VERSION/lib/sprockets/loader.rb:67
  def compress_key_from_hash(hash, key); end

  # source://sprockets-VERSION/lib/sprockets/loader.rb:87
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/loader.rb:323
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/loader.rb:139
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/loader.rb:287
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/loader.rb:237
...
#
# source://sprockets-VERSION/lib/sprockets/manifest.rb:19
class Sprockets::Manifest
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:32
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:91
  def assets; end
  ...
  #   age=600.
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:246
  def clean(count = T.unsafe(nil), age = T.unsafe(nil)); end

  # Wipe directive
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:269
  def clobber; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:161
  def compile(*args); end

  # Returns the value of attribute directory.
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:80
  def dir; end
  ...
  # Returns the value of attribute environment.
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:22
  def environment; end

  # Returns String path to manifest.json file.
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:77
  def filename; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:108
  def files; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:115
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:139
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:216
  def remove(filename); end

  # Persist manifest back to FS
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:278
  def save; end

  private

  # source://sprockets-VERSION/lib/sprockets/manifest.rb:335
  def executor; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest.rb:299
  def exporters_for_asset(asset); end

  # source://sprockets-VERSION/lib/sprockets/manifest.rb:317
  def json_decode(obj); end

  # source://sprockets-VERSION/lib/sprockets/manifest.rb:321
  def json_encode(obj); end

  # source://sprockets-VERSION/lib/sprockets/manifest.rb:325
  def logger; end
end

# Public: Manifest utilities.
#
# source://sprockets-VERSION/lib/sprockets/manifest_utils.rb:7
module Sprockets::ManifestUtils
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/manifest_utils.rb:37
  ...
  # Return String path.
  #
  # source://sprockets-VERSION/lib/sprockets/manifest_utils.rb:23
  def generate_manifest_path; end
end

# source://sprockets-VERSION/lib/sprockets/manifest_utils.rb:10
Sprockets::ManifestUtils::MANIFEST_RE = T.let(T.unsafe(nil), Regexp)

# source://sprockets-VERSION/lib/sprockets/mime.rb:7
module Sprockets::Mime
  ...
  # Returns Hash.
  #
  # source://sprockets-VERSION/lib/sprockets/mime.rb:34
  def mime_exts; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/mime.rb:71
  ...
  # Returns Hash.
  #
  # source://sprockets-VERSION/lib/sprockets/mime.rb:18
  def mime_types; end
  ...
  # encoding.
  #
  # source://sprockets-VERSION/lib/sprockets/mime.rb:86
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/mime.rb:46
  def register_mime_type(mime_type, extensions: T.unsafe(nil), charset: T.unsafe(nil)); end
end

# source://sprockets-VERSION/lib/sprockets/errors.rb:8
class Sprockets::NotFound < ::Sprockets::Error; end

# source://sprockets-VERSION/lib/sprockets/errors.rb:7
class Sprockets::NotImplementedError < ::Sprockets::Error; end

# source://sprockets-VERSION/lib/sprockets/npm.rb:5
module Sprockets::Npm
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/npm.rb:39
  ...
  # Returns candidate filenames.
  #
  # source://sprockets-VERSION/lib/sprockets/npm.rb:12
  def resolve_alternates(load_path, logical_path); end
end
...
#     # => "\x03\x04\x05"
#
# source://sprockets-VERSION/lib/sprockets/path_dependency_utils.rb:32
module Sprockets::PathDependencyUtils
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_dependency_utils.rb:44
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_dependency_utils.rb:56
  ...
  # Returns an Array of filenames and a Set of dependency URIs.
  #
  # source://sprockets-VERSION/lib/sprockets/path_dependency_utils.rb:68
  def stat_sorted_tree_with_dependencies(dir); end
end

# Internal: Crossover of path and digest utilities functions.
#
# source://sprockets-VERSION/lib/sprockets/path_digest_utils.rb:7
module Sprockets::PathDigestUtils
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_digest_utils.rb:33
  def file_digest(path); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_digest_utils.rb:44
  ...
  # Returns String digest bytes.
  #
  # source://sprockets-VERSION/lib/sprockets/path_digest_utils.rb:16
...
#
# source://sprockets-VERSION/lib/sprockets/path_utils.rb:7
module Sprockets::PathUtils
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:83
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:348
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:42
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:56
  def entries(path); end
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:29
  def file?(path); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:231
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:273
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:127
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:202
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:192
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:252
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:178
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:100
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:110
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:146
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:162
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:16
  def stat(path); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:286
  ...
  # Returns an Enumerator of [path, stat].
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:324
  ...
  # Returns an Enumerator of [path, stat].
  #
  # source://sprockets-VERSION/lib/sprockets/path_utils.rb:304
  def stat_tree(dir, &block); end
end

# source://sprockets-VERSION/lib/sprockets/path_utils.rb:91
Sprockets::PathUtils::SEPARATOR_PATTERN = T.let(T.unsafe(nil), String)

# source://sprockets-VERSION/lib/sprockets/paths.rb:6
module Sprockets::Paths
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/paths.rb:47
  ...
  # you want.
  #
  # source://sprockets-VERSION/lib/sprockets/paths.rb:59
  def clear_paths; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/paths.rb:68
  def each_file; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/paths.rb:30
  def paths; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/paths.rb:37
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/paths.rb:13
  def root; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/paths.rb:20
  def root=(path); end
end

# source://sprockets-VERSION/lib/sprockets/preprocessors/default_source_map.rb:3
...
# available.
#
# source://sprockets-VERSION/lib/sprockets/preprocessors/default_source_map.rb:10
class Sprockets::Preprocessors::DefaultSourceMap
  # source://sprockets-VERSION/lib/sprockets/preprocessors/default_source_map.rb:11
  def call(input); end

  private

  # source://sprockets-VERSION/lib/sprockets/preprocessors/default_source_map.rb:38
...
# the `Environment` and `CachedEnvironment` classes.
#
# source://sprockets-VERSION/lib/sprockets/processing.rb:11
module Sprockets::Processing
  ...
  # individual files.
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:95
  def bundle_processors; end

  # source://sprockets-VERSION/lib/sprockets/processing.rb:14
  def pipelines; end

  # Postprocessors are ran after Preprocessors and Engine processors.
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:39
  def postprocessors; end

  # Preprocessors are ran before Postprocessors and Engine
  # processors.
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:33
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:137
  ...
  #     end
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:109
  def register_bundle_processor(*args, &block); end

  # Registers a pipeline that will be called by `call_processor` method.
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:19
  ...
  #     end
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:69
  ...
  #     end
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:53
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:117
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:88
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processing.rb:78
  ...
  # source://sprockets-VERSION/lib/sprockets/processing.rb:168
  def build_processors_uri(type, file_type, pipeline); end

  # source://sprockets-VERSION/lib/sprockets/processing.rb:186
  def default_processors_for(type, file_type); end

  # source://sprockets-VERSION/lib/sprockets/processing.rb:177
  def processors_for(type, file_type, pipeline); end

  # source://sprockets-VERSION/lib/sprockets/processing.rb:162
  def resolve_processors_cache_key_uri(uri); end

  # source://sprockets-VERSION/lib/sprockets/processing.rb:195
  def self_processors_for(type, file_type); end

  private

  # source://sprockets-VERSION/lib/sprockets/processing.rb:212
  def register_config_processor(type, mime_type, processor = T.unsafe(nil), &block); end

  # source://sprockets-VERSION/lib/sprockets/processing.rb:221
...
#
# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:17
module Sprockets::ProcessorUtils
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:80
  ...
  # Returns a Hash with :data and other processor metadata key/values.
  #
  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:61
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:46
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:101
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:110
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:152
  def validate_processor_result!(result); end
end

# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:20
class Sprockets::ProcessorUtils::CompositeProcessor < ::Struct
  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:36
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:32
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/processor_utils.rb:24
    def create(processors); end
  end
end

# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:22
Sprockets::ProcessorUtils::CompositeProcessor::PLURAL = T.let(T.unsafe(nil), Proc)

# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:21
Sprockets::ProcessorUtils::CompositeProcessor::SINGULAR = T.let(T.unsafe(nil), Proc)

# Internal: Set of all nested compound metadata types that can nest values.
#
# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:126
...
#
# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:139
...
#
# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:144
...
# processor metadata.
#
# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:116
...
# processor metadata.
#
# source://sprockets-VERSION/lib/sprockets/processor_utils.rb:134
Sprockets::ProcessorUtils::VALID_METADATA_VALUE_TYPES_HASH = T.let(T.unsafe(nil), Hash)

# source://sprockets-VERSION/lib/sprockets/resolve.rb:8
module Sprockets::Resolve
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:24
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:46
  def resolve!(path, **kargs); end
  ...
  #     []
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:279
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:92
  def resolve_absolute_path(paths, filename, accept); end

  # source://sprockets-VERSION/lib/sprockets/resolve.rb:291
  def resolve_alternates(load_path, logical_name); end

  # source://sprockets-VERSION/lib/sprockets/resolve.rb:257
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:77
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:239
  ...
  # Returns Array. Filename, type, path_pipeline, deps, index_alias
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:142
  ...
  # Returns Array. First element is an Array of hashes or empty, second is a String
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:217
  ...
  # Returns Array. Filename, type, path_pipeline, deps, index_alias
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:120
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/resolve.rb:176
...
#
# source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:19
class Sprockets::SassCompressor
  # @return [SassCompressor] a new instance of SassCompressor
  #
  # source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:39
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute cache_key.
  #
  # source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:37
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:49
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:33
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:29
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:25
    def instance; end
  end
end

# source://sprockets-VERSION/lib/sprockets/sass_compressor.rb:20
...
#
# source://sprockets-VERSION/lib/sprockets/sassc_compressor.rb:18
class Sprockets::SasscCompressor
  # @return [SasscCompressor] a new instance of SasscCompressor
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_compressor.rb:30
  def initialize(options = T.unsafe(nil)); end

  # source://sprockets-VERSION/lib/sprockets/sassc_compressor.rb:39
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/sassc_compressor.rb:26
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/sassc_compressor.rb:22
    def instance; end
  end
end
...
#
# source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:15
class Sprockets::SasscProcessor
  # @return [SasscProcessor] a new instance of SasscProcessor
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:40
  def initialize(options = T.unsafe(nil), &block); end

  # Returns the value of attribute cache_key.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:38
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:52
  def call(input); end

  private

  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:273
  def engine_options(input, context); end

  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:78
  def merge_options(options); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:34
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:30
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:26
    def instance; end

    # Internal: Defines default sass syntax to use. Exposed so the ScsscProcessor
    # may override it.
    #
    # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:19
    def syntax; end
  end
end
...
# end
#
# source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:100
module Sprockets::SasscProcessor::Functions
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:243
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:110
  def asset_path(path, options = T.unsafe(nil)); end
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:126
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:171
  def audio_path(path); end
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:180
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:189
  def font_path(path); end
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:198
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:135
  def image_path(path); end
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:144
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:207
  def javascript_path(path); end
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:216
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:225
  def stylesheet_path(path); end
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:234
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:153
  def video_path(path); end
  ...
  # Returns a SassC::Script::Value::String.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:162
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:267
  ...
  # Returns a Set.
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:259
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:252
  def sprockets_environment; end
end

# source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:292
class Sprockets::ScsscProcessor < ::Sprockets::SasscProcessor
  class << self
    # source://sprockets-VERSION/lib/sprockets/sassc_processor.rb:293
    def syntax; end
  end
end
...
#
# source://sprockets-VERSION/lib/sprockets/server.rb:10
module Sprockets::Server
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:27
  def call(env); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:149
  def bad_request_response(env); end

  # source://sprockets-VERSION/lib/sprockets/server.rb:257
  def cache_headers(env, etag); end

  # Returns a CSS response that hides all elements on the page and
  # displays the exception
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:197
  def css_exception_response(exception); end

  # Escape special characters for use inside a CSS content("...") string
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:249
  def escape_css_content(content); end

  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:122
  def forbidden_request?(path); end

  # Returns a 403 Forbidden response tuple
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:158
  def forbidden_response(env); end

  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:130
  def head_request?(env); end

  # source://sprockets-VERSION/lib/sprockets/server.rb:278
  def headers(env, asset, length); end

  # Returns a JavaScript response that re-throws a Ruby exception
  # in the browser
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:189
  def javascript_exception_response(exception); end

  # source://sprockets-VERSION/lib/sprockets/server.rb:175
  def method_not_allowed_response; end

  # Returns a 404 Not Found response tuple
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:167
  def not_found_response(env); end

  # Returns a 304 Not Modified response tuple
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:144
  def not_modified_response(env, etag); end

  # Returns a 200 OK response tuple
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:135
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/server.rb:301
  def path_fingerprint(path); end

  # source://sprockets-VERSION/lib/sprockets/server.rb:179
  def precondition_failed_response(env); end
end

# Supported HTTP request methods.
#
# source://sprockets-VERSION/lib/sprockets/server.rb:12
...
#   }
#
# source://sprockets-VERSION/lib/sprockets/source_map_processor.rb:25
class Sprockets::SourceMapProcessor
  class << self
    # source://sprockets-VERSION/lib/sprockets/source_map_processor.rb:26
    def call(input); end

    # source://sprockets-VERSION/lib/sprockets/source_map_processor.rb:54
    def original_content_type(source_map_content_type, error_when_not_found: T.unsafe(nil)); end
  end
end

# source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:6
module Sprockets::SourceMapUtils
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:273
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:156
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:254
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:73
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:192
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:297
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:235
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:346
  ...
  #     #}
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:37
  ...
  #     }
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:129
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:429
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:470
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:408
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:457
  def vlq_encode_mappings(ary); end
end

# source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:400
Sprockets::SourceMapUtils::BASE64_DIGITS = T.let(T.unsafe(nil), Array)

# source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:401
Sprockets::SourceMapUtils::BASE64_VALUES = T.let(T.unsafe(nil), Hash)

# source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:396
Sprockets::SourceMapUtils::VLQ_BASE = T.let(T.unsafe(nil), Integer)

# source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:397
...
#
# source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:395
Sprockets::SourceMapUtils::VLQ_BASE_SHIFT = T.let(T.unsafe(nil), Integer)

# source://sprockets-VERSION/lib/sprockets/source_map_utils.rb:398
Sprockets::SourceMapUtils::VLQ_CONTINUATION_BIT = T.let(T.unsafe(nil), Integer)

# source://sprockets-VERSION/lib/sprockets/transformers.rb:7
module Sprockets::Transformers
  ...
  # Returns Processor.
  #
  # source://sprockets-VERSION/lib/sprockets/transformers.rb:115
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/transformers.rb:97
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/transformers.rb:38
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/transformers.rb:53
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/transformers.rb:83
  ...
  #        }
  #
  # source://sprockets-VERSION/lib/sprockets/transformers.rb:18
  def transformers; end

  private

  # source://sprockets-VERSION/lib/sprockets/transformers.rb:131
  def compose_transformer_list(transformers, preprocessors, postprocessors); end

  # source://sprockets-VERSION/lib/sprockets/transformers.rb:147
  def compute_transformers!(registered_transformers); end
end

# source://sprockets-VERSION/lib/sprockets/transformers.rb:22
...
#
# source://sprockets-VERSION/lib/sprockets/uri_tar.rb:6
class Sprockets::URITar
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/uri_tar.rb:13
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/uri_tar.rb:44
  ...
  # Returns String
  #
  # source://sprockets-VERSION/lib/sprockets/uri_tar.rb:35
  def compress; end
  ...
  # Returns String
  #
  # source://sprockets-VERSION/lib/sprockets/uri_tar.rb:84
  ...
  # Returns String
  #
  # source://sprockets-VERSION/lib/sprockets/uri_tar.rb:60
  def expand; end

  # Returns the value of attribute path.
  #
  # source://sprockets-VERSION/lib/sprockets/uri_tar.rb:7
  def path; end
...
#
# source://sprockets-VERSION/lib/sprockets/uri_utils.rb:21
module Sprockets::URIUtils
  ...
  # Returns String URI.
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:114
  ...
  # Returns String URI.
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:148
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:157
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:62
  ...
  # Returns String.
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:36
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:93
  ...
  # Returns String path.
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:128
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:182
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:45
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:29
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/uri_utils.rb:76
  def valid_asset_uri?(str); end
end

# source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:19
class Sprockets::UglifierCompressor
  # @return [UglifierCompressor] a new instance of UglifierCompressor
  #
  # source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:39
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute cache_key.
  #
  # source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:37
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:46
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:33
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:29
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:25
    def instance; end
  end
end

# source://sprockets-VERSION/lib/sprockets/uglifier_compressor.rb:20
...
#
# source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:8
class Sprockets::UnloadedAsset
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:22
  def initialize(uri, env); end
  ...
  # Returns a String.
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:77
  def asset_key; end

  # Returns the value of attribute compressed_path.
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:29
  def compressed_path; end
  ...
  # Returns a String.
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:104
  ...
  # Returns a String.
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:117
  ...
  # Returns a String.
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:127
  ...
  # Returns a String.
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:43
  def filename; end
  ...
  # Returns a Hash.
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:63
  def params; end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/unloaded_asset.rb:135
...
#
# source://sprockets-VERSION/lib/sprockets/utils.rb:7
module Sprockets::Utils
  ...
  # Returns buf String.
  #
  # source://sprockets-VERSION/lib/sprockets/utils.rb:100
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/utils.rb:160
  def dfs(initial); end
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/utils.rb:187
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/utils.rb:17
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/utils.rb:61
  ...
  # Returns Hash.
  #
  # source://sprockets-VERSION/lib/sprockets/utils.rb:34
  ...
  #
  # source://sprockets-VERSION/lib/sprockets/utils.rb:126
...
class Sprockets::Utils::Gzip
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:68
  ...
  # @return [Boolean]
  #
  # source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:80
  ...
  # Returns nothing.
  #
  # source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:91
...
#
# source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:52
...
#
# source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:12
module Sprockets::Utils::Gzip::ZlibArchiver
  class << self
    # source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:13
...
# written file to passed in `mtime`
#
# source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:30
module Sprockets::Utils::Gzip::ZopfliArchiver
  class << self
    # source://sprockets-VERSION/lib/sprockets/utils/gzip.rb:31
    def call(file, source, mtime); end
  end
end

# source://sprockets-VERSION/lib/sprockets/utils.rb:71
Sprockets::Utils::WHITESPACE_ORDINALS = T.let(T.unsafe(nil), Hash)

# source://sprockets-VERSION/lib/sprockets/version.rb:3
...
#
# source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:18
class Sprockets::YUICompressor
  # @return [YUICompressor] a new instance of YUICompressor
  #
  # source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:38
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute cache_key.
  #
  # source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:36
  def cache_key; end

  # source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:43
  def call(input); end

  class << self
    # source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:32
    def cache_key; end

    # source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:28
    def call(input); end
    ...
    #
    # source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:24
    def instance; end
  end
end

# source://sprockets-VERSION/lib/sprockets/yui_compressor.rb:19
