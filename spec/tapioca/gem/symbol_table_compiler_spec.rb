...
class Tapioca::Gem::SymbolTableCompilerSpec < Minitest::HooksSpec
  ...
  describe Tapioca::Gem::SymbolTableCompiler do
    ...
    def compile(include_doc: false)
      ...
      tree = Tapioca::Gem::SymbolTableCompiler.new(gem, include_doc: include_doc).compile
