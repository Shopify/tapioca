...
class Tapioca::Gem::PipelineSpec < Minitest::HooksSpec
  ...
  describe Tapioca::Gem::Pipeline do
    ...
    it "compile RBIs with location from gem source" do
      ...
      output = template(<<~RBI)
        # source://the-dep-VERSION/lib/bar.rb:1
        module Bar
          # Some documentation
          #
          # source://the-dep-VERSION/lib/bar.rb:6
          sig { void }
          def bar; end

          def foo1; end

          # source://the-dep-VERSION/lib/bar.rb:15
          def foo2; end

          class << self
            # Some documentation
            #
            # source://the-dep-VERSION/lib/bar.rb:9
            def bar; end
          end
        end

        # source://the-dep-VERSION/lib/bar.rb:11
        Bar::BAR = T.let(T.unsafe(nil), Integer)

        # source://the-dep-VERSION/lib/foo.rb:23
        class BasicFoo < ::BasicObject
          # source://the-dep-VERSION/lib/foo.rb:27
          sig { void }
          def foo; end
        end
        ...
        #
        # source://the-dep-VERSION/lib/foo.rb:11
        class Baz
          abstract!

          # source://sorbet-runtime-VERSION/lib/types/private/abstract/declare.rb:37
        <% if ruby_version(">= 3.1") %>
          def initialize(*args, **_arg1, &blk); end
        <% else %>
          def initialize(*args, &blk); end
        ...
        # source://the-dep-VERSION/lib/foo.rb:1
        class Foo; end

        # source://the-dep-VERSION/lib/foo.rb:6
        module Foo::Helper
          # source://the-dep-VERSION/lib/foo.rb:7
          def helper_method; end
        end

        # source://the-dep-VERSION/lib/foo.rb:30
        class NewClass; end

        # source://the-dep-VERSION/lib/option.rb:1
        class Option
          include ::Mutex_m
        ...
        # source://the-dep-VERSION/lib/foo.rb:16
        class Quux < ::T::Struct
          class << self
            # source://sorbet-runtime-VERSION/lib/types/struct.rb:13
            def inherited(s); end
          end
        end

        # source://the-dep-VERSION/lib/foo.rb:19
        class String
          include ::Comparable

          # source://the-dep-VERSION/lib/foo.rb:20
          def foo; end
        end

        # source://activesupport-VERSION/lib/active_support/core_ext/object/blank.rb:104
        String::BLANK_RE = T.let(T.unsafe(nil), Regexp)

        # source://activesupport-VERSION/lib/active_support/core_ext/object/blank.rb:105
        String::ENCODED_BLANKS = T.let(T.unsafe(nil), Concurrent::Map)
      RBI
