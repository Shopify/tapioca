...
describe(Tapioca::Cli) do
  ...
  describe("#dsl") do
    it 'does not generate anything if there are no matching constants' do
      ...
      refute_path_exists(repo_path / "sorbet/rbi/dsl/post.rbi")
      refute_path_exists(repo_path / "sorbet/rbi/dsl/namespace/comment.rbi")
    ...
    it 'generates RBI files for only required constants' do
      ...
      assert_equal(<<~CONTENTS.chomp, File.read(repo_path / "sorbet/rbi/dsl/post.rbi"))
        # DO NOT EDIT MANUALLY
    ...
    it 'generates RBI files for all processable constants' do
      ...
      assert_equal(<<~CONTENTS.chomp, File.read(repo_path / "sorbet/rbi/dsl/namespace/comment.rbi"))
        # DO NOT EDIT MANUALLY
