    ...
    module Helpers
      class GraphqlTypeHelperSpec < Minitest::Spec
        ...
        it "generates the expected sorbet type expression when using type GraphQL::Types::Boolean" do
          ...
          assert_equal(
            "::T.nilable(T::Boolean)",
            Tapioca::Dsl::Helpers::GraphqlTypeHelper.type_for(type).to_rbi,
          )
          assert_equal(
            "::T.nilable(T::Boolean)",
            Tapioca::Dsl::Helpers::GraphqlTypeHelper.type_for(GraphQL::Schema::Wrapper.new(type)).to_rbi,
          )
          assert_equal(
            "::T.nilable(T::Array[T::Boolean])",
            Tapioca::Dsl::Helpers::GraphqlTypeHelper.type_for(GraphQL::Schema::List.new(type)).to_rbi,
          )
          assert_equal(
            "T::Boolean",
            Tapioca::Dsl::Helpers::GraphqlTypeHelper.type_for(GraphQL::Schema::NonNull.new(type)).to_rbi,
          )
        end
