      ...
      class ProtobufSpec < ::DslSpec
        describe "Tapioca::Dsl::Compilers::Protobuf" do
          ...
          describe "decorate" do
            ...
            it "handles map types by matching on key and value fields" do
              add_ruby_file("protobuf.rb", <<~RUBY)
                Google::Protobuf::DescriptorPool.generated_pool.build do
                  add_file("cart.proto", :syntax => :proto3) do
                    ...
                    add_message "MyCart" do
                      repeated :tables, :message, 1, "CartEntry"
              ...
              expected = <<~RBI
                ...
                class Cart
                  sig { params(items: T.nilable(T.any(Google::Protobuf::RepeatedField[NonMapEntry], T::Array[NonMapEntry])), tables: T.nilable(T.any(Google::Protobuf::Map[String, String], T::Hash[String, String]))).void }
                  def initialize(items: Google::Protobuf::RepeatedField.new(:message, NonMapEntry), tables: Google::Protobuf::Map.new(:string, :string)); end
                  ...
                  sig { returns(Google::Protobuf::RepeatedField[NonMapEntry]) }
                  def items; end

                  sig { params(value: Google::Protobuf::RepeatedField[NonMapEntry]).void }
                  def items=(value); end
