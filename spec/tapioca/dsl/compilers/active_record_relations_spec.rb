              ...
              expected = template(<<~RUBY)
                ...
                class Post
                  ...
                  module CommonRelationMethods
                    ...
                    sig { params(args: ::T.any(::String, ::Symbol, ::ActiveSupport::Multibyte::Chars, ::BigDecimal, ::Numeric, ::ActiveRecord::Type::Binary::Data, ::ActiveRecord::Type::Time::Value, ::Date, ::Time, ::ActiveSupport::Duration, T::Class[::T.anything], ::CustomId, T::Boolean)).returns(::Post) }
                    sig { params(args: T::Array[::T.any(::String, ::Symbol, ::ActiveSupport::Multibyte::Chars, ::BigDecimal, ::Numeric, ::ActiveRecord::Type::Binary::Data, ::ActiveRecord::Type::Time::Value, ::Date, ::Time, ::ActiveSupport::Duration, T::Class[::T.anything], ::CustomId, T::Boolean)]).returns(T::Enumerable[::Post]) }
              ...
              expected = template(<<~RUBY)
                ...
                class Post
                  ...
                  module CommonRelationMethods
                    ...
                    sig { params(args: T::Array[::T.any(::String, ::Symbol, ::ActiveSupport::Multibyte::Chars, ::BigDecimal, ::Numeric, ::ActiveRecord::Type::Binary::Data, ::ActiveRecord::Type::Time::Value, ::Date, ::Time, ::ActiveSupport::Duration, T::Class[::T.anything], T::Boolean)]).returns(::Post) }
                    sig { params(args: T::Array[T::Array[::T.any(::String, ::Symbol, ::ActiveSupport::Multibyte::Chars, ::BigDecimal, ::Numeric, ::ActiveRecord::Type::Binary::Data, ::ActiveRecord::Type::Time::Value, ::Date, ::Time, ::ActiveSupport::Duration, T::Class[::T.anything], T::Boolean)]]).returns(T::Enumerable[::Post]) }
                    sig { params(args: NilClass, block: ::T.proc.params(object: ::Post).void).returns(::T.nilable(::Post)) }
                    def find(args = nil, &block); end
