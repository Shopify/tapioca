          ...
          describe "decorate" do
            ...
            it "generates correct RBI for all graphql types" do
              ...
              expected = <<~RBI
                ...
                class CreateComment
                  sig { params(boolean: T::Boolean, float: ::Float, id: ::String, int: ::Integer, big_int: ::Integer, date: ::Date, datetime: ::Time, json: ::String, string: ::String, enum_a: ::String, enum_b: T.any(::String, ::Symbol), input_object: ::CreateCommentInput, custom_scalar: T.untyped).returns(T.untyped) }
