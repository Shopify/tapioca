  ...
  class GemSpec < SpecWithProject
    ...
    describe "cli::gem" do
      ...
      describe "generate" do
        ...
        it "must generate a gem RBI and resolves conflicts with exported gem " \
          "RBIs by keeping the exported RBI with `--favor-exported-gem-rbis`" do
          foo = mock_gem("foo", "0.0.1") do
            write("lib/foo.rb", FOO_RB)
          ...
          result = @project.tapioca("gem foo --favor-exported-gem-rbis")

          assert_includes(result.out, "create  sorbet/rbi/gems/foo@0.0.1.rbi")
          assert_project_file_equal(
