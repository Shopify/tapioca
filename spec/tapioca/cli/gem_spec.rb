  ...
  class GemSpec < SpecWithProject
    ...
    describe "cli::gem" do
      ...
      describe "generate" do
        ...
        it "must generate mixins properly" do
          foo = mock_gem("spoom", "0.0.1") do
            write("lib/sorbet/bar.rb", <<~RBI)
          ...
          assert_project_file_equal("sorbet/rbi/gems/spoom@0.0.1.rbi", <<~RBI)
            # typed: true
