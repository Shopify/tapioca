  ...
  class GemSpec < SpecWithProject
    ...
    describe "cli::gem" do
      ...
      describe "generate" do
        ...
        it "generates `ObjectSpace::WeakMap` as a generic type with Sorbet < 0.5.10587" do
          foo = mock_gem("foo", "0.0.1") do
            write("lib/foo.rb", <<~RB)
        ...
        it "generates `ObjectSpace::WeakMap` as a non-generic type with Sorbet >= 0.5.10587" do
          foo = mock_gem("foo", "0.0.1") do
            write("lib/foo.rb", <<~RB)
              Foo = ObjectSpace::WeakMap.new
            RB
