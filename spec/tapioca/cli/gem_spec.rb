  ...
  class GemSpec < SpecWithProject
    ...
    describe "cli::gem" do
      ...
      describe "verify all" do
        ...
        it "ignores source location mismatches" do
          @project.tapioca("gem --all --loc")
          includes_source = mock_gem("my_gem", "0.0.1") do
            write("lib/my_gem.rb", <<~RB)
              module MyGem
                def useful_method; end
              end
            RB
          end
          @project.require_mock_gem(includes_source)
          @project.bundle_install

          @project.write("sorbet/rbi/gems/my_gem@0.0.1.rbi", <<~RBI)
            # typed: true

            # DO NOT EDIT MANUALLY
            # This is an autogenerated file for types exported from the `my_gem` gem.
            # Please instead update this file by running `bin/tapioca gem my_gem`.

            # source://will-definitely-not-match:1
            module MyGem
              # source://will-definitely-not-match:2
              def useful_method; end
            end
          RBI

          result = @project.tapioca("gem --all --verify --loc")
          ...
          @project.tapioca("gem --all --no-loc")
        end
