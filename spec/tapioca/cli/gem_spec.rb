    ...
    describe("#cli::gem") do
      ...
      describe("sync") do
        ...
        it "must respect exclude option" do
          ...
          assert_includes(out, "-- Removing: sorbet/rbi/gems/foo@0.0.1.rbi\n")
          assert_includes(out, "-- Removing: sorbet/rbi/gems/bar@0.3.0.rbi\n")
          refute_includes(out, "-- Removing: sorbet/rbi/gems/baz@0.0.2.rbi\n")
        ...
        it "must remove outdated RBIs" do
          ...
          assert_includes(out, "-- Removing: sorbet/rbi/gems/outdated@5.0.0.rbi\n")
          refute_includes(out, "create sorbet/rbi/gems/foo@0.0.1.rbi")
          refute_includes(out, "create sorbet/rbi/gems/bar@0.3.0.rbi")
          refute_includes(out, "create sorbet/rbi/gems/baz@0.0.2.rbi")
          refute_includes(out, "-> Moving:")
