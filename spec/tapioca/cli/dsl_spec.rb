      ...
      describe("generate") do
        ...
        it "removes stale RBI files" do
          ...
          assert_equal(<<~OUT, out)
            ...
            -- Removing: sorbet/rbi/dsl/does_not_exist.rbi
            -- Removing: sorbet/rbi/dsl/to_be_deleted/baz.rbi
            -- Removing: sorbet/rbi/dsl/to_be_deleted/foo.rbi
        ...
        it "removes stale RBI files of requested constants" do
          ...
          assert_equal(<<~OUT, out)
            ...
            Removing stale RBI files...
            -- Removing: sorbet/rbi/dsl/user.rbi
