      ...
      describe "verify" do
        ...
        it "advises of removed file(s) and returns exit status 1 when files are excluded" do
          ...
          assert_stderr_equals(<<~ERROR, result)
            ...
            Diff:
            --- Current post.rbi
            +++ Correct post.rbi (After running `bin/tapioca dsl`)
            @@ -1,18 +0,0 @@
            -# typed: true
            -
            -# DO NOT EDIT MANUALLY
        ...
        it "advises of new file(s) and returns exit status 1 with new files" do
          ...
          assert_stderr_equals(<<~ERROR, result)
            ...
            Diff:
            --- Current image.rbi
            +++ Correct image.rbi (After running `bin/tapioca dsl`)
            @@ -0,0 +1,18 @@
            +# typed: true
            +
            +# DO NOT EDIT MANUALLY
        ...
        it "truncates diff output to 250 lines when it exceeds the limit" do
          ...
          diff_section = result.err.to_s.partition("Diff truncated to 250 lines:\n").last
          assert_equal(250, diff_section.lines.count)
        ...
        it "respects a custom --max-diff-lines value" do
          ...
          diff_section = result.err.to_s.partition("Diff truncated to 5 lines:\n").last
          assert_equal(5, diff_section.lines.count)
