...
module RBI
  class File
    ...
    def transform_rbi!
      ...
      root.group_nodes! unless empty? # NOTE: This raises when we don't have any nodes
      root.sort_nodes!
    end
    ...
    sig { void }
    def include_empty_rbi_comment
      # TODO: I think it would make more sense for this to exist under `root.comments`, however,
      # those don't seem to be rendered with the string output. So for the interim, this seems like
      # the most logical way to append it and keep this logic within `RBI::File`.

      # NOTE: Should we include an `RBI::EmptyComment` here? Causes slightly weird formatting in empty
      # RBI case.
