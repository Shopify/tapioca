    ...
    class Main < Thor
      ...
      def gem(*gems)
        Tapioca.silence_warnings do
          ...
          raise MalformattedArgumentError, "Option '--all' must be provided without any other arguments" if all && !gems.empty?
          raise MalformattedArgumentError, "Option '--verify' must be provided without any other arguments" if verify && !gems.empty?
