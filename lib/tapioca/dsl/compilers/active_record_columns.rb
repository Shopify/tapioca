  ...
  module Dsl
    module Compilers
      ...
      class ActiveRecordColumns < Compiler
        ...
        #| ) -> void
        def add_method(klass, name, methods_to_add, return_type: RBI::Type.void, parameters: [])
          klass.create_method(
            name,
        ...
        def add_methods_for_attribute(klass, attribute_name, column_name = attribute_name, methods_to_add = nil)
          ...
          add_method(
            ...
            methods_to_add,
            return_type: RBI::Type.tuple(getter_type, getter_type).nilable,
          )
          add_method(
            klass,
          ...
          add_method(
            ...
            return_type: RBI::Type.boolean,
            parameters: [
              create_kw_opt_param("from", type: RBI::Type.untyped, default: "T.unsafe(nil)"),
              create_kw_opt_param("to", type: RBI::Type.untyped, default: "T.unsafe(nil)"),
            ],
          )
          add_method(
            klass,
